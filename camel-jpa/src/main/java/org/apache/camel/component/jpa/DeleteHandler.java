...
parameter_list|>
block|{
comment|/**      * Deletes the entity bean after it has been processed either by actually      * deleting the object or updating it in a way so that future queries do not return this object again.      *      * @param consumer the consumer which has access to the {@link JpaEndpoint} and JPA {@link EntityManager}      * @param entityBean the entity bean that has been processed and should be deleted      */
DECL|method|deleteObject (JpaConsumer consumer, T entityBean)
name|void
name|deleteObject
parameter_list|(
name|JpaConsumer
