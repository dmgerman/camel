...
begin_comment
comment|/**  * Client route  */
end_comment

begin_class
DECL|class|MyFtpClientRouteBuilder
specifier|public
class|class
...
name|from
argument_list|(
literal|"file:target/upload?moveFailed=../error"
argument_list|)
operator|.
name|log
argument_list|(
literal|"Uploading file ${file:name}"
argument_list|)
operator|.
name|to
argument_list|(
...
name|println
argument_list|(
literal|"Camel will route files from target/upload directory to the FTP server: "
operator|+
name|getContext
argument_list|()
operator|.
...
name|println
argument_list|(
literal|"If the file upload fails, then the file is moved to the target/error directory."
argument_list|)
expr_stmt|;
name|System
operator|.
