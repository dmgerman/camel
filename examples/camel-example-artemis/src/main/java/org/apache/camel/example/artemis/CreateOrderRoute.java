...
begin_comment
comment|/**  * A simple route that routes orders from the file system to the Artemis newOrder queue.  */
end_comment
...
argument_list|)
comment|// route to the newOrder queue on the Artemis broker
operator|.
name|to
argument_list|(
literal|"artemis:queue:newOrder?jmsMessageType=Text"
argument_list|)
expr_stmt|;
block|}
block|}
