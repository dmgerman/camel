...
name|info
argument_list|(
literal|"About to start route: Google Pubsub -> Log "
argument_list|)
expr_stmt|;
name|from
argument_list|(
literal|"google-pubsub:{{pubsub.projectId}}:{{pubsub.subscription}}?"
operator|+
literal|"maxMessagesPerPoll={{consumer.maxMessagesPerPoll}}&"
operator|+
literal|"concurrentConsumers={{consumer.concurrentConsumers}}"
argument_list|)
operator|.
name|routeId
argument_list|(
literal|"FromGooglePubsub"
argument_list|)
operator|.
name|log
argument_list|(
