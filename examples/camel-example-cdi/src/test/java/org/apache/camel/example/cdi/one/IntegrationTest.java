...
begin_package
DECL|package|org.apache.camel.example.cdi.one
package|package
name|org
operator|.
name|apache
...
begin_comment
comment|/**  * Lets use an embedded {@link RouteBuilder} to test {@link MyRoutes}  */
end_comment
...
name|assertTrue
argument_list|(
literal|"RouteBuilder has not been configured!"
argument_list|,
name|routeConfigured
argument_list|)
expr_stmt|;
...
name|class
argument_list|)
comment|//.addPackage(CdiCamelContext.class.getPackage())
operator|.
name|addPackage
argument_list|(
name|CamelExtension
