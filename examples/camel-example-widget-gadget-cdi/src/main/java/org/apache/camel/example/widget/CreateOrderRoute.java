...
name|RouteBuilder
block|{
comment|// we do not have to use @Inject to inject the endpoints
comment|// camel-cdi will auto detect all RouteBuilder classes and include those in the application
annotation|@
name|Override
