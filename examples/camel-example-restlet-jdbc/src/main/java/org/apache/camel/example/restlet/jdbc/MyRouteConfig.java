...
name|from
argument_list|(
literal|"restlet:/persons?restletMethod=POST"
argument_list|)
operator|.
name|setBody
argument_list|(
...
name|from
argument_list|(
literal|"restlet:/persons/{personId}?restletMethods=GET,PUT,DELETE"
argument_list|)
operator|.
name|choice
argument_list|()
...
name|simple
argument_list|(
literal|"${header.CamelHttpMethod} == 'GET'"
argument_list|)
argument_list|)
operator|.
name|setBody
...
name|simple
argument_list|(
literal|"${header.CamelHttpMethod} == 'PUT'"
argument_list|)
argument_list|)
operator|.
name|setBody
...
name|simple
argument_list|(
literal|"${header.CamelHttpMethod} == 'DELETE'"
argument_list|)
argument_list|)
operator|.
name|setBody
...
name|from
argument_list|(
literal|"restlet:/persons?restletMethod=GET"
argument_list|)
operator|.
name|setBody
argument_list|(
