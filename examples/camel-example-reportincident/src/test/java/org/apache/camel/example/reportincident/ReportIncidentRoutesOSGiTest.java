...
name|class
argument_list|)
DECL|class|ReportIncidentRoutesOSGiTest
specifier|public
class|class
name|ReportIncidentRoutesOSGiTest
extends|extends
...
name|systemProperty
argument_list|(
literal|"xml.catalog.staticCatalog"
argument_list|)
operator|.
name|value
argument_list|(
...
argument_list|()
argument_list|,
comment|// create a customer bundle start up the report incident bundle
name|bundle
argument_list|(
name|newBundle
argument_list|()
...
name|addResource
argument_list|(
literal|"etc/report_incident.wsdl"
argument_list|,
name|ReportIncidentRoutesTest
operator|.
name|class
...
argument_list|,
literal|"CamelExampleReportIncidentBundle"
argument_list|)
operator|.
name|set
argument_list|(
...
name|EXPORT_PACKAGE
argument_list|,
literal|"org.apache.camel.example.reportincident,etc"
argument_list|)
argument_list|)
operator|.
name|build
