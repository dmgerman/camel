...
begin_comment
comment|/**  * A simple example router from a file system to an ActiveMQ queue and then to a file system  *  * @version $Revision: 644171 $  */
end_comment
...
name|to
argument_list|(
literal|"file://target/routeOutput"
argument_list|)
expr_stmt|;
