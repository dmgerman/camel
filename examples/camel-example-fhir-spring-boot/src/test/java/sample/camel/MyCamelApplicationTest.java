...
name|uri
operator|=
literal|"mock:fhir:create/resource"
argument_list|)
DECL|field|mock
specifier|private
name|MockEndpoint
...
annotation|@
name|Test
DECL|method|shouldPushConvertedHl7toFhir ()
specifier|public
name|void
name|shouldPushConvertedHl7toFhir
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|(
literal|"{\"resourceType\":\"Patient\",\"id\":\"100005056\",\"name\":[{\"family\":\"Freeman\",\"given\":[\"Vincent\"]}]}"
argument_list|)
expr_stmt|;
name|mock
operator|.
