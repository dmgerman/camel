...
begin_comment
comment|/**  * Client that uses the {@link ProducerTemplate} to easily exchange messages with the Server.  *<p/>  * Requires that the Pulsar broker is running, as well as CamelServer  */
end_comment
...
name|sendBody
argument_list|(
literal|"pulsar:non-persistent://tn1/ns1/cameltest?producerName=clientProd"
argument_list|,
name|ExchangePattern
operator|.
name|InOnly
