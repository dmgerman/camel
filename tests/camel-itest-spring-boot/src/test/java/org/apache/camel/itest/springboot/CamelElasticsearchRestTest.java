...
name|class
argument_list|)
DECL|class|CamelElasticsearchRestTest
specifier|public
class|class
name|CamelElasticsearchRestTest
extends|extends
...
name|dependency
argument_list|(
literal|"org.elasticsearch.client:elasticsearch-rest-client-sniffer:7.1.1"
argument_list|)
operator|.
name|dependency
argument_list|(
literal|"org.elasticsearch.client:elasticsearch-rest-client:7.1.1"
argument_list|)
operator|.
name|dependency
argument_list|(
literal|"org.elasticsearch.client:elasticsearch-rest-high-level-client:7.1.1"
argument_list|)
operator|.
name|build
argument_list|()
