...
name|class
argument_list|)
DECL|class|CamelResilience4jTest
specifier|public
class|class
name|CamelResilience4jTest
extends|extends
...
argument_list|(
literal|".*(\\.integration\\..*|IntegrationTest$|BlueprintResilienceRouteOkTest$|BlueprintResilienceRouteFallbackTest$)"
argument_list|)
operator|.
name|build
argument_list|()
