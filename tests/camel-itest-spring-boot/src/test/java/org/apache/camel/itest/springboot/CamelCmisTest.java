...
argument_list|()
decl_stmt|;
comment|//ArquillianPackager.copyResource(config.getModulesPath() + config.getModuleName() + "/target/dependency/", "chemistry-opencmis-server-inmemory-.*\\.war", "target/dependency/");
return|return
name|ArquillianPackager
operator|.
