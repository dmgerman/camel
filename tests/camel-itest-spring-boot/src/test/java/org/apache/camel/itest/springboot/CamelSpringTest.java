...
argument_list|(
literal|".*(\\.integration\\..*|IntegrationTest$|ManagedRefEndpointTest$|SpringLogProcessorWithProvidedLoggerTest$|SpringManagedCamelContextTest$)"
argument_list|)
operator|.
name|testLibraryVersion
argument_list|(
literal|"com.google.guava:guava"
argument_list|,
name|DependencyResolver
operator|.
name|resolveCamelParentProperty
argument_list|(
literal|"${google-guava-version}"
argument_list|)
argument_list|)
operator|.
name|build
