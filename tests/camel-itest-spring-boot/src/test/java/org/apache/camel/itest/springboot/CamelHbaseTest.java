...
argument_list|)
argument_list|)
comment|// Because HBase uses Hadoop 2.5.1 in test scope
operator|.
name|dependency
argument_list|(
literal|"org.apache.hadoop:hadoop-common:"
operator|+
name|DependencyResolver
operator|.
name|resolveParentProperty
argument_list|(
literal|"${hadoop2-version}"
argument_list|)
argument_list|)
operator|.
name|dependency
argument_list|(
literal|"org.apache.hadoop:hadoop-auth:"
operator|+
name|DependencyResolver
operator|.
name|resolveParentProperty
...
name|dependency
argument_list|(
literal|"org.apache.hadoop:hadoop-mapreduce-client-core:"
operator|+
name|DependencyResolver
operator|.
name|resolveParentProperty
...
name|dependency
argument_list|(
literal|"org.apache.hadoop:hadoop-yarn-common:"
operator|+
name|DependencyResolver
operator|.
name|resolveParentProperty
