...
argument_list|)
decl_stmt|;
comment|//        List<ScopeType> resolvedScopes = new LinkedList<>();
comment|//        resolvedScopes.add(ScopeType.COMPILE);
comment|//        resolvedScopes.add(ScopeType.RUNTIME);
comment|//        resolvedScopes.addAll(scopes);
name|List
argument_list|<
name|MavenResolvedArtifact
argument_list|>
...
return|;
block|}
DECL|method|createResolverPom (ITestConfig config, List<String> cleanTestProvidedDependencies)
specifier|private
specifier|static
name|File
name|createResolverPom
...
expr_stmt|;
block|}
comment|//        StringBuilder dependencies = new StringBuilder();
comment|//        for (String dep : cleanTestProvidedDependencies) {
comment|//            dependencies.append(dep);
comment|//            dependencies.append("\n");
comment|//        }
comment|//
comment|//        pom = pom.replace("<!-- DEPENDENCIES -->", dependencies.toString());
name|Map
argument_list|<
name|String
argument_list|,
...
return|;
block|}
DECL|method|setResolvedVersion (ITestConfig config, String dependencyXml, Map<String, String> resolvedVersions)
specifier|private
specifier|static
name|String
