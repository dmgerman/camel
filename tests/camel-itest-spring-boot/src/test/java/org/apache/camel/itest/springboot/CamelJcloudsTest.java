...
name|class
argument_list|)
DECL|class|CamelJcloudsTest
specifier|public
class|class
name|CamelJcloudsTest
extends|extends
...
argument_list|)
argument_list|)
comment|//.dependency(DependencyResolver.withVersion("com.google.inject:guice"))
comment|//.dependency(DependencyResolver.withVersion("com.google.guava:guava"))
operator|.
name|build
argument_list|()
return|;
