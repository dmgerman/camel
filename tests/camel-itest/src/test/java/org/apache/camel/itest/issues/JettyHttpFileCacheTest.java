...
name|Exception
block|{
comment|// use HttpClient for testing so we wont use Camel to send the request as well, which
comment|// may trigger using stream caching as well and store stream to file
name|HttpClient
name|client
init|=
operator|new
