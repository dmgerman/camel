...
name|Exception
block|{
comment|// TODO: the host header is removed in bridgeEndpoint in the http4 producer, that seems wrong
comment|// as Camel as a reverse-proxy should update the host header accordingly
name|Exchange
name|reply
init|=
name|template
...
name|port2
operator|+
literal|"/foo?bridgeEndpoint=true&throwExceptionOnFailure=false"
argument_list|)
operator|.
name|to
argument_list|(
