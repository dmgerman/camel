...
begin_class
DECL|class|RecipientListCxfTest
specifier|public
class|class
name|RecipientListCxfTest
extends|extends
name|CamelSpringTestSupport
block|{
DECL|field|port1
...
literal|"foo"
argument_list|,
literal|"cxf:bean:serviceEndpoint2"
argument_list|)
expr_stmt|;
...
literal|"foo"
argument_list|,
literal|"cxf:bean:serviceEndpoint,cxf:bean:serviceEndpoint2"
argument_list|)
expr_stmt|;
...
literal|"foo"
argument_list|,
literal|"cxf:bean:serviceEndpoint2,cxf:bean:serviceEndpoint"
argument_list|)
expr_stmt|;
comment|// and call again to ensure that it really works also
comment|// returns the last message from the recipient list
