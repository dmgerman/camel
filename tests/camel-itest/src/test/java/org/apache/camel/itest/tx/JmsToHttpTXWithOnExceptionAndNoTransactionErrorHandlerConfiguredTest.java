...
annotation|@
name|ContextConfiguration
DECL|class|JmsToHttpTXWithOnExceptionAndNoTransactionErrorHandlerConfiguredTest
specifier|public
class|class
name|JmsToHttpTXWithOnExceptionAndNoTransactionErrorHandlerConfiguredTest
extends|extends
name|AbstractJUnit4SpringContextTests
block|{
annotation|@
