...
begin_comment
comment|/**  * Unit testing FTP configured using spring bean  */
end_comment

begin_class
annotation|@
name|ContextConfiguration
DECL|class|SpringFtpEndpointTest
specifier|public
class|class
name|SpringFtpEndpointTest
extends|extends
name|AbstractJUnit4SpringContextTests
block|{
DECL|field|ftpPort
...
name|setProperty
argument_list|(
literal|"SpringFtpEndpointTest.ftpPort"
argument_list|,
name|Integer
operator|.
name|toString
...
annotation|@
name|Test
DECL|method|testFtpEndpointAsSpringBean ()
specifier|public
name|void
name|testFtpEndpointAsSpringBean
parameter_list|()
throws|throws
name|Exception
block|{
