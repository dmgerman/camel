...
name|Ignore
argument_list|(
literal|"Weird osgi linkage error"
argument_list|)
DECL|class|CamelHystrixTest
specifier|public
class|class
name|CamelHystrixTest
extends|extends
name|AbstractFeatureTest
block|{
annotation|@
name|Test
DECL|method|testCamelHystrix ()
specifier|public
name|void
name|testCamelHystrix
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|(
literal|"org/apache/camel/itest/CamelHystrixTest.xml"
argument_list|,
name|CamelHystrixTest
operator|.
name|class
