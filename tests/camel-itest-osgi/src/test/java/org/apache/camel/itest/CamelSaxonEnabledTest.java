...
name|class
argument_list|)
DECL|class|CamelSaxonEnabledTest
specifier|public
class|class
name|CamelSaxonEnabledTest
extends|extends
name|AbstractFeatureTest
block|{
annotation|@
name|Test
DECL|method|testCamelSaxonEnabled ()
specifier|public
name|void
name|testCamelSaxonEnabled
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|(
literal|"org/apache/camel/itest/CamelSaxonEnabledTest.xml"
argument_list|,
name|CamelSaxonEnabledTest
operator|.
name|class
