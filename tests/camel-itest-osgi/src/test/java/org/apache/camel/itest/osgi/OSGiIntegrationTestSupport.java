...
comment|// Need to override the jre setting
name|KarafDistributionOption
operator|.
...
argument_list|)
block|,
comment|//Grab JUnit and put it very early in the startup to make sure any bundles that are loaded
comment|//will use the same version/bundle
name|getJUnitBundle
argument_list|()
block|,
