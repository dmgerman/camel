...
name|Ignore
argument_list|(
literal|"Needs a running PostgreSQL instance"
argument_list|)
...
annotation|@
name|Test
DECL|method|testCamelPgEvent ()
specifier|public
name|void
name|testCamelPgEvent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|(
literal|"org/apache/camel/itest/CamelPgEventTest.xml"
argument_list|,
name|CamelPgEventTest
operator|.
name|class
