...
argument_list|)
argument_list|,
comment|// create a bundle that has the protobuf class
comment|/*provision(newBundle().add(AddressBookProtos.class)                    .add(AddressBookProtos.AddressBook.class)                    .add(AddressBookProtos.Person.class)                    .set(Constants.BUNDLE_SYMBOLICNAME, "CamelProtoBufTinyBundle")                    .set(Constants.EXPORT_PACKAGE, "org.apache.camel.itest.osgi.protobuf.generated")                    .build()),*/
name|felix
argument_list|()
argument_list|)
decl_stmt|;
