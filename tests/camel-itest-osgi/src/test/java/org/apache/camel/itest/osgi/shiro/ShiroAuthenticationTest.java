...
begin_package
DECL|package|org.apache.camel.itest.osgi.shiro
package|package
name|org
operator|.
name|apache
...
argument_list|)
argument_list|,
comment|// add the camel-shior bundles
name|wrappedBundle
argument_list|(
name|maven
argument_list|()
...
name|ShiroSecurityPolicy
argument_list|(
literal|"classpath:/org/apache/camel/itest/osgi/shiro/securityconfig.ini"
argument_list|,
name|passPhrase
argument_list|)
decl_stmt|;
