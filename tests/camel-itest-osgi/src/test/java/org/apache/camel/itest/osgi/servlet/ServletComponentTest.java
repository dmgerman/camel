...
argument_list|)
argument_list|,
comment|// install the profile for OSGi web
name|mavenBundle
argument_list|()
operator|.
name|groupId
...
argument_list|)
argument_list|,
comment|// create a customer bundle start up the CamelHttpTransportServlet
name|bundle
argument_list|(
name|newBundle
argument_list|()
...
argument_list|,
literal|"CamelServletTinyBundle"
argument_list|)
operator|.
name|set
argument_list|(
