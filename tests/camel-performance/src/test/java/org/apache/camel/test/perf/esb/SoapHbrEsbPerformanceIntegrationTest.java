...
begin_class
DECL|class|SoapHbrEsbPerformanceIntegrationTest
specifier|public
class|class
name|SoapHbrEsbPerformanceIntegrationTest
extends|extends
name|AbstractBaseEsbPerformanceIntegrationTest
block|{
annotation|@
name|Test
DECL|method|testSoapHbr ()
specifier|public
name|void
name|testSoapHbr
parameter_list|()
...
name|send
argument_list|(
literal|"http://127.0.0.1:8192/service/CBRSOAPHeaderProxy"
argument_list|,
literal|1000
argument_list|)
expr_stmt|;
...
block|{
return|return
literal|"OSGI-INF/blueprint/soap-hbr-bundle-context.xml"
return|;
block|}
block|}
end_class
