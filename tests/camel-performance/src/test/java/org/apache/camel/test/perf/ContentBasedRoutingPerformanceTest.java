...
begin_class
DECL|class|ContentBasedRoutingPerformanceTest
specifier|public
class|class
name|ContentBasedRoutingPerformanceTest
extends|extends
...
name|simple
argument_list|(
literal|"${body} contains 'xadmin;server1;community#1.0##'"
argument_list|)
operator|.
name|to
argument_list|(
...
name|contains
argument_list|(
literal|"<order><symbol>IBM</symbol><buyerID>asankha</buyerID>"
argument_list|)
argument_list|)
operator|.
name|to
