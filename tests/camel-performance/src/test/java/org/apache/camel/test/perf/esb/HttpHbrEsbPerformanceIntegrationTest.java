...
begin_class
DECL|class|HttpHbrEsbPerformanceIntegrationTest
specifier|public
class|class
name|HttpHbrEsbPerformanceIntegrationTest
extends|extends
name|AbstractBaseEsbPerformanceIntegrationTest
block|{
annotation|@
name|Test
DECL|method|testHttpHbr ()
specifier|public
name|void
name|testHttpHbr
parameter_list|()
...
name|send
argument_list|(
literal|"http://127.0.0.1:8192/service/CBRTransportHeaderProxy"
argument_list|,
literal|1000
argument_list|)
expr_stmt|;
...
block|{
return|return
literal|"OSGI-INF/blueprint/http-hbr-bundle-context.xml"
return|;
block|}
block|}
end_class
