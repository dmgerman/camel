...
begin_comment
comment|/**  * Tests a simple Camel route  */
end_comment

begin_class
DECL|class|SimpleMockPlaceholderTest
specifier|public
class|class
name|SimpleMockPlaceholderTest
block|{
annotation|@
name|Test
...
literal|"mymock"
argument_list|,
literal|"mock:result?retainFirst=0"
argument_list|)
expr_stmt|;
name|camel
operator|.
...
literal|1000
argument_list|)
DECL|method|simpleMockPlaceholderTest (BenchmarkState state, Blackhole bh)
specifier|public
name|void
name|simpleMockPlaceholderTest
parameter_list|(
