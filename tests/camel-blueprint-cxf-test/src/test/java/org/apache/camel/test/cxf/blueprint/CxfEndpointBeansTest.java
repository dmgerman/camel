...
begin_class
DECL|class|CxfEndpointBeansTest
specifier|public
class|class
name|CxfEndpointBeansTest
extends|extends
name|CamelBlueprintTestSupport
block|{
annotation|@
...
block|{
return|return
literal|"org/apache/camel/test/cxf/blueprint/CxfEndpointBeans.xml"
return|;
block|}
annotation|@
name|Override
...
argument_list|()
operator|+
literal|"/CxfEndpointBeansRouterTest/service"
argument_list|)
expr_stmt|;
name|extra
operator|.
...
name|assertEquals
argument_list|(
literal|"These endpoints don't share the same bus"
argument_list|,
name|serviceEndpoint
operator|.
name|getBus
...
annotation|@
name|Test
DECL|method|testCxfFeatureSetting ()
specifier|public
name|void
name|testCxfFeatureSetting
parameter_list|()
block|{
name|CxfEndpoint
name|routerEndpoint
...
name|assertEquals
argument_list|(
literal|"Get a wrong size of features."
argument_list|,
literal|1
argument_list|,
name|routerEndpoint
...
name|assertTrue
argument_list|(
literal|"Get a wrong feature instance."
argument_list|,
name|routerEndpoint
operator|.
name|getFeatures
