...
name|class
argument_list|)
comment|// add a bunch of deltaspike packages so we can find those cdi beans to make arquillian happy
operator|.
name|addPackage
argument_list|(
name|WindowBeanHolder
