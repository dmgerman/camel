...
name|Conditional
argument_list|(
name|StreamComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
literal|"org.apache.camel.spring.boot.CamelAutoConfiguration"
argument_list|)
DECL|class|StreamComponentAutoConfiguration
specifier|public
class|class
name|StreamComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureStreamComponent (CamelContext camelContext)
specifier|public
name|StreamComponent
name|configureStreamComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
