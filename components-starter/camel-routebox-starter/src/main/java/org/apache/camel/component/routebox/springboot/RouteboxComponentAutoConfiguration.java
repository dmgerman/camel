...
begin_package
DECL|package|org.apache.camel.component.routebox.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|RouteboxComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
literal|"org.apache.camel.spring.boot.CamelAutoConfiguration"
argument_list|)
DECL|class|RouteboxComponentAutoConfiguration
specifier|public
class|class
name|RouteboxComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureRouteboxComponent ( CamelContext camelContext)
specifier|public
name|RouteboxComponent
name|configureRouteboxComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
...
name|forCondition
argument_list|(
literal|"camel.component.routebox"
argument_list|)
decl_stmt|;
if|if
condition|(
