...
name|Conditional
argument_list|(
name|SqlLanguageAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|SqlLanguageAutoConfiguration
specifier|public
class|class
name|SqlLanguageAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureSqlLanguage (CamelContext camelContext, SqlLanguageConfiguration configuration)
specifier|public
name|SqlLanguage
name|configureSqlLanguage
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
