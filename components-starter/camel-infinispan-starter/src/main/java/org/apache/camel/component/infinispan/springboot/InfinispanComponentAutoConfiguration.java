...
argument_list|)
DECL|class|InfinispanComponentAutoConfiguration
specifier|public
class|class
...
name|class
argument_list|)
DECL|method|configureInfinispanComponent ( CamelContext camelContext)
specifier|public
name|InfinispanComponent
name|configureInfinispanComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
