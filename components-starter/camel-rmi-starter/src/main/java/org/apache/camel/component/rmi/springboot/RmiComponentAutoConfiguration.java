...
name|Conditional
argument_list|(
name|RmiComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
literal|"org.apache.camel.spring.boot.CamelAutoConfiguration"
argument_list|)
DECL|class|RmiComponentAutoConfiguration
specifier|public
class|class
name|RmiComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureRmiComponent (CamelContext camelContext)
specifier|public
name|RmiComponent
name|configureRmiComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
