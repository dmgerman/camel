...
name|Conditional
argument_list|(
name|PythonLanguageAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|PythonLanguageAutoConfiguration
specifier|public
class|class
name|PythonLanguageAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configurePythonLanguage (CamelContext camelContext, PythonLanguageConfiguration configuration)
specifier|public
name|PythonLanguage
name|configurePythonLanguage
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
