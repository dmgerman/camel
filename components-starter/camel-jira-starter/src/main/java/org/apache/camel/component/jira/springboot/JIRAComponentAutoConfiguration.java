...
literal|"org.apache.camel.spring.boot.CamelAutoConfiguration"
argument_list|)
DECL|class|JIRAComponentAutoConfiguration
specifier|public
class|class
name|JIRAComponentAutoConfiguration
block|{
annotation|@
name|Bean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureJIRAComponent (CamelContext camelContext)
specifier|public
name|JIRAComponent
name|configureJIRAComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
