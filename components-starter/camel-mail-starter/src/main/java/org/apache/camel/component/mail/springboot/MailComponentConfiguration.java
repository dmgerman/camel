...
begin_comment
comment|/**  * To send or receive emails using imap/pop3 or stmp protocols.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
block|{
comment|/**      * Sets the Mail configuration. Properties of the shared configuration can      * also be set individually.      */
...
name|contentTypeResolver
decl_stmt|;
comment|/**      * To use a custom JavaMailSender for sending emails.      */
