...
name|name
operator|=
literal|"json-jackson-dataformat"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureJacksonDataFormat ( CamelContext camelContext, JacksonDataFormatConfiguration configuration)
specifier|public
name|JacksonDataFormat
name|configureJacksonDataFormat
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
