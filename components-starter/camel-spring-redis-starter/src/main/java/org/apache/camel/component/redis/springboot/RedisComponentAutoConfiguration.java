...
begin_package
DECL|package|org.apache.camel.component.redis.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|RedisComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
literal|"org.apache.camel.spring.boot.CamelAutoConfiguration"
argument_list|)
DECL|class|RedisComponentAutoConfiguration
specifier|public
class|class
name|RedisComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"spring-redis-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureRedisComponent (CamelContext camelContext)
specifier|public
name|RedisComponent
name|configureRedisComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
...
name|forCondition
argument_list|(
literal|"camel.component.spring-redis"
argument_list|)
decl_stmt|;
if|if
condition|(
