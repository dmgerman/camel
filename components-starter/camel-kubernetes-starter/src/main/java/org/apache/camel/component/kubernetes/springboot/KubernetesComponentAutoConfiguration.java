...
begin_package
DECL|package|org.apache.camel.component.kubernetes.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|KubernetesComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
literal|"org.apache.camel.spring.boot.CamelAutoConfiguration"
argument_list|)
DECL|class|KubernetesComponentAutoConfiguration
specifier|public
class|class
name|KubernetesComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureKubernetesComponent ( CamelContext camelContext)
specifier|public
name|KubernetesComponent
name|configureKubernetesComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
...
name|forCondition
argument_list|(
literal|"camel.component.kubernetes"
argument_list|)
decl_stmt|;
if|if
condition|(
