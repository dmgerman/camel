...
name|Conditional
argument_list|(
name|AtmosComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
literal|"org.apache.camel.spring.boot.CamelAutoConfiguration"
argument_list|)
DECL|class|AtmosComponentAutoConfiguration
specifier|public
class|class
name|AtmosComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureAtmosComponent (CamelContext camelContext)
specifier|public
name|AtmosComponent
name|configureAtmosComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
