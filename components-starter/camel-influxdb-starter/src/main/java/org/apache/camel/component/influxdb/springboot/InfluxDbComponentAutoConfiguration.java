...
begin_package
DECL|package|org.apache.camel.component.influxdb.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|InfluxDbComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
literal|"org.apache.camel.spring.boot.CamelAutoConfiguration"
argument_list|)
DECL|class|InfluxDbComponentAutoConfiguration
specifier|public
class|class
name|InfluxDbComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureInfluxDbComponent ( CamelContext camelContext)
specifier|public
name|InfluxDbComponent
name|configureInfluxDbComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
...
name|forCondition
argument_list|(
literal|"camel.component.influxdb"
argument_list|)
decl_stmt|;
if|if
condition|(
