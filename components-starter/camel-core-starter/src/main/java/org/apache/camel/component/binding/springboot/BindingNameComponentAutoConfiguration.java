...
begin_package
DECL|package|org.apache.camel.component.binding.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|BindingNameComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
literal|"org.apache.camel.spring.boot.CamelAutoConfiguration"
argument_list|)
DECL|class|BindingNameComponentAutoConfiguration
specifier|public
class|class
name|BindingNameComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureBindingNameComponent ( CamelContext camelContext)
specifier|public
name|BindingNameComponent
name|configureBindingNameComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
...
name|forCondition
argument_list|(
literal|"camel.component.binding"
argument_list|)
decl_stmt|;
if|if
condition|(
