...
begin_package
DECL|package|org.apache.camel.dataformat.avro.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|AvroDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|AvroDataFormatConfiguration
operator|.
name|class
argument_list|)
DECL|class|AvroDataFormatAutoConfiguration
specifier|public
class|class
name|AvroDataFormatAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureAvroDataFormat (CamelContext camelContext, AvroDataFormatConfiguration configuration)
specifier|public
name|AvroDataFormat
name|configureAvroDataFormat
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
