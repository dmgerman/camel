...
begin_package
DECL|package|org.apache.camel.dataformat.lzf.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|LZFDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|LZFDataFormatConfiguration
operator|.
name|class
argument_list|)
DECL|class|LZFDataFormatAutoConfiguration
specifier|public
class|class
name|LZFDataFormatAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureLZFDataFormat (CamelContext camelContext, LZFDataFormatConfiguration configuration)
specifier|public
name|LZFDataFormat
name|configureLZFDataFormat
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
