...
begin_class
DECL|class|ManagedEnricherTest
specifier|public
class|class
name|ManagedEnricherTest
extends|extends
...
annotation|@
name|Test
DECL|method|testManageEnricher ()
specifier|public
name|void
name|testManageEnricher
parameter_list|()
throws|throws
name|Exception
block|{
...
name|contains
argument_list|(
literal|"\"description\": \"Enriches a message with data from a secondary resource"
argument_list|)
argument_list|)
expr_stmt|;
block|}
