...
begin_class
DECL|class|ManagedRouteSuspendAndResumeTest
specifier|public
class|class
name|ManagedRouteSuspendAndResumeTest
extends|extends
...
annotation|@
name|Test
DECL|method|testSuspendAndResume ()
specifier|public
name|void
name|testSuspendAndResume
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// wait a little bit while route is stopped to verify that file was not consumed
name|mock
operator|.
