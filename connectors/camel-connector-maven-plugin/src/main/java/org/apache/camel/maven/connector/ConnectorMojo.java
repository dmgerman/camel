...
name|updateBaseVersionInCamelConnectorJSon
argument_list|(
name|baseVersion
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|updateBaseVersionInCamelConnectorJSon (String baseVersion)
specifier|private
name|void
name|updateBaseVersionInCamelConnectorJSon
parameter_list|(
...
name|info
argument_list|(
literal|"Updating baseVersion to "
operator|+
name|baseVersion
operator|+
literal|" in "
