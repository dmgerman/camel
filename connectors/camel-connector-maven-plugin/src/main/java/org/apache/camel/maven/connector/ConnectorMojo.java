...
argument_list|)
expr_stmt|;
comment|// we do not offer editing component properties (yet) so clear the rows
name|rows
operator|.
name|clear
argument_list|()
...
name|MojoExecutionException
argument_list|(
literal|"Error in connector-maven-plugin"
argument_list|,
name|e
argument_list|)
throw|;
...
argument_list|)
expr_stmt|;
comment|// TODO: if no options should we include all by default instead?
if|if
condition|(
name|options
operator|==
...
return|;
block|}
DECL|method|extractScheme (List<String> json)
specifier|private
name|String
name|extractScheme
parameter_list|(
...
return|;
block|}
DECL|method|extractGroupId (List<String> json)
specifier|private
name|String
name|extractGroupId
parameter_list|(
...
return|;
block|}
DECL|method|extractArtifactId (List<String> json)
specifier|private
name|String
name|extractArtifactId
parameter_list|(
...
return|;
block|}
DECL|method|extractVersion (List<String> json)
specifier|private
name|String
name|extractVersion
parameter_list|(
