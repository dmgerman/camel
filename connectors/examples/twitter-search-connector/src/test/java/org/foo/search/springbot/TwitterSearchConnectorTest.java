...
begin_package
DECL|package|org.foo.search.springbot
package|package
name|org
operator|.
name|foo
...
operator|=
block|{
name|TwitterSearchConnectorTest
operator|.
...
block|}
argument_list|)
DECL|class|TwitterSearchConnectorTest
specifier|public
class|class
name|TwitterSearchConnectorTest
block|{
...
name|from
argument_list|(
literal|"tw-search?keywords=camelsearchtest&filterOld=false"
argument_list|)
operator|.
name|noAutoStartup
argument_list|()
