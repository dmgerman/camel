...
name|EnableConfigurationProperties
argument_list|(
name|TwitterFindConnectorConfiguration
operator|.
name|class
argument_list|)
DECL|class|TwitterFindConnectorAutoConfiguration
specifier|public
class|class
name|TwitterFindConnectorAutoConfiguration
block|{
DECL|field|LOGGER
specifier|private
specifier|static
...
annotation|@
name|ConditionalOnMissingBean
DECL|method|configureTwitterFindComponent ()
specifier|public
name|TwitterFindComponent
name|configureTwitterFindComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.connector.twitter-find.customizer"
argument_list|,
operator|(
operator|(
name|HasId
...
annotation|@
name|PostConstruct
DECL|method|postConstructTwitterFindComponent ()
specifier|public
name|void
name|postConstructTwitterFindComponent
parameter_list|()
block|{
name|Map
argument_list|<
...
literal|"camel.connector.customizer"
argument_list|,
literal|"camel.connector.twitter-find."
operator|+
name|entry
operator|.
name|getKey
