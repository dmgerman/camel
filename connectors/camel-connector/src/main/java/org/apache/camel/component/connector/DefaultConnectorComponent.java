...
argument_list|()
decl_stmt|;
comment|// if we have component options then we need to create a new instance of the component
comment|// which we then configure before it create the endpoint
if|if
condition|(
name|componentOptions
operator|!=
...
comment|// Helpers
comment|// ***************************************
DECL|method|buildEnpointOptions (String remaining, Map<String, Object> parameters)
specifier|private
name|Map
argument_list|<
name|String
