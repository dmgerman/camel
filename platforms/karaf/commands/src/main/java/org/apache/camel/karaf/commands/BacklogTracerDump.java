...
name|name
operator|=
literal|"backlog-tracer-dump"
argument_list|,
name|description
operator|=
literal|"Dumps traced messages from the Backlog tracer"
argument_list|)
DECL|class|BacklogTracerDump
specifier|public
class|class
name|BacklogTracerDump
extends|extends
name|OsgiCommandSupport
block|{
annotation|@
...
name|description
operator|=
literal|"To dump trace messages only for nodes or routes matching the given pattern (default is all)"
argument_list|,
name|required
operator|=
literal|false
...
name|description
operator|=
literal|"Format to use with the dump action (text or xml)"
argument_list|,
name|required
operator|=
literal|false
...
name|description
operator|=
literal|"To limit the body size when using text format"
argument_list|,
name|required
operator|=
literal|false
