...
begin_comment
comment|/**  * From the Camel catalog lists all the data formats.  */
end_comment
...
name|label
decl_stmt|;
DECL|method|CatalogDataFormatListCommand (boolean verbose, String label)
specifier|public
name|CatalogDataFormatListCommand
parameter_list|(
name|boolean
...
return|;
block|}
DECL|method|computeColumnWidths (final Iterable<Map<String, String>> dataFormats)
specifier|private
name|Map
argument_list|<
name|String
