...
begin_comment
comment|/**  * List the Camel REST services API documentation (requires camel-swagger-java on classpath)  */
end_comment

begin_class
DECL|class|RestApiDocCommand
specifier|public
class|class
name|RestApiDocCommand
extends|extends
name|AbstractContextCommand
block|{
DECL|method|RestApiDocCommand (String context)
specifier|public
name|RestApiDocCommand
parameter_list|(
name|String
