...
name|name
decl_stmt|;
DECL|method|RouteListCommand (String name)
specifier|public
name|RouteListCommand
parameter_list|(
name|String
...
return|;
block|}
DECL|method|computeColumnWidths (final Iterable<Map<String, String>> routes)
specifier|private
specifier|static
name|Map
argument_list|<
...
argument_list|(
literal|"Unable to determine column widths from null Iterable<Route>"
argument_list|)
throw|;
block|}
else|else
