...
begin_comment
comment|/**  * From the Camel catalog lists all the language labels.  */
end_comment

begin_class
DECL|class|CatalogLanguageLabelListCommand
specifier|public
class|class
...
name|verbose
decl_stmt|;
DECL|method|CatalogLanguageLabelListCommand (boolean verbose)
specifier|public
name|CatalogLanguageLabelListCommand
parameter_list|(
name|boolean
