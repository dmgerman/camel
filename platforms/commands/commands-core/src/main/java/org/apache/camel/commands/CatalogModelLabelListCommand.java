...
begin_comment
comment|/**  * From the Camel catalog lists all the model labels.  */
end_comment

begin_class
DECL|class|CatalogModelLabelListCommand
specifier|public
class|class
...
name|verbose
decl_stmt|;
DECL|method|CatalogModelLabelListCommand (boolean verbose)
specifier|public
name|CatalogModelLabelListCommand
parameter_list|(
name|boolean
