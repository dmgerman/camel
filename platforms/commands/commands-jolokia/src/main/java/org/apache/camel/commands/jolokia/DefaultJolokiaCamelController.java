...
name|get
argument_list|(
literal|"headersMapFactoryClassName"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|format
argument_list|(
literal|"%s:context=%s,type=services,name=DefaultTransformerRegistry"
argument_list|,
name|found
operator|.
name|getDomain
...
name|format
argument_list|(
literal|"%s:context=%s,type=services,name=DefaultValidatorRegistry"
argument_list|,
name|found
operator|.
name|getDomain
