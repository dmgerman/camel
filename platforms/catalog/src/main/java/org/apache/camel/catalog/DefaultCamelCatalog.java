...
throw|;
block|}
comment|// grab the json schema for the endpoint properties
comment|// rows = JSonSchemaHelper.parseJsonSchema("properties", json, true);
...
argument_list|)
decl_stmt|;
comment|// skip the scheme as we know that already
if|if
condition|(
operator|!
name|scheme
