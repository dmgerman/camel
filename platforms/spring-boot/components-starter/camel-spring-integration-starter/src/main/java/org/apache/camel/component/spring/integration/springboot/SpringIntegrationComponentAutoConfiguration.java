...
name|Conditional
argument_list|(
name|SpringIntegrationComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|SpringIntegrationComponentAutoConfiguration
specifier|public
class|class
name|SpringIntegrationComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"spring-integration-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureSpringIntegrationComponent ( CamelContext camelContext, SpringIntegrationComponentConfiguration configuration)
specifier|public
name|SpringIntegrationComponent
name|configureSpringIntegrationComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
