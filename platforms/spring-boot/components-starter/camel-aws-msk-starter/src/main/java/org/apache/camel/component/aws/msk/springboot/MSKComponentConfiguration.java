...
begin_comment
comment|/**  * The aws-msk is used for managing Amazon MSK  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
name|operation
decl_stmt|;
comment|/**          * To define a proxy protocol when instantiating the MSK client          */
...
name|proxyPort
decl_stmt|;
comment|/**          * The region in which MSK client needs to work. When using this          * parameter, the configuration will expect the capitalized name of the          * region (for example AP_EAST_1) You'll need to use the name          * Regions.EU_WEST_1.name()          */
DECL|field|region
specifier|private
name|String
name|region
