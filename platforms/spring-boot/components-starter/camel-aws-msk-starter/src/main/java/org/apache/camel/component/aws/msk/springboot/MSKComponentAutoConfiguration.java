...
name|class
block|,
name|MSKComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|MSKComponentAutoConfiguration
specifier|public
class|class
name|MSKComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureMSKComponent ()
specifier|public
name|MSKComponent
name|configureMSKComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.aws-msk.customizer"
argument_list|,
operator|(
operator|(
name|HasId
