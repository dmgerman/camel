...
begin_package
DECL|package|org.apache.camel.language.header.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|HeaderLanguageAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|HeaderLanguageConfiguration
operator|.
name|class
argument_list|)
DECL|class|HeaderLanguageAutoConfiguration
specifier|public
class|class
name|HeaderLanguageAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureHeaderLanguage (CamelContext camelContext, HeaderLanguageConfiguration configuration)
specifier|public
name|HeaderLanguage
name|configureHeaderLanguage
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
