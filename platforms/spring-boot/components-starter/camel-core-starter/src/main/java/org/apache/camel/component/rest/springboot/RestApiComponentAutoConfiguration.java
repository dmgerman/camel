...
name|Conditional
argument_list|(
name|RestApiComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|RestApiComponentAutoConfiguration
specifier|public
class|class
name|RestApiComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureRestApiComponent ( CamelContext camelContext, RestApiComponentConfiguration configuration)
specifier|public
name|RestApiComponent
name|configureRestApiComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
