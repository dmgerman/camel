...
begin_comment
comment|/**  * String data format is a textual based format that supports character  * encoding.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|class|StringDataFormatConfiguration
specifier|public
class|class
