...
name|EnableConfigurationProperties
argument_list|(
name|ControlBusComponentConfiguration
operator|.
name|class
argument_list|)
...
name|class
argument_list|)
DECL|method|configureControlBusComponent ( CamelContext camelContext, ControlBusComponentConfiguration configuration)
specifier|public
name|ControlBusComponent
...
name|forCondition
argument_list|(
literal|"camel.component.controlbus"
argument_list|)
decl_stmt|;
if|if
condition|(
