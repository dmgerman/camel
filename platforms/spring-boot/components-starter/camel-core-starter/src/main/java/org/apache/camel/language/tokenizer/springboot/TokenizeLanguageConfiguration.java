...
begin_comment
comment|/**  * To use Camel message body or header with a tokenizer in Camel expressions or  * predicates.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
name|LanguageConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the tokenize language. This is      * enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
