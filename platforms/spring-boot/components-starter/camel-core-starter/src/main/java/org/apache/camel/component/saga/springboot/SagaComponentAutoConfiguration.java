...
begin_package
DECL|package|org.apache.camel.component.saga.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|SagaComponentAutoConfiguration
operator|.
...
name|class
block|,
name|SagaComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|SagaComponentAutoConfiguration
specifier|public
class|class
name|SagaComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureSagaComponent ()
specifier|public
name|SagaComponent
name|configureSagaComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.saga.customizer"
argument_list|,
operator|(
operator|(
name|HasId
