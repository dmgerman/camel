...
begin_comment
comment|/**  * Zip Deflate Compression data format is a message compression and  * de-compression format (not zip files).  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
