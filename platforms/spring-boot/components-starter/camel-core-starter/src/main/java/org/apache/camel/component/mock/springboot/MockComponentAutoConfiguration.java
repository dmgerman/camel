...
begin_package
DECL|package|org.apache.camel.component.mock.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|MockComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|MockComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|MockComponentAutoConfiguration
specifier|public
class|class
name|MockComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureMockComponent (CamelContext camelContext, MockComponentConfiguration configuration)
specifier|public
name|MockComponent
name|configureMockComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
