...
begin_package
DECL|package|org.apache.camel.component.cm.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|CMComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|CMComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|CMComponentAutoConfiguration
specifier|public
class|class
name|CMComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureCMComponent (CamelContext camelContext, CMComponentConfiguration configuration)
specifier|public
name|CMComponent
name|configureCMComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.cm-sms"
argument_list|)
decl_stmt|;
if|if
condition|(
