...
name|Conditional
argument_list|(
name|QualifiedContextComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|QualifiedContextComponentAutoConfiguration
specifier|public
class|class
name|QualifiedContextComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureQualifiedContextComponent ( CamelContext camelContext, QualifiedContextComponentConfiguration configuration)
specifier|public
name|QualifiedContextComponent
name|configureQualifiedContextComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
