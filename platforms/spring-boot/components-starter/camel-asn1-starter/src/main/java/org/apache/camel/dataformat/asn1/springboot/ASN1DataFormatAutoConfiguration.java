...
name|class
block|,
name|ASN1DataFormatAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|ASN1DataFormatAutoConfiguration
specifier|public
class|class
name|ASN1DataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"asn1-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureASN1DataFormatFactory ()
specifier|public
name|DataFormatFactory
name|configureASN1DataFormatFactory
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.dataformat.asn1.customizer"
argument_list|,
operator|(
operator|(
name|HasId
