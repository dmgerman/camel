...
begin_package
DECL|package|org.apache.camel.dataformat.asn1.springboot
package|package
name|org
operator|.
name|apache
...
begin_comment
comment|/**  * The ASN.1 data format is used for file transfer with telecommunications  * protocols.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
name|prefix
operator|=
literal|"camel.dataformat.asn1"
argument_list|)
DECL|class|ASN1DataFormatConfiguration
specifier|public
class|class
name|ASN1DataFormatConfiguration
extends|extends
name|DataFormatConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the asn1 data format. This is      * enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
