...
name|Conditional
argument_list|(
name|MiloServerComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|MiloServerComponentAutoConfiguration
specifier|public
class|class
name|MiloServerComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureMiloServerComponent ( CamelContext camelContext, MiloServerComponentConfiguration configuration)
specifier|public
name|MiloServerComponent
name|configureMiloServerComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
