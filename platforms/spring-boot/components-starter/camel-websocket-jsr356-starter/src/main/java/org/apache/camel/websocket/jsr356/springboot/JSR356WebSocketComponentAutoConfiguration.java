...
begin_package
DECL|package|org.apache.camel.websocket.jsr356.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|JSR356WebSocketComponentAutoConfiguration
operator|.
...
name|class
block|,
name|JSR356WebSocketComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|JSR356WebSocketComponentAutoConfiguration
specifier|public
class|class
name|JSR356WebSocketComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.websocket-jsr356"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|name
operator|=
literal|"websocket-jsr356-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureJSR356WebSocketComponent ()
specifier|public
name|JSR356WebSocketComponent
name|configureJSR356WebSocketComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.websocket-jsr356.customizer"
argument_list|,
operator|(
operator|(
name|HasId
