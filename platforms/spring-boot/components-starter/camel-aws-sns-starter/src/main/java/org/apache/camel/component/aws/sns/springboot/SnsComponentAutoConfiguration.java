...
name|class
block|,
name|SnsComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|SnsComponentAutoConfiguration
specifier|public
class|class
name|SnsComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureSnsComponent ()
specifier|public
name|SnsComponent
name|configureSnsComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.aws-sns.customizer"
argument_list|,
operator|(
operator|(
name|HasId
