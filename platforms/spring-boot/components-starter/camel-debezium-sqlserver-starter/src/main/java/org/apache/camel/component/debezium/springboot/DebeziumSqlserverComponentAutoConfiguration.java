...
name|class
block|,
name|DebeziumSqlserverComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|DebeziumSqlserverComponentAutoConfiguration
specifier|public
class|class
name|DebeziumSqlserverComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"debezium-sqlserver-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureDebeziumSqlserverComponent ()
specifier|public
name|DebeziumSqlserverComponent
name|configureDebeziumSqlserverComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.debezium-sqlserver.customizer"
argument_list|,
operator|(
operator|(
name|HasId
