...
begin_package
DECL|package|org.apache.camel.component.ignite.cache.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|IgniteCacheComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|IgniteCacheComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|IgniteCacheComponentAutoConfiguration
specifier|public
class|class
name|IgniteCacheComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"ignite-cache-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureIgniteCacheComponent ( CamelContext camelContext, IgniteCacheComponentConfiguration configuration)
specifier|public
name|IgniteCacheComponent
name|configureIgniteCacheComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.ignite-cache"
argument_list|)
decl_stmt|;
if|if
condition|(
