...
name|Conditional
argument_list|(
name|IgniteMessagingComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|IgniteMessagingComponentAutoConfiguration
specifier|public
class|class
name|IgniteMessagingComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"ignite-messaging-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureIgniteMessagingComponent ( CamelContext camelContext, IgniteMessagingComponentConfiguration configuration)
specifier|public
name|IgniteMessagingComponent
name|configureIgniteMessagingComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
