...
begin_package
DECL|package|org.apache.camel.component.ignite.idgen.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|IgniteIdGenComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|IgniteIdGenComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|IgniteIdGenComponentAutoConfiguration
specifier|public
class|class
name|IgniteIdGenComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"ignite-idgen-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureIgniteIdGenComponent ( CamelContext camelContext, IgniteIdGenComponentConfiguration configuration)
specifier|public
name|IgniteIdGenComponent
name|configureIgniteIdGenComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.ignite-idgen"
argument_list|)
decl_stmt|;
if|if
condition|(
