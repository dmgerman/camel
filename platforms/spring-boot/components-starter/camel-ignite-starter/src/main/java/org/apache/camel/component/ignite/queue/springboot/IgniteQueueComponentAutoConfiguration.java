...
begin_package
DECL|package|org.apache.camel.component.ignite.queue.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|IgniteQueueComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|IgniteQueueComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|IgniteQueueComponentAutoConfiguration
specifier|public
class|class
name|IgniteQueueComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"ignite-queue-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureIgniteQueueComponent ( CamelContext camelContext, IgniteQueueComponentConfiguration configuration)
specifier|public
name|IgniteQueueComponent
name|configureIgniteQueueComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.ignite-queue"
argument_list|)
decl_stmt|;
if|if
condition|(
