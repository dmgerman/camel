...
begin_package
DECL|package|org.apache.camel.component.ignite.events.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|IgniteEventsComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|IgniteEventsComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|IgniteEventsComponentAutoConfiguration
specifier|public
class|class
name|IgniteEventsComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"ignite-events-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureIgniteEventsComponent ( CamelContext camelContext, IgniteEventsComponentConfiguration configuration)
specifier|public
name|IgniteEventsComponent
name|configureIgniteEventsComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.ignite-events"
argument_list|)
decl_stmt|;
if|if
condition|(
