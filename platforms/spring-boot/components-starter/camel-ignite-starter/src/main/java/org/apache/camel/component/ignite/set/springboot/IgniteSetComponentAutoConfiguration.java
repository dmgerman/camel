...
name|Conditional
argument_list|(
name|IgniteSetComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|IgniteSetComponentAutoConfiguration
specifier|public
class|class
name|IgniteSetComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureIgniteSetComponent ( CamelContext camelContext, IgniteSetComponentConfiguration configuration)
specifier|public
name|IgniteSetComponent
name|configureIgniteSetComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
