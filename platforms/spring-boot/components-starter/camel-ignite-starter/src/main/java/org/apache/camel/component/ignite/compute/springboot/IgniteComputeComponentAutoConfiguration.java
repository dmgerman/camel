...
name|Conditional
argument_list|(
name|IgniteComputeComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|IgniteComputeComponentAutoConfiguration
specifier|public
class|class
name|IgniteComputeComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"ignite-compute-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureIgniteComputeComponent ( CamelContext camelContext, IgniteComputeComponentConfiguration configuration)
specifier|public
name|IgniteComputeComponent
name|configureIgniteComputeComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
