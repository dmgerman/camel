...
name|Conditional
argument_list|(
name|JibxDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|JibxDataFormatAutoConfiguration
specifier|public
class|class
name|JibxDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"jibx-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureJibxDataFormatFactory ( final CamelContext camelContext, final JibxDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureJibxDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
