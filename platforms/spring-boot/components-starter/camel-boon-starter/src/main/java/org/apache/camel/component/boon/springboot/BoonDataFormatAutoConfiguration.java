...
name|name
operator|=
literal|"boon-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureBoonDataFormatFactory ( final CamelContext camelContext, final BoonDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureBoonDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
