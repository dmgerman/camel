...
begin_package
DECL|package|org.apache.camel.component.twitter.directmessage.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|TwitterDirectMessageComponentAutoConfiguration
operator|.
...
name|class
block|,
name|TwitterDirectMessageComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|TwitterDirectMessageComponentAutoConfiguration
specifier|public
class|class
name|TwitterDirectMessageComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.twitter-directmessage"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|name
operator|=
literal|"twitter-directmessage-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureTwitterDirectMessageComponent ()
specifier|public
name|TwitterDirectMessageComponent
name|configureTwitterDirectMessageComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.twitter-directmessage.customizer"
argument_list|,
operator|(
operator|(
name|HasId
