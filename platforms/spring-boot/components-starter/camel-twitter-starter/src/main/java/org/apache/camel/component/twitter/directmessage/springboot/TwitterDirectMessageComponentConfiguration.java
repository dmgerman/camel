...
argument_list|)
DECL|class|TwitterDirectMessageComponentConfiguration
specifier|public
class|class
...
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the twitter-directmessage      * component. This is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
