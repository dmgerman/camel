...
begin_package
DECL|package|org.apache.camel.component.twitter.search.springboot
package|package
name|org
operator|.
name|apache
...
begin_comment
comment|/**  * The Twitter Search component consumes search results.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
name|prefix
operator|=
literal|"camel.component.twitter-search"
argument_list|)
DECL|class|TwitterSearchComponentConfiguration
specifier|public
class|class
name|TwitterSearchComponentConfiguration
extends|extends
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the twitter-search component.      * This is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
