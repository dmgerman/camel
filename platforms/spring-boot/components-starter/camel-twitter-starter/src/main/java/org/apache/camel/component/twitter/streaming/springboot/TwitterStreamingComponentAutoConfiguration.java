...
begin_package
DECL|package|org.apache.camel.component.twitter.streaming.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|TwitterStreamingComponentAutoConfiguration
operator|.
...
name|class
block|,
name|TwitterStreamingComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|TwitterStreamingComponentAutoConfiguration
specifier|public
class|class
name|TwitterStreamingComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.twitter-streaming"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|name
operator|=
literal|"twitter-streaming-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureTwitterStreamingComponent ()
specifier|public
name|TwitterStreamingComponent
name|configureTwitterStreamingComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.twitter-streaming.customizer"
argument_list|,
operator|(
operator|(
name|HasId
