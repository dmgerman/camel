...
begin_package
DECL|package|org.apache.camel.component.validator.springboot
package|package
name|org
operator|.
name|apache
...
name|prefix
operator|=
literal|"camel.component.validator"
argument_list|)
DECL|class|ValidatorComponentConfiguration
specifier|public
class|class
...
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the validator component. This is      * enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
...
return|;
block|}
DECL|method|setResourceResolverFactory (String resourceResolverFactory)
specifier|public
name|void
