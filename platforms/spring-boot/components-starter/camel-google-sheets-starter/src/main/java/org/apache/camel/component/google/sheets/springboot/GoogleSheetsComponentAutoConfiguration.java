...
name|class
block|,
name|GoogleSheetsComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|GoogleSheetsComponentAutoConfiguration
specifier|public
class|class
name|GoogleSheetsComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"google-sheets-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureGoogleSheetsComponent ()
specifier|public
name|GoogleSheetsComponent
name|configureGoogleSheetsComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.google-sheets.customizer"
argument_list|,
operator|(
operator|(
name|HasId
