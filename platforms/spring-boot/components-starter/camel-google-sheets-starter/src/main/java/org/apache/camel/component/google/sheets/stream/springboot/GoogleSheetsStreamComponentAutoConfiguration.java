...
name|class
block|,
name|GoogleSheetsStreamComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|GoogleSheetsStreamComponentAutoConfiguration
specifier|public
class|class
name|GoogleSheetsStreamComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"google-sheets-stream-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureGoogleSheetsStreamComponent ()
specifier|public
name|GoogleSheetsStreamComponent
name|configureGoogleSheetsStreamComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.google-sheets-stream.customizer"
argument_list|,
operator|(
operator|(
name|HasId
