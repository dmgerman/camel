...
name|Conditional
argument_list|(
name|BarcodeDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|BarcodeDataFormatAutoConfiguration
specifier|public
class|class
name|BarcodeDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"barcode-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureBarcodeDataFormatFactory ( final CamelContext camelContext, final BarcodeDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureBarcodeDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
