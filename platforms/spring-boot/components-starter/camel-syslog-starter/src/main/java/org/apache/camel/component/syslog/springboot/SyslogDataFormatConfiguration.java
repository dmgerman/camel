...
begin_comment
comment|/**  * The Syslog dataformat is used for working with RFC3164 and RFC5424 messages  * (logging and monitoring).  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|class|SyslogDataFormatConfiguration
specifier|public
class|class
...
name|DataFormatConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the syslog data format. This is      * enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
