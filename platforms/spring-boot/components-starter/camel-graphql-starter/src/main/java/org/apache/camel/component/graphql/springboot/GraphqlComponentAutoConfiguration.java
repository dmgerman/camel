...
begin_package
DECL|package|org.apache.camel.component.graphql.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|GraphqlComponentAutoConfiguration
operator|.
...
name|class
block|,
name|GraphqlComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|GraphqlComponentAutoConfiguration
specifier|public
class|class
name|GraphqlComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.graphql"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|class
argument_list|)
DECL|method|configureGraphqlComponent ()
specifier|public
name|GraphqlComponent
name|configureGraphqlComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.graphql.customizer"
argument_list|,
operator|(
operator|(
name|HasId
