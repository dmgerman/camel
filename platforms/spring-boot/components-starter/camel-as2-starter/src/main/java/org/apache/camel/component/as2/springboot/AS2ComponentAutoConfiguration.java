...
name|class
block|,
name|AS2ComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|AS2ComponentAutoConfiguration
specifier|public
class|class
name|AS2ComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureAS2Component ()
specifier|public
name|AS2Component
name|configureAS2Component
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.as2.customizer"
argument_list|,
operator|(
operator|(
name|HasId
