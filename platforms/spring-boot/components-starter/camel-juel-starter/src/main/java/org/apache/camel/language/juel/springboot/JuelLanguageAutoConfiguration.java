...
begin_package
DECL|package|org.apache.camel.language.juel.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|JuelLanguageAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|JuelLanguageConfiguration
operator|.
name|class
argument_list|)
DECL|class|JuelLanguageAutoConfiguration
specifier|public
class|class
name|JuelLanguageAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureJuelLanguage (CamelContext camelContext, JuelLanguageConfiguration configuration)
specifier|public
name|JuelLanguage
name|configureJuelLanguage
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
