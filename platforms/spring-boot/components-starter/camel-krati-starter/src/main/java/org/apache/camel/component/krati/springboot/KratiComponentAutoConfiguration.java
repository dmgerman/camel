...
begin_package
DECL|package|org.apache.camel.component.krati.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|KratiComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|KratiComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|KratiComponentAutoConfiguration
specifier|public
class|class
name|KratiComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureKratiComponent (CamelContext camelContext, KratiComponentConfiguration configuration)
specifier|public
name|KratiComponent
name|configureKratiComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
