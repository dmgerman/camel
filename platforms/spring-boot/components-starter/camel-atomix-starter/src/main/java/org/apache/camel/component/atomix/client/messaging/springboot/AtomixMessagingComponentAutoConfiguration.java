...
name|class
block|,
name|AtomixMessagingComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|AtomixMessagingComponentAutoConfiguration
specifier|public
class|class
name|AtomixMessagingComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"atomix-messaging-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureAtomixMessagingComponent ()
specifier|public
name|AtomixMessagingComponent
name|configureAtomixMessagingComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.atomix-messaging.customizer"
argument_list|,
operator|(
operator|(
name|HasId
