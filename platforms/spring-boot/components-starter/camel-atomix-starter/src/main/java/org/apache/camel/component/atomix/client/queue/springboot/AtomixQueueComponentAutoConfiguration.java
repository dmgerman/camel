...
name|class
block|,
name|AtomixQueueComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|AtomixQueueComponentAutoConfiguration
specifier|public
class|class
name|AtomixQueueComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"atomix-queue-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureAtomixQueueComponent ()
specifier|public
name|AtomixQueueComponent
name|configureAtomixQueueComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.atomix-queue.customizer"
argument_list|,
operator|(
operator|(
name|HasId
