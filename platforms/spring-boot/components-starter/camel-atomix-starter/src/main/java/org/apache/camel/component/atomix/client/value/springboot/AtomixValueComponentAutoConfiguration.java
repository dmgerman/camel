...
name|class
block|,
name|AtomixValueComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|AtomixValueComponentAutoConfiguration
specifier|public
class|class
name|AtomixValueComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"atomix-value-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureAtomixValueComponent ()
specifier|public
name|AtomixValueComponent
name|configureAtomixValueComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.atomix-value.customizer"
argument_list|,
operator|(
operator|(
name|HasId
