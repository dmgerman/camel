...
name|class
block|,
name|AtomixMultiMapComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|AtomixMultiMapComponentAutoConfiguration
specifier|public
class|class
name|AtomixMultiMapComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"atomix-multimap-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureAtomixMultiMapComponent ()
specifier|public
name|AtomixMultiMapComponent
name|configureAtomixMultiMapComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.atomix-multimap.customizer"
argument_list|,
operator|(
operator|(
name|HasId
