...
begin_package
DECL|package|org.apache.camel.component.timer.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|TimerComponentAutoConfiguration
operator|.
...
name|class
block|,
name|TimerComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|TimerComponentAutoConfiguration
specifier|public
class|class
name|TimerComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureTimerComponent ()
specifier|public
name|TimerComponent
name|configureTimerComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.timer.customizer"
argument_list|,
operator|(
operator|(
name|HasId
