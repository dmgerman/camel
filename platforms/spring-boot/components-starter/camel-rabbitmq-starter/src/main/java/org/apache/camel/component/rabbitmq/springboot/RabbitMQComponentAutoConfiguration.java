...
name|Conditional
argument_list|(
name|RabbitMQComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|RabbitMQComponentAutoConfiguration
specifier|public
class|class
name|RabbitMQComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureRabbitMQComponent ( CamelContext camelContext, RabbitMQComponentConfiguration configuration)
specifier|public
name|RabbitMQComponent
name|configureRabbitMQComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
