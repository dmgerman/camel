...
name|class
block|,
name|FhirComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|FhirComponentAutoConfiguration
specifier|public
class|class
name|FhirComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureFhirComponent ()
specifier|public
name|FhirComponent
name|configureFhirComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.fhir.customizer"
argument_list|,
operator|(
operator|(
name|HasId
