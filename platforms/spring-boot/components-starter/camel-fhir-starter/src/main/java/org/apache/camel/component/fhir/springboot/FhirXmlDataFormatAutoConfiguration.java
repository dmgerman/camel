...
name|class
block|,
name|FhirXmlDataFormatAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|FhirXmlDataFormatAutoConfiguration
specifier|public
class|class
name|FhirXmlDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"fhirXml-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureFhirXmlDataFormatFactory ()
specifier|public
name|DataFormatFactory
name|configureFhirXmlDataFormatFactory
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.dataformat.fhirxml.customizer"
argument_list|,
operator|(
operator|(
name|HasId
