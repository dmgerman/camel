...
name|class
block|,
name|FhirJsonDataFormatAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|FhirJsonDataFormatAutoConfiguration
specifier|public
class|class
name|FhirJsonDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"fhirJson-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureFhirJsonDataFormatFactory ()
specifier|public
name|DataFormatFactory
name|configureFhirJsonDataFormatFactory
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.dataformat.fhirjson.customizer"
argument_list|,
operator|(
operator|(
name|HasId
