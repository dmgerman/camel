...
name|class
block|,
name|MyBatisBeanComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|MyBatisBeanComponentAutoConfiguration
specifier|public
class|class
name|MyBatisBeanComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"mybatis-bean-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureMyBatisBeanComponent ()
specifier|public
name|MyBatisBeanComponent
name|configureMyBatisBeanComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.mybatis-bean.customizer"
argument_list|,
operator|(
operator|(
name|HasId
