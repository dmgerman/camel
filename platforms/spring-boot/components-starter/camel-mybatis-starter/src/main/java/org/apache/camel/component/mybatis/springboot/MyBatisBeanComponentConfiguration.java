...
name|prefix
operator|=
literal|"camel.component.mybatis-bean"
argument_list|)
DECL|class|MyBatisBeanComponentConfiguration
specifier|public
class|class
name|MyBatisBeanComponentConfiguration
extends|extends
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the mybatis-bean component. This      * is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
