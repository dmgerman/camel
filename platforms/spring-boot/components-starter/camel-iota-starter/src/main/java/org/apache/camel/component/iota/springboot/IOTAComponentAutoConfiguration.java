...
name|class
block|,
name|IOTAComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|IOTAComponentAutoConfiguration
specifier|public
class|class
name|IOTAComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureIOTAComponent ()
specifier|public
name|IOTAComponent
name|configureIOTAComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.iota.customizer"
argument_list|,
operator|(
operator|(
name|HasId
