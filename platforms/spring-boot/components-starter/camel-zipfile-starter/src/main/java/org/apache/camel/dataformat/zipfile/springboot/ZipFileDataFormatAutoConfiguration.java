...
name|Conditional
argument_list|(
name|ZipFileDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|ZipFileDataFormatAutoConfiguration
specifier|public
class|class
name|ZipFileDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"zipfile-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureZipFileDataFormatFactory ( final CamelContext camelContext, final ZipFileDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureZipFileDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
