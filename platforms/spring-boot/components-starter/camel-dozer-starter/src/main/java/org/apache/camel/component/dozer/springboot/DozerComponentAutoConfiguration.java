...
begin_package
DECL|package|org.apache.camel.component.dozer.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|DozerComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|DozerComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|DozerComponentAutoConfiguration
specifier|public
class|class
name|DozerComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureDozerComponent (CamelContext camelContext, DozerComponentConfiguration configuration)
specifier|public
name|DozerComponent
name|configureDozerComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
