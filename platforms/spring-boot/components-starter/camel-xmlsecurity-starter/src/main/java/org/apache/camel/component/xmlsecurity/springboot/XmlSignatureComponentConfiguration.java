...
name|parentXpath
decl_stmt|;
comment|/**          * If you want to restrict the remote access via reference URIs, you can          * set an own dereferencer. Optional parameter. If not set the provider          * default dereferencer is used which can resolve URI fragments, HTTP,          * file and XPpointer URIs.          *<p>          * Attention: The implementation is provider dependent!          *           * @seeXMLCryptoContext#setURIDereferencer(URIDereferencer)          */
DECL|field|uriDereferencer
specifier|private
name|URIDereferencer
name|uriDereferencer
decl_stmt|;
comment|/**          * You can set a base URI which is used in the URI dereferencing.          * Relative URIs are then concatenated with the base URI.          *           * @seeXMLCryptoContext#setBaseURI(String)          */
DECL|field|baseUri
specifier|private
name|String
name|baseUri
