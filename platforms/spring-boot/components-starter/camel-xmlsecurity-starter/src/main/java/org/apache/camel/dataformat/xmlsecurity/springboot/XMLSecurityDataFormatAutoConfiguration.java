...
name|name
operator|=
literal|"secureXML-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureXMLSecurityDataFormatFactory ( final CamelContext camelContext, final XMLSecurityDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureXMLSecurityDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
