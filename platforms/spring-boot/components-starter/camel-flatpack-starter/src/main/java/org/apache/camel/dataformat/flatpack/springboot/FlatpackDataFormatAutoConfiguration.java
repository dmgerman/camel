...
name|name
operator|=
literal|"flatpack-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureFlatpackDataFormatFactory ( final CamelContext camelContext, final FlatpackDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureFlatpackDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
