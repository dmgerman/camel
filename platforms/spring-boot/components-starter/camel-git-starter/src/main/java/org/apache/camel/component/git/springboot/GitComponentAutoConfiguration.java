...
begin_package
DECL|package|org.apache.camel.component.git.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|GitComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|GitComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|GitComponentAutoConfiguration
specifier|public
class|class
name|GitComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureGitComponent (CamelContext camelContext, GitComponentConfiguration configuration)
specifier|public
name|GitComponent
name|configureGitComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
