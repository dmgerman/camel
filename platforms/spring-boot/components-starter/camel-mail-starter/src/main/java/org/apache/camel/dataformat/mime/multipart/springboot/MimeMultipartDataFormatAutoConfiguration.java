...
name|Conditional
argument_list|(
name|MimeMultipartDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|MimeMultipartDataFormatAutoConfiguration
specifier|public
class|class
name|MimeMultipartDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"mime-multipart-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureMimeMultipartDataFormatFactory ( final CamelContext camelContext, final MimeMultipartDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureMimeMultipartDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
