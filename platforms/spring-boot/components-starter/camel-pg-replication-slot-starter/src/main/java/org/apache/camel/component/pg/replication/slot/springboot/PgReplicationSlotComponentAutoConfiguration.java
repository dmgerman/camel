...
name|class
block|,
name|PgReplicationSlotComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|PgReplicationSlotComponentAutoConfiguration
specifier|public
class|class
name|PgReplicationSlotComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"pg-replication-slot-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configurePgReplicationSlotComponent ()
specifier|public
name|PgReplicationSlotComponent
name|configurePgReplicationSlotComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.pg-replication-slot.customizer"
argument_list|,
operator|(
operator|(
name|HasId
