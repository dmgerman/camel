...
name|class
block|,
name|DataSetComponentAutoConfiguration
operator|.
...
name|class
block|,
name|DataSetComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|DataSetComponentAutoConfiguration
specifier|public
class|class
name|DataSetComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.dataset"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|class
argument_list|)
DECL|method|configureDataSetComponent ()
specifier|public
name|DataSetComponent
name|configureDataSetComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.dataset.customizer"
argument_list|,
operator|(
operator|(
name|HasId
