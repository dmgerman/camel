...
begin_package
DECL|package|org.apache.camel.component.rest.openapi.springboot
package|package
name|org
operator|.
name|apache
...
name|prefix
operator|=
literal|"camel.component.rest-openapi"
argument_list|)
DECL|class|RestOpenApiComponentConfiguration
specifier|public
class|class
name|RestOpenApiComponentConfiguration
extends|extends
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the rest-openapi component. This      * is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
decl_stmt|;
comment|/**      * API basePath, for example /v2. Default is unset, if set overrides the      * value present in OpenApi specification.      */
DECL|field|basePath
specifier|private
name|String
name|basePath
...
name|consumes
decl_stmt|;
comment|/**      * Scheme hostname and port to direct the HTTP requests to in the form of      * https://hostname:port. Can be configured at the endpoint, component or in      * the corresponding REST configuration in the Camel Context. If you give      * this component a name (e.g. petstore) that REST configuration is      * consulted first, rest-openapi next, and global configuration last. If set      * overrides any value found in the OpenApi specification,      * RestConfiguration. Can be overridden in endpoint configuration.      */
DECL|field|host
specifier|private
name|String
name|host
decl_stmt|;
comment|/**      * What payload type this component is producing. For example      * application/json according to the RFC7231. This equates to the value of      * Content-Type HTTP header. If set overrides any value present in the      * OpenApi specification. Can be overridden in endpoint configuration.      */
DECL|field|produces
specifier|private
name|String
name|produces
decl_stmt|;
comment|/**      * Path to the OpenApi specification file. The scheme, host base path are      * taken from this specification, but these can be overridden with      * properties on the component or endpoint level. If not given the component      * tries to load openapi.json resource. Note that the host defined on the      * component and endpoint of this Component should contain the scheme,      * hostname and optionally the port in the URI syntax (i.e.      * https://api.example.com:8080). Can be overridden in endpoint      * configuration.      */
