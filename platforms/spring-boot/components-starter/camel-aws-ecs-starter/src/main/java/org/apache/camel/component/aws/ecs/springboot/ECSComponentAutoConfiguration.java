...
name|class
block|,
name|ECSComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|ECSComponentAutoConfiguration
specifier|public
class|class
name|ECSComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureECSComponent ()
specifier|public
name|ECSComponent
name|configureECSComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.aws-ecs.customizer"
argument_list|,
operator|(
operator|(
name|HasId
