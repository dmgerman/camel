...
name|Conditional
argument_list|(
name|IrcComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|IrcComponentAutoConfiguration
specifier|public
class|class
name|IrcComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureIrcComponent (CamelContext camelContext, IrcComponentConfiguration configuration)
specifier|public
name|IrcComponent
name|configureIrcComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
