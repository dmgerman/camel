...
name|Conditional
argument_list|(
name|StringTemplateComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|StringTemplateComponentAutoConfiguration
specifier|public
class|class
name|StringTemplateComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"string-template-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureStringTemplateComponent ( CamelContext camelContext, StringTemplateComponentConfiguration configuration)
specifier|public
name|StringTemplateComponent
name|configureStringTemplateComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
