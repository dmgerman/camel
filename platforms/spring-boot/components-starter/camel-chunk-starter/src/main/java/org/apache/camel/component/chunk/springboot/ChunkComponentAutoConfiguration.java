...
name|Conditional
argument_list|(
name|ChunkComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|ChunkComponentAutoConfiguration
specifier|public
class|class
name|ChunkComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureChunkComponent (CamelContext camelContext, ChunkComponentConfiguration configuration)
specifier|public
name|ChunkComponent
name|configureChunkComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
