...
name|class
block|,
name|KuduComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|KuduComponentAutoConfiguration
specifier|public
class|class
name|KuduComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureKuduComponent ()
specifier|public
name|KuduComponent
name|configureKuduComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.kudu.customizer"
argument_list|,
operator|(
operator|(
name|HasId
