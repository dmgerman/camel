...
name|class
block|,
name|IPFSComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|IPFSComponentAutoConfiguration
specifier|public
class|class
name|IPFSComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureIPFSComponent ()
specifier|public
name|IPFSComponent
name|configureIPFSComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.ipfs.customizer"
argument_list|,
operator|(
operator|(
name|HasId
