...
name|Conditional
argument_list|(
name|CouchbaseComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|CouchbaseComponentAutoConfiguration
specifier|public
class|class
name|CouchbaseComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureCouchbaseComponent ( CamelContext camelContext, CouchbaseComponentConfiguration configuration)
specifier|public
name|CouchbaseComponent
name|configureCouchbaseComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
