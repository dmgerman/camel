...
name|Conditional
argument_list|(
name|BeanValidatorComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|BeanValidatorComponentAutoConfiguration
specifier|public
class|class
name|BeanValidatorComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"bean-validator-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureBeanValidatorComponent ( CamelContext camelContext, BeanValidatorComponentConfiguration configuration)
specifier|public
name|BeanValidatorComponent
name|configureBeanValidatorComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
