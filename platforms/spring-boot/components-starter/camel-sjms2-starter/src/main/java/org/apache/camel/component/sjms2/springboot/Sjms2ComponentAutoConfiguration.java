...
name|Conditional
argument_list|(
name|Sjms2ComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|Sjms2ComponentAutoConfiguration
specifier|public
class|class
name|Sjms2ComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureSjms2Component (CamelContext camelContext, Sjms2ComponentConfiguration configuration)
specifier|public
name|Sjms2Component
name|configureSjms2Component
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
