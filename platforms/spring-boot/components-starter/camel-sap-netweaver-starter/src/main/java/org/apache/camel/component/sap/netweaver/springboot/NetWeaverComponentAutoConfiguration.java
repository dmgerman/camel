...
begin_package
DECL|package|org.apache.camel.component.sap.netweaver.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|NetWeaverComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|NetWeaverComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|NetWeaverComponentAutoConfiguration
specifier|public
class|class
name|NetWeaverComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"sap-netweaver-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureNetWeaverComponent ( CamelContext camelContext, NetWeaverComponentConfiguration configuration)
specifier|public
name|NetWeaverComponent
name|configureNetWeaverComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.sap-netweaver"
argument_list|)
decl_stmt|;
if|if
condition|(
