...
name|class
block|,
name|DebeziumMongodbComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|DebeziumMongodbComponentAutoConfiguration
specifier|public
class|class
name|DebeziumMongodbComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"debezium-mongodb-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureDebeziumMongodbComponent ()
specifier|public
name|DebeziumMongodbComponent
name|configureDebeziumMongodbComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.debezium-mongodb.customizer"
argument_list|,
operator|(
operator|(
name|HasId
