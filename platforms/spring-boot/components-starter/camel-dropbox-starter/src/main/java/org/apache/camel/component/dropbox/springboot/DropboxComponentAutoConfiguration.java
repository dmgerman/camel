...
name|Conditional
argument_list|(
name|DropboxComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|DropboxComponentAutoConfiguration
specifier|public
class|class
name|DropboxComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureDropboxComponent ( CamelContext camelContext, DropboxComponentConfiguration configuration)
specifier|public
name|DropboxComponent
name|configureDropboxComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
