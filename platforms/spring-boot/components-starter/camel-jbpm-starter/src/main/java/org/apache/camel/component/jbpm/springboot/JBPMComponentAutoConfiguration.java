...
begin_package
DECL|package|org.apache.camel.component.jbpm.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|JBPMComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|JBPMComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|JBPMComponentAutoConfiguration
specifier|public
class|class
name|JBPMComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureJBPMComponent (CamelContext camelContext, JBPMComponentConfiguration configuration)
specifier|public
name|JBPMComponent
name|configureJBPMComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
