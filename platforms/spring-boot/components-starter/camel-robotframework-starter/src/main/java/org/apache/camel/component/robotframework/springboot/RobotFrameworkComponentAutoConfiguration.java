...
name|class
block|,
name|RobotFrameworkComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|RobotFrameworkComponentAutoConfiguration
specifier|public
class|class
name|RobotFrameworkComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"robotframework-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureRobotFrameworkComponent ()
specifier|public
name|RobotFrameworkComponent
name|configureRobotFrameworkComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.robotframework.customizer"
argument_list|,
operator|(
operator|(
name|HasId
