...
name|class
block|,
name|MicrometerComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|MicrometerComponentAutoConfiguration
specifier|public
class|class
name|MicrometerComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureMicrometerComponent ()
specifier|public
name|MicrometerComponent
name|configureMicrometerComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.micrometer.customizer"
argument_list|,
operator|(
operator|(
name|HasId
