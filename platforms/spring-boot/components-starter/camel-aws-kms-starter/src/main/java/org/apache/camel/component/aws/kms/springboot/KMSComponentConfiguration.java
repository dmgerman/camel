...
begin_package
DECL|package|org.apache.camel.component.aws.kms.springboot
package|package
name|org
operator|.
name|apache
...
name|prefix
operator|=
literal|"camel.component.aws-kms"
argument_list|)
DECL|class|KMSComponentConfiguration
specifier|public
class|class
name|KMSComponentConfiguration
extends|extends
name|ComponentConfigurationPropertiesCommon
block|{
...
return|;
block|}
DECL|method|setConfiguration ( KMSConfigurationNestedConfiguration configuration)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|class|KMSConfigurationNestedConfiguration
specifier|public
specifier|static
class|class
name|KMSConfigurationNestedConfiguration
...
name|class
decl_stmt|;
comment|/**          * To use a existing configured AWS KMS as client          */
DECL|field|kmsClient
specifier|private
name|AWSKMS
name|kmsClient
decl_stmt|;
...
name|operation
decl_stmt|;
comment|/**          * To define a proxy protocol when instantiating the KMS client          */
...
name|proxyPort
decl_stmt|;
comment|/**          * The region in which KMS client needs to work. When using this          * parameter, the configuration will expect the capitalized name of the          * region (for example AP_EAST_1) You'll need to use the name          * Regions.EU_WEST_1.name()          */
DECL|field|region
specifier|private
name|String
name|region
decl_stmt|;
DECL|method|getKmsClient ()
specifier|public
name|AWSKMS
name|getKmsClient
parameter_list|()
...
return|;
block|}
DECL|method|setKmsClient (AWSKMS kmsClient)
specifier|public
name|void
name|setKmsClient
parameter_list|(
...
return|;
block|}
DECL|method|setOperation (KMSOperations operation)
specifier|public
name|void
name|setOperation
parameter_list|(
