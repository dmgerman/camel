...
name|date
operator|=
literal|"2017-04-19T08:40:54.730Z"
argument_list|)
annotation|@
name|Configuration
annotation|@
...
name|Conditional
argument_list|(
name|RestSwaggerComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|RestSwaggerComponentAutoConfiguration
specifier|public
class|class
name|RestSwaggerComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureRestSwaggerComponent ( CamelContext camelContext, RestSwaggerComponentConfiguration configuration)
specifier|public
name|RestSwaggerComponent
name|configureRestSwaggerComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|date
operator|=
literal|"2017-04-19T08:40:54.785Z"
argument_list|)
