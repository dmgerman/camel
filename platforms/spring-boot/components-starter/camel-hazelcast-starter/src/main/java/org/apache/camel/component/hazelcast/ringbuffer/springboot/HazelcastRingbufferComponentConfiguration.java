...
argument_list|)
DECL|class|HazelcastRingbufferComponentConfiguration
specifier|public
class|class
...
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the hazelcast-ringbuffer      * component. This is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
