...
begin_package
DECL|package|org.apache.camel.component.hazelcast.queue.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|HazelcastQueueComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|HazelcastQueueComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|HazelcastQueueComponentAutoConfiguration
specifier|public
class|class
name|HazelcastQueueComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"hazelcast-queue-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureHazelcastQueueComponent ( CamelContext camelContext, HazelcastQueueComponentConfiguration configuration)
specifier|public
name|HazelcastQueueComponent
name|configureHazelcastQueueComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.hazelcast-queue"
argument_list|)
decl_stmt|;
if|if
condition|(
