...
argument_list|)
DECL|class|HazelcastInstanceComponentConfiguration
specifier|public
class|class
...
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the hazelcast-instance component.      * This is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
