...
name|Conditional
argument_list|(
name|HazelcastMapComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|HazelcastMapComponentAutoConfiguration
specifier|public
class|class
name|HazelcastMapComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"hazelcast-map-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureHazelcastMapComponent ( CamelContext camelContext, HazelcastMapComponentConfiguration configuration)
specifier|public
name|HazelcastMapComponent
name|configureHazelcastMapComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
