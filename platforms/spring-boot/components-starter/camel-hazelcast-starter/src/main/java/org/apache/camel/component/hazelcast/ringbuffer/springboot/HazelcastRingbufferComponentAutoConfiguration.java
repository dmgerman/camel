...
begin_package
DECL|package|org.apache.camel.component.hazelcast.ringbuffer.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|HazelcastRingbufferComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|HazelcastRingbufferComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|HazelcastRingbufferComponentAutoConfiguration
specifier|public
class|class
name|HazelcastRingbufferComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"hazelcast-ringbuffer-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureHazelcastRingbufferComponent ( CamelContext camelContext, HazelcastRingbufferComponentConfiguration configuration)
specifier|public
name|HazelcastRingbufferComponent
name|configureHazelcastRingbufferComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.hazelcast-ringbuffer"
argument_list|)
decl_stmt|;
if|if
condition|(
