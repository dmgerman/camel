...
begin_package
DECL|package|org.apache.camel.component.hazelcast.list.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|HazelcastListComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|HazelcastListComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|HazelcastListComponentAutoConfiguration
specifier|public
class|class
name|HazelcastListComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"hazelcast-list-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureHazelcastListComponent ( CamelContext camelContext, HazelcastListComponentConfiguration configuration)
specifier|public
name|HazelcastListComponent
name|configureHazelcastListComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.hazelcast-list"
argument_list|)
decl_stmt|;
if|if
condition|(
