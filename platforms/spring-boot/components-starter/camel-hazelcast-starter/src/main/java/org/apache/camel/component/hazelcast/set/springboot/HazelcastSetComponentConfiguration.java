...
begin_package
DECL|package|org.apache.camel.component.hazelcast.set.springboot
package|package
name|org
operator|.
name|apache
...
name|prefix
operator|=
literal|"camel.component.hazelcast-set"
argument_list|)
DECL|class|HazelcastSetComponentConfiguration
specifier|public
class|class
name|HazelcastSetComponentConfiguration
extends|extends
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the hazelcast-set component. This      * is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
