...
name|Conditional
argument_list|(
name|HazelcastTopicComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|HazelcastTopicComponentAutoConfiguration
specifier|public
class|class
name|HazelcastTopicComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"hazelcast-topic-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureHazelcastTopicComponent ( CamelContext camelContext, HazelcastTopicComponentConfiguration configuration)
specifier|public
name|HazelcastTopicComponent
name|configureHazelcastTopicComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
