...
name|class
argument_list|)
DECL|class|HazelcastAtomicnumberComponentAutoConfiguration
specifier|public
class|class
name|HazelcastAtomicnumberComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"hazelcast-atomicvalue-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureHazelcastAtomicnumberComponent ( CamelContext camelContext, HazelcastAtomicnumberComponentConfiguration configuration)
specifier|public
name|HazelcastAtomicnumberComponent
name|configureHazelcastAtomicnumberComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
