...
name|Conditional
argument_list|(
name|HazelcastSetComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|HazelcastSetComponentAutoConfiguration
specifier|public
class|class
name|HazelcastSetComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"hazelcast-set-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureHazelcastSetComponent ( CamelContext camelContext, HazelcastSetComponentConfiguration configuration)
specifier|public
name|HazelcastSetComponent
name|configureHazelcastSetComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
