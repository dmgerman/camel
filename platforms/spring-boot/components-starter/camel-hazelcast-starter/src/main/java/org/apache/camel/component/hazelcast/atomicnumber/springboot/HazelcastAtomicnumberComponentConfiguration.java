...
begin_package
DECL|package|org.apache.camel.component.hazelcast.atomicnumber.springboot
package|package
name|org
operator|.
name|apache
...
name|prefix
operator|=
literal|"camel.component.hazelcast-atomicvalue"
argument_list|)
DECL|class|HazelcastAtomicnumberComponentConfiguration
specifier|public
class|class
name|HazelcastAtomicnumberComponentConfiguration
extends|extends
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the hazelcast-atomicvalue      * component. This is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
