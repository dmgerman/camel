...
begin_package
DECL|package|org.apache.camel.component.service.springboot
package|package
name|org
operator|.
name|apache
...
name|prefix
operator|=
literal|"camel.component.service"
argument_list|)
DECL|class|ServiceComponentConfiguration
specifier|public
class|class
name|ServiceComponentConfiguration
extends|extends
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the service component. This is      * enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
