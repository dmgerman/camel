...
name|class
block|,
name|DebeziumPostgresComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|DebeziumPostgresComponentAutoConfiguration
specifier|public
class|class
name|DebeziumPostgresComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"debezium-postgres-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureDebeziumPostgresComponent ()
specifier|public
name|DebeziumPostgresComponent
name|configureDebeziumPostgresComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.debezium-postgres.customizer"
argument_list|,
operator|(
operator|(
name|HasId
