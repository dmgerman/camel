...
begin_package
DECL|package|org.apache.camel.component.jacksonxml.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|JacksonXMLDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|JacksonXMLDataFormatConfiguration
operator|.
name|class
argument_list|)
DECL|class|JacksonXMLDataFormatAutoConfiguration
specifier|public
class|class
name|JacksonXMLDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"jacksonxml-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureJacksonXMLDataFormatFactory ( final CamelContext camelContext, final JacksonXMLDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureJacksonXMLDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
...
name|forCondition
argument_list|(
literal|"camel.dataformat.jacksonxml"
argument_list|)
decl_stmt|;
if|if
condition|(
