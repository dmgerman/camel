...
begin_comment
comment|/**  * JacksonXML data format is used for unmarshal a XML payload to POJO or to  * marshal POJO back to XML payload.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
name|DataFormatConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the jacksonxml data format. This      * is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
