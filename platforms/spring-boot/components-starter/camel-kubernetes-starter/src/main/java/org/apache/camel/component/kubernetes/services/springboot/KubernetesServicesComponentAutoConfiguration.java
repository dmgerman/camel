...
begin_package
DECL|package|org.apache.camel.component.kubernetes.services.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|KubernetesServicesComponentAutoConfiguration
operator|.
...
name|class
block|,
name|KubernetesServicesComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|KubernetesServicesComponentAutoConfiguration
specifier|public
class|class
name|KubernetesServicesComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.kubernetes-services"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|name
operator|=
literal|"kubernetes-services-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKubernetesServicesComponent ()
specifier|public
name|KubernetesServicesComponent
name|configureKubernetesServicesComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.kubernetes-services.customizer"
argument_list|,
operator|(
operator|(
name|HasId
