...
begin_package
DECL|package|org.apache.camel.component.kubernetes.job.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|KubernetesJobComponentAutoConfiguration
operator|.
...
name|class
block|,
name|KubernetesJobComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|KubernetesJobComponentAutoConfiguration
specifier|public
class|class
name|KubernetesJobComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.kubernetes-job"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|name
operator|=
literal|"kubernetes-job-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKubernetesJobComponent ()
specifier|public
name|KubernetesJobComponent
name|configureKubernetesJobComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.kubernetes-job.customizer"
argument_list|,
operator|(
operator|(
name|HasId
