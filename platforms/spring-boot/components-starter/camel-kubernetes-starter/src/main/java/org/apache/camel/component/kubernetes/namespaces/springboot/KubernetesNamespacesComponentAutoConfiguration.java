...
begin_package
DECL|package|org.apache.camel.component.kubernetes.namespaces.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|KubernetesNamespacesComponentAutoConfiguration
operator|.
...
name|class
block|,
name|KubernetesNamespacesComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|KubernetesNamespacesComponentAutoConfiguration
specifier|public
class|class
name|KubernetesNamespacesComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.kubernetes-namespaces"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|name
operator|=
literal|"kubernetes-namespaces-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKubernetesNamespacesComponent ()
specifier|public
name|KubernetesNamespacesComponent
name|configureKubernetesNamespacesComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.kubernetes-namespaces.customizer"
argument_list|,
operator|(
operator|(
name|HasId
