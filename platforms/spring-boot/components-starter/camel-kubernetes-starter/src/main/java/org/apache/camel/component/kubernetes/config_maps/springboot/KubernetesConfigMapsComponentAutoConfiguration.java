...
begin_package
DECL|package|org.apache.camel.component.kubernetes.config_maps.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|KubernetesConfigMapsComponentAutoConfiguration
operator|.
...
name|class
block|,
name|KubernetesConfigMapsComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|KubernetesConfigMapsComponentAutoConfiguration
specifier|public
class|class
name|KubernetesConfigMapsComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.kubernetes-config-maps"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|name
operator|=
literal|"kubernetes-config-maps-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKubernetesConfigMapsComponent ()
specifier|public
name|KubernetesConfigMapsComponent
name|configureKubernetesConfigMapsComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.kubernetes-config-maps.customizer"
argument_list|,
operator|(
operator|(
name|HasId
