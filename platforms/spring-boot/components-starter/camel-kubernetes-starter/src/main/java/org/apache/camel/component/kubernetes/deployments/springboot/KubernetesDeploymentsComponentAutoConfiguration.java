...
begin_package
DECL|package|org.apache.camel.component.kubernetes.deployments.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|KubernetesDeploymentsComponentAutoConfiguration
operator|.
...
name|class
block|,
name|KubernetesDeploymentsComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|KubernetesDeploymentsComponentAutoConfiguration
specifier|public
class|class
name|KubernetesDeploymentsComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.kubernetes-deployments"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|name
operator|=
literal|"kubernetes-deployments-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKubernetesDeploymentsComponent ()
specifier|public
name|KubernetesDeploymentsComponent
name|configureKubernetesDeploymentsComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.kubernetes-deployments.customizer"
argument_list|,
operator|(
operator|(
name|HasId
