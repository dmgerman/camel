...
name|class
block|,
name|KubernetesHPAComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|KubernetesHPAComponentAutoConfiguration
specifier|public
class|class
name|KubernetesHPAComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"kubernetes-hpa-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKubernetesHPAComponent ()
specifier|public
name|KubernetesHPAComponent
name|configureKubernetesHPAComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.kubernetes-hpa.customizer"
argument_list|,
operator|(
operator|(
name|HasId
