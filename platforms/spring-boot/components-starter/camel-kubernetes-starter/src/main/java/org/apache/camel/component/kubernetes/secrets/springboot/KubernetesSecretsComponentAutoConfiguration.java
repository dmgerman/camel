...
name|secrets
operator|.
name|KubernetesSecretsComponent
import|;
end_import
...
name|class
block|,
name|KubernetesSecretsComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|KubernetesSecretsComponentAutoConfiguration
specifier|public
class|class
name|KubernetesSecretsComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"kubernetes-secrets-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKubernetesSecretsComponent ()
specifier|public
name|KubernetesSecretsComponent
name|configureKubernetesSecretsComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.kubernetes-secrets.customizer"
argument_list|,
operator|(
operator|(
name|HasId
