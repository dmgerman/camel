...
name|class
block|,
name|KubernetesResourcesQuotaComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|KubernetesResourcesQuotaComponentAutoConfiguration
specifier|public
class|class
name|KubernetesResourcesQuotaComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"kubernetes-resources-quota-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKubernetesResourcesQuotaComponent ()
specifier|public
name|KubernetesResourcesQuotaComponent
name|configureKubernetesResourcesQuotaComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.kubernetes-resources-quota.customizer"
argument_list|,
operator|(
operator|(
name|HasId
