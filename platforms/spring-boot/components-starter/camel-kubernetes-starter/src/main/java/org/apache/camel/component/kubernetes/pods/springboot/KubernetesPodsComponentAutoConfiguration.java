...
begin_package
DECL|package|org.apache.camel.component.kubernetes.pods.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|KubernetesPodsComponentAutoConfiguration
operator|.
...
name|class
block|,
name|KubernetesPodsComponentConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|KubernetesPodsComponentAutoConfiguration
specifier|public
class|class
name|KubernetesPodsComponentAutoConfiguration
block|{
...
argument_list|,
literal|"camel.component.kubernetes-pods"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|name
operator|=
literal|"kubernetes-pods-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKubernetesPodsComponent ()
specifier|public
name|KubernetesPodsComponent
name|configureKubernetesPodsComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.kubernetes-pods.customizer"
argument_list|,
operator|(
operator|(
name|HasId
