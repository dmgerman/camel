...
argument_list|,
literal|"camel.component.zookeeper.service-registry.nodes="
operator|+
name|zkServer
operator|.
name|serverList
...
comment|// Helpers
comment|// *************************************
DECL|class|ZooKeeperTestServer
specifier|public
specifier|static
class|class
name|ZooKeeperTestServer
...
name|zkServer
decl_stmt|;
DECL|method|ZooKeeperTestServer (File root)
specifier|public
name|ZooKeeperTestServer
parameter_list|(
name|File
