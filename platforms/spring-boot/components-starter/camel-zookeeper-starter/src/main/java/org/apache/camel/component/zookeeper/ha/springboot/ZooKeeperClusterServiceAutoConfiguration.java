...
begin_package
DECL|package|org.apache.camel.component.zookeeper.ha.springboot
package|package
name|org
operator|.
name|apache
...
name|class
argument_list|)
DECL|class|ZooKeeperClusterServiceAutoConfiguration
specifier|public
class|class
name|ZooKeeperClusterServiceAutoConfiguration
block|{
annotation|@
name|Autowired
...
name|name
operator|=
literal|"zookeeper-cluster-service"
argument_list|)
annotation|@
name|Scope
argument_list|(
