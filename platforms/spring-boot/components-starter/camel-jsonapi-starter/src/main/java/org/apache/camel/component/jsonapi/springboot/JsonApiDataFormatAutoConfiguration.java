...
name|class
block|,
name|JsonApiDataFormatAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|JsonApiDataFormatAutoConfiguration
specifier|public
class|class
name|JsonApiDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"jsonApi-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureJsonApiDataFormatFactory ()
specifier|public
name|DataFormatFactory
name|configureJsonApiDataFormatFactory
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.dataformat.jsonapi.customizer"
argument_list|,
operator|(
operator|(
name|HasId
