...
name|date
operator|=
literal|"2017-04-19T08:39:35.390Z"
argument_list|)
annotation|@
name|Configuration
annotation|@
...
name|Conditional
argument_list|(
name|PubNubComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
literal|"org.apache.camel.spring.boot.CamelAutoConfiguration"
argument_list|)
DECL|class|PubNubComponentAutoConfiguration
specifier|public
class|class
name|PubNubComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configurePubNubComponent (CamelContext camelContext)
specifier|public
name|PubNubComponent
name|configurePubNubComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|)
...
name|date
operator|=
literal|"2017-04-19T08:39:35.455Z"
argument_list|)
