...
name|class
block|,
name|JGroupsRaftComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|JGroupsRaftComponentAutoConfiguration
specifier|public
class|class
name|JGroupsRaftComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"jgroups-raft-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureJGroupsRaftComponent ()
specifier|public
name|JGroupsRaftComponent
name|configureJGroupsRaftComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.jgroups-raft.customizer"
argument_list|,
operator|(
operator|(
name|HasId
