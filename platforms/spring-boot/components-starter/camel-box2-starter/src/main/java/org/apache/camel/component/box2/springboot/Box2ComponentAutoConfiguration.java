...
name|Conditional
argument_list|(
name|Box2ComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|Box2ComponentAutoConfiguration
specifier|public
class|class
name|Box2ComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureBox2Component (CamelContext camelContext, Box2ComponentConfiguration configuration)
specifier|public
name|Box2Component
name|configureBox2Component
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
