...
name|Conditional
argument_list|(
name|DnsCloudAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|DnsCloudAutoConfiguration
specifier|public
class|class
name|DnsCloudAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureServiceDiscoveryFactory (CamelContext camelContext, DnsCloudConfiguration configuration)
specifier|public
name|ServiceDiscovery
