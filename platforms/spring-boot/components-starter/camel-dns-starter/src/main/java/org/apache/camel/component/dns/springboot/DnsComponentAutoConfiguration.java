...
name|Conditional
argument_list|(
name|DnsComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|DnsComponentAutoConfiguration
specifier|public
class|class
name|DnsComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureDnsComponent (CamelContext camelContext, DnsComponentConfiguration configuration)
specifier|public
name|DnsComponent
name|configureDnsComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
