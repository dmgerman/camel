...
name|class
block|,
name|IAMComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|IAMComponentAutoConfiguration
specifier|public
class|class
name|IAMComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureIAMComponent ()
specifier|public
name|IAMComponent
name|configureIAMComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.aws-iam.customizer"
argument_list|,
operator|(
operator|(
name|HasId
