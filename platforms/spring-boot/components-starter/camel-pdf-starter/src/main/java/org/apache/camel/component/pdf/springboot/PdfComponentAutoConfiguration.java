...
begin_package
DECL|package|org.apache.camel.component.pdf.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|PdfComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|PdfComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|PdfComponentAutoConfiguration
specifier|public
class|class
name|PdfComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configurePdfComponent (CamelContext camelContext, PdfComponentConfiguration configuration)
specifier|public
name|PdfComponent
name|configurePdfComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
