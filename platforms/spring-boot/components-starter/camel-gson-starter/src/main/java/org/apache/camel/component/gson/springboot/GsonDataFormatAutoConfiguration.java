...
name|Conditional
argument_list|(
name|GsonDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|GsonDataFormatAutoConfiguration
specifier|public
class|class
name|GsonDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"json-gson-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureGsonDataFormatFactory ( final CamelContext camelContext, final GsonDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureGsonDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
