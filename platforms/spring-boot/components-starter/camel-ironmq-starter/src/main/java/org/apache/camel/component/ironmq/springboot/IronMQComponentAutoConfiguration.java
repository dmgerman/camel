...
begin_package
DECL|package|org.apache.camel.component.ironmq.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|IronMQComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|IronMQComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|IronMQComponentAutoConfiguration
specifier|public
class|class
name|IronMQComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureIronMQComponent (CamelContext camelContext, IronMQComponentConfiguration configuration)
specifier|public
name|IronMQComponent
name|configureIronMQComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.ironmq"
argument_list|)
decl_stmt|;
if|if
condition|(
