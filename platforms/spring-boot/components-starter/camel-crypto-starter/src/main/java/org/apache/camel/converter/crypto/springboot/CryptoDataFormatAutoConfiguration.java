...
name|Conditional
argument_list|(
name|CryptoDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|CryptoDataFormatAutoConfiguration
specifier|public
class|class
name|CryptoDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"crypto-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureCryptoDataFormatFactory ( final CamelContext camelContext, final CryptoDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureCryptoDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
