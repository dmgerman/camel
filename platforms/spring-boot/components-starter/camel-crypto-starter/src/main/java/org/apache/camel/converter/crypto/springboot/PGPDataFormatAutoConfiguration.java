...
name|name
operator|=
literal|"pgp-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configurePGPDataFormatFactory ( final CamelContext camelContext, final PGPDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configurePGPDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
