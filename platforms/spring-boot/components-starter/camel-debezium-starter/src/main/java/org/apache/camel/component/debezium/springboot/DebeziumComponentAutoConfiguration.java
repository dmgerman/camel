...
name|class
block|,
name|DebeziumComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|DebeziumComponentAutoConfiguration
specifier|public
class|class
name|DebeziumComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureDebeziumComponent ()
specifier|public
name|DebeziumComponent
name|configureDebeziumComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.debezium.customizer"
argument_list|,
operator|(
operator|(
name|HasId
