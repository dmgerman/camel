...
name|class
block|,
name|GoogleBigQuerySQLComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|GoogleBigQuerySQLComponentAutoConfiguration
specifier|public
class|class
name|GoogleBigQuerySQLComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"google-bigquery-sql-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureGoogleBigQuerySQLComponent ()
specifier|public
name|GoogleBigQuerySQLComponent
name|configureGoogleBigQuerySQLComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.google-bigquery-sql.customizer"
argument_list|,
operator|(
operator|(
name|HasId
