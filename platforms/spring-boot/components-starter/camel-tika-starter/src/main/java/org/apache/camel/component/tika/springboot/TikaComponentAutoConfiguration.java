...
begin_package
DECL|package|org.apache.camel.component.tika.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|TikaComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|TikaComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|TikaComponentAutoConfiguration
specifier|public
class|class
name|TikaComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureTikaComponent (CamelContext camelContext, TikaComponentConfiguration configuration)
specifier|public
name|TikaComponent
name|configureTikaComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
