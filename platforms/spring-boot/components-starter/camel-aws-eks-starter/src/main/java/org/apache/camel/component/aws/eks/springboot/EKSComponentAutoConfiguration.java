...
name|class
block|,
name|EKSComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|EKSComponentAutoConfiguration
specifier|public
class|class
name|EKSComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureEKSComponent ()
specifier|public
name|EKSComponent
name|configureEKSComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.aws-eks.customizer"
argument_list|,
operator|(
operator|(
name|HasId
