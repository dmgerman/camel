...
name|Conditional
argument_list|(
name|GeoCoderComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|GeoCoderComponentAutoConfiguration
specifier|public
class|class
name|GeoCoderComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureGeoCoderComponent ( CamelContext camelContext, GeoCoderComponentConfiguration configuration)
specifier|public
name|GeoCoderComponent
name|configureGeoCoderComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
