...
name|class
block|,
name|GzipDeflaterDataFormatAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|GzipDeflaterDataFormatAutoConfiguration
specifier|public
class|class
name|GzipDeflaterDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"gzipdeflater-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureGzipDeflaterDataFormatFactory ()
specifier|public
name|DataFormatFactory
name|configureGzipDeflaterDataFormatFactory
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.dataformat.gzipdeflater.customizer"
argument_list|,
operator|(
operator|(
name|HasId
