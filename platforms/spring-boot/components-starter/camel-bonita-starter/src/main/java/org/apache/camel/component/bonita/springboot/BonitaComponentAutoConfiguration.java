...
begin_package
DECL|package|org.apache.camel.component.bonita.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|BonitaComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|BonitaComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|BonitaComponentAutoConfiguration
specifier|public
class|class
name|BonitaComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureBonitaComponent (CamelContext camelContext, BonitaComponentConfiguration configuration)
specifier|public
name|BonitaComponent
name|configureBonitaComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.bonita"
argument_list|)
decl_stmt|;
if|if
condition|(
