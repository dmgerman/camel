...
begin_package
DECL|package|org.apache.camel.component.fastjson.springboot
package|package
name|org
operator|.
name|apache
...
name|class
block|,
name|FastjsonDataFormatAutoConfiguration
operator|.
...
name|class
block|,
name|FastjsonDataFormatConfiguration
operator|.
name|class
block|}
argument_list|)
DECL|class|FastjsonDataFormatAutoConfiguration
specifier|public
class|class
name|FastjsonDataFormatAutoConfiguration
block|{
...
argument_list|,
literal|"camel.dataformat.json-fastjson"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|name
operator|=
literal|"json-fastjson-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureFastjsonDataFormatFactory ()
specifier|public
name|DataFormatFactory
name|configureFastjsonDataFormatFactory
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.dataformat.json-fastjson.customizer"
argument_list|,
operator|(
operator|(
name|HasId
