...
name|class
block|,
name|GoogleCalendarStreamComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|GoogleCalendarStreamComponentAutoConfiguration
specifier|public
class|class
name|GoogleCalendarStreamComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"google-calendar-stream-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureGoogleCalendarStreamComponent ()
specifier|public
name|GoogleCalendarStreamComponent
name|configureGoogleCalendarStreamComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.google-calendar-stream.customizer"
argument_list|,
operator|(
operator|(
name|HasId
