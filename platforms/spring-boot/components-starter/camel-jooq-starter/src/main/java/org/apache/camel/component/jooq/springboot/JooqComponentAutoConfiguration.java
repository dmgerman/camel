...
name|class
block|,
name|JooqComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|JooqComponentAutoConfiguration
specifier|public
class|class
name|JooqComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureJooqComponent ()
specifier|public
name|JooqComponent
name|configureJooqComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.jooq.customizer"
argument_list|,
operator|(
operator|(
name|HasId
