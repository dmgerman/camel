...
name|class
block|,
name|TranslateComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|TranslateComponentAutoConfiguration
specifier|public
class|class
name|TranslateComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"aws-translate-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureTranslateComponent ()
specifier|public
name|TranslateComponent
name|configureTranslateComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.aws-translate.customizer"
argument_list|,
operator|(
operator|(
name|HasId
