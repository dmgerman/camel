...
name|name
operator|=
literal|"bindy-fixed-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureBindyFixedLengthDataFormatFactory ( final CamelContext camelContext, final BindyFixedLengthDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureBindyFixedLengthDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
