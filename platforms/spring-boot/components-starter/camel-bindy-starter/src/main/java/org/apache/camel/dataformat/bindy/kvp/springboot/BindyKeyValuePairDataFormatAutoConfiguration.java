...
name|name
operator|=
literal|"bindy-kvp-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureBindyKeyValuePairDataFormatFactory ( final CamelContext camelContext, final BindyKeyValuePairDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureBindyKeyValuePairDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
