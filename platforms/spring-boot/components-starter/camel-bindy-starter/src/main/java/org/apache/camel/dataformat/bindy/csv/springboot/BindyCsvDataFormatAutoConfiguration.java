...
name|Conditional
argument_list|(
name|BindyCsvDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|BindyCsvDataFormatAutoConfiguration
specifier|public
class|class
name|BindyCsvDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"bindy-csv-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureBindyCsvDataFormatFactory ( final CamelContext camelContext, final BindyCsvDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureBindyCsvDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
