...
begin_package
DECL|package|org.apache.camel.component.drill.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|DrillComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|DrillComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|DrillComponentAutoConfiguration
specifier|public
class|class
name|DrillComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureDrillComponent (CamelContext camelContext, DrillComponentConfiguration configuration)
specifier|public
name|DrillComponent
name|configureDrillComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
