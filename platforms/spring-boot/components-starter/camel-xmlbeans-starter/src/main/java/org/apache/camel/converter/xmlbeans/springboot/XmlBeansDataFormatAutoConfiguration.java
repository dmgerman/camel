...
name|name
operator|=
literal|"xmlBeans-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureXmlBeansDataFormatFactory ( final CamelContext camelContext, final XmlBeansDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureXmlBeansDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
