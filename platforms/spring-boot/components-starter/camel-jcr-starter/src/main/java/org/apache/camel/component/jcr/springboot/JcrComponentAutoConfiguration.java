...
begin_package
DECL|package|org.apache.camel.component.jcr.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|JcrComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|JcrComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|JcrComponentAutoConfiguration
specifier|public
class|class
name|JcrComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureJcrComponent (CamelContext camelContext, JcrComponentConfiguration configuration)
specifier|public
name|JcrComponent
name|configureJcrComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
