...
name|prefix
operator|=
literal|"camel.component.mongodb"
argument_list|)
DECL|class|MongoDbComponentConfiguration
specifier|public
class|class
...
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the mongodb component. This is      * enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
