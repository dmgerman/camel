...
begin_package
DECL|package|org.apache.camel.component.seda.springboot
package|package
name|org
operator|.
name|apache
...
name|prefix
operator|=
literal|"camel.component.seda"
argument_list|)
DECL|class|SedaComponentConfiguration
specifier|public
class|class
name|SedaComponentConfiguration
extends|extends
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the seda component. This is      * enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
