...
name|class
block|,
name|GrokDataFormatAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|GrokDataFormatAutoConfiguration
specifier|public
class|class
name|GrokDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"grok-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureGrokDataFormatFactory ()
specifier|public
name|DataFormatFactory
name|configureGrokDataFormatFactory
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.dataformat.grok.customizer"
argument_list|,
operator|(
operator|(
name|HasId
