...
name|class
block|,
name|DdbComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|DdbComponentAutoConfiguration
specifier|public
class|class
name|DdbComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureDdbComponent ()
specifier|public
name|DdbComponent
name|configureDdbComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.aws-ddb.customizer"
argument_list|,
operator|(
operator|(
name|HasId
