...
name|class
block|,
name|ServerComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|ServerComponentAutoConfiguration
specifier|public
class|class
name|ServerComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"iec60870-server-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureServerComponent ()
specifier|public
name|ServerComponent
name|configureServerComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.iec60870-server.customizer"
argument_list|,
operator|(
operator|(
name|HasId
