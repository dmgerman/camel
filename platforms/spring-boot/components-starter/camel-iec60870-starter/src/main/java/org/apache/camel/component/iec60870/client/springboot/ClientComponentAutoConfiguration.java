...
name|class
block|,
name|ClientComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|ClientComponentAutoConfiguration
specifier|public
class|class
name|ClientComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"iec60870-client-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureClientComponent ()
specifier|public
name|ClientComponent
name|configureClientComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.iec60870-client.customizer"
argument_list|,
operator|(
operator|(
name|HasId
