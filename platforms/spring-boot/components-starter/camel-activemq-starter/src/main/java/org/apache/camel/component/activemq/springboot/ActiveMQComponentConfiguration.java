...
begin_package
DECL|package|org.apache.camel.component.activemq.springboot
package|package
name|org
operator|.
name|apache
...
name|prefix
operator|=
literal|"camel.component.activemq"
argument_list|)
DECL|class|ActiveMQComponentConfiguration
specifier|public
class|class
name|ActiveMQComponentConfiguration
extends|extends
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the activemq component. This is      * enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
...
literal|false
decl_stmt|;
comment|/**      * Enables or disables whether a Spring SingleConnectionFactory will be used      * so that when messages are sent to ActiveMQ from outside of a message      * consuming thread, pooling will be used rather than the default with the      * Spring JmsTemplate which will create a new connection, session, producer      * for each message then close them all down again. The default value is      * false and a pooled connection is used by default.      */
...
literal|false
decl_stmt|;
comment|/**      * Configuration of ActiveMQ. The option is a      * org.apache.camel.component.jms.JmsConfiguration type.      */
...
expr_stmt|;
block|}
DECL|method|getTrustAllPackages ()
specifier|public
name|Boolean
name|getTrustAllPackages
parameter_list|()
block|{
return|return
name|trustAllPackages
...
expr_stmt|;
block|}
DECL|method|getUseSingleConnection ()
specifier|public
name|Boolean
name|getUseSingleConnection
parameter_list|()
block|{
return|return
name|useSingleConnection
