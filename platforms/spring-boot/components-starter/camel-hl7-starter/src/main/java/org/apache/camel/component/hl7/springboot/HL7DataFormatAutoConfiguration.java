...
name|Conditional
argument_list|(
name|HL7DataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|HL7DataFormatAutoConfiguration
specifier|public
class|class
name|HL7DataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"hl7-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureHL7DataFormatFactory ( final CamelContext camelContext, final HL7DataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureHL7DataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
