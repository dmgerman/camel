...
begin_comment
comment|/**  * XML JSon data format can convert from XML to JSON and vice-versa directly,  * without stepping through intermediate POJOs.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
