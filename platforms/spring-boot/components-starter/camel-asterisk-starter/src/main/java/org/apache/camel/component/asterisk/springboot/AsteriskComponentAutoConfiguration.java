...
begin_package
DECL|package|org.apache.camel.component.asterisk.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|AsteriskComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|AsteriskComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|AsteriskComponentAutoConfiguration
specifier|public
class|class
name|AsteriskComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureAsteriskComponent ( CamelContext camelContext, AsteriskComponentConfiguration configuration)
specifier|public
name|AsteriskComponent
name|configureAsteriskComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.asterisk"
argument_list|)
decl_stmt|;
if|if
condition|(
