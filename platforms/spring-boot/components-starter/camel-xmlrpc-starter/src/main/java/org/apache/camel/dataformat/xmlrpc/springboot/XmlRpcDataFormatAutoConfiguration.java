...
name|Conditional
argument_list|(
name|XmlRpcDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|XmlRpcDataFormatAutoConfiguration
specifier|public
class|class
name|XmlRpcDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"xmlrpc-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureXmlRpcDataFormatFactory ( final CamelContext camelContext, final XmlRpcDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureXmlRpcDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
