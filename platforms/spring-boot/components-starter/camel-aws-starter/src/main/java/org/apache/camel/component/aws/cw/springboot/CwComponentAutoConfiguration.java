...
name|Conditional
argument_list|(
name|CwComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|CwComponentAutoConfiguration
specifier|public
class|class
name|CwComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureCwComponent (CamelContext camelContext, CwComponentConfiguration configuration)
specifier|public
name|CwComponent
name|configureCwComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
