...
name|Conditional
argument_list|(
name|DdbStreamComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|DdbStreamComponentAutoConfiguration
specifier|public
class|class
name|DdbStreamComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"aws-ddbstream-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureDdbStreamComponent ( CamelContext camelContext, DdbStreamComponentConfiguration configuration)
specifier|public
name|DdbStreamComponent
name|configureDdbStreamComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
