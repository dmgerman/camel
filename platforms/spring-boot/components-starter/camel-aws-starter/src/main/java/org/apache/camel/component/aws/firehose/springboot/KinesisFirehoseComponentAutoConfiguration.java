...
name|class
block|,
name|KinesisFirehoseComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|KinesisFirehoseComponentAutoConfiguration
specifier|public
class|class
name|KinesisFirehoseComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"aws-kinesis-firehose-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKinesisFirehoseComponent ()
specifier|public
name|KinesisFirehoseComponent
name|configureKinesisFirehoseComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.aws-kinesis-firehose.customizer"
argument_list|,
operator|(
operator|(
name|HasId
