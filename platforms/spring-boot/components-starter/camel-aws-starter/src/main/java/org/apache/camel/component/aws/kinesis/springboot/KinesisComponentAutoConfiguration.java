...
name|Conditional
argument_list|(
name|KinesisComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|KinesisComponentAutoConfiguration
specifier|public
class|class
name|KinesisComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureKinesisComponent ( CamelContext camelContext, KinesisComponentConfiguration configuration)
specifier|public
name|KinesisComponent
name|configureKinesisComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
