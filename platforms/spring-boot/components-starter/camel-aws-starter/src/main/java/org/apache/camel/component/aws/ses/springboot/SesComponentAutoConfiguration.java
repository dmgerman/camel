...
name|Conditional
argument_list|(
name|SesComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|SesComponentAutoConfiguration
specifier|public
class|class
name|SesComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureSesComponent (CamelContext camelContext, SesComponentConfiguration configuration)
specifier|public
name|SesComponent
name|configureSesComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
