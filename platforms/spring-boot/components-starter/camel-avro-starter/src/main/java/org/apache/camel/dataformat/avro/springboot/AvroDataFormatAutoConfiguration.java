...
name|name
operator|=
literal|"avro-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureAvroDataFormatFactory ( final CamelContext camelContext, final AvroDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureAvroDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
