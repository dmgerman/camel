...
begin_comment
comment|/**  * The Avro data format is used for serialization and deserialization of  * messages using Apache Avro binary dataformat.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
name|DataFormatConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the avro data format. This is      * enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
