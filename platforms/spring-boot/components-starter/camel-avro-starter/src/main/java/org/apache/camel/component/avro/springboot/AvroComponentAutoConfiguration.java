...
name|Conditional
argument_list|(
name|AvroComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
block|}
argument_list|)
DECL|class|AvroComponentAutoConfiguration
specifier|public
class|class
name|AvroComponentAutoConfiguration
extends|extends
...
decl_stmt|;
DECL|method|AvroComponentAutoConfiguration ()
specifier|public
name|AvroComponentAutoConfiguration
parameter_list|()
block|{
...
name|class
argument_list|)
DECL|method|configureAvroComponent ()
specifier|public
name|AvroComponent
