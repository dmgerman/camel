...
name|prefix
operator|=
literal|"camel.component.spring-ldap"
argument_list|)
DECL|class|SpringLdapComponentConfiguration
specifier|public
class|class
name|SpringLdapComponentConfiguration
extends|extends
name|ComponentConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the spring-ldap component. This      * is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
