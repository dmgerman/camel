...
begin_package
DECL|package|org.apache.camel.component.ldap.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|LdapComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|LdapComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|LdapComponentAutoConfiguration
specifier|public
class|class
name|LdapComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureLdapComponent (CamelContext camelContext, LdapComponentConfiguration configuration)
specifier|public
name|LdapComponent
name|configureLdapComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
