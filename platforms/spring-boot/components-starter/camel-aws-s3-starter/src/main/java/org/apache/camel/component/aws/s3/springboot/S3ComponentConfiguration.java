...
begin_comment
comment|/**  * The aws-s3 component is used for storing and retrieving object from Amazon S3  * Storage Service.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
name|fileName
decl_stmt|;
comment|/**          * The region in which S3 client needs to work. When using this          * parameter, the configuration will expect the capitalized name of the          * region (for example AP_EAST_1) You'll need to use the name          * Regions.EU_WEST_1.name()          */
DECL|field|region
specifier|private
name|String
name|region
