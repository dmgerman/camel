...
begin_comment
comment|/**  * The uniVocity Fixed Length data format is used for working with fixed length  * flat payloads.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
name|prefix
operator|=
literal|"camel.dataformat.univocity-fixed"
argument_list|)
DECL|class|UniVocityFixedWidthDataFormatConfiguration
specifier|public
class|class
name|UniVocityFixedWidthDataFormatConfiguration
extends|extends
name|DataFormatConfigurationPropertiesCommon
block|{
comment|/**      * Whether to enable auto configuration of the univocity-fixed data format.      * This is enabled by default.      */
DECL|field|enabled
specifier|private
name|Boolean
name|enabled
decl_stmt|;
comment|/**      * Whether or not the trailing characters until new line must be ignored.      * The default value is false      */
...
literal|false
decl_stmt|;
comment|/**      * Whether or not the record ends on new line. The default value is false      */
...
literal|false
decl_stmt|;
comment|/**      * The padding character. The default value is a space      */
DECL|field|padding
specifier|private
name|String
name|padding
