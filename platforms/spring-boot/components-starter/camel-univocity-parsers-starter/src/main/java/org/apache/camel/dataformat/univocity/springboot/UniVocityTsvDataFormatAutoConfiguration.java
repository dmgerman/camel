...
name|class
argument_list|)
DECL|method|configureUniVocityTsvDataFormat ( CamelContext camelContext, UniVocityTsvDataFormatConfiguration configuration)
specifier|public
name|UniVocityTsvDataFormat
name|configureUniVocityTsvDataFormat
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
