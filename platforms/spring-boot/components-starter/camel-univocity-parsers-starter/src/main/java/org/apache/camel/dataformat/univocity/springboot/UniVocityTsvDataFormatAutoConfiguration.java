...
name|Conditional
argument_list|(
name|UniVocityTsvDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|UniVocityTsvDataFormatAutoConfiguration
specifier|public
class|class
name|UniVocityTsvDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"univocity-tsv-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureUniVocityTsvDataFormatFactory ( final CamelContext camelContext, final UniVocityTsvDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureUniVocityTsvDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
