...
name|Conditional
argument_list|(
name|UniVocityCsvDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|UniVocityCsvDataFormatAutoConfiguration
specifier|public
class|class
name|UniVocityCsvDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"univocity-csv-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureUniVocityCsvDataFormatFactory ( final CamelContext camelContext, final UniVocityCsvDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureUniVocityCsvDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
