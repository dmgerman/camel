...
name|Conditional
argument_list|(
name|UniVocityFixedWidthDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|UniVocityFixedWidthDataFormatAutoConfiguration
specifier|public
class|class
name|UniVocityFixedWidthDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"univocity-fixed-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureUniVocityFixedWidthDataFormatFactory ( final CamelContext camelContext, final UniVocityFixedWidthDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureUniVocityFixedWidthDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
