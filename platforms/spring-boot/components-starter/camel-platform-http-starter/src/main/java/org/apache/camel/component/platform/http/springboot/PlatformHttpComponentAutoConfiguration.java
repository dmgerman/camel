...
name|class
block|,
name|PlatformHttpComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|PlatformHttpComponentAutoConfiguration
specifier|public
class|class
name|PlatformHttpComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"platform-http-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configurePlatformHttpComponent ()
specifier|public
name|PlatformHttpComponent
name|configurePlatformHttpComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.platform-http.customizer"
argument_list|,
operator|(
operator|(
name|HasId
