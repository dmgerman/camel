...
name|name
operator|=
literal|"xstream-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureXStreamDataFormatFactory ( final CamelContext camelContext, final XStreamDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureXStreamDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
