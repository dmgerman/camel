...
name|name
operator|=
literal|"json-xstream-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureJsonDataFormatFactory ( final CamelContext camelContext, final JsonDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureJsonDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
