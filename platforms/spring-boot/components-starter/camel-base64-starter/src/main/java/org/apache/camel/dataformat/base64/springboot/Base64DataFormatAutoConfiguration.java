...
name|name
operator|=
literal|"base64-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureBase64DataFormatFactory ( final CamelContext camelContext, final Base64DataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureBase64DataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
