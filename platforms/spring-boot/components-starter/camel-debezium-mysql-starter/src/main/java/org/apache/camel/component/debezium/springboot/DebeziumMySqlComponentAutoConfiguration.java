...
name|class
block|,
name|DebeziumMySqlComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|DebeziumMySqlComponentAutoConfiguration
specifier|public
class|class
name|DebeziumMySqlComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"debezium-mysql-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureDebeziumMySqlComponent ()
specifier|public
name|DebeziumMySqlComponent
name|configureDebeziumMySqlComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.debezium-mysql.customizer"
argument_list|,
operator|(
operator|(
name|HasId
