...
begin_package
DECL|package|org.apache.camel.component.couchdb.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|CouchDbComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|CouchDbComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|CouchDbComponentAutoConfiguration
specifier|public
class|class
name|CouchDbComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureCouchDbComponent ( CamelContext camelContext, CouchDbComponentConfiguration configuration)
specifier|public
name|CouchDbComponent
name|configureCouchDbComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.couchdb"
argument_list|)
decl_stmt|;
if|if
condition|(
