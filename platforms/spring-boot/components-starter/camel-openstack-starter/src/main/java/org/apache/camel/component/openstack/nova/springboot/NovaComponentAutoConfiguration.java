...
begin_package
DECL|package|org.apache.camel.component.openstack.nova.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|NovaComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|NovaComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|NovaComponentAutoConfiguration
specifier|public
class|class
name|NovaComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"openstack-nova-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureNovaComponent (CamelContext camelContext, NovaComponentConfiguration configuration)
specifier|public
name|NovaComponent
name|configureNovaComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
...
name|forCondition
argument_list|(
literal|"camel.component.openstack-nova"
argument_list|)
decl_stmt|;
if|if
condition|(
