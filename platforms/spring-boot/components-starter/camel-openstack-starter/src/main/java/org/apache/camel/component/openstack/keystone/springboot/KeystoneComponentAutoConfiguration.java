...
name|Conditional
argument_list|(
name|KeystoneComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|KeystoneComponentAutoConfiguration
specifier|public
class|class
name|KeystoneComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"openstack-keystone-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureKeystoneComponent ( CamelContext camelContext, KeystoneComponentConfiguration configuration)
specifier|public
name|KeystoneComponent
name|configureKeystoneComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
