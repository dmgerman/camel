...
name|Conditional
argument_list|(
name|CinderComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|CinderComponentAutoConfiguration
specifier|public
class|class
name|CinderComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"openstack-cinder-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureCinderComponent (CamelContext camelContext, CinderComponentConfiguration configuration)
specifier|public
name|CinderComponent
name|configureCinderComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
