...
name|class
block|,
name|CaffeineLoadCacheComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|CaffeineLoadCacheComponentAutoConfiguration
specifier|public
class|class
name|CaffeineLoadCacheComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"caffeine-loadcache-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureCaffeineLoadCacheComponent ()
specifier|public
name|CaffeineLoadCacheComponent
name|configureCaffeineLoadCacheComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.caffeine-loadcache.customizer"
argument_list|,
operator|(
operator|(
name|HasId
