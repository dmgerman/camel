...
name|class
block|,
name|CaffeineCacheComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|CaffeineCacheComponentAutoConfiguration
specifier|public
class|class
name|CaffeineCacheComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"caffeine-cache-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureCaffeineCacheComponent ()
specifier|public
name|CaffeineCacheComponent
name|configureCaffeineCacheComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.caffeine-cache.customizer"
argument_list|,
operator|(
operator|(
name|HasId
