...
name|Conditional
argument_list|(
name|ChronicleEngineComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|ChronicleEngineComponentAutoConfiguration
specifier|public
class|class
name|ChronicleEngineComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"chronicle-engine-component"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureChronicleEngineComponent ( CamelContext camelContext, ChronicleEngineComponentConfiguration configuration)
specifier|public
name|ChronicleEngineComponent
name|configureChronicleEngineComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
