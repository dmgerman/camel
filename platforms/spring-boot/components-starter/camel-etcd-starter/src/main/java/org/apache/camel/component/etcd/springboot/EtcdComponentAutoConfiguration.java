...
name|Conditional
argument_list|(
name|EtcdComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|EtcdComponentAutoConfiguration
specifier|public
class|class
name|EtcdComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureEtcdComponent (CamelContext camelContext, EtcdComponentConfiguration configuration)
specifier|public
name|EtcdComponent
name|configureEtcdComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
