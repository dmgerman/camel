...
name|name
operator|=
literal|"jaxb-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureJaxbDataFormatFactory ( final CamelContext camelContext, final JaxbDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureJaxbDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
