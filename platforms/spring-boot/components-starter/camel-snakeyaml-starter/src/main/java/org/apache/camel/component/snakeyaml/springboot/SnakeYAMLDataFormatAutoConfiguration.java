...
name|Conditional
argument_list|(
name|SnakeYAMLDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|SnakeYAMLDataFormatAutoConfiguration
specifier|public
class|class
name|SnakeYAMLDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"yaml-snakeyaml-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureSnakeYAMLDataFormatFactory ( final CamelContext camelContext, final SnakeYAMLDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureSnakeYAMLDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
