...
name|class
block|,
name|ThriftDataFormatAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|ThriftDataFormatAutoConfiguration
specifier|public
class|class
name|ThriftDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"thrift-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureThriftDataFormatFactory ()
specifier|public
name|DataFormatFactory
name|configureThriftDataFormatFactory
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.dataformat.thrift.customizer"
argument_list|,
operator|(
operator|(
name|HasId
