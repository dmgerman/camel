...
name|Conditional
argument_list|(
name|Olingo4ComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|Olingo4ComponentAutoConfiguration
specifier|public
class|class
name|Olingo4ComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureOlingo4Component ( CamelContext camelContext, Olingo4ComponentConfiguration configuration)
specifier|public
name|Olingo4Component
name|configureOlingo4Component
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
