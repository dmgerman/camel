...
begin_package
DECL|package|org.apache.camel.component.johnzon.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|JohnzonDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|JohnzonDataFormatConfiguration
operator|.
name|class
argument_list|)
DECL|class|JohnzonDataFormatAutoConfiguration
specifier|public
class|class
name|JohnzonDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"json-johnzon-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureJohnzonDataFormatFactory ( final CamelContext camelContext, final JohnzonDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureJohnzonDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
