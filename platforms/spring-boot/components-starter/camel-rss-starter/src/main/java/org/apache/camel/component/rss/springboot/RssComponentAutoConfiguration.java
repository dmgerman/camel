...
begin_package
DECL|package|org.apache.camel.component.rss.springboot
package|package
name|org
operator|.
name|apache
...
name|Conditional
argument_list|(
name|RssComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|EnableConfigurationProperties
argument_list|(
name|RssComponentConfiguration
operator|.
name|class
argument_list|)
DECL|class|RssComponentAutoConfiguration
specifier|public
class|class
name|RssComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureRssComponent (CamelContext camelContext, RssComponentConfiguration configuration)
specifier|public
name|RssComponent
name|configureRssComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
