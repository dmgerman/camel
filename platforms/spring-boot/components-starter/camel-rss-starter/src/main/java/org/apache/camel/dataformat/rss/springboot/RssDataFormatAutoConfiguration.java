...
name|Conditional
argument_list|(
name|RssDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|RssDataFormatAutoConfiguration
specifier|public
class|class
name|RssDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"rss-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureRssDataFormatFactory ( final CamelContext camelContext, final RssDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureRssDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
