...
name|Conditional
argument_list|(
name|ZendeskComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|ZendeskComponentAutoConfiguration
specifier|public
class|class
name|ZendeskComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureZendeskComponent ( CamelContext camelContext, ZendeskComponentConfiguration configuration)
specifier|public
name|ZendeskComponent
name|configureZendeskComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
