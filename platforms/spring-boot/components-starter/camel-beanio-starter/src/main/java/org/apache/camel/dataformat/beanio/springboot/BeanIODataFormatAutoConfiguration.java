...
name|Conditional
argument_list|(
name|BeanIODataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|BeanIODataFormatAutoConfiguration
specifier|public
class|class
name|BeanIODataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"beanio-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureBeanIODataFormatFactory ( final CamelContext camelContext, final BeanIODataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureBeanIODataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
