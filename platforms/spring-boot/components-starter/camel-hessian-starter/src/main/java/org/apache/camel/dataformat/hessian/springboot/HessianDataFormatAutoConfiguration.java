...
name|name
operator|=
literal|"hessian-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureHessianDataFormatFactory ( final CamelContext camelContext, final HessianDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureHessianDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
