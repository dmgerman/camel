...
name|class
block|,
name|GoogleMailStreamComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|GoogleMailStreamComponentAutoConfiguration
specifier|public
class|class
name|GoogleMailStreamComponentAutoConfiguration
block|{
...
name|name
operator|=
literal|"google-mail-stream-component"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureGoogleMailStreamComponent ()
specifier|public
name|GoogleMailStreamComponent
name|configureGoogleMailStreamComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.google-mail-stream.customizer"
argument_list|,
operator|(
operator|(
name|HasId
