...
name|class
block|,
name|TwilioComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|TwilioComponentAutoConfiguration
specifier|public
class|class
name|TwilioComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureTwilioComponent ()
specifier|public
name|TwilioComponent
name|configureTwilioComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.twilio.customizer"
argument_list|,
operator|(
operator|(
name|HasId
