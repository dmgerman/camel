...
name|class
block|,
name|YqlComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|YqlComponentAutoConfiguration
specifier|public
class|class
name|YqlComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureYqlComponent ()
specifier|public
name|YqlComponent
name|configureYqlComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.yql.customizer"
argument_list|,
operator|(
operator|(
name|HasId
