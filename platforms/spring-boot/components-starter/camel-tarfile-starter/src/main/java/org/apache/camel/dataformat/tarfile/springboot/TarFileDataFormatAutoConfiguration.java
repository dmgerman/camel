...
name|Conditional
argument_list|(
name|TarFileDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|TarFileDataFormatAutoConfiguration
specifier|public
class|class
name|TarFileDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"tarfile-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureTarFileDataFormatFactory ( final CamelContext camelContext, final TarFileDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureTarFileDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
