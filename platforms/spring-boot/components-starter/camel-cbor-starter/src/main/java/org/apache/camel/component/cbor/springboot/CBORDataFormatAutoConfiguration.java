...
name|class
block|,
name|CBORDataFormatAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|CBORDataFormatAutoConfiguration
specifier|public
class|class
name|CBORDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"cbor-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnMissingBean
argument_list|(
...
name|class
argument_list|)
DECL|method|configureCBORDataFormatFactory ()
specifier|public
name|DataFormatFactory
name|configureCBORDataFormatFactory
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.dataformat.cbor.customizer"
argument_list|,
operator|(
operator|(
name|HasId
