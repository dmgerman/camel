...
name|Conditional
argument_list|(
name|CsvDataFormatAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|CsvDataFormatAutoConfiguration
specifier|public
class|class
name|CsvDataFormatAutoConfiguration
block|{
...
name|name
operator|=
literal|"csv-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureCsvDataFormatFactory ( final CamelContext camelContext, final CsvDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureCsvDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
