...
name|name
operator|=
literal|"lzf-dataformat-factory"
argument_list|)
annotation|@
name|ConditionalOnClass
argument_list|(
...
name|class
argument_list|)
DECL|method|configureLZFDataFormatFactory ( final CamelContext camelContext, final LZFDataFormatConfiguration configuration)
specifier|public
name|DataFormatFactory
name|configureLZFDataFormatFactory
parameter_list|(
specifier|final
name|CamelContext
name|camelContext
