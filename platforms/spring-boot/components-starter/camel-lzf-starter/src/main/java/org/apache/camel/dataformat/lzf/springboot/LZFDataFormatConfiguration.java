...
begin_comment
comment|/**  * The LZF data format is a message compression and de-compression format (uses  * the LZF deflate algorithm).  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|class|LZFDataFormatConfiguration
specifier|public
class|class
