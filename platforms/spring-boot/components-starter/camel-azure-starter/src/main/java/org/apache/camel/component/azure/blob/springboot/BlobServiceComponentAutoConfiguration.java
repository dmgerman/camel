...
name|Conditional
argument_list|(
name|BlobServiceComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|BlobServiceComponentAutoConfiguration
specifier|public
class|class
name|BlobServiceComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureBlobServiceComponent ( CamelContext camelContext, BlobServiceComponentConfiguration configuration)
specifier|public
name|BlobServiceComponent
name|configureBlobServiceComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
