...
name|Conditional
argument_list|(
name|JavaSpaceComponentAutoConfiguration
operator|.
name|Condition
operator|.
name|class
...
name|class
argument_list|)
DECL|class|JavaSpaceComponentAutoConfiguration
specifier|public
class|class
name|JavaSpaceComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureJavaSpaceComponent ( CamelContext camelContext, JavaSpaceComponentConfiguration configuration)
specifier|public
name|JavaSpaceComponent
name|configureJavaSpaceComponent
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
