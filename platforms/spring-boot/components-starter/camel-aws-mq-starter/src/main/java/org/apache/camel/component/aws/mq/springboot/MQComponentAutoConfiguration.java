...
name|class
block|,
name|MQComponentAutoConfiguration
operator|.
...
block|}
argument_list|)
DECL|class|MQComponentAutoConfiguration
specifier|public
class|class
name|MQComponentAutoConfiguration
block|{
...
name|class
argument_list|)
DECL|method|configureMQComponent ()
specifier|public
name|MQComponent
name|configureMQComponent
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"camel.component.aws-mq.customizer"
argument_list|,
operator|(
operator|(
name|HasId
