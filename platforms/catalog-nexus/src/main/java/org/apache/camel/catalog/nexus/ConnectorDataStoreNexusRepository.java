...
block|}
block|}
comment|/**      * Adds the connector to the data store      *      * @param dto                 the artifact      * @param name                name of connector      * @param connectorJson       camel-connector JSon      * @param connectorSchemaJson camel-connector-schema JSon      */
...
return|;
block|}
comment|/**      * Extracts the name of the connector from the json blob      */
DECL|method|extractConnectorName (String json)
specifier|private
specifier|static
name|String
name|extractConnectorName
