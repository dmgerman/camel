...
return|;
block|}
comment|/**      * Creates a consumer using the given processor and transport      *      * @param processor the processor to use to process the messages      * @param transport the JavaMail transport to use for inbound messages      * @return a newly created consumer      * @throws Exception if the consumer cannot be created      */
DECL|method|createConsumer (Processor<MailExchange> processor, Transport transport)
specifier|public
name|Consumer
argument_list|<
name|MailExchange
