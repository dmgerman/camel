...
annotation|@
name|Test
DECL|method|testAsEndpointUriNettyHttpHostnameWithDash ()
specifier|public
name|void
name|testAsEndpointUriNettyHttpHostnameWithDash
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testValidateEndpointHttpPropertyPlaceholder ()
specifier|public
name|void
name|testValidateEndpointHttpPropertyPlaceholder
parameter_list|()
throws|throws
name|Exception
block|{
...
name|uri
init|=
literal|"http://api.openweathermap.org/data/2.5/weather?{{property.weatherUri}}"
decl_stmt|;
name|EndpointValidationResult
name|result
init|=
...
argument_list|)
expr_stmt|;
comment|// use incorrect style using ${ } as placeholder
name|uri
operator|=
literal|"http://api.openweathermap.org/data/2.5/weather?${property.weatherUri}"
expr_stmt|;
