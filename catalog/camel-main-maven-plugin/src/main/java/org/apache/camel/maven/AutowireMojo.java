...
comment|// TODO: Allow to configure include/exclude names on components,names
comment|// TODO: Skip some known types
...
argument_list|(
literal|"/known-types.properties"
argument_list|)
decl_stmt|;
if|if
condition|(
...
name|MojoFailureException
argument_list|(
literal|"Cannot load known-types.properties from classpath"
argument_list|)
throw|;
block|}
return|return
...
return|;
block|}
DECL|method|findAutowireComponentOptionsByClasspath (CamelCatalog catalog, Set<String> components, Reflections reflections, Properties knownTypes)
specifier|protected
name|List
argument_list|<
name|String
