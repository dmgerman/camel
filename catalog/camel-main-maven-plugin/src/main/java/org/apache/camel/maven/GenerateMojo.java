...
condition|)
block|{
comment|// is this a new component
name|File
name|file
init|=
operator|new
...
name|outSpringBootFolder
operator|+
literal|"/spring-configuration-metadata.json file"
argument_list|)
throw|;
block|}
block|}
...
specifier|final
name|String
name|springBootExistingText
init|=
name|existingText
decl_stmt|;
specifier|final
name|AtomicBoolean
name|springBootChanged
init|=
operator|new
name|AtomicBoolean
argument_list|(
...
block|}
block|}
DECL|method|writeSpringBootFile (List<SpringBootPropertyData> propertyData, List<SpringBootGroupData> groupData)
specifier|protected
name|void
name|writeSpringBootFile
parameter_list|(
...
name|MojoFailureException
argument_list|(
literal|"Cannot serialize or deserialize json due "
operator|+
name|e
operator|.
name|getMessage
...
specifier|final
name|String
name|autowireExisting
init|=
name|existingText
decl_stmt|;
comment|// only write the file if its changed
name|boolean
name|matches
init|=
name|autowireExisting
...
block|}
block|}
DECL|method|extractJavaDocFromMethod (Object input, Method method)
specifier|private
name|String
name|extractJavaDocFromMethod
parameter_list|(
...
literal|""
decl_stmt|;
comment|// input can be both a class or interface so we need to split this up into several pieces
name|MethodHolderSource
name|mhs
init|=
operator|(
...
condition|)
block|{
comment|// special for activemq-artemis
if|if
condition|(
literal|"org.apache.activemq.artemis.jms.client.ActiveMQConnectionFactory"
operator|.
name|equals
argument_list|(
name|jt
...
name|st
operator|=
literal|"org.apache.activemq.artemis.api.core.client.ServerLocator"
expr_stmt|;
block|}
else|else
block|{
