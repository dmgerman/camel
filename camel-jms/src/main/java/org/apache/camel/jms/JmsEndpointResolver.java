...
begin_comment
comment|/**  * An implementation of {@link EndpointResolver} that creates  * {@link QueueEndpoint} objects.  *  * The synatx for a Queue URI looks like:  *  *<pre><code>queue:[component:]queuename</code></pre>  * the component is optional, and if it is not specified, the default component name  * is assumed.  *  * @version $Revision$  */
end_comment
...
return|;
block|}
DECL|method|resolveJmsComponent (final CamelContainer container, String[] splitURI)
specifier|private
name|JmsComponent
name|resolveJmsComponent
parameter_list|(
