...
name|processor
decl_stmt|;
DECL|field|startedConsuming
specifier|private
name|AtomicBoolean
name|startedConsuming
init|=
operator|new
name|AtomicBoolean
argument_list|(
...
argument_list|)
decl_stmt|;
DECL|method|JmsEndpoint (String endpointUri, CamelContainer container, Destination destination, JmsOperations template, AbstractMessageListenerContainer listenerContainer)
specifier|public
name|JmsEndpoint
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|setProcessor (Processor<Exchange> processor)
specifier|public
name|void
name|setProcessor
parameter_list|(
