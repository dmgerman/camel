...
comment|// Do a rollback, should cause the transacted consumer to re-deliver but not the un-trasacted one.
name|JmsEndpoint
name|endpoint1
init|=
operator|(
...
expr_stmt|;
block|}
DECL|method|disabletestSenarioF ()
specifier|public
name|void
name|disabletestSenarioF
parameter_list|()
throws|throws
name|Exception
block|{
