...
argument_list|()
decl_stmt|;
comment|// must be the target route
if|if
condition|(
name|routeId
operator|.
...
condition|)
block|{
comment|// parse each route and build a Map<String, Integer> with the no of messages processed
comment|// where String is the EIP name
name|AtomicInteger
name|counter
init|=
operator|new
