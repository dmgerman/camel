...
begin_class
DECL|class|RoasterJavaRestDslTest
specifier|public
class|class
name|RoasterJavaRestDslTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
annotation|@
name|Test
DECL|method|parseRestConfiguration ()
specifier|public
name|void
...
name|File
argument_list|(
literal|"src/test/java/org/apache/camel/parser/java/MyRestDslRouteBuilder.java"
argument_list|)
argument_list|)
decl_stmt|;
name|List
...
name|assertEquals
argument_list|(
literal|"org.apache.camel.parser.java.MyRestDslRouteBuilder"
argument_list|,
name|details
operator|.
name|getClassName
