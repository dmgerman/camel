...
decl_stmt|;
DECL|method|RestDslSourceCodeGenerator (final OasDocument openapi)
name|RestDslSourceCodeGenerator
parameter_list|(
specifier|final
name|OasDocument
...
return|;
block|}
DECL|method|generateConfigureMethod (final OasDocument openapi)
name|MethodSpec
...
name|addJavadoc
argument_list|(
literal|"Generated from OpenApi specification by Camel REST DSL generator.\n"
argument_list|)
decl_stmt|;
if|if
condition|(
...
return|;
block|}
DECL|method|generateClassName (final OasDocument openapi)
specifier|static
name|String
name|generateClassName
parameter_list|(
...
return|;
block|}
DECL|method|generatePackageName (final OasDocument openapi)
specifier|static
name|String
name|generatePackageName
parameter_list|(
