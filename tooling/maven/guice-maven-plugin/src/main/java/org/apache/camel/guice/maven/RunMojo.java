...
begin_comment
comment|/**  * Runs a Camel using the  *<code>jndi.properties</code> file on the classpath as the  * way to<a href="http://activemq.apache.org/camel/guice.html">bootstrap Camel using Guice</a>  *  * @goal run  * @requiresDependencyResolution runtime  * @execute phase="test-compile"  */
end_comment
...
block|}
block|}
comment|/**      * Set up a classloader for the execution of the main class.      *      * @return the classloader      * @throws org.apache.maven.plugin.MojoExecutionException      */
...
return|;
block|}
comment|/**      * Determine all plugin dependencies relevant to the executable. Takes      * includePlugins, and the executableDependency into consideration.      *      * @return a set of Artifact objects. (Empty set is returned if there are no      *         relevant plugin dependencies.)      * @throws org.apache.maven.plugin.MojoExecutionException      */
...
return|;
block|}
comment|/**      * Examine the plugin dependencies to find the executable artifact.      *      * @return an artifact which refers to the actual executable tool (not a POM)      * @throws org.apache.maven.plugin.MojoExecutionException      */
