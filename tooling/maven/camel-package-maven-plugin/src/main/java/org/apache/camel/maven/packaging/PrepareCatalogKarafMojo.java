...
begin_comment
comment|/**  * Prepares the Karaf provider camel catalog to include component it supports  */
end_comment
...
name|defaultValue
operator|=
literal|"${project.build.directory}/classes/org/apache/camel/catalog/karaf/components"
argument_list|)
...
name|defaultValue
operator|=
literal|"${project.build.directory}/classes/org/apache/camel/catalog/karaf/dataformats"
argument_list|)
...
name|defaultValue
operator|=
literal|"${project.build.directory}/classes/org/apache/camel/catalog/karaf/languages"
argument_list|)
...
name|defaultValue
operator|=
literal|"${project.build.directory}/classes/org/apache/camel/catalog/karaf/others"
argument_list|)
...
name|othersOutDir
decl_stmt|;
comment|/**      * The karaf features directory      */
annotation|@
name|Parameter
argument_list|(
name|defaultValue
operator|=
literal|"${project.build.directory}/../../../platforms/karaf/features/src/main/resources/"
argument_list|)
...
continue|continue;
block|}
comment|// special for some components which is in a sub dir
if|if
condition|(
literal|"camel-as2"
operator|.
...
control|)
block|{
comment|// the directory must be in the list of known features (or known languages)
if|if
condition|(
operator|!
name|features
...
block|}
block|}
DECL|method|executeOthers (Set<String> features)
specifier|protected
name|void
name|executeOthers
parameter_list|(
