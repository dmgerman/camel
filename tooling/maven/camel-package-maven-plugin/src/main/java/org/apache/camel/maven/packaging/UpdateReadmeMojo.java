...
name|docDir
decl_stmt|;
comment|/**      * The documentation directory      *      * @parameter default-value="${basedir}/src/main/docs/eips"      */
...
argument_list|()
decl_stmt|;
comment|// TODO: how to find model json files
specifier|final
name|Set
argument_list|<
name|File
...
block|}
block|}
DECL|method|asEipName (String name)
specifier|private
specifier|static
name|String
name|asEipName
...
block|}
block|}
DECL|method|asEipTitle (String name, String title)
specifier|private
specifier|static
name|String
name|asEipTitle
...
block|}
block|}
DECL|method|updateEipOptions (File file, String changed)
specifier|private
name|boolean
name|updateEipOptions
parameter_list|(
...
name|text
argument_list|,
literal|"// eip options: START"
argument_list|,
literal|"// eip options: END"
argument_list|)
decl_stmt|;
if|if
condition|(
...
return|;
block|}
DECL|method|loadEipJson (Set<File> jsonFiles, String eipName)
specifier|private
name|String
name|loadEipJson
parameter_list|(
...
block|}
block|}
DECL|method|templateEipOptions (EipModel model)
specifier|private
name|String
name|templateEipOptions
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// TODO: find by scanning model (prepare catalog does something)
return|return
name|eipNames
return|;
block|}
