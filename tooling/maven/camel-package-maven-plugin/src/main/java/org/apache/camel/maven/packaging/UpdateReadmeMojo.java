...
return|;
block|}
DECL|method|updateComponentHeader (final File file, final ComponentModel model)
specifier|private
name|boolean
name|updateComponentHeader
parameter_list|(
...
block|{
comment|// so we don't have the marker, so we add it somewhere after the camel version
specifier|final
name|String
name|sinceVersion
init|=
...
block|}
block|}
DECL|method|generateHeaderTextData (final ComponentModel model)
specifier|private
specifier|static
name|String
name|generateHeaderTextData
...
argument_list|)
decl_stmt|;
comment|// if we have only producer support
if|if
condition|(
operator|!
name|consumerOnly
...
return|;
block|}
DECL|method|shortenVersion (final String firstVersion)
specifier|private
specifier|static
name|String
name|shortenVersion
