...
begin_comment
comment|/**  * Updates the website docs with the component list to be up to date with all the artifacts that Apache Camel ships.  */
end_comment
...
expr_stmt|;
block|}
DECL|method|executeComponentsList ()
specifier|protected
name|void
name|executeComponentsList
parameter_list|()
...
block|}
block|}
DECL|method|executeDataFormatsList ()
specifier|protected
name|void
name|executeDataFormatsList
parameter_list|()
...
block|}
block|}
DECL|method|executeLanguagesList ()
specifier|protected
name|void
name|executeLanguagesList
parameter_list|()
