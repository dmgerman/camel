...
begin_comment
comment|/**  * Analyses the Camel plugins in a project and generates extra descriptor information for easier auto-discovery in Camel.  *  * @goal generate-dataformats-list  * @execute phase="generate-resources"  */
end_comment
...
name|debug
argument_list|(
literal|"Java types found "
operator|+
name|javaTypes
argument_list|)
expr_stmt|;
comment|// TODO: find model from camel-core and enrich to generate a .json
if|if
condition|(
name|count
operator|>
