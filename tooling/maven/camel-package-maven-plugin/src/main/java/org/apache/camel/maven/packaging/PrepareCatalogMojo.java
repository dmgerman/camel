...
name|componentsDir
decl_stmt|;
comment|/**      * The dataformats directory where all the Apache Camel components are      *      * @parameter default-value="${project.build.directory}/../../..//dataformats"      */
...
argument_list|()
decl_stmt|;
comment|// find all dataformats and camel-core
if|if
condition|(
name|dataFormatsDir
operator|!=
