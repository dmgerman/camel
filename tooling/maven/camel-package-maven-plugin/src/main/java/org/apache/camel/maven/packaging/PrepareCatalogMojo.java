...
expr_stmt|;
block|}
DECL|method|printComponentsReport (Set<File> json, Set<File> duplicate, Set<File> missing, Set<File> missingEndpointJavaDoc, Set<File> missingComponentJavaDoc, Set<File> missingUriPaths, Set<File>missingLabels, Map<String, Set<String>> usedLabels)
specifier|private
name|void
name|printComponentsReport
parameter_list|(
...
name|warn
argument_list|(
literal|"\tMissing component options javadoc detected: "
operator|+
name|missingComponentJavaDoc
operator|.
name|size
...
name|warn
argument_list|(
literal|"\tMissing endpoint options javadoc detected: "
operator|+
name|missingEndpointJavaDoc
operator|.
name|size
...
expr_stmt|;
block|}
DECL|method|printDataFormatsReport (Set<File> json, Set<File> duplicate, Set<File> missingLabels, Map<String, Set<String>> usedLabels)
specifier|private
name|void
name|printDataFormatsReport
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|printLanguagesReport (Set<File> json, Set<File> duplicate, Set<File> missingLabels, Map<String, Set<String>> usedLabels)
specifier|private
name|void
name|printLanguagesReport
parameter_list|(
