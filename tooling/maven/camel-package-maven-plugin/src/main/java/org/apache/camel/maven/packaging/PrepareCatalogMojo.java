...
name|schemasOutDir
decl_stmt|;
comment|/**      * The output directory for main      */
annotation|@
name|Parameter
argument_list|(
name|defaultValue
operator|=
literal|"${project.build.directory}/classes/org/apache/camel/catalog/main"
argument_list|)
DECL|field|mainOutDir
specifier|protected
name|File
name|mainOutDir
decl_stmt|;
...
decl_stmt|;
comment|/**      * The directory where the camel-main metadata are      */
annotation|@
name|Parameter
argument_list|(
name|defaultValue
operator|=
literal|"${project.build.directory}/../../../core/camel-main/target/classes/META-INF"
argument_list|)
DECL|field|mainDir
specifier|protected
name|File
...
name|info
argument_list|(
literal|"Copying camel-main metadata"
argument_list|)
expr_stmt|;
name|mainOutDir
operator|.
