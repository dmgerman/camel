...
expr_stmt|;
block|}
DECL|method|printComponentsReport (Set<File> json, Set<File> duplicate, Set<File> missing, Set<File> missingJavaDoc, Set<File> missingUriPaths, Set<File>missingLabels, Map<String, Set<String>> usedLabels)
specifier|private
name|void
name|printComponentsReport
parameter_list|(
...
name|warn
argument_list|(
literal|"\tMissing javadoc detected: "
operator|+
name|missingJavaDoc
operator|.
name|size
