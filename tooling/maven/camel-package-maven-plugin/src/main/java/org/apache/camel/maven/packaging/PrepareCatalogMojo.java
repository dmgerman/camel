...
name|dir
argument_list|,
literal|"target/classes/META-INF/services/org/apache/camel/dataformat"
argument_list|)
decl_stmt|;
name|findDataFormatJavaTypes
argument_list|(
name|javaTypesDir
argument_list|,
name|javaTypes
...
name|coreDir
argument_list|,
literal|"target/classes/org/apache/camel/model/dataformat"
argument_list|)
decl_stmt|;
name|findDataFormatJsonFiles
argument_list|(
name|target
argument_list|,
name|jsonFiles
...
argument_list|()
expr_stmt|;
comment|// TODO: much of this is no longer needed when we fix PackageDataFormatMojo to do the grunt work for us!
comment|// need to capture which maven projects we have data formats within, so we can enrich the .json files with that data
name|Map
argument_list|<
name|String
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// TODO: we should likely use the description from the json files as-is
name|String
name|doc
init|=
name|map
...
control|)
block|{
comment|// TODO: enrich json file with model data from above
name|File
name|to
init|=
operator|new
...
expr_stmt|;
block|}
DECL|method|printModelsReport (Set<File> json, Set<File> duplicate, Set<File> missingLabels, Map<String, Set<String>> usedLabels)
specifier|private
name|void
name|printModelsReport
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|printComponentsReport (Set<File> json, Set<File> duplicate, Set<File> missing, Set<File> missingUriPaths, Set<File> missingLabels, Map<String, Set<String>> usedLabels)
specifier|private
name|void
name|printComponentsReport
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|printDataFormatsReport (Set<File> json, Set<File> missingLabels, Map<String, Set<String>> usedLabels)
specifier|private
name|void
name|printDataFormatsReport
parameter_list|(
...
block|}
block|}
DECL|method|findDataFormatFilesRecursive (File dir, Set<File> dataFormats, FileFilter filter)
specifier|private
name|void
name|findDataFormatFilesRecursive
parameter_list|(
...
block|}
block|}
DECL|method|findDataFormatJavaTypes (File dir, Map<String, String> javaTypes)
specifier|private
name|void
name|findDataFormatJavaTypes
parameter_list|(
...
control|)
block|{
comment|// name of file is the key
name|String
name|name
init|=
name|file
...
block|}
block|}
DECL|method|findDataFormatJsonFiles (File dir, Set<File> jsonFiles)
specifier|private
name|void
name|findDataFormatJsonFiles
parameter_list|(
