...
block|}
block|}
DECL|method|createEndpointDsl (String packageName, ComponentModel model, List<ComponentModel> aliases, String overrideComponentName)
specifier|private
name|void
name|createEndpointDsl
parameter_list|(
...
name|builderName
operator|+
literal|"Impl(String scheme, String path) {\n"
operator|+
literal|"        super(scheme, path);\n"
operator|+
literal|"    }\n"
operator|+
literal|"}\n"
...
expr_stmt|;
block|}
DECL|method|synchronizeEndpointBuilderFactoryInterface ()
specifier|private
name|void
name|synchronizeEndpointBuilderFactoryInterface
parameter_list|()
...
name|MojoExecutionException
block|{
comment|// load components with indent
specifier|final
name|List
argument_list|<
name|String
...
init|=
name|loadAllComponentsDslEndpointFactoriesAsString
argument_list|()
operator|.
name|stream
argument_list|()
...
argument_list|)
decl_stmt|;
comment|// load EndpointBuilderFactory interface
specifier|final
name|String
name|interfaceFactoryPath
init|=
name|packageName
operator|.
name|replaceAll
...
argument_list|)
operator|+
literal|"EndpointBuilderFactory.java"
decl_stmt|;
specifier|final
name|File
name|interfaceFactoryPathFile
init|=
operator|new
name|File
argument_list|(
...
name|markerStart
init|=
literal|"// FACTORY INTERFACE UPDATE START"
decl_stmt|;
specifier|final
name|String
name|markerEnd
init|=
literal|"// FACTORY INTERFACE UPDATE END"
decl_stmt|;
try|try
init|(
specifier|final
...
argument_list|)
decl_stmt|;
comment|// we make sure these markers exists
if|if
condition|(
name|before
operator|==
...
throw|;
block|}
comment|// we build our new updated class
specifier|final
name|String
name|updatedInterfaceAsText
init|=
name|before
operator|+
name|markerStart
...
block|}
block|}
DECL|method|loadAllComponentsDslEndpointFactoriesAsString ()
specifier|private
name|List
argument_list|<
name|String
...
specifier|final
name|File
name|allComponentsDslEndpointFactory
init|=
operator|new
name|File
argument_list|(
...
return|;
block|}
DECL|method|camelCaseLower (String s)
specifier|private
specifier|static
name|String
name|camelCaseLower
...
return|;
block|}
DECL|method|getMainDescription (ComponentModel model)
specifier|private
name|String
name|getMainDescription
parameter_list|(
...
argument_list|()
expr_stmt|;
comment|// include javadoc for all path parameters and mark which are required
name|desc
operator|+=
literal|"\n"
expr_stmt|;
...
name|desc
operator|+=
literal|"<strong>deprecated</strong>"
expr_stmt|;
block|}
name|desc
operator|+=
