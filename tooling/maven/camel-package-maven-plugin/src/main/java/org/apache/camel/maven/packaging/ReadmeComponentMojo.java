...
begin_comment
comment|/**  * Generate or updates the component/dataformat/language readme.md and .adoc files in the project root directory.  *  * @goal update-readme  */
end_comment
...
block|}
block|}
DECL|method|updateTitle (File file, String title)
specifier|private
name|boolean
name|updateTitle
parameter_list|(
...
return|;
block|}
comment|// they may be in old title format which we want to avoid
comment|// [[Bean-BeanComponent]]
comment|// Bean Component
comment|// ~~~~~~~~~~~~~~
try|try
block|{
name|String
...
argument_list|)
decl_stmt|;
comment|// grab the first 3 lines which can have old legacy format
name|String
name|before
init|=
name|StringHelper
...
condition|)
block|{
comment|// insert title in top of file
name|String
name|newText
init|=
name|changed
...
literal|"\n"
decl_stmt|;
comment|// keep the before lines that was okay to keep
if|if
condition|(
name|before
operator|!=
...
expr_stmt|;
block|}
comment|// and remember the doc body
name|newText
operator|+=
name|text
expr_stmt|;
