...
begin_comment
comment|/**  * Generate or updates the component/dataformat/language/other readme.md and .adoc files in the project root directory.  *  * @goal update-readme  */
end_comment
...
argument_list|)
expr_stmt|;
comment|// only if there is other we should update the documentation files
if|if
condition|(
operator|!
name|otherNames
...
return|;
block|}
DECL|method|updateAvailableFrom (File file, String firstVersion)
specifier|private
name|boolean
name|updateAvailableFrom
parameter_list|(
...
return|;
block|}
DECL|method|loadOtherJson (Set<File> jsonFiles, String otherName)
specifier|private
name|String
name|loadOtherJson
parameter_list|(
...
return|;
block|}
DECL|method|generateOtherModel (String otherName, String json)
specifier|private
name|OtherModel
name|generateOtherModel
parameter_list|(
...
name|f
argument_list|,
literal|"META-INF/services/org/apache/camel/other.properties"
argument_list|)
expr_stmt|;
if|if
condition|(
