...
return|;
block|}
DECL|method|updateReadMeFile (File readmeFile, String componentName, String json)
specifier|private
name|void
name|updateReadMeFile
parameter_list|(
...
name|MojoExecutionException
block|{
comment|// TODO: use some template like velocity or freemarker
name|List
argument_list|<
name|Map
argument_list|<
