...
expr_stmt|;
block|}
DECL|method|prepareLanguage (Log log, MavenProject project, MavenProjectHelper projectHelper, File buildDir, File languageOutDir, File schemaOutDir, BuildContext buildContext)
specifier|public
specifier|static
name|int
name|prepareLanguage
...
condition|)
block|{
comment|// special for camel-xpath as we need to build this before camel-core so we load the schema from a static file
name|is
operator|=
operator|new
name|FileInputStream
...
name|buildDir
argument_list|,
literal|"../src/main/schema/xpath.json"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
condition|)
block|{
comment|// special for camel-bean as we need to build this before camel-core so we load the schema from a static file
name|is
operator|=
operator|new
name|FileInputStream
...
name|buildDir
argument_list|,
literal|"../src/main/schema/method.json"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
condition|)
block|{
comment|// special for camel-jaxp as we need to build this before camel-core so we load the schema from a static file
name|is
operator|=
operator|new
name|FileInputStream
...
name|buildDir
argument_list|,
literal|"../src/main/schema/xtokenize.json"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|core
argument_list|,
literal|"target/classes/org/apache/camel/model/language/"
operator|+
name|modelName
operator|+
literal|".json"
