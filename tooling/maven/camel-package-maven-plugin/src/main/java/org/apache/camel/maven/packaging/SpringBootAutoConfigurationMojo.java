...
DECL|field|EXCLUDE_CLASSES_PATTERN
specifier|private
specifier|static
specifier|final
name|Pattern
name|EXCLUDE_CLASSES_PATTERN
init|=
name|Pattern
operator|.
name|compile
...
name|sourcePropType
operator|.
name|getQualifiedNameWithGenerics
argument_list|()
argument_list|)
decl_stmt|;
specifier|final
...
expr_stmt|;
block|}
DECL|method|isEnum (ClassLoader projectClassLoader, String optionType)
specifier|private
name|boolean
name|isEnum
parameter_list|(
...
return|;
block|}
comment|// it's a nested property if the source exists in this project, e.g. endpoint configuration
DECL|method|isNestedProperty (String type, MavenProject project, Set<JavaClassSource> nestedTypes)
specifier|private
name|boolean
name|isNestedProperty
parameter_list|(
