...
expr_stmt|;
block|}
comment|// need to generate and load this class so the compiler can compile
if|if
condition|(
name|type
operator|.
...
parameter_list|)
block|{
comment|// we can configure map/list/set types from spring-boot so do not regard them as complex
if|if
condition|(
name|option
operator|.
