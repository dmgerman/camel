...
expr_stmt|;
block|}
DECL|method|makeFQ (JavaClassSource source, String literal)
specifier|private
name|String
name|makeFQ
parameter_list|(
...
condition|)
block|{
comment|// if it's not a java.lang object, then it's in the same package
if|if
condition|(
operator|!
name|JAVA_LANG_TYPES
...
return|;
block|}
DECL|method|extractClasses (String literal)
specifier|private
name|List
argument_list|<
name|String
...
name|compile
argument_list|(
literal|"[^A-Za-z0-9_.]*([A-Z][A-Za-z0-9]*)[.][A-Za-z0-9_.-]+"
argument_list|)
decl_stmt|;
name|Matcher
name|m
