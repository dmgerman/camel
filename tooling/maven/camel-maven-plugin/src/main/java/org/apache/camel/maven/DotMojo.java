...
name|buildDirectory
decl_stmt|;
comment|/**      * Base output directory for reports.      *      * @parameter expression="${project.reporting.outputDirectory}"      * @readonly      * @required      */
DECL|field|outputDirectory
specifier|private
name|File
name|outputDirectory
decl_stmt|;
comment|/**      * The input directory used to find the dot files      *      * @parameter default-value="${project.build.directory}/site/cameldoc"      * @required      */
...
block|}
block|}
DECL|method|writeIndexHtmlFile (String fileName, String content)
specifier|protected
name|void
name|writeIndexHtmlFile
parameter_list|(
...
block|}
block|}
DECL|method|printHtmlHeader (PrintWriter out)
specifier|protected
name|void
name|printHtmlHeader
parameter_list|(
