...
decl_stmt|;
comment|/**      * Whether to validate for direct/seda endpoints not having matching pairs, such as producing to      * a non existing seda endpoint.      *      * @parameter property="camel.directOrSedaPairCheck"      *            default-value="true"      */
...
argument_list|)
decl_stmt|;
comment|// find all pairs, eg consumers that has a producer (no need to check for producer that has a consumer)
for|for
control|(
name|CamelEndpointDetails
name|c
...
argument_list|)
decl_stmt|;
comment|// are there any consumers that do not have a producer pair
for|for
control|(
name|CamelEndpointDetails
name|c
