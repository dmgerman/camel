...
begin_comment
comment|/**  * Runs a CamelContext using any Spring XML configuration files found in  *<code>META-INF/spring/*.xml</code> and starting up the context; then generating  * the DOT file before closing the context down.  *  * @goal embedded  * @requiresDependencyResolution runtime  * @execute phase="test-compile"  */
end_comment
