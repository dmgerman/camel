...
begin_comment
comment|/**  * Runs a CamelContext using any Spring XML configuration files found in  *<code>META-INF/spring/*.xml</code> and<code>camel-*.xml</code>  * and starting up the context; then generating  * the DOT file before closing the context down.  */
end_comment
...
name|AbstractExecMojo
block|{
comment|/**      * The duration to run the application for which by default is in milliseconds.      * A value<= 0 will run forever.       * Adding a s indicates seconds - eg "5s" means 5 seconds.      */
annotation|@
name|Parameter
argument_list|(
name|property
...
name|duration
decl_stmt|;
comment|/**      * The classpath based application context uri that spring wants to get.      */
annotation|@
name|Parameter
argument_list|(
name|property
...
decl_stmt|;
comment|/**      * The filesystem based application context uri that spring wants to get.      */
annotation|@
name|Parameter
argument_list|(
name|property
...
decl_stmt|;
comment|/**      * Project classpath.      */
annotation|@
name|Parameter
argument_list|(
name|property
operator|=
literal|"project.testClasspathElements"
argument_list|,
name|required
operator|=
literal|true
