...
name|mainClass
decl_stmt|;
comment|/**      * The basedPackages that spring java config want to gets.      *      * @parameter expression="${camel.basedPackages}"      */
DECL|field|basedPackages
specifier|private
name|String
name|basedPackages
decl_stmt|;
comment|/**      * The configClasses that spring java config want to gets.      *      * @parameter expression="${camel.configClasses}"      */
