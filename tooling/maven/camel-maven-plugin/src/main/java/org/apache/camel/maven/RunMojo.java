...
control|)
block|{
comment|// we must skip org.apache.aries.blueprint.core:, otherwise we get duplicate blueprint extenders
if|if
condition|(
name|dep
operator|.
...
name|debug
argument_list|(
literal|"Skipping org.apache.aries.blueprint.core -> "
operator|+
name|dep
operator|.
name|getGroupId
...
name|debug
argument_list|(
literal|"Skipping provided scoped -> "
operator|+
name|dep
operator|.
name|getGroupId
