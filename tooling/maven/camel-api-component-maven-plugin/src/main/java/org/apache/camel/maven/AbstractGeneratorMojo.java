...
try|try
block|{
comment|// Expensive construction of ClassLoader
name|setProjectClassLoader
argument_list|(
name|buildProjectClassLoader
argument_list|()
argument_list|)
expr_stmt|;
...
literal|null
expr_stmt|;
comment|// Eagerly discard in the case of FAE semantics
block|}
block|}
comment|/**      * Template Method which assumes {@link #projectClassLoader} is set.      */
...
return|;
block|}
DECL|method|setProjectClassLoader (ClassLoader projectClassLoader)
specifier|protected
name|void
name|setProjectClassLoader
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|buildProjectClassLoader ()
specifier|private
name|ClassLoader
name|buildProjectClassLoader
parameter_list|()
