...
begin_class
DECL|class|RoasterConcatFieldRouteBuilderConfigureTest
specifier|public
class|class
name|RoasterConcatFieldRouteBuilderConfigureTest
block|{
DECL|field|LOG
specifier|private
specifier|static
...
name|File
argument_list|(
literal|"src/test/java/org/apache/camel/parser/MyConcatFieldRouteBuilder.java"
argument_list|)
argument_list|)
decl_stmt|;
name|MethodSource
...
name|assertEquals
argument_list|(
literal|"ftp:localhost:{{ftpPort}}/myapp?password=admin&username=admin"
argument_list|,
name|list
operator|.
name|get
