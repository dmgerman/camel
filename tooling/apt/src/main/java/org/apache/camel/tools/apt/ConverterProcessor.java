...
name|RELEASE_8
argument_list|)
DECL|class|ConverterProcessor
specifier|public
class|class
name|ConverterProcessor
extends|extends
name|AbstractProcessor
block|{
annotation|@
...
name|getTypeElement
argument_list|(
literal|"org.apache.camel.impl.converter.CoreFallbackConverter"
argument_list|)
operator|!=
literal|null
condition|)
...
name|append
argument_list|(
literal|" extends TypeConverterSupport {\n"
argument_list|)
expr_stmt|;
name|writer
operator|.
...
name|append
argument_list|(
literal|"            return (T) doConvert(type, exchange, value);\n"
argument_list|)
expr_stmt|;
name|writer
operator|.
...
name|append
argument_list|(
literal|"    private Object doConvert(Class<?> type, Exchange exchange, Object value) throws Exception {\n"
argument_list|)
expr_stmt|;
name|writer
operator|.
...
argument_list|,
literal|"Error processing @Converter"
argument_list|,
name|e
argument_list|)
expr_stmt|;
