...
name|oneOfTypes
decl_stmt|;
DECL|method|EipOption (String name, String kind, String type, boolean required, String defaultValue, String defaultValueNote, String documentation, boolean enumType, Set<String> enums, boolean oneOf, Set<String> oneOfTypes)
specifier|private
name|EipOption
parameter_list|(
name|String
