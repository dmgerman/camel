...
name|enums
decl_stmt|;
DECL|method|ComponentOption (String name, String type, String defaultValue, String defaultValueNote, String documentation, boolean deprecated, boolean enumType, Set<String> enums)
specifier|private
name|ComponentOption
parameter_list|(
name|String
