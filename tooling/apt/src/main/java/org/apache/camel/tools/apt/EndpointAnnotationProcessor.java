...
expr_stmt|;
block|}
comment|// TODO: include component meta-data such as scheme name, java class, mvn coordinate etc.
comment|// also component summary, eg grab<description> from mvn pom.xml
name|Set
argument_list|<
name|EndpointOption
argument_list|>
...
block|}
block|}
DECL|method|createParameterJsonSchema (Set<EndpointOption> options)
specifier|public
name|String
name|createParameterJsonSchema
parameter_list|(
