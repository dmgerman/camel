...
name|RELEASE_8
argument_list|)
DECL|class|CamelContextAnnotationProcessor
specifier|public
class|class
name|CamelContextAnnotationProcessor
extends|extends
...
argument_list|,
literal|"Error processing CamelContext model"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
parameter_list|)
block|{
comment|// must be from camel-spring or camel-core-xml
specifier|final
name|String
name|javaTypeName
init|=
...
expr_stmt|;
block|}
DECL|method|processElement (RoundEnvironment roundEnv, TypeElement classElement, XmlElement element, XmlElementRef elementRef, VariableElement fieldElement, Set<EipOption> eipOptions, String prefix)
specifier|private
name|void
name|processElement
parameter_list|(
