...
name|enums
decl_stmt|;
DECL|method|EndpointPath (String name, String type, String required, String defaultValue, String documentation, boolean deprecated, String group, String label, boolean enumType, Set<String> enums)
specifier|public
name|EndpointPath
parameter_list|(
name|String
