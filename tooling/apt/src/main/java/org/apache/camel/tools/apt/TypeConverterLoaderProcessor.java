...
if|if
condition|(
name|isFallbackConverterMethod
argument_list|(
name|ee
argument_list|)
condition|)
...
return|;
block|}
DECL|method|isConverterMethod (ExecutableElement element)
specifier|private
specifier|static
name|boolean
name|isConverterMethod
...
return|;
block|}
DECL|method|isFallbackConverterMethod (ExecutableElement element)
specifier|private
specifier|static
name|boolean
name|isFallbackConverterMethod
