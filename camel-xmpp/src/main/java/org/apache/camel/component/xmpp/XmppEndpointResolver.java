...
begin_comment
comment|/**  * An implementation of {@link EndpointResolver} that creates  * {@link XmppEndpoint} objects.  *<p/>  * The syntax for a XMPP URI looks like:  *<p/>  *<pre><code>xmpp:[component:]destination</code></pre>  * the component is optional, and if it is not specified, the default component name  * is assumed.  *  * @version $Revision:520964 $  */
end_comment

begin_class
DECL|class|XmppEndpointResolver
specifier|public
class|class
name|XmppEndpointResolver
