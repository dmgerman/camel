...
begin_class
DECL|class|ConfigAdminExtFileTest
specifier|public
class|class
name|ConfigAdminExtFileTest
extends|extends
...
block|{
return|return
literal|"org/apache/camel/test/blueprint/ConfigAdminExtFileTest.xml"
return|;
block|}
annotation|@
name|Test
...
name|assertFalse
argument_list|(
literal|"Message history should be disabled"
argument_list|,
name|context
operator|.
