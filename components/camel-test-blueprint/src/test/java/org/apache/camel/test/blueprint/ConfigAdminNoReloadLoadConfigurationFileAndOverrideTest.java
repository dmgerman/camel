...
begin_comment
comment|/**  * This example will load a Blueprint .cfg file, and also override its property placeholders from this unit test  * source code directly.  * But having<code>update-strategy="none"</code> means that BP container won't be reloaded  */
end_comment
...
literal|"Hello World"
argument_list|,
literal|"Hey Hello WorldHey Hello World"
argument_list|)
expr_stmt|;
name|getMockEndpoint
argument_list|(
