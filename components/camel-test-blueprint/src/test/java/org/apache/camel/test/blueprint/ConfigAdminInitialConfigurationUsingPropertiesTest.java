...
begin_class
DECL|class|ConfigAdminInitialConfigurationUsingPropertiesTest
specifier|public
class|class
name|ConfigAdminInitialConfigurationUsingPropertiesTest
extends|extends
...
block|{
return|return
literal|"org/apache/camel/test/blueprint/configadmin-endpoint-no-defaults.xml"
return|;
block|}
annotation|@
name|Override
