...
begin_comment
comment|/**  * The aws-eks is used for managing Amazon EKS  */
end_comment
...
name|configuration
decl_stmt|;
DECL|method|EKSEndpoint (String uri, Component component, EKSConfiguration configuration)
specifier|public
name|EKSEndpoint
parameter_list|(
name|String
