...
name|CamelTestSupport
block|{
DECL|field|LEASE_TIME_SECONDS
specifier|private
specifier|static
specifier|final
name|int
name|LEASE_TIME_SECONDS
init|=
literal|5
decl_stmt|;
...
name|assertTrue
argument_list|(
literal|"At least 2 seconds must elapse from leadership loss and regain (see renewDeadlineSeconds)"
argument_list|,
name|gainTimestamp
operator|>=
name|lossTimestamp
...
annotation|@
name|Test
DECL|method|testSlowLeaderLosingLeadership ()
specifier|public
name|void
name|testSlowLeaderLosingLeadership
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"Lease time not elapsed between switch"
argument_list|,
name|delay
operator|>=
name|TimeUnit
...
argument_list|)
expr_stmt|;
comment|// 5-3 = at least 2 seconds for switching on leadership loss
name|member
operator|.
