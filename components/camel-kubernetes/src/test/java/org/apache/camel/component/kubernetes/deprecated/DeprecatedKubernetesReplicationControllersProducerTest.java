...
name|producer
operator|.
name|KubernetesReplicationControllersProducerTest
import|;
end_import
...
annotation|@
name|Deprecated
DECL|class|DeprecatedKubernetesReplicationControllersProducerTest
specifier|public
class|class
name|DeprecatedKubernetesReplicationControllersProducerTest
extends|extends
name|KubernetesReplicationControllersProducerTest
block|{
annotation|@
...
name|from
argument_list|(
literal|"direct:scaleReplicationController"
argument_list|)
operator|.
name|toF
argument_list|(
literal|"kubernetes://%s?oauthToken=%s&category=replicationControllers&operation=scaleReplicationController"
argument_list|,
name|host
argument_list|,
name|authToken
