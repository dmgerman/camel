...
name|toF
argument_list|(
literal|"kubernetes-build-configs://%s?oauthToken=%s&operation=listBuildConfigs"
argument_list|,
name|host
argument_list|,
name|authToken
...
name|toF
argument_list|(
literal|"kubernetes-build-configs://%s?oauthToken=%s&operation=listBuildConfigsByLabels"
argument_list|,
name|host
argument_list|,
name|authToken
