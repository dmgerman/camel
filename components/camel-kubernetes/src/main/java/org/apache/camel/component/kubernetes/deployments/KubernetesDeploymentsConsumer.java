...
begin_class
DECL|class|KubernetesDeploymentsConsumer
specifier|public
class|class
...
name|executor
decl_stmt|;
DECL|field|deploymentsWatcher
specifier|private
name|DeploymentsConsumerTask
name|deploymentsWatcher
decl_stmt|;
DECL|method|KubernetesDeploymentsConsumer (AbstractKubernetesEndpoint endpoint, Processor processor)
specifier|public
name|KubernetesDeploymentsConsumer
parameter_list|(
name|AbstractKubernetesEndpoint
...
name|debug
argument_list|(
literal|"Stopping Kubernetes Deployments Consumer"
argument_list|)
expr_stmt|;
if|if
condition|(
...
expr_stmt|;
block|}
DECL|class|DeploymentsConsumerTask
class|class
name|DeploymentsConsumerTask
