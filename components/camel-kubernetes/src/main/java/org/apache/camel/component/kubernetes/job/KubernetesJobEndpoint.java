...
begin_comment
comment|/**  * The Kubernetes Jobs component provides a producer to execute kubernetes job  * operations  */
end_comment
...
name|syntax
operator|=
literal|"kubernetes-job:masterUrl"
argument_list|,
name|label
operator|=
literal|"container,cloud,paas"
argument_list|)
DECL|class|KubernetesJobEndpoint
specifier|public
class|class
...
argument_list|(
literal|"The kubernetes-job doesn't support consumer"
argument_list|)
throw|;
block|}
block|}
