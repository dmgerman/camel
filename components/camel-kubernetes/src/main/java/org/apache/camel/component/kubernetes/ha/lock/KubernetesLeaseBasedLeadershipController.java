...
argument_list|)
expr_stmt|;
name|scheduleCheckForPossibleLeadershipLoss
argument_list|()
expr_stmt|;
return|return
literal|true
...
expr_stmt|;
block|}
DECL|method|scheduleCheckForPossibleLeadershipLoss ()
specifier|private
name|void
name|scheduleCheckForPossibleLeadershipLoss
parameter_list|()
block|{
comment|// Adding check for the case of main thread busy on http calls
if|if
condition|(
name|this
operator|.
