...
begin_class
DECL|class|KubernetesServicesConsumer
specifier|public
class|class
...
name|executor
decl_stmt|;
DECL|field|servicesWatcher
specifier|private
name|ServicesConsumerTask
name|servicesWatcher
decl_stmt|;
DECL|method|KubernetesServicesConsumer (AbstractKubernetesEndpoint endpoint, Processor processor)
specifier|public
name|KubernetesServicesConsumer
parameter_list|(
name|AbstractKubernetesEndpoint
...
name|debug
argument_list|(
literal|"Stopping Kubernetes Services Consumer"
argument_list|)
expr_stmt|;
if|if
condition|(
...
expr_stmt|;
block|}
DECL|class|ServicesConsumerTask
class|class
name|ServicesConsumerTask
