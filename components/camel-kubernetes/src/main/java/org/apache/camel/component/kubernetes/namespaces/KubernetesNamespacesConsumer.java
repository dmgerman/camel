...
begin_class
DECL|class|KubernetesNamespacesConsumer
specifier|public
class|class
...
name|executor
decl_stmt|;
DECL|field|nsWatcher
specifier|private
name|NamespacesConsumerTask
name|nsWatcher
decl_stmt|;
DECL|method|KubernetesNamespacesConsumer (AbstractKubernetesEndpoint endpoint, Processor processor)
specifier|public
name|KubernetesNamespacesConsumer
parameter_list|(
name|AbstractKubernetesEndpoint
...
name|debug
argument_list|(
literal|"Stopping Kubernetes Namespace Consumer"
argument_list|)
expr_stmt|;
if|if
condition|(
...
expr_stmt|;
block|}
DECL|class|NamespacesConsumerTask
class|class
name|NamespacesConsumerTask
