...
name|deployment
decl_stmt|;
DECL|method|DeploymentEvent (Action action, Deployment deployment)
specifier|public
name|DeploymentEvent
parameter_list|(
name|Action
...
return|;
block|}
DECL|method|setNode (Deployment deployment)
specifier|public
name|void
name|setNode
parameter_list|(
