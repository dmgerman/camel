...
begin_class
DECL|class|KubernetesSecretsConsumer
specifier|public
class|class
name|KubernetesSecretsConsumer
extends|extends
name|DefaultConsumer
block|{
DECL|field|LOG
...
name|executor
decl_stmt|;
DECL|method|KubernetesSecretsConsumer (KubernetesEndpoint endpoint, Processor processor)
specifier|public
name|KubernetesSecretsConsumer
parameter_list|(
name|KubernetesEndpoint
...
name|debug
argument_list|(
literal|"Stopping Kubernetes Secrets Consumer"
argument_list|)
expr_stmt|;
if|if
condition|(
...
expr_stmt|;
block|}
DECL|class|SecretsConsumerTask
class|class
name|SecretsConsumerTask
