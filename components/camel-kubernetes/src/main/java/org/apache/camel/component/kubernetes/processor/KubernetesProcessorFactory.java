...
annotation|@
name|Override
DECL|method|createProcessor ( String name, String component, String uri, ExchangePattern mep, KubernetesConfiguration conf, Map<String, String> properties)
specifier|protected
name|DefaultServiceCallProcessor
...
annotation|@
name|Override
DECL|method|builtInServerListStrategy (KubernetesConfiguration conf, String name)
specifier|protected
name|Optional
argument_list|<
name|ServiceCallServerListStrategy
...
annotation|@
name|Override
DECL|method|createDefaultServerListStrategy (KubernetesConfiguration conf)
specifier|protected
name|ServiceCallServerListStrategy
argument_list|<
name|ServiceCallServer
