...
begin_class
DECL|class|KubernetesEnvironmentServiceCallProcessor
specifier|public
class|class
...
name|port
decl_stmt|;
DECL|method|KubernetesEnvironmentServiceCallProcessor (String name, String namespace, String scheme, String uri, ExchangePattern exchangePattern)
specifier|public
name|KubernetesEnvironmentServiceCallProcessor
parameter_list|(
name|String
...
name|info
argument_list|(
literal|"KubernetesServiceCall at namespace: {} with service name: {} using {}:{}"
argument_list|,
name|namespace
argument_list|,
name|name
