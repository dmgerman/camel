...
comment|// As the component's NettyHttpBinding could be override by the setHeaderFilterStrategy
comment|// Here we just create a new DefaultNettyHttpBinding here
if|if
condition|(
name|answer
operator|.
