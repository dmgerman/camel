...
argument_list|(
literal|"Cannot have both realm and securityConfiguration options configured"
argument_list|)
throw|;
block|}
elseif|else
...
condition|)
block|{
comment|// use default security configuration with the given realm, as a very easy way of enabling this
name|securityConfiguration
operator|=
operator|new
name|NettyHttpSecurityConfiguration
