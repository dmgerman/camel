...
condition|)
block|{
comment|// when we send text/plain message we're using the route with
comment|// uppercase processor before the netty-http producer
name|assertThat
argument_list|(
name|body
argument_list|)
...
condition|)
block|{
comment|// only if we received a payload we'll uppercase it
name|message
operator|.
name|setBody
argument_list|(
