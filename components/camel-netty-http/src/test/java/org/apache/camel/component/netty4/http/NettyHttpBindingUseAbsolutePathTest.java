...
name|request
argument_list|(
literal|"netty-http:http://localhost:{{port}}/mypath?useRelativePath=false"
argument_list|,
operator|new
name|Processor
argument_list|()
...
name|request
argument_list|(
literal|"netty-http:http://localhost:{{port}}?useRelativePath=false"
argument_list|,
operator|new
name|Processor
argument_list|()
...
name|from
argument_list|(
literal|"netty-http:http://localhost:{{port}}/mypath"
argument_list|)
operator|.
name|process
argument_list|(
