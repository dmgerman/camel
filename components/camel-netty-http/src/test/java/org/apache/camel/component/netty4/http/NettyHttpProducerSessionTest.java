...
name|toF
argument_list|(
literal|"netty-http:http://127.0.0.1:%d/session"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|toF
argument_list|(
literal|"netty-http:http://127.0.0.1:%d/session?cookieHandler=#instanceCookieHandler"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|toF
argument_list|(
literal|"netty-http:http://127.0.0.1:%d/session?cookieHandler=#exchangeCookieHandler"
argument_list|,
name|getPort
argument_list|()
argument_list|)
