...
begin_class
DECL|class|NettyHttpProducerTwoParametersWithSameKeyTest
specifier|public
class|class
name|NettyHttpProducerTwoParametersWithSameKeyTest
extends|extends
name|BaseNettyTest
block|{
annotation|@
...
name|request
argument_list|(
literal|"netty-http:http://localhost:{{port}}/myapp?from=me&to=foo&to=bar"
argument_list|,
literal|null
argument_list|)
decl_stmt|;
...
name|request
argument_list|(
literal|"netty-http:http://localhost:{{port}}/myapp"
argument_list|,
operator|new
name|Processor
argument_list|()
