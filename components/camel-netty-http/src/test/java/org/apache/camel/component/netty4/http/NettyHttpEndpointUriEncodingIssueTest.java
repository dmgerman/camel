...
name|uri
init|=
literal|"netty-http:http://localhost:{{port}}/myapp/mytest?columns=totalsens,upsens&username=apiuser"
decl_stmt|;
name|String
name|out
init|=
...
name|uri
init|=
literal|"netty-http:http://localhost:{{port}}/myapp/mytest?columns=claus,s\u00F8ren&username=apiuser"
decl_stmt|;
name|String
name|out
init|=
