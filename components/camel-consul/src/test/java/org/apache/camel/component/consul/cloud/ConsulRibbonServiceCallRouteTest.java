...
begin_class
DECL|class|ConsulRibbonServiceCallRouteTest
specifier|public
class|class
name|ConsulRibbonServiceCallRouteTest
extends|extends
name|ConsulTestSupport
block|{
...
name|to
argument_list|(
literal|"log:org.apache.camel.component.consul.processor.service?level=INFO&showAll=true&multiline=true"
argument_list|)
operator|.
name|to
argument_list|(
