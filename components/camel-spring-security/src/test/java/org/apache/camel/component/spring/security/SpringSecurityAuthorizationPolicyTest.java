...
annotation|@
name|Test
DECL|method|testAuthorizationFailedWithWrongExplicitRole ()
specifier|public
name|void
name|testAuthorizationFailedWithWrongExplicitRole
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|sendMessageWithAuthentication (String username, String password)
specifier|private
name|void
name|sendMessageWithAuthentication
parameter_list|(
