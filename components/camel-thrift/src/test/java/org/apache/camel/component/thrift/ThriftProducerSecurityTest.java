...
operator|+
literal|"method=calculate&negotiationType=SSL&sslConfiguration=#sslConfig&synchronous=true"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
literal|"/org.apache.camel.component.thrift.generated.Calculator?"
operator|+
literal|"method=add&negotiationType=SSL&sslConfiguration=#sslConfig&synchronous=true"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
literal|"/org.apache.camel.component.thrift.generated.Calculator?"
operator|+
literal|"method=ping&negotiationType=SSL&sslConfiguration=#sslConfig&synchronous=true"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
literal|"/org.apache.camel.component.thrift.generated.Calculator?"
operator|+
literal|"method=zip&negotiationType=SSL&sslConfiguration=#sslConfig&synchronous=true"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
literal|"/org.apache.camel.component.thrift.generated.Calculator?"
operator|+
literal|"method=alltypes&negotiationType=SSL&sslConfiguration=#sslConfig&synchronous=true"
argument_list|)
expr_stmt|;
block|}
block|}
