...
begin_comment
comment|/**  * Security negotiation types enum  */
end_comment
...
block|{
comment|/**      * No security negotiation defined      */
DECL|enumConstant|PLAINTEXT
name|PLAINTEXT
block|,
comment|/**      * SSL/TLS security negotiation      */
DECL|enumConstant|SSL
name|SSL
block|,
comment|/**      * SASL security negotiation. Not implemented      */
