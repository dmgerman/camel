...
block|}
argument_list|)
DECL|method|constructClientInstance (String packageName, String serviceName, TProtocol protocol, final CamelContext context)
specifier|public
specifier|static
name|Object
...
block|}
argument_list|)
DECL|method|constructAsyncClientInstance (String packageName, String serviceName, TNonblockingTransport transport, final CamelContext context)
specifier|public
specifier|static
name|Object
...
return|;
block|}
comment|/*      * This function find onComplete method inside interface implementation and      * get fist parameter (but not Object.class) as return type      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"rawtypes"
...
return|;
block|}
comment|/*      * This function transforms objects types stored as list or simple object      * inside Body to the primitives objects to find appropriate method      */
annotation|@
name|SuppressWarnings
argument_list|(
block|{
