...
begin_comment
comment|/**  * Exchange protocol serialization types enum  */
end_comment
...
block|{
comment|/**      * Binary protocol      */
DECL|enumConstant|BINARY
name|BINARY
block|,
comment|/**      * Full JSON protocol      */
DECL|enumConstant|JSON
name|JSON
block|,
comment|/**      * Simple JSON protocol      */
DECL|enumConstant|SJSON
name|SJSON
block|,
comment|/**      * Compact binary protocol      */
