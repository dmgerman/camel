...
name|description
operator|=
literal|"Managed ReactiveStreamsConsumer"
argument_list|)
...
name|description
operator|=
literal|"Number of inflight messages"
argument_list|)
...
name|description
operator|=
literal|"Number of messages to be requested on next request"
argument_list|)
DECL|method|getToBeRequested ()
specifier|public
name|long
name|getToBeRequested
parameter_list|()
block|{
return|return
name|subscriber
...
name|description
operator|=
literal|"Number of pending messages in the buffer"
argument_list|)
