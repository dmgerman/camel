...
name|sending
decl_stmt|;
DECL|method|CamelSubscription (ExecutorService workerPool, CamelPublisher publisher, String name, ReactiveStreamsBackpressureStrategy backpressureStrategy, Subscriber<? super StreamPayload<Exchange>> subscriber)
specifier|public
name|CamelSubscription
parameter_list|(
name|ExecutorService
