...
argument_list|()
operator|+
literal|" dropped according to the backpressure strategy "
operator|+
name|ReactiveStreamsBackpressureStrategy
operator|.
name|DROP
...
name|discardReason
operator|=
literal|"the backpressure strategy (DROP) does not allow buffering"
expr_stmt|;
block|}
else|else
block|{
...
name|discardReason
operator|=
literal|"the backpressure strategy (LATEST) does not allow buffering"
expr_stmt|;
block|}
name|buffer
operator|.
...
name|IllegalStateException
argument_list|(
literal|"Unsupported backpressure strategy: "
operator|+
name|this
operator|.
name|backpressureStrategy
