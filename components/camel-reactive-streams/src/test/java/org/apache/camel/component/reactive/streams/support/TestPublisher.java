...
expr_stmt|;
block|}
DECL|method|TestPublisher (Iterable<T> data, long delay, RequestObserver requestObserver)
specifier|public
name|TestPublisher
parameter_list|(
name|Iterable
...
expr_stmt|;
block|}
DECL|interface|RequestObserver
specifier|public
interface|interface
name|RequestObserver
block|{
DECL|method|observe (long request)
name|void
name|observe
parameter_list|(
name|long
