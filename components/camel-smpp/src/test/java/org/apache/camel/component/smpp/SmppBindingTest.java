...
begin_comment
comment|/**  * JUnit test class for<code>org.apache.camel.component.smpp.SmppBinding</code>  */
end_comment
...
annotation|@
name|Test
DECL|method|createSmppMessageFromDeliveryReceiptWithOptionalParametersShouldReturnASmppMessage ()
specifier|public
name|void
name|createSmppMessageFromDeliveryReceiptWithOptionalParametersShouldReturnASmppMessage
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|createSmppMessageFromDeliveryReceiptWithPayloadInOptionalParameterShouldReturnASmppMessage ()
specifier|public
name|void
name|createSmppMessageFromDeliveryReceiptWithPayloadInOptionalParameterShouldReturnASmppMessage
parameter_list|()
block|{
name|DeliverSm
name|deliverSm
...
name|fail
argument_list|(
literal|"Should not throw exception while creating smppMessage."
argument_list|)
expr_stmt|;
block|}
block|}
annotation|@
name|Test
DECL|method|createSmppMessageFromDeliveryReceiptWithoutShortMessageShouldNotThrowException ()
specifier|public
name|void
...
name|fail
argument_list|(
literal|"Should not throw exception while creating smppMessage in absence of shortMessage"
argument_list|)
expr_stmt|;
block|}
block|}
