...
parameter_list|)
function_decl|;
comment|/**      * Tries to return an instance of {@link SmppCommandType} using      * {@link SmppConstants#COMMAND} header of the incoming message.      *<p/>      * Returns {@link #SUBMIT_SM} if threre is no {@link SmppConstants#COMMAND}      * header in the incoming message or value of such a header cannot be      * recognized.      *<p/>      * The valid values for the {@link SmppConstants#COMMAND} header are:<span      * style="font: bold;">SubmitSm</span><span      * style="font: bold;">ReplaceSm</span>,<span      * style="font: bold;">QuerySm</span>,<span      * style="font: bold;">SubmitMulti</span>,<span      * style="font: bold;">CancelSm</span>,<span      * style="font: bold;">DataSm</span>.      *       * @param exchange      *            an exchange to get an incoming message from      * @return an instalce of {@link SmppCommandType}      */
