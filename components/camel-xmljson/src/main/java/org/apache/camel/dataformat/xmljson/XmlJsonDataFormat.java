...
return|;
block|}
comment|/**      * If enabled then XmlJson will set the Content-Type header to<tt>application/json</tt> when marshalling,      * and<tt>application/xml</tt> when unmarshalling.      */
