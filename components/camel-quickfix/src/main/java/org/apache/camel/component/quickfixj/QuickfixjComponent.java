...
expr_stmt|;
block|}
DECL|method|setEngineSettings (Map<String, SessionSettings> engineSettings)
specifier|public
name|void
name|setEngineSettings
parameter_list|(
name|Map
argument_list|<
name|String
...
control|)
block|{
comment|// QuickfixjEngine engine = new QuickfixjEngine(s.getKey(), s.getValue(),
comment|// forcedShutdown, messageStoreFactory, logFactory, messageFactory);
name|this
operator|.
name|engineSettings
operator|.
...
name|URISyntaxException
block|{
comment|// Adapted from DefaultComponent
name|URI
name|u
init|=
operator|new
