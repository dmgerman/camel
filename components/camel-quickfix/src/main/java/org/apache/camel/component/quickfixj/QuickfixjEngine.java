...
expr_stmt|;
block|}
DECL|method|QuickfixjEngine (String uri, SessionSettings settings, MessageStoreFactory messageStoreFactoryOverride, LogFactory sessionLogFactoryOverride, MessageFactory messageFactoryOverride, boolean lazy)
specifier|public
name|QuickfixjEngine
parameter_list|(
name|String
...
block|}
block|}
comment|/**      * Initializes the engine on demand. May be called immediately in constructor or when needed.      * If initializing later, it should be started afterwards.      */
DECL|method|initializeEngine ()
name|void
name|initializeEngine
parameter_list|()
throws|throws
