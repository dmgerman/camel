...
expr_stmt|;
block|}
DECL|method|QuickfixjEngine (String settingsResourceName, boolean forcedShutdown, MessageStoreFactory messageStoreFactoryOverride, LogFactory sessionLogFactoryOverride, MessageFactory messageFactoryOverride)
specifier|public
name|QuickfixjEngine
parameter_list|(
name|String
