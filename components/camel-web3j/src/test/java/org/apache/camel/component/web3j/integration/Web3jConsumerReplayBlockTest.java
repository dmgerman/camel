...
name|Ignore
argument_list|(
literal|"Requires Ganache instance with 10 transactions"
argument_list|)
DECL|class|Web3jConsumerReplayBlockTest
specifier|public
class|class
name|Web3jConsumerReplayBlockTest
extends|extends
...
argument_list|)
expr_stmt|;
comment|// 3 blocks + DONE exchange
name|mockError
operator|.
