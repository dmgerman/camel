...
expr_stmt|;
block|}
comment|//channelFactory = new NioServerSocketChannelFactory(bg, wg);
name|serverBootstrap
operator|=
operator|new
name|ServerBootstrap
...
expr_stmt|;
block|}
comment|// TODO set any additional netty options and child options
comment|/*if (configuration.getOptions() != null) {             for (Map.Entry<String, Object> entry : configuration.getOptions().entrySet()) {                 serverBootstrap.setOption(entry.getKey(), entry.getValue());             }         }*/
