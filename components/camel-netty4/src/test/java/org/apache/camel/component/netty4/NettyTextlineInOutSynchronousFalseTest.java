...
begin_class
DECL|class|NettyTextlineInOutSynchronousFalseTest
specifier|public
class|class
name|NettyTextlineInOutSynchronousFalseTest
extends|extends
name|BaseNettyTest
block|{
...
name|to
argument_list|(
literal|"netty4:tcp://localhost:{{port}}?textline=true&sync=true&synchronous=false"
argument_list|)
operator|.
name|process
argument_list|(
