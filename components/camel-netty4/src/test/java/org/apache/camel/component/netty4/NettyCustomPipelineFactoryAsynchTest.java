...
literal|"cpf"
argument_list|)
DECL|field|testClientFactory
specifier|private
name|TestClientChannelInitializerFactory
name|testClientFactory
init|=
operator|new
name|TestClientChannelInitializerFactory
argument_list|(
...
name|from
argument_list|(
literal|"netty4:tcp://localhost:{{port}}?serverInitializerFactory=#spf&textline=true"
argument_list|)
operator|.
name|process
argument_list|(
...
name|requestBody
argument_list|(
literal|"netty4:tcp://localhost:{{port}}?clientInitializerFactory=#cpf&textline=true"
argument_list|,
