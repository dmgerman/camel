...
argument_list|)
decl_stmt|;
comment|//        endpoint.setOnConsume(onConsume);
comment|//        endpoint.setOnConsumeFailed(onConsumeFailed);
comment|//        endpoint.setOnConsumeBatchComplete(onConsumeBatchComplete);
name|endpoint
operator|.
name|setDataSource
argument_list|(
