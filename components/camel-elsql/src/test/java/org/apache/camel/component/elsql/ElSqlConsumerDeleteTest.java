...
begin_class
DECL|class|ElSqlConsumerDeleteTest
specifier|public
class|class
name|ElSqlConsumerDeleteTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|db
...
name|setResourceUri
argument_list|(
literal|"elsql/projects.elsql,elsql/delete.elsql"
argument_list|)
expr_stmt|;
name|from
argument_list|(
literal|"elsql:allProjects?consumer.onConsume=deleteProject"
argument_list|)
operator|.
name|to
argument_list|(
