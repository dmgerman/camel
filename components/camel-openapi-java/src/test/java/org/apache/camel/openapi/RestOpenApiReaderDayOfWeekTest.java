...
begin_class
DECL|class|RestOpenApiReaderDayOfWeekTest
specifier|public
class|class
name|RestOpenApiReaderDayOfWeekTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|contains
argument_list|(
literal|"\"format\" : \"org.apache.camel.openapi.DayResponse\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"$ref\" : \"#/components/schemas/DayResponse\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
