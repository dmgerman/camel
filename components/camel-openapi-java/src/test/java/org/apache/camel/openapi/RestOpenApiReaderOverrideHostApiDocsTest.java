...
begin_class
DECL|class|RestOpenApiReaderOverrideHostApiDocsTest
specifier|public
class|class
name|RestOpenApiReaderOverrideHostApiDocsTest
extends|extends
name|RestOpenApiReaderApiDocsTest
block|{
annotation|@
name|Override
annotation|@
...
name|contains
argument_list|(
literal|"\"url\" : \"http://http:mycoolserver:8888/myapi/api\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertFalse
