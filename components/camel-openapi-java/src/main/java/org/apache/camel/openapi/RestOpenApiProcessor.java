...
begin_class
DECL|class|RestOpenApiProcessor
specifier|public
class|class
...
literal|"unchecked"
argument_list|)
DECL|method|RestOpenApiProcessor (String contextIdPattern, boolean contextIdListing, Map<String, Object> parameters, RestConfiguration configuration)
specifier|public
name|RestOpenApiProcessor
parameter_list|(
name|String
...
name|warn
argument_list|(
literal|"Error rendering OpenApi API due "
operator|+
name|e
operator|.
name|getMessage
