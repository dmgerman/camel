...
begin_class
DECL|class|ManagedZipkinSimpleRouteTest
specifier|public
class|class
name|ManagedZipkinSimpleRouteTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|zipkin
...
name|ObjectName
argument_list|(
literal|"org.apache.camel:context=camel-1,type=services,name=ZipkinTracer"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
