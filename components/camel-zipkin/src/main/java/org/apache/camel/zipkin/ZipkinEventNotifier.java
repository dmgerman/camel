...
return|;
block|}
DECL|method|getServiceName (EventObject event, Exchange exchange, Endpoint endpoint, boolean server, boolean client)
specifier|private
name|String
name|getServiceName
parameter_list|(
...
block|}
block|}
DECL|method|getServiceName (EventObject event, Exchange exchange, Endpoint endpoint, Map<String, String> serviceMappings, boolean server, boolean client)
specifier|private
name|String
name|getServiceName
parameter_list|(
...
block|}
block|}
comment|// special for created event as its a server side to know where it was from
if|if
condition|(
name|server
operator|&&
...
block|}
block|}
comment|// server received client request
if|if
condition|(
name|event
operator|instanceof
...
name|event
decl_stmt|;
comment|// we should only emit a server request if we have an existing trace id (eg a client has called us)
if|if
condition|(
...
block|}
block|}
comment|// server completed events
if|if
condition|(
name|event
operator|instanceof
...
name|debug
argument_list|(
literal|"clientRequest [service={}, traceId={}, spanId={}, parentId={}]"
argument_list|,
name|serviceName
argument_list|,
name|traceId
...
name|debug
argument_list|(
literal|"clientResponse[service={}, traceId={}, spanId={}, parentId={}]"
argument_list|,
name|serviceName
argument_list|,
name|traceId
...
name|debug
argument_list|(
literal|"serverRequest [service={}, traceId={}, spanId={}, parentId={}]"
argument_list|,
name|serviceName
argument_list|,
name|traceId
