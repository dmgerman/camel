...
begin_class
DECL|class|CamelMessageConsumer
specifier|public
class|class
...
name|closed
decl_stmt|;
DECL|method|CamelMessageConsumer (CamelDestination destination, Endpoint endpoint, ActiveMQSession session, String messageSelector, boolean noLocal)
specifier|public
name|CamelMessageConsumer
parameter_list|(
name|CamelDestination
...
comment|// -----------------------------------------------------------------------
DECL|method|getPollingConsumer ()
specifier|protected
name|PollingConsumer
name|getPollingConsumer
parameter_list|()
