...
annotation|@
name|Test
DECL|method|testJmsTemplateUsesSingleConnectionFactory ()
specifier|public
name|void
...
annotation|@
name|Test
DECL|method|testSessionTransactedWithoutTransactionManager ()
specifier|public
name|void
name|testSessionTransactedWithoutTransactionManager
parameter_list|()
throws|throws
name|Exception
block|{
...
name|resolveMandatoryEndpoint
argument_list|(
literal|"activemq:test.foo?transacted=true&lazyCreateTransactionManager=false"
argument_list|)
decl_stmt|;
name|JmsConfiguration
name|configuration
...
name|assertTrue
argument_list|(
literal|"The JMS sessions are not transacted!"
argument_list|,
name|endpoint
operator|.
name|isTransacted
...
name|assertNull
argument_list|(
literal|"A transaction manager has been lazy-created!"
argument_list|,
name|endpoint
operator|.
...
annotation|@
name|Test
DECL|method|testJmsTemplateDoesNotUsePoolingConnectionFactory ()
specifier|public
name|void
