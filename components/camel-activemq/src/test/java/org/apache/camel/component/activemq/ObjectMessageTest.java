...
expr_stmt|;
block|}
DECL|method|assertCorrectObjectReceived (MockEndpoint result)
specifier|protected
name|void
name|assertCorrectObjectReceived
parameter_list|(
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/activemq/jms-object-message.xml"
argument_list|)
decl_stmt|;
return|return
name|context
