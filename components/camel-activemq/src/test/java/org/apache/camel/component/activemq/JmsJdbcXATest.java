...
return|;
block|}
DECL|method|dumpDb (java.sql.Connection jdbcConn)
specifier|private
name|int
name|dumpDb
parameter_list|(
...
annotation|@
name|Test
DECL|method|testRecoveryCommit ()
specifier|public
name|void
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/activemq/jmsXajdbc.xml"
argument_list|)
return|;
end_return
