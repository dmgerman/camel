...
begin_class
DECL|class|JmsJdbcXARollbackTest
specifier|public
class|class
...
annotation|@
name|Test
DECL|method|testConsumeRollback ()
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|consumedFrom (String qName)
specifier|private
name|boolean
name|consumedFrom
parameter_list|(
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/activemq/jmsXajdbcRollback.xml"
argument_list|)
return|;
block|}
DECL|class|MarkRollbackOnly
specifier|public
specifier|static
class|class
name|MarkRollbackOnly
block|{
DECL|method|enrich (Exchange exchange)
specifier|public
name|String
name|enrich
parameter_list|(
