...
begin_comment
comment|/**  * Common interface for Wordpress Service adapters.  */
end_comment

begin_interface
DECL|interface|WordpressService
specifier|public
interface|interface
name|WordpressService
block|{
comment|/**      * Sets the Wordpress Authentication Model      *       * @param authentication      */
