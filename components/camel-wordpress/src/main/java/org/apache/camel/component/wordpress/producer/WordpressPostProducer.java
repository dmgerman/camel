...
begin_comment
comment|/**  * The Wordpress Post producer.  */
end_comment

begin_class
DECL|class|WordpressPostProducer
specifier|public
class|class
...
name|servicePosts
decl_stmt|;
DECL|method|WordpressPostProducer (WordpressEndpoint endpoint)
specifier|public
name|WordpressPostProducer
parameter_list|(
name|WordpressEndpoint
...
name|debug
argument_list|(
literal|"Trying to create a new blog post with {}"
argument_list|,
name|exchange
operator|.
name|getIn
...
name|debug
argument_list|(
literal|"Trying to delete a post with id {}"
argument_list|,
name|this
operator|.
name|getConfiguration
