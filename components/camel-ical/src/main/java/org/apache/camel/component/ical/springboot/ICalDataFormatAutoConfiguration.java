...
name|class
argument_list|)
DECL|method|configureICalDataFormat (CamelContext camelContext, ICalDataFormatConfiguration configuration)
specifier|public
name|ICalDataFormat
name|configureICalDataFormat
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
