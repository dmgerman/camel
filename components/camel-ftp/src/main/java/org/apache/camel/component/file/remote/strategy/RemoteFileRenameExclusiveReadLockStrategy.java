...
begin_class
DECL|class|RemoteFileRenameExclusiveReadLockStrategy
specifier|public
class|class
...
name|trace
argument_list|(
literal|"Waiting for exclusive read lock to remote file: "
operator|+
name|file
argument_list|)
expr_stmt|;
...
name|timeout
operator|+
literal|" millis. Will skip the remote file: "
operator|+
name|file
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**      * Sets an optional timeout period.      *<p/>      * If the readlock could not be granted within the timeperiod then the wait is stopped and the      * {@link #acquireExclusiveReadLock(org.apache.camel.component.file.remote.RemoteFileOperations,      * org.apache.camel.component.file.remote.RemoteFile) acquireExclusiveReadLock} returns<tt>false</tt>.      *      * @param timeout period in millis      */
