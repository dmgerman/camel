...
name|CopyStreamListener
block|{
comment|// TODO: allow to reconfigure level, interval, verbose etc via JMX
DECL|field|logger
specifier|private
specifier|final
name|CamelLogger
...
argument_list|()
decl_stmt|;
DECL|method|DefaultFtpClientActivityListener (CamelLogger logger, boolean verbose, int intervalSeconds, String host)
specifier|public
name|DefaultFtpClientActivityListener
parameter_list|(
name|CamelLogger
