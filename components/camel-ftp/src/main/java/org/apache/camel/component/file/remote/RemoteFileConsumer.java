...
expr_stmt|;
block|}
comment|/**      * Strategy for validating if the given remote file should be included or not      *      * @param file         the remote file      * @param isDirectory  wether the file is a directory or a file      * @return<tttrue</tt> to include the file,<tt>false</tt> to skip it      */
...
return|;
block|}
comment|/**      * Is the given file matched to be consumed.      *      * @param file         the remote file      * @param isDirectory  is the given file a directory or a file      * @return<tt>true</tt> to include the file,<tt>false</tt> to skip it      */
