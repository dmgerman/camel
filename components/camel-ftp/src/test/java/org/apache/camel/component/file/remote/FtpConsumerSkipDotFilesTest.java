...
begin_comment
comment|/**  * Unit test that ftp consumer will skip any files starting with a dot  */
end_comment

begin_class
DECL|class|FtpConsumerSkipDotFilesTest
specifier|public
class|class
name|FtpConsumerSkipDotFilesTest
extends|extends
...
argument_list|()
operator|+
literal|"/dotfiles?password=admin"
return|;
block|}
annotation|@
name|Override
