...
expr_stmt|;
block|}
DECL|method|testSftpKnownHostsConfiguration ()
specifier|public
name|void
name|testSftpKnownHostsConfiguration
parameter_list|()
block|{
name|Endpoint
name|endpoint
...
name|getEndpoint
argument_list|(
literal|"sftp://user@hostname:1021/some/file?password=secret&binary=true&directory=false&knownHosts=/home/janstey/.ssh/known_hosts"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
