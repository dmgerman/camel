...
begin_comment
comment|/**  * Test the ftps component over TLS (explicit) and without client authentication  *   * @version $Revision$  * @author muellerc  */
end_comment

begin_class
DECL|class|FileToFtpsWithDefaultSettingsTest
specifier|public
class|class
name|FileToFtpsWithDefaultSettingsTest
extends|extends
