...
begin_comment
comment|/**  * Abstract base class for unit testing using a secure FTP Server over TLS (implicit)  * and without client authentication.  *   * @version $Revision$  * @author muellerc  */
end_comment

begin_class
DECL|class|FtpsServerImplicitTLSWithoutClientAuthTestSupport
specifier|public
specifier|abstract
class|class
name|FtpsServerImplicitTLSWithoutClientAuthTestSupport
extends|extends
