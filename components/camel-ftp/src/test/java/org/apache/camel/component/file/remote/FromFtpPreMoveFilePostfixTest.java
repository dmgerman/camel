...
begin_comment
comment|/**  * Unit test to test preMoveNamePostfix option.  */
end_comment

begin_class
DECL|class|FromFtpPreMoveFilePostfixTest
specifier|public
class|class
name|FromFtpPreMoveFilePostfixTest
extends|extends
...
argument_list|)
expr_stmt|;
comment|//mock.expectedBodiesReceived("Hello World this file will be moved");
name|mock
operator|.
...
name|File
argument_list|(
literal|"./res/home/movefile/hello.txt.old"
argument_list|)
decl_stmt|;
name|file
operator|=
