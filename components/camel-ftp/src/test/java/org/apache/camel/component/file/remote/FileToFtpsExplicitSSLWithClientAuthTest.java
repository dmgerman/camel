...
begin_comment
comment|/**  * Test the ftps component over SSL (explicit) with client authentication  *   * @version $Revision$  * @author muellerc  */
end_comment

begin_class
DECL|class|FileToFtpsExplicitSSLWithClientAuthTest
specifier|public
class|class
name|FileToFtpsExplicitSSLWithClientAuthTest
extends|extends
name|FtpsServerExplicitSSLWithClientAuthTestSupport
block|{
