...
begin_class
DECL|class|FtpChangedReadLockMinAgeTest
specifier|public
class|class
name|FtpChangedReadLockMinAgeTest
extends|extends
...
argument_list|()
operator|+
literal|"/changed?password=admin&readLock=changed&readLockCheckInterval=1000&readLockMinAge=3000&delete=true"
return|;
block|}
annotation|@
name|Test
