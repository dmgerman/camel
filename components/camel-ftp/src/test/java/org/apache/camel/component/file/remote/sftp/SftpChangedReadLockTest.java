...
begin_class
DECL|class|SftpChangedReadLockTest
specifier|public
class|class
name|SftpChangedReadLockTest
extends|extends
...
name|FTP_ROOT_DIR
operator|+
literal|"/changed?username=admin&password=admin&readLock=changed&readLockCheckInterval=1000&delete=true"
return|;
block|}
annotation|@
name|Override
