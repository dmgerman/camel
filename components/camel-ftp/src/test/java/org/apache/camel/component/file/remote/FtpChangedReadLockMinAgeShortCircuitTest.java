...
begin_class
DECL|class|FtpChangedReadLockMinAgeShortCircuitTest
specifier|public
class|class
name|FtpChangedReadLockMinAgeShortCircuitTest
extends|extends
...
argument_list|()
operator|+
literal|"/changed?password=admin&readLock=changed&readLockMinAge=500&readLockCheckInterval=30000&readLockTimeout=90000&delete=true"
return|;
block|}
annotation|@
name|Override
