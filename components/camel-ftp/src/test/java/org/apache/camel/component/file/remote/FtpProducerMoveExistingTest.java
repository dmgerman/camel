...
begin_class
DECL|class|FtpProducerMoveExistingTest
specifier|public
class|class
name|FtpProducerMoveExistingTest
extends|extends
...
argument_list|()
operator|+
literal|"&tempFileName=${file:onlyname}.temp&moveExisting=${file:parent}/renamed-${file:onlyname}"
argument_list|,
literal|"Hello World"
argument_list|,
name|Exchange
