...
begin_class
DECL|class|FtpConsumerRelativeFileNameTest
specifier|public
class|class
name|FtpConsumerRelativeFileNameTest
extends|extends
...
argument_list|()
operator|+
literal|"/target/filename-consumer?password=admin&recursive=true&sortBy=file:name"
return|;
block|}
annotation|@
name|Override
