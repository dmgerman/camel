...
begin_class
DECL|class|FtpsComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|FtpsComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|(
literal|"ftps:127.0.0.1?username=foo&password=secret"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|contains
argument_list|(
literal|"\"port\": { \"kind\": \"path\", \"type\": \"integer\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|assertNotNull
argument_list|(
literal|"Should have found some auto-generated"
argument_list|,
name|html
argument_list|)
expr_stmt|;
