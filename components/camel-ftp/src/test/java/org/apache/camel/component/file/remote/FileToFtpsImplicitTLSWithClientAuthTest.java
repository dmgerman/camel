...
begin_comment
comment|/**  * Test the ftps component over TLS (implicit) with client authentication  */
end_comment

begin_class
DECL|class|FileToFtpsImplicitTLSWithClientAuthTest
specifier|public
class|class
...
operator|+
literal|"&securityProtocol=TLSv1.2&implicit=true&ftpClient.keyStore.file=./src/test/resources/server.jks&ftpClient.keyStore.type=JKS"
operator|+
