...
begin_comment
comment|/**  * Abstract base class for unit testing using a secure FTP Server over SSL (implicit)  * and with client authentication.  *   * @version $Revision$  * @author muellerc  */
end_comment
