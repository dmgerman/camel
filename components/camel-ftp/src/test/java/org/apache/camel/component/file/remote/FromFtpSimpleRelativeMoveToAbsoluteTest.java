...
begin_class
DECL|class|FromFtpSimpleRelativeMoveToAbsoluteTest
specifier|public
class|class
...
operator|+
literal|"&move=/movefile/.done&initialDelay=2500&delay=5000"
return|;
block|}
annotation|@
name|Override
...
name|FTP_ROOT_DIR
operator|+
literal|"/movefile/.done/goodday.txt"
argument_list|)
expr_stmt|;
name|mock
operator|.
