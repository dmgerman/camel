...
begin_class
DECL|class|FromFtpMoveFileRecursiveTest
specifier|public
class|class
...
name|FTP_ROOT_DIR
operator|+
literal|"/movefile/.done/hello.txt.old"
argument_list|)
expr_stmt|;
name|mock
operator|.
...
name|FTP_ROOT_DIR
operator|+
literal|"/movefile/.done/bye/bye.txt.old"
argument_list|)
expr_stmt|;
name|mock
operator|.
...
name|FTP_ROOT_DIR
operator|+
literal|"/movefile/.done/goodday/goodday.txt.old"
argument_list|)
expr_stmt|;
name|mock
operator|.
