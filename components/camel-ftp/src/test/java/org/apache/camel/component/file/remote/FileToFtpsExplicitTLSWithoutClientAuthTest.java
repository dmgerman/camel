...
begin_comment
comment|/**  * Test the ftps component over TLS (explicit) without client authentication  *   * @version $Revision$  * @author muellerc  */
end_comment

begin_class
DECL|class|FileToFtpsExplicitTLSWithoutClientAuthTest
specifier|public
class|class
...
operator|+
literal|"&securityProtocol=TLS&isImplicit=false"
return|;
block|}
annotation|@
name|Test
