...
begin_comment
comment|/**  * Test the ftps component over TLS (explicit) without client authentication  *   * @version $Revision$  */
end_comment
...
operator|+
literal|"&securityProtocol=TLS&isImplicit=false&delete=true"
return|;
block|}
annotation|@
name|Test
