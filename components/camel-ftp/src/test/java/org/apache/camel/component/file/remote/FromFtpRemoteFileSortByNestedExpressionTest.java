...
begin_class
DECL|class|FromFtpRemoteFileSortByNestedExpressionTest
specifier|public
class|class
name|FromFtpRemoteFileSortByNestedExpressionTest
extends|extends
...
argument_list|()
operator|+
literal|"/sortbynested?password=admin&delay=5000"
return|;
block|}
annotation|@
name|Override
...
argument_list|()
operator|+
literal|"&sortBy=file:ext;file:name"
argument_list|)
operator|.
name|to
argument_list|(
...
argument_list|()
operator|+
literal|"&sortBy=file:ext;reverse:file:name"
argument_list|)
operator|.
name|to
argument_list|(
