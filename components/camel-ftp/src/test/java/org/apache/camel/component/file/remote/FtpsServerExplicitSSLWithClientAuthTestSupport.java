...
begin_comment
comment|/**  * Abstract base class for unit testing using a secure FTP Server over SSL (explicit)  * and with client authentication.  *   * @version $Revision$  * @author muellerc  */
end_comment

begin_class
DECL|class|FtpsServerExplicitSSLWithClientAuthTestSupport
specifier|public
specifier|abstract
class|class
