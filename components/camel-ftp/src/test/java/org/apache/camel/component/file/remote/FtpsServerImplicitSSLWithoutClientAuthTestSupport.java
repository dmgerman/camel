...
begin_comment
comment|/**  * Abstract base class for unit testing using a secure FTP Server over SSL (implicit)  * and without client authentication.  *   * @version   */
end_comment

begin_class
DECL|class|FtpsServerImplicitSSLWithoutClientAuthTestSupport
specifier|public
specifier|abstract
class|class
