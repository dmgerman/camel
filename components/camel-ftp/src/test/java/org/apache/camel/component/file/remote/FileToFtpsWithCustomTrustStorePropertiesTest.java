...
begin_class
DECL|class|FileToFtpsWithCustomTrustStorePropertiesTest
specifier|public
class|class
name|FileToFtpsWithCustomTrustStorePropertiesTest
extends|extends
...
operator|+
literal|"&securityProtocol=SSL&isImplicit=false&ftpClient.trustStore.file=./src/test/resources/server.jks&ftpClient.trustStore.type=JKS"
operator|+
