...
begin_comment
comment|/**  * Abstract base class for unit testing using a secure FTP Server over TLS (implicit)  * and with client authentication.  *   * @version $Revision$  * @author muellerc  */
end_comment

begin_class
DECL|class|FtpsServerImplicitTLSWithClientAuthTestSupport
specifier|public
specifier|abstract
class|class
