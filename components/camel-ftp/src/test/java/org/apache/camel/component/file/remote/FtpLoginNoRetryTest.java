...
begin_comment
comment|/**  * Unit test for login failure due bad password and no re connect attempts  */
end_comment

begin_class
DECL|class|FtpLoginNoRetryTest
specifier|public
class|class
name|FtpLoginNoRetryTest
extends|extends
...
name|password
operator|+
literal|"&maximumReconnectAttempts=0"
argument_list|)
decl_stmt|;
name|Exchange
name|exchange
