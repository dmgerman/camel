...
begin_class
DECL|class|PulsarConcurrentProducerInTest
specifier|public
class|class
name|PulsarConcurrentProducerInTest
extends|extends
...
name|TOPIC_URI
init|=
literal|"persistent://public/default/camel-concurrent-producers-topic"
decl_stmt|;
DECL|field|PRODUCER
specifier|private
specifier|static
...
return|;
block|}
DECL|method|registerPulsarBeans (SimpleRegistry registry)
specifier|private
name|void
name|registerPulsarBeans
parameter_list|(
...
annotation|@
name|Test
DECL|method|testConcurrentMessagesAreSentAndThenConsumed ()
specifier|public
name|void
name|testConcurrentMessagesAreSentAndThenConsumed
parameter_list|()
throws|throws
name|Exception
block|{
