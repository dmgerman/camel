...
begin_class
DECL|class|PulsarConsumerNoAcknowledgementTest
specifier|public
class|class
name|PulsarConsumerNoAcknowledgementTest
extends|extends
...
parameter_list|()
block|{
comment|// Nothing in the route will ack the message.
name|from
argument_list|(
name|from
argument_list|)
...
annotation|@
name|Test
DECL|method|testAMessageIsConsumedMultipleTimes ()
specifier|public
name|void
name|testAMessageIsConsumedMultipleTimes
parameter_list|()
throws|throws
name|Exception
block|{
