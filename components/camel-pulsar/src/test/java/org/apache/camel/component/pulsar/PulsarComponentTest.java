...
annotation|@
name|Test
DECL|method|testPulsarEndpointAllowManualAcknowledgementDefaultTrue ()
specifier|public
name|void
name|testPulsarEndpointAllowManualAcknowledgementDefaultTrue
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// allowManualAcknowledgement is absent as a query parameter.
name|PulsarEndpoint
name|endpoint
init|=
operator|(
