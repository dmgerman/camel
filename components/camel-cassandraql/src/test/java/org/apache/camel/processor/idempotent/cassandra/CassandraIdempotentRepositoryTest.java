...
name|execute
argument_list|(
literal|"select KEY from CAMEL_IDEMPOTENT where NAME=? and KEY=?"
argument_list|,
literal|"ID"
argument_list|,
name|key
...
annotation|@
name|Test
DECL|method|testAdd_NotExists ()
specifier|public
name|void
name|testAdd_NotExists
parameter_list|()
block|{
comment|// Given
name|String
...
annotation|@
name|Test
DECL|method|testContains_NotExists ()
specifier|public
name|void
name|testContains_NotExists
parameter_list|()
block|{
comment|// Given
name|String
...
annotation|@
name|Test
DECL|method|testContains_Exists ()
specifier|public
name|void
name|testContains_Exists
parameter_list|()
block|{
comment|// Given
name|String
