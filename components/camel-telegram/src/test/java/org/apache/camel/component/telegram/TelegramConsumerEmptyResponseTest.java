...
parameter_list|()
block|{
comment|/* First make sure the message containing zero updates was sent by the API */
name|Awaitility
operator|.
name|await
argument_list|()
...
argument_list|)
expr_stmt|;
comment|/* Then make sure that the consumer has sent zero exchanges to the route */
name|assertThrows
argument_list|(
name|AssertionError
operator|.
