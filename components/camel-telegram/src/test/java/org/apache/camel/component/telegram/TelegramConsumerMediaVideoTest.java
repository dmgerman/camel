...
begin_class
DECL|class|TelegramConsumerMediaVideoTest
specifier|public
class|class
name|TelegramConsumerMediaVideoTest
extends|extends
name|TelegramTestSupport
block|{
annotation|@
...
argument_list|(
literal|"messages/updates-media-video.json"
argument_list|,
name|UpdateResult
operator|.
name|class
...
annotation|@
name|Test
DECL|method|testReceptionOfAMessageWithAVideo ()
specifier|public
name|void
name|testReceptionOfAMessageWithAVideo
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"BAADBAADAgADyzvwCC7_4AyvdAXXXX"
argument_list|,
name|video
operator|.
name|getFileId
