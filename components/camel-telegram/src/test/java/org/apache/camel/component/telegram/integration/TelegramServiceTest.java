...
parameter_list|()
block|{
comment|/* Telegram bots by design see neither their own messages nor other bots' messages.          * So, for this test to succeed a human should have sent some messages to the bot manually          * before running the test */
name|IncomingMessage
name|res
init|=
name|consumer
...
name|format
argument_list|(
literal|"telegram://bots?chatId=%s"
argument_list|,
name|chatId
argument_list|)
argument_list|,
