...
name|sendBody
argument_list|(
literal|"mina2:xxx://localhost:8080"
argument_list|,
literal|"mina2:xxx://localhost:8080"
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"Unrecognised MINA protocol: xxx for uri: mina2://xxx://localhost:8080"
argument_list|,
name|e
operator|.
name|getCause
...
name|sendBody
argument_list|(
literal|"mina2:tcp//localhost:8080"
argument_list|,
literal|"mina2:tcp//localhost:8080"
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"Unrecognised MINA protocol: null for uri: mina2://tcp//localhost:8080"
argument_list|,
name|e
operator|.
name|getCause
