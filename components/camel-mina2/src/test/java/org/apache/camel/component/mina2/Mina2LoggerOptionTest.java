...
begin_class
DECL|class|Mina2LoggerOptionTest
specifier|public
class|class
name|Mina2LoggerOptionTest
extends|extends
name|BaseMina2Test
block|{
annotation|@
...
name|uri
init|=
literal|"mina2:tcp://localhost:{{port}}?textline=true&minaLogger=true&sync=false"
decl_stmt|;
name|context
operator|.
name|addRoutes
...
name|uri
init|=
literal|"mina2:tcp://localhost:{{port}}?textline=true&minaLogger=false&sync=false"
decl_stmt|;
name|context
operator|.
name|addRoutes
