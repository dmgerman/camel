...
begin_class
DECL|class|Mina2TransferExchangeOptionTest
specifier|public
class|class
name|Mina2TransferExchangeOptionTest
extends|extends
name|BaseMina2Test
block|{
DECL|field|LOG
...
name|getEndpoint
argument_list|(
literal|"mina2:tcp://localhost:{{port}}?sync=true&encoding=UTF-8&transferExchange=true"
argument_list|)
decl_stmt|;
name|Producer
name|producer
...
argument_list|()
decl_stmt|;
comment|//Exchange exchange = endpoint.createExchange();
name|Message
name|message
init|=
name|exchange
