...
begin_class
DECL|class|Mina2VMCustomCodecTest
specifier|public
class|class
name|Mina2VMCustomCodecTest
extends|extends
name|BaseMina2Test
block|{
annotation|@
...
name|format
argument_list|(
literal|"mina2:vm://localhost:%1$s?sync=true&codec=#myCodec"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina2:vm://localhost:%1$s?encoding=UTF-8&sync=false"
argument_list|,
name|getNextPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina2:vm://localhost:%1$s?sync=true&codec=#XXX"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
annotation|@
name|Override
DECL|method|getEncoder (IoSession is)
specifier|public
name|ProtocolEncoder
name|getEncoder
parameter_list|(
...
annotation|@
name|Override
DECL|method|getDecoder (IoSession is)
specifier|public
name|ProtocolDecoder
name|getDecoder
parameter_list|(
