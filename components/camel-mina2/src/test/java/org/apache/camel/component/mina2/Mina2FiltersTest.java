...
name|testFilter
argument_list|(
literal|"mina2:tcp://localhost:{{port}}?textline=true&minaLogger=true&sync=false&filters=#myFilters"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|testFilter
argument_list|(
literal|"mina2:tcp://localhost:{{port}}?textline=true&minaLogger=true&sync=false&filters=#myFilter"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|assertTrue
argument_list|(
literal|"There should be a test filter"
argument_list|,
name|session
operator|.
name|getFilterChain
