...
begin_class
DECL|class|Mina2SslGlobalContextParametersTcpTest
specifier|public
class|class
name|Mina2SslGlobalContextParametersTcpTest
extends|extends
name|BaseMina2Test
block|{
annotation|@
...
annotation|@
name|Test
DECL|method|testMinaRouteWithoutSSL ()
specifier|public
name|void
name|testMinaRouteWithoutSSL
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
operator|+
literal|"?useGlobalSslContextParameters=false&sync=false&minaLogger=true"
argument_list|,
name|body
argument_list|,
literal|"cheese"
...
name|fromF
argument_list|(
literal|"mina2:tcp://localhost:%s?sync=false&minaLogger=true"
argument_list|,
name|getPort
argument_list|()
argument_list|)
