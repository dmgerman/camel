...
begin_class
DECL|class|Mina2VMTransferExchangeOptionTest
specifier|public
class|class
name|Mina2VMTransferExchangeOptionTest
extends|extends
name|BaseMina2Test
block|{
annotation|@
...
name|getEndpoint
argument_list|(
literal|"mina2:vm://localhost:{{port}}?sync=true&encoding=UTF-8&transferExchange=true"
argument_list|)
decl_stmt|;
name|Exchange
name|exchange
