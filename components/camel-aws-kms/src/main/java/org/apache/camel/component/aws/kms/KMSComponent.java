...
expr_stmt|;
block|}
DECL|method|KMSComponent (CamelContext context)
specifier|public
name|KMSComponent
parameter_list|(
name|CamelContext
...
argument_list|(
operator|new
name|KMSComponentVerifierExtension
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
argument_list|(
literal|"Amazon kms client or accessKey and secretKey must be specified"
argument_list|)
throw|;
block|}
name|KMSEndpoint
...
DECL|method|setConfiguration (KMSConfiguration configuration)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|checkAndSetRegistryClient (KMSConfiguration configuration)
specifier|private
name|void
name|checkAndSetRegistryClient
parameter_list|(
