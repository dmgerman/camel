...
name|inputStream
expr_stmt|;
comment|// use the input stream as the body
name|processHdfsInputStream
argument_list|(
name|inputStream
argument_list|,
...
begin_function
DECL|method|processHdfsInputStream (HdfsInputStream inputStream, Holder<Object> key, Holder<Object> value, AtomicInteger messageCount, int totalFiles)
specifier|private
name|void
name|processHdfsInputStream
parameter_list|(
