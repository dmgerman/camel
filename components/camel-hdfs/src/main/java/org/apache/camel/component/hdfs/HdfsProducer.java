...
name|warn
argument_list|(
literal|"Failed to start the HDFS producer. Caused by: [{}]"
argument_list|,
name|e
operator|.
name|getMessage
...
return|;
block|}
DECL|method|tryFindIdleStrategy (List<SplitStrategy> strategies)
specifier|private
name|Optional
argument_list|<
name|SplitStrategy
...
return|;
block|}
DECL|method|isSplitRequired (List<SplitStrategy> strategies)
specifier|private
name|boolean
name|isSplitRequired
parameter_list|(
