...
name|to
argument_list|(
literal|"hdfs://localhost/tmp/test/test-camel-simple-write-file?fileSystemType=LOCAL"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|URL
argument_list|(
literal|"file:///tmp/test/test-camel-simple-write-file"
argument_list|)
operator|.
name|openStream
argument_list|()
...
name|to
argument_list|(
literal|"hdfs://localhost/tmp/test/test-camel-sequence-write-file1?fileSystemType=LOCAL&fileType=SEQUENCE_FILE"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|Path
argument_list|(
literal|"file:///tmp/test/test-camel-sequence-write-file1"
argument_list|)
decl_stmt|;
name|FileSystem
name|fs1
...
name|to
argument_list|(
literal|"hdfs://localhost/tmp/test/test-camel-sequence-write-file2?fileSystemType=LOCAL&keyType=TEXT&fileType=SEQUENCE_FILE"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|Path
argument_list|(
literal|"file:///tmp/test/test-camel-sequence-write-file2"
argument_list|)
decl_stmt|;
name|FileSystem
name|fs1
...
name|to
argument_list|(
literal|"hdfs://localhost/tmp/test/test-camel-map-write-file1?fileSystemType=LOCAL&keyType=TEXT&fileType=MAP_FILE"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|Path
argument_list|(
literal|"file:///tmp/test/test-camel-map-write-file1"
argument_list|)
decl_stmt|;
name|FileSystem
name|fs1
...
name|to
argument_list|(
literal|"hdfs://localhost/tmp/test/test-camel-sequence-write-file3?fileSystemType=LOCAL&fileType=SEQUENCE_FILE&splitStrategy=IDLE:100&checkIdleInterval=10"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|Path
argument_list|(
literal|"file:///tmp/test/test-camel-sequence-write-file3/"
operator|+
literal|'/'
operator|+
name|HdfsConstants
