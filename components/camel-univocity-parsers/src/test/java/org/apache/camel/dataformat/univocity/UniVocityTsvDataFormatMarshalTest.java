...
begin_comment
comment|/**  * This class tests the marshalling of {@link org.apache.camel.dataformat.univocity.UniVocityTsvDataFormat}.  */
end_comment

begin_class
DECL|class|UniVocityTsvDataFormatMarshalTest
specifier|public
specifier|final
class|class
name|UniVocityTsvDataFormatMarshalTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|()
decl_stmt|;
comment|// Default writing of TSV
name|tests
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Write a TSV with specific headers
name|tests
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Write a TSV with an advanced configuration
name|tests
operator|.
name|put
argument_list|(
