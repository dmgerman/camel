...
begin_comment
comment|/**  * This class tests the unmarshalling of {@link org.apache.camel.dataformat.univocity.UniVocityFixedWidthDataFormat}  * using the Spring DSL.  */
end_comment

begin_class
DECL|class|UniVocityFixedWidthDataFormatUnmarshalSpringTest
specifier|public
specifier|final
class|class
name|UniVocityFixedWidthDataFormatUnmarshalSpringTest
extends|extends
name|CamelSpringTestSupport
block|{
annotation|@
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/dataformat/univocity/UniVocityFixedWidthDataFormatUnmarshalSpringTest.xml"
argument_list|)
return|;
block|}
block|}
