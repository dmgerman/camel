...
begin_comment
comment|/**  * This class tests the marshalling of {@link org.apache.camel.dataformat.univocity.UniVocityCsvDataFormat} using the  * Spring DSL.  */
end_comment

begin_class
DECL|class|UniVocityCsvDataFormatMarshalSpringTest
specifier|public
specifier|final
class|class
name|UniVocityCsvDataFormatMarshalSpringTest
extends|extends
name|CamelSpringTestSupport
block|{
annotation|@
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/dataformat/univocity/UniVocityCsvDataFormatMarshalSpringTest.xml"
argument_list|)
return|;
block|}
block|}
