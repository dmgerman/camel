...
name|warn
argument_list|(
literal|"A Quartz job is already started. Cannot apply the 'startDelayedSeconds' configuration!"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
argument_list|)
expr_stmt|;
comment|// enrich job data map with trigger information
if|if
condition|(
name|cron
operator|!=
...
return|;
block|}
DECL|method|encodeCronExpression (String path)
specifier|private
specifier|static
name|String
name|encodeCronExpression
...
argument_list|)
expr_stmt|;
comment|// fast forward start time to now, as we do not want any misfire to kick in
name|trigger
operator|.
name|setStartTime
argument_list|(
...
name|debug
argument_list|(
literal|"Trigger: {}/{} already exists and will be resumed by Quartz."
argument_list|,
name|trigger
operator|.
name|getGroup
...
name|debug
argument_list|(
literal|"Trigger: {}/{} already exists and is already scheduled by clustered JobStore."
argument_list|,
name|trigger
operator|.
name|getGroup
...
name|debug
argument_list|(
literal|"Using SchedulerFactory {} to get/create Scheduler {}({})"
argument_list|,
operator|new
name|Object
index|[]
...
argument_list|)
expr_stmt|;
comment|// store Camel job counter
name|AtomicInteger
name|number
init|=
operator|(
...
return|;
block|}
DECL|method|decrementJobCounter (Scheduler scheduler)
specifier|private
specifier|static
name|void
name|decrementJobCounter
...
block|}
block|}
DECL|method|incrementJobCounter (Scheduler scheduler)
specifier|private
specifier|static
name|void
name|incrementJobCounter
