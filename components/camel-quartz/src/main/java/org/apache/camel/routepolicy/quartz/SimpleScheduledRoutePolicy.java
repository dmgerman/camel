...
decl_stmt|;
DECL|method|SimpleScheduledRoutePolicy ()
specifier|public
name|SimpleScheduledRoutePolicy
parameter_list|()
block|{
...
expr_stmt|;
block|}
DECL|method|SimpleScheduledRoutePolicy (String propertiesFile)
specifier|public
name|SimpleScheduledRoutePolicy
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|SimpleScheduledRoutePolicy (Properties properties)
specifier|public
name|SimpleScheduledRoutePolicy
parameter_list|(
name|Properties
