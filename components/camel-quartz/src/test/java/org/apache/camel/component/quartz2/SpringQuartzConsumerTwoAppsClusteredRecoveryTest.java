...
begin_class
DECL|class|SpringQuartzConsumerTwoAppsClusteredRecoveryTest
specifier|public
class|class
name|SpringQuartzConsumerTwoAppsClusteredRecoveryTest
extends|extends
name|TestSupport
block|{
annotation|@
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/quartz2/SpringQuartzConsumerRecoveryClusteredAppTwo.xml"
argument_list|)
decl_stmt|;
name|app2
operator|.
...
name|Exception
block|{
comment|// shutdown the application context;
operator|(
operator|(
name|AbstractXmlApplicationContext
operator|)
