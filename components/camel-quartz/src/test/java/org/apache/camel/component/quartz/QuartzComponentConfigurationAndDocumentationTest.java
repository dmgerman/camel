...
begin_class
DECL|class|QuartzComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|QuartzComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
operator|+
literal|"&stateful=true&deleteJob=false"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|contains
argument_list|(
literal|"\"groupName\": { \"kind\": \"path\", \"type\": \"string\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"stateful\": { \"kind\": \"parameter\", \"type\": \"boolean\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"deleteJob\": { \"kind\": \"parameter\", \"type\": \"boolean\""
argument_list|)
argument_list|)
expr_stmt|;
block|}
