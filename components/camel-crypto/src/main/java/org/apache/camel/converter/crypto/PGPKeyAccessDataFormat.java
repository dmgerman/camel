...
decl_stmt|;
comment|/**      * During encryption the number of asymmectirc encryption keys is set to      * this header parameter. The Value is of type Integer.      */
...
argument_list|()
decl_stmt|;
comment|// enable streaming via OutputStreamCache
name|CachedOutputStream
name|cos
decl_stmt|;
name|ByteArrayOutputStream
...
name|IllegalArgumentException
argument_list|(
literal|"No public key found fitting to the signature key Id; cannot verify the signature"
argument_list|)
throw|;
block|}
block|}
DECL|method|isAllowedVerifyingKey (List<String> allowedUserIds, PGPPublicKey verifyingPublicKey)
specifier|public
name|boolean
name|isAllowedVerifyingKey
parameter_list|(
...
name|debug
argument_list|(
literal|"Public key with  user ID {} fulfills the User ID restriction {}. Therefore this key will be used for the signature verification. "
argument_list|,
name|keyUserId
argument_list|,
name|allowedUserIds
...
name|warn
argument_list|(
literal|"Public key with User ID {} does not fulfill the User ID restriction {}. Therefore this key will not be used for the signature verification."
argument_list|,
name|keyUserId
argument_list|,
name|allowedUserIds
