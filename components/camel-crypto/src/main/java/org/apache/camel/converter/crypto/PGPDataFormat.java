...
argument_list|)
decl_stmt|;
comment|//TODO why do we need a byte array input stream? --> streaming not possible?
name|InputStream
name|byteStream
init|=
operator|new
...
argument_list|()
decl_stmt|;
comment|//TODO we should enable streaming here with CashedOutputStream!!
name|byte
index|[]
name|answer
decl_stmt|;
