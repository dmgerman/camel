...
literal|"unchecked"
argument_list|)
DECL|method|findPublicKeys (List<String> userids, boolean forEncryption, PGPPublicKeyRingCollection pgpPublicKeyringCollection)
specifier|public
specifier|static
name|List
argument_list|<
...
name|debug
argument_list|(
literal|"Public encryption key with key user ID {} and key ID {} found for specified user ID part {}"
argument_list|,
operator|new
name|Object
index|[]
...
name|debug
argument_list|(
literal|"Public key with key user ID {} and key ID {} found for specified user ID part {}"
argument_list|,
operator|new
name|Object
index|[]
...
literal|"unchecked"
argument_list|)
DECL|method|getUserIds (PGPPublicKeyRing keyRing)
specifier|private
specifier|static
name|Set
argument_list|<
...
return|;
block|}
comment|// Within a secret keyring, the master / primary key has the user ID(s); the subkeys don't
comment|// have user IDs associated directly to them, but the subkeys are implicitly associated with
comment|// the user IDs of the master / primary key. The master / primary key is the first key in
comment|// the keyring, and the rest of the keys are subkeys.
comment|// http://bouncy-castle.1462172.n4.nabble.com/How-to-find-PGP-subkeys-td1465289.html
...
literal|"unchecked"
argument_list|)
DECL|method|getUserIds (PGPSecretKeyRing keyRing)
specifier|private
specifier|static
name|Set
argument_list|<
...
name|debug
argument_list|(
literal|"Private key with key user ID {} and key ID {} found for specified user ID part {}"
argument_list|,
operator|new
name|Object
index|[]
