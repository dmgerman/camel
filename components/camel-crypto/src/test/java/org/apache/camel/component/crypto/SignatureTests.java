...
name|to
argument_list|(
literal|"sign://basic?privateKey=myPrivateKey"
argument_list|,
literal|"verify://basic?publicKey=myPublicKey"
argument_list|,
literal|"mock:result"
argument_list|)
expr_stmt|;
...
name|getEndpoint
argument_list|(
literal|"sign://rsa?algorithm=MD5withRSA"
argument_list|,
...
name|getEndpoint
argument_list|(
literal|"verify://rsa?algorithm=MD5withRSA"
argument_list|,
name|DigitalSignatureEndpoint
operator|.
name|class
...
name|to
argument_list|(
literal|"sign://buffer?privateKey=myPrivateKey&buffersize=1024"
argument_list|,
literal|"verify://buffer?publicKey=myPublicKey&buffersize=1024"
argument_list|,
literal|"mock:result"
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"sign://provider?privateKey=myPrivateKey&provider=SUN"
argument_list|,
literal|"verify://provider?publicKey=myPublicKey&provider=SUN"
argument_list|,
literal|"mock:result"
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"sign://withcert?privateKey=myPrivateKey"
argument_list|,
literal|"verify://withcert?certificate=myCert"
argument_list|,
literal|"mock:result"
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"sign://keystore?keystore=keystore&alias=bob&password=letmein"
argument_list|,
literal|"verify://keystore?keystore=keystore&alias=bob"
argument_list|,
literal|"mock:result"
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"sign://another?privateKey=myPrivateKey&signatureHeader=AnotherDigitalSignature"
argument_list|,
literal|"verify://another?publicKey=myPublicKey&signatureHeader=AnotherDigitalSignature"
argument_list|,
literal|"mock:result"
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"sign://another?privateKey=myPrivateKey&secureRandom=someRandom"
argument_list|,
literal|"verify://another?publicKey=myPublicKey&secureRandom=someRandom"
argument_list|,
literal|"mock:result"
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"sign://alias?keystore=keystore"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
name|to
argument_list|(
literal|"verify://alias?keystore=keystore"
argument_list|,
literal|"mock:result"
argument_list|)
expr_stmt|;
