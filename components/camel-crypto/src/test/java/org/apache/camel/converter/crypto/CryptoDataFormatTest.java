...
annotation|@
name|Test
DECL|method|testAES128GCMSymmetric ()
specifier|public
name|void
name|testAES128GCMSymmetric
parameter_list|()
throws|throws
name|Exception
block|{
...
name|doRoundTripEncryptionTests
argument_list|(
literal|"direct:aes-gcm-encryption"
argument_list|)
expr_stmt|;
block|}
block|}
annotation|@
name|Test
DECL|method|testNoAlgorithm ()
specifier|public
name|void
name|testNoAlgorithm
parameter_list|()
throws|throws
name|Exception
block|{
...
name|doRoundTripEncryptionTests
argument_list|(
literal|"direct:no-algorithm"
argument_list|)
expr_stmt|;
name|fail
argument_list|(
literal|"Failure expected on no algorithm specified"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|)
expr_stmt|;
comment|// cryptoFormat.setAlgorithm("DES/CBC/PKCS5Padding");
name|from
argument_list|(
literal|"direct:no-algorithm"
argument_list|)
