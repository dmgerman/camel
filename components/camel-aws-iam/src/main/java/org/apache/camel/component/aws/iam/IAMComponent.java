...
expr_stmt|;
block|}
DECL|method|IAMComponent (CamelContext context)
specifier|public
name|IAMComponent
parameter_list|(
name|CamelContext
...
argument_list|(
operator|new
name|IAMComponentVerifierExtension
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
argument_list|(
literal|"Amazon IAM client or accessKey and secretKey must be specified"
argument_list|)
throw|;
block|}
name|IAMEndpoint
...
expr_stmt|;
block|}
DECL|method|checkAndSetRegistryClient (IAMConfiguration configuration)
specifier|private
name|void
name|checkAndSetRegistryClient
parameter_list|(
