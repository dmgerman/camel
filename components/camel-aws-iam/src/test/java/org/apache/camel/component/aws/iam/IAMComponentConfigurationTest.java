...
begin_class
DECL|class|IAMComponentConfigurationTest
specifier|public
class|class
name|IAMComponentConfigurationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|createEndpoint
argument_list|(
literal|"aws-iam://label?accessKey=xxxxxx&secretKey=yyyyy&region=US_EAST_1"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|createEndpoint
argument_list|(
literal|"aws-iam://label?accessKey=xxxxxx&secretKey=yyyyy&region=US_EAST_1&proxyHost=localhost&proxyPort=9000&proxyProtocol=HTTP"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
