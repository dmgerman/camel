...
begin_comment
comment|/**  * A<a href="http://camel.apache.org/type-coverter.html">Type Converter</a>  * of XMLBeans objects  *  * @version $Revision$  */
end_comment
...
annotation|@
name|Converter
DECL|method|toXmlObject (GenericFile<File> value)
specifier|public
specifier|static
name|XmlObject
name|toXmlObject
