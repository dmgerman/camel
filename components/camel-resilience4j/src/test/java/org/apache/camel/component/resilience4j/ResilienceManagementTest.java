...
begin_class
DECL|class|ResilienceManagementTest
specifier|public
class|class
name|ResilienceManagementTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|on
argument_list|,
literal|"CircuitBreakerMinimumNumberOfCalls"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|on
argument_list|,
literal|"NumberOfSuccessfulCalls"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
