...
begin_comment
comment|/**  * Resilience using timeout and fallback with Java DSL  */
end_comment

begin_class
DECL|class|ResilienceTimeoutWithFallbackTest
specifier|public
class|class
name|ResilienceTimeoutWithFallbackTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|log
argument_list|(
literal|"Resilience fallback start: ${threadName}"
argument_list|)
operator|.
name|transform
argument_list|()
...
name|log
argument_list|(
literal|"Resilience fallback end: ${threadName}"
argument_list|)
operator|.
name|end
argument_list|()
