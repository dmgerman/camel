...
begin_comment
comment|/**  * The aws-mq is used for managing Amazon MQ instances.  */
end_comment
...
name|configuration
decl_stmt|;
DECL|method|MQEndpoint (String uri, Component component, MQConfiguration configuration)
specifier|public
name|MQEndpoint
parameter_list|(
name|String
