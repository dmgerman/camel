...
begin_class
DECL|class|YammerMessagesConsumerOptionTest
specifier|public
class|class
name|YammerMessagesConsumerOptionTest
extends|extends
...
operator|+
literal|"messages.json?limit=1&older_than=130&newer_than=127&threaded=true"
argument_list|,
name|yammerComponent
operator|.
name|getConfig
