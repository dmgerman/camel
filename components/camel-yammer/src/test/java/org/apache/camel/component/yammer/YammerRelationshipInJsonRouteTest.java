...
begin_class
DECL|class|YammerRelationshipInJsonRouteTest
specifier|public
class|class
name|YammerRelationshipInJsonRouteTest
extends|extends
...
name|from
argument_list|(
literal|"yammer:relationships?consumerKey=aConsumerKey&consumerSecret=aConsumerSecretKey&accessToken=aAccessToken&useJson=true"
argument_list|)
operator|.
name|to
argument_list|(
