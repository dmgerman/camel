...
begin_class
DECL|class|YammerMessageProducerRouteTest
specifier|public
class|class
name|YammerMessageProducerRouteTest
extends|extends
name|YammerComponentTestSupport
block|{
annotation|@
name|Test
DECL|method|testCreateMessage ()
specifier|public
name|void
...
expr_stmt|;
name|String
name|messageBodyToCreate
init|=
literal|"Hi from Camel!"
decl_stmt|;
name|template
operator|.
name|sendBody
