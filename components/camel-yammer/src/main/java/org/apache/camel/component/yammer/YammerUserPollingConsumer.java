...
begin_comment
comment|/**  * A Yammer consumer that periodically polls messages from Yammer's user API.  */
end_comment

begin_class
DECL|class|YammerUserPollingConsumer
specifier|public
class|class
...
name|apiUrl
decl_stmt|;
DECL|method|YammerUserPollingConsumer (YammerEndpoint endpoint, Processor processor)
specifier|public
name|YammerUserPollingConsumer
parameter_list|(
name|YammerEndpoint
...
name|format
argument_list|(
literal|"%s is not a valid Yammer user function type."
argument_list|,
name|function
argument_list|)
argument_list|)
