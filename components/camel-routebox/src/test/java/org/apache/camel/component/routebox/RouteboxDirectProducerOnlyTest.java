...
begin_class
DECL|class|RouteboxDirectProducerOnlyTest
specifier|public
class|class
name|RouteboxDirectProducerOnlyTest
extends|extends
name|RouteboxDemoTestSupport
block|{
DECL|field|LOG
...
name|routeboxUri
init|=
literal|"routebox:multipleRoutes?sendToConsumer=false&innerContext=#ctx&dispatchStrategy=#strategy"
decl_stmt|;
annotation|@
name|Override
...
annotation|@
name|Test
DECL|method|testRouteboxDirectProducerOnlyRequests ()
specifier|public
name|void
name|testRouteboxDirectProducerOnlyRequests
parameter_list|()
throws|throws
name|Exception
block|{
...
name|debug
argument_list|(
literal|"Beginning Test ---> testRouteboxDirectSyncRequests()"
argument_list|)
expr_stmt|;
name|Book
name|book
...
name|debug
argument_list|(
literal|"Completed Test ---> testRouteboxDirectSyncRequests()"
argument_list|)
expr_stmt|;
name|context
operator|.
