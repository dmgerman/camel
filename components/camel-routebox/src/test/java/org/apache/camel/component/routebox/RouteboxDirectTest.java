...
begin_class
DECL|class|RouteboxDirectTest
specifier|public
class|class
name|RouteboxDirectTest
extends|extends
name|RouteboxDemoTestSupport
block|{
DECL|field|LOG
...
name|routeboxUri
init|=
literal|"routebox:multipleRoutes?innerContext=#ctx&dispatchStrategy=#strategy"
decl_stmt|;
annotation|@
name|Override
...
annotation|@
name|Test
DECL|method|testRouteboxDirectAsyncRequests ()
specifier|public
name|void
name|testRouteboxDirectAsyncRequests
parameter_list|()
throws|throws
name|Exception
block|{
