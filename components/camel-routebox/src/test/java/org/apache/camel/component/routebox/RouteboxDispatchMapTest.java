...
begin_class
DECL|class|RouteboxDispatchMapTest
specifier|public
class|class
name|RouteboxDispatchMapTest
extends|extends
name|RouteboxDemoTestSupport
block|{
DECL|field|LOG
...
name|routeboxUri
init|=
literal|"routebox:multipleRoutes?innerRegistry=#registry&routeBuilders=#routes&dispatchMap=#map"
decl_stmt|;
annotation|@
name|Override
...
annotation|@
name|Test
DECL|method|testRouteboxUsingDispatchMap ()
specifier|public
name|void
name|testRouteboxUsingDispatchMap
parameter_list|()
throws|throws
name|Exception
block|{
