...
begin_comment
comment|/**  * @version $Revision: 955924 $  */
end_comment

begin_class
DECL|class|RouteboxSedaProducer
specifier|public
class|class
...
name|timeout
decl_stmt|;
DECL|method|RouteboxSedaProducer (RouteboxSedaEndpoint endpoint, BlockingQueue<Exchange> queue, WaitForTaskToComplete waitForTaskToComplete, long timeout)
specifier|public
name|RouteboxSedaProducer
parameter_list|(
name|RouteboxSedaEndpoint
