...
argument_list|)
decl_stmt|;
DECL|field|TOKENIZED_FIELD_TYPE
specifier|private
specifier|static
specifier|final
name|FieldType
name|TOKENIZED_FIELD_TYPE
init|=
...
argument_list|)
decl_stmt|;
DECL|field|NON_TOKENIZED_FIELD_TYPE
specifier|private
specifier|static
specifier|final
name|FieldType
name|NON_TOKENIZED_FIELD_TYPE
init|=
name|createFieldType
argument_list|(
literal|false
...
expr_stmt|;
block|}
DECL|method|createFieldType (boolean tokenized)
specifier|private
specifier|static
name|FieldType
name|createFieldType
...
argument_list|)
expr_stmt|;
comment|// freeze the answer so that it becomes immutable
name|answer
operator|.
name|freeze
argument_list|()
