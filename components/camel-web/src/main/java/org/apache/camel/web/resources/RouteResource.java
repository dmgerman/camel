...
name|LANGUAGE_XML
decl_stmt|;
comment|// the route configuration: when language is Xml, the routeDefinition is
comment|// null; when language is Groovy/Scala/Ruby, the routeDefinition contains
comment|// the route definition class. It must be initialized because RouteResource
...
argument_list|)
expr_stmt|;
comment|// lets install the updated routes
name|camelContext
operator|.
name|addRoutes
argument_list|(
