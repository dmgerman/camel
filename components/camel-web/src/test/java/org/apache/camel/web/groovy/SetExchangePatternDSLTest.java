...
begin_class
DECL|class|SetExchangePatternDSLTest
specifier|public
class|class
name|SetExchangePatternDSLTest
extends|extends
...
name|dsl
init|=
literal|"from(\"direct:start\").inOut(\"mock:result\")"
decl_stmt|;
name|assertEquals
argument_list|(
name|dsl
...
name|dsl
init|=
literal|"from(\"direct:start\").setExchangePattern(ExchangePattern.InOnly).to(\"mock:result\")"
decl_stmt|;
name|assertEquals
argument_list|(
name|dsl
