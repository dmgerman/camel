...
argument_list|)
expr_stmt|;
comment|// search for @Link-ed fields and add them to the model
for|for
control|(
name|Field
name|field
...
block|}
block|}
comment|/**      * Concatenate "the rest of the line" as the last record. Works similar as if quoted      *      * @param result    input result set      * @param maxpos    position of maximum record      * @param separator csv separator char      * @return List<String> with concatenated last record      */
DECL|method|autospanLine (final List<String> result, final int maxpos, final String separator)
specifier|private
specifier|static
name|List
argument_list|<
