...
argument_list|)
decl_stmt|;
comment|// If a DataField can be skipped, it needs to check whether it is in dataFields keyset
if|if
condition|(
name|isSkipField
argument_list|()
...
block|}
block|}
DECL|method|setDataFieldValue (CamelContext camelContext, Map<String, Object> model, int line, int pos, int counterMandatoryFields, String data, DataField dataField)
specifier|private
name|int
name|setDataFieldValue
parameter_list|(
