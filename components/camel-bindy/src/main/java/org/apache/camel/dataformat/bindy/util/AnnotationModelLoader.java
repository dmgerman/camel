...
name|resolver
decl_stmt|;
comment|//private PackageScanFilter filter;
...
expr_stmt|;
block|}
comment|/*     public AnnotationModelLoader(PackageScanClassResolver resolver, PackageScanFilter filter) {         this(resolver);         this.filter = filter;     }     */
