...
comment|// noop
block|}
DECL|method|bind (CamelContext camelContext, String record, Map<String, Object> model, int line)
specifier|public
name|void
name|bind
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// this iterator is for a link list that was built using items in order
while|while
condition|(
name|itr
operator|.
...
argument_list|(
literal|"Either length or delimiter must be specified for the field : "
operator|+
name|dataField
operator|.
name|toString
...
argument_list|)
expr_stmt|;
comment|// include the delimiter in the offset calculation
name|offset
operator|+=
name|token
operator|.
...
block|{
comment|// defined as a zero-length field
name|token
operator|=
literal|""
expr_stmt|;
...
expr_stmt|;
block|}
comment|// check for unmapped non-whitespace data at the end of the line
if|if
condition|(
name|offset
operator|<=
...
name|IllegalArgumentException
argument_list|(
literal|"Unexpected / unmapped characters found at the end of the fixed-length record at line : "
operator|+
name|line
argument_list|)
throw|;
...
block|}
block|}
DECL|method|trim (String token, DataField dataField, char paddingChar)
specifier|private
name|String
name|trim
parameter_list|(
...
block|}
block|}
DECL|method|rightTrim (String token, char myPaddingChar)
specifier|private
name|String
name|rightTrim
parameter_list|(
...
return|;
block|}
DECL|method|leftTrim (String token, char myPaddingChar)
specifier|private
name|String
name|leftTrim
parameter_list|(
...
name|IllegalArgumentException
argument_list|(
literal|"Either a delimiter value or length for the field: "
operator|+
name|field
operator|.
name|getName
...
argument_list|()
operator|+
literal|" must be equal to R for RIGHT or L for LEFT or B for trimming both ends"
argument_list|)
throw|;
block|}
name|result
...
argument_list|)
expr_stmt|;
comment|// Get skipHeader parameter
name|skipHeader
operator|=
name|record
operator|.
...
argument_list|)
expr_stmt|;
comment|// Get skipFooter parameter
name|skipFooter
operator|=
name|record
operator|.
...
name|debug
argument_list|(
literal|"Enable ignore missing chars: {}"
argument_list|,
name|ignoreMissingChars
argument_list|)
expr_stmt|;
...
name|IllegalArgumentException
argument_list|(
literal|"Record can not be configured with both 'isHeader=true' and 'hasHeader=true'"
argument_list|)
throw|;
block|}
if|if
...
name|IllegalArgumentException
argument_list|(
literal|"Record can not be configured with both 'isFooter=true' and 'hasFooter=true'"
argument_list|)
throw|;
block|}
if|if
...
name|IllegalArgumentException
argument_list|(
literal|"skipHeader and/or skipFooter can not be configured on a record where 'isHeader=true' or 'isFooter=true'"
argument_list|)
throw|;
block|}
block|}
...
return|;
block|}
comment|/**      * Flag indicating whether to skip the header parsing      */
...
return|;
block|}
comment|/**      * Flag indicating whether to skip the footer processing      */
...
return|;
block|}
comment|/**      * Flag indicating whether this factory is for a header      */
...
return|;
block|}
comment|/**      * Flag indicating whether this factory is for a footer      */
...
return|;
block|}
comment|/**      *  Expected fixed length of the record      */
...
return|;
block|}
comment|/**      * Flag indicating whether too short lines are ignored      */
DECL|method|isIgnoreMissingChars ()
specifier|public
name|boolean
