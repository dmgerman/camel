...
argument_list|)
decl_stmt|;
comment|/**         Exception cause = exch.getProperty(Exchange.EXCEPTION_CAUGHT, IllegalArgumentException.class);         TestSupport.assertIsInstanceOf(IllegalArgumentException.class, cause.getCause());          assertEquals("@Section and/or @KeyValuePairDataField have not been defined !", cause.getMessage());         **/
block|}
...
name|BindyKeyValuePairDataFormat
argument_list|(
literal|"org.apache.camel.dataformat.bindy.model.fix.withoutsection"
argument_list|)
decl_stmt|;
