...
begin_class
DECL|class|BindySimpleFixedLengthHeaderFooterTest
specifier|public
class|class
name|BindySimpleFixedLengthHeaderFooterTest
extends|extends
name|CamelTestSupport
block|{
...
expr_stmt|;
block|}
comment|/**      * Verifies that header& footer provided as part of message body are marshalled successfully      */
annotation|@
name|Test
DECL|method|testMarshallMessageWithDirectHeaderAndFooterInput ()
specifier|public
name|void
name|testMarshallMessageWithDirectHeaderAndFooterInput
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Verifies that header& footer provided via message headers are marshalled successfully      */
annotation|@
name|Test
DECL|method|testMarshallMessageWithIndirectHeaderAndFooterInput ()
specifier|public
name|void
name|testMarshallMessageWithIndirectHeaderAndFooterInput
parameter_list|()
throws|throws
name|Exception
block|{
