...
begin_package
DECL|package|org.apache.camel.dataformat.bindy.fixed.delimited
package|package
name|org
operator|.
name|apache
...
begin_comment
comment|/**  * This test validates the marshalling / unmarshalling of delimited, variable-length fields within a 'fixed-length' record.   */
end_comment

begin_class
DECL|class|BindyFixedLengthDelimitedFieldTest
specifier|public
class|class
name|BindyFixedLengthDelimitedFieldTest
extends|extends
name|CamelTestSupport
block|{
...
name|TEST_RECORD
init|=
literal|"10A9Pauline^M^ISINXD12345678BUYShare000002500.45USD01-08-2009\r\n"
decl_stmt|;
...
init|=
literal|"10A9Pauline^M^ISINXD12345678BUYShare000002500.45USD01-08-2009xxx\r\n"
decl_stmt|;
DECL|field|TEST_RECORD_WITH_SINGLE_EXTRA_CHAR
specifier|private
specifier|static
specifier|final
name|String
name|TEST_RECORD_WITH_SINGLE_EXTRA_CHAR
init|=
literal|"10A9Pauline^M^ISINXD12345678BUYShare000002500.45USD01-08-2009x\r\n"
decl_stmt|;
DECL|field|TEST_RECORD_WITH_WHITSPACE_THEN_EXTRA_CHAR
specifier|private
specifier|static
specifier|final
name|String
name|TEST_RECORD_WITH_WHITSPACE_THEN_EXTRA_CHAR
init|=
literal|"10A9Pauline^M^ISINXD12345678BUYShare000002500.45USD01-08-2009   x\r\n"
decl_stmt|;
annotation|@
name|EndpointInject
argument_list|(
...
annotation|@
name|Test
DECL|method|testFailWhenUnmarshallMessageWithWhitespaceThenUnmappedChar ()
specifier|public
name|void
name|testFailWhenUnmarshallMessageWithWhitespaceThenUnmappedChar
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testFailWhenUnmarshallMessageWithUnmappedChar ()
specifier|public
name|void
name|testFailWhenUnmarshallMessageWithUnmappedChar
parameter_list|()
throws|throws
name|Exception
block|{
