...
annotation|@
name|ContextConfiguration
DECL|class|BindySingleQuotesWithDoubleQuotesInFieldCsvUnmarshallTest
specifier|public
class|class
name|BindySingleQuotesWithDoubleQuotesInFieldCsvUnmarshallTest
extends|extends
name|AbstractJUnit4SpringContextTests
block|{
...
name|expected
operator|=
literal|"10,A9,'Pauline de \"\"Quotes\"\"','O'Donald',ISIN,XD12345678,BUY,Share,2500.45,USD,08-01-2009"
expr_stmt|;
name|template
operator|.
name|sendBody
