...
begin_class
DECL|class|BindyCsvClassTypeAsStringTest
specifier|public
class|class
name|BindyCsvClassTypeAsStringTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|expected
init|=
literal|"1,B2,Keira,Knightley,ISIN,XX23456789,BUY,Share,400.25,EUR,14-01-2009,11-02-2010 23:21:59\r\n"
decl_stmt|;
...
name|data
init|=
literal|"1,B2,Keira,Knightley,ISIN,XX23456789,BUY,Share,400.25,EUR,14-01-2009,03-02-2010 23:21:59\r\n"
decl_stmt|;
name|getMockEndpoint
argument_list|(
literal|"mock:out"
...
comment|// 03-02-2010 23:21:59 by GMT+4
name|calendar
operator|.
name|set
argument_list|(
...
expr_stmt|;
comment|// 4 hour shift
comment|// 11-02-2010 23:21:59 by GMT+4
name|calendar
operator|.
name|set
argument_list|(
