...
annotation|@
name|ContextConfiguration
DECL|class|BindyComplexCsvUnmarshallEmptyStreamTest
specifier|public
class|class
name|BindyComplexCsvUnmarshallEmptyStreamTest
extends|extends
name|AbstractJUnit4SpringContextTests
block|{
DECL|field|TYPE
...
argument_list|()
expr_stmt|;
comment|// there should be an empty list and no exception should be thrown
name|List
name|list
init|=
name|resultEndpoint
