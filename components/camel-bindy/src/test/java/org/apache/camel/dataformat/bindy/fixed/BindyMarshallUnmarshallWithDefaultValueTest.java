...
begin_class
DECL|class|BindyMarshallUnmarshallWithDefaultValueTest
specifier|public
class|class
name|BindyMarshallUnmarshallWithDefaultValueTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|,
literal|"10A9              ISINXD12345678BUYShare000002500.45USD01-08-2009Hello     "
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Default values are set
name|Assert
operator|.
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|testUnMarshallMessageWithEol ()
specifier|public
name|void
name|testUnMarshallMessageWithEol
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getMockEndpoint
argument_list|(
literal|"mock:resultUnmarshalEol"
argument_list|)
decl_stmt|;
name|template
operator|.
name|sendBody
argument_list|(
literal|"direct:unmarshaleol"
argument_list|,
literal|"10A9              ISINXD12345678BUYShare000002500.45USD01-08-2009Hello     QWERTY"
argument_list|)
expr_stmt|;
comment|// check the model
name|OrderEol
...
argument_list|(
literal|"10A9     JohnDoe  ISINXD12345678BUYShare000002500.45USD01-08-2009          \r\n"
argument_list|)
expr_stmt|;
name|template
operator|.
...
annotation|@
name|Test
DECL|method|testMarshallMessageWithEol ()
specifier|public
name|void
name|testMarshallMessageWithEol
parameter_list|()
throws|throws
name|Exception
block|{
