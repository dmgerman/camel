...
name|locations
operator|=
literal|"org.apache.camel.dataformat.bindy.csv.BindySimpleCsvGenerateHeaderMarshallTest$ContextConfig"
argument_list|,
name|loader
operator|=
name|JavaConfigContextLoader
...
name|class
argument_list|)
DECL|class|BindySimpleCsvGenerateHeaderMarshallTest
specifier|public
class|class
name|BindySimpleCsvGenerateHeaderMarshallTest
extends|extends
name|AbstractJUnit4SpringContextTests
block|{
DECL|field|models
...
name|BindyCsvDataFormat
argument_list|(
literal|"org.apache.camel.dataformat.bindy.model.simple.oneclassgenerateheader"
argument_list|)
decl_stmt|;
annotation|@
name|Override
