...
begin_class
DECL|class|BindySimpleFixedLengthMarshallWithNoClipTest
specifier|public
class|class
name|BindySimpleFixedLengthMarshallWithNoClipTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|models
...
name|assertEquals
argument_list|(
literal|"Length for the firstName must not be larger than allowed, was: 13, allowed: 9"
argument_list|,
name|cause
operator|.
name|getMessage
