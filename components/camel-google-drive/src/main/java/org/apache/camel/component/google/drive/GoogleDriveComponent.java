...
return|;
block|}
comment|/**      * Client ID of the drive application      * @param clientId      */
...
return|;
block|}
comment|/**      * Client secret of the drive application      * @param clientSecret      */
...
return|;
block|}
comment|/**      * Google drive application name. Example would be "camel-google-drive/1.0"      * @param applicationName      */
...
return|;
block|}
comment|/**      * Specifies the level of permissions you want a drive application to have to a user account. See https://developers.google.com/drive/web/scopes for more info.      * @param scopes      */
