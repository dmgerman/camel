...
begin_comment
comment|/**  * Test class for com.google.api.services.drive.Drive$Children APIs.  * TODO Move the file to src/test/java, populate parameter values, and remove @Ignore annotations.  * The class source won't be generated again if the generator MOJO finds it under src/test/java.  */
end_comment
