...
begin_class
DECL|class|DriveConfigurationTest
specifier|public
class|class
name|DriveConfigurationTest
extends|extends
...
name|PATH_PREFIX
operator|+
literal|"/copy?clientId=a&clientSecret=b&applicationName=c&accessToken=d&refreshToken=e"
decl_stmt|;
annotation|@
name|Override
...
argument_list|)
decl_stmt|;
comment|// add GoogleDriveComponent to Camel context but don't set up configuration
specifier|final
