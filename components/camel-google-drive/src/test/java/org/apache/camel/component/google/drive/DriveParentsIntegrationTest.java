...
name|internal
operator|.
name|DriveParentsApiMethod
import|;
end_import

begin_comment
comment|/**  * Test class for com.google.api.services.drive.Drive$Parents APIs.  * TODO Move the file to src/test/java, populate parameter values, and remove @Ignore annotations.  * The class source won't be generated again if the generator MOJO finds it under src/test/java.  */
end_comment

begin_class
DECL|class|DriveParentsIntegrationTest
specifier|public
class|class
name|DriveParentsIntegrationTest
extends|extends
...
name|put
argument_list|(
literal|"CamelGoogleDrive.parentId"
argument_list|,
literal|null
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// parameter type is com.google.api.services.drive.model.ParentReference
name|headers
operator|.
name|put
argument_list|(
