...
begin_class
DECL|class|DriveRepliesIntegrationTest
specifier|public
class|class
name|DriveRepliesIntegrationTest
extends|extends
...
argument_list|)
expr_stmt|;
comment|// parameter type is com.google.api.services.drive.model.CommentReply
name|com
operator|.
name|google
operator|.
...
argument_list|)
expr_stmt|;
comment|// 5. list replies on comment to file
name|headers
operator|=
operator|new
name|HashMap
...
name|to
argument_list|(
literal|"google-drive://drive-comments/insert"
argument_list|)
expr_stmt|;
comment|// test route for list
name|from
...
name|to
argument_list|(
literal|"google-drive://drive-comments/list?inBody=fileId"
argument_list|)
expr_stmt|;
block|}
block|}
