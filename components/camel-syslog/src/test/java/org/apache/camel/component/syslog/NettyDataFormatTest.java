...
begin_class
DECL|class|NettyDataFormatTest
specifier|public
class|class
name|NettyDataFormatTest
extends|extends
name|CamelTestSupport
block|{
...
annotation|@
name|Test
DECL|method|testSendingRawUDPFromNetty ()
specifier|public
name|void
name|testSendingRawUDPFromNetty
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|serverPort
operator|+
literal|"?sync=false&allowDefaultCodec=false&useChannelBuffer=true"
argument_list|,
name|message
argument_list|)
expr_stmt|;
...
name|serverPort
operator|+
literal|"?sync=false&allowDefaultCodec=false"
argument_list|)
operator|.
name|unmarshal
argument_list|(
