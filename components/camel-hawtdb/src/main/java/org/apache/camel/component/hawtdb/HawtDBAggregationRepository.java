...
begin_comment
comment|/**  * An instance of AggregationRepository which is backed by a HawtDB.  *   * @author<a href="http://hiramchirino.com">Hiram Chirino</a>  */
end_comment
...
return|;
block|}
DECL|method|setKeyMarshaller (Marshaller<K> keyMarshaller)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|getExchangeMarshaller ()
specifier|public
name|Marshaller
argument_list|<
name|Exchange
argument_list|>
name|getExchangeMarshaller
parameter_list|()
block|{
return|return
name|exchangeMarshaller
return|;
block|}
DECL|method|setExchangeMarshaller (Marshaller<Exchange> exchangeMarshaller)
specifier|public
name|void
name|setExchangeMarshaller
parameter_list|(
name|Marshaller
argument_list|<
name|Exchange
