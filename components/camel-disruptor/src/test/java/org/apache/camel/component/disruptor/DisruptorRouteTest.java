...
begin_class
DECL|class|DisruptorRouteTest
specifier|public
class|class
name|DisruptorRouteTest
extends|extends
name|TestSupport
block|{
annotation|@
name|Test
DECL|method|testDisruptorQueue ()
specifier|public
name|void
name|testDisruptorQueue
parameter_list|()
throws|throws
name|Exception
block|{
...
name|from
argument_list|(
literal|"disruptor:test.a"
argument_list|)
operator|.
name|to
argument_list|(
literal|"disruptor:test.b"
argument_list|)
expr_stmt|;
name|from
argument_list|(
