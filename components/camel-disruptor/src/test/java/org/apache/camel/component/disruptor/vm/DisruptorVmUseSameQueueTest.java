...
begin_class
DECL|class|DisruptorVmUseSameQueueTest
specifier|public
class|class
name|DisruptorVmUseSameQueueTest
extends|extends
name|AbstractVmTestSupport
block|{
DECL|method|testDisruptorVmUseSameQueue ()
specifier|public
name|void
name|testDisruptorVmUseSameQueue
parameter_list|()
throws|throws
name|Exception
block|{
...
name|from
argument_list|(
literal|"disruptor-vm:foo?size=500"
argument_list|)
operator|.
name|to
argument_list|(
