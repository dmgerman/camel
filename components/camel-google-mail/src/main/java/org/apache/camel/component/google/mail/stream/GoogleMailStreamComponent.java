...
begin_comment
comment|/**  * Represents the component that manages {@link GoogleMailStreamEndpoint}.  */
end_comment
...
argument_list|)
DECL|class|GoogleMailStreamComponent
specifier|public
class|class
...
name|configuration
decl_stmt|;
DECL|method|GoogleMailStreamComponent ()
specifier|public
name|GoogleMailStreamComponent
parameter_list|()
block|{
...
expr_stmt|;
block|}
DECL|method|GoogleMailStreamComponent (CamelContext context)
specifier|public
name|GoogleMailStreamComponent
parameter_list|(
name|CamelContext
...
expr_stmt|;
block|}
DECL|method|getClient (GoogleMailStreamConfiguration googleMailConfiguration)
specifier|public
name|Gmail
name|getClient
parameter_list|(
