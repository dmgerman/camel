...
name|info
argument_list|(
literal|"Configuring DozerBeanContainer and DozerBeanMapper"
argument_list|)
expr_stmt|;
comment|// must setup dozer to be able to load the EL factory we are using which is from glashfish
name|ClassLoader
name|oldCl
init|=
name|Thread
...
argument_list|(
literal|"Error configuring DozerBeanContainer/DozerBeanMapper due "
operator|+
name|e
operator|.
name|getMessage
...
expr_stmt|;
block|}
comment|// configure mapper as well
if|if
condition|(
name|mapper
operator|==
