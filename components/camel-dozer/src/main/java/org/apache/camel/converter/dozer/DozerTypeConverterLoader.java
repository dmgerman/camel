...
name|info
argument_list|(
literal|"Current Dozer container-wide classloader: {}."
argument_list|,
name|oldCl
argument_list|)
expr_stmt|;
comment|// if the classloader we're replacing is not a ThreadContextClassLoader, pass it on as delegate target
comment|// otherwise, don't do anything as we have
if|if
condition|(
operator|!
operator|(
...
name|info
argument_list|(
literal|"Switched Dozer container-wide classloader from: {} to {} (where the latter delegates to former)."
argument_list|,
name|oldCl
argument_list|,
name|newCl
...
name|info
argument_list|(
literal|"Dozer container-wide classloader already set: {}. No switch necessary."
argument_list|,
name|oldCl
argument_list|)
expr_stmt|;
