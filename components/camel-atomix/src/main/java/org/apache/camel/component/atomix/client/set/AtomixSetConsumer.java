...
begin_class
DECL|class|AtomixSetConsumer
specifier|public
specifier|final
class|class
name|AtomixSetConsumer
extends|extends
name|AbstractAtomixClientConsumer
argument_list|<
...
name|set
decl_stmt|;
DECL|method|AtomixSetConsumer (AtomixSetEndpoint endpoint, Processor processor, String resourceName)
specifier|public
name|AtomixSetConsumer
parameter_list|(
name|AtomixSetEndpoint
...
name|debug
argument_list|(
literal|"Subscribe to events for set: {}"
argument_list|,
name|resourceName
argument_list|)
expr_stmt|;
...
comment|// ********************************************
DECL|method|onEvent (DistributedSet.ValueEvent<Object> event)
specifier|private
name|void
name|onEvent
parameter_list|(
