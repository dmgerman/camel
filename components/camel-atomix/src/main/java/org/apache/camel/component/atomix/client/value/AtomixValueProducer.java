...
begin_class
DECL|class|AtomixValueProducer
specifier|final
class|class
...
name|configuration
decl_stmt|;
DECL|method|AtomixValueProducer (AtomixValueEndpoint endpoint)
specifier|protected
name|AtomixValueProducer
parameter_list|(
name|AtomixValueEndpoint
...
literal|"SET"
argument_list|)
DECL|method|onSet (Message message, AsyncCallback callback)
name|boolean
name|onSet
parameter_list|(
name|Message
...
literal|"GET_AND_SET"
argument_list|)
DECL|method|onGetAndSet (Message message, AsyncCallback callback)
name|boolean
name|onGetAndSet
parameter_list|(
name|Message
...
name|InvokeOnHeader
argument_list|(
literal|"COMPARE_AND_SET"
argument_list|)
DECL|method|onCompareAndSet (Message message, AsyncCallback callback)
name|boolean
name|onCompareAndSet
parameter_list|(
name|Message
name|message
parameter_list|,
