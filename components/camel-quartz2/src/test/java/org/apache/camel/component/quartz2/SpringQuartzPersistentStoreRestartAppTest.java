...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/quartz2/SpringQuartzPersistentStoreRestartTest.xml"
argument_list|)
decl_stmt|;
name|app2
operator|.
...
argument_list|()
expr_stmt|;
comment|// we're done so let's properly close the application contexts
name|app
operator|.
name|close
argument_list|()
