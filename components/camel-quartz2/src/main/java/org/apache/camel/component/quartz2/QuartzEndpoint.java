...
begin_comment
comment|/**  * This endpoint represent each job to be created in scheduler. When consumer is started or stopped, it will  * call back into doConsumerStart()/Stop() to pause/resume the scheduler trigger.  *  * @author Zemian Deng saltnlight5@gmail.com  */
end_comment
