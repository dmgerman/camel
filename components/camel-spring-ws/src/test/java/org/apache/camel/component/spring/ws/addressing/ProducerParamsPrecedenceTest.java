...
begin_class
DECL|class|ProducerParamsPrecedenceTest
specifier|public
class|class
name|ProducerParamsPrecedenceTest
extends|extends
name|CamelSpringTestSupport
block|{
...
name|requestBody
argument_list|(
literal|"direct:wsAddressingAction"
argument_list|,
name|xmlBody
argument_list|)
decl_stmt|;
...
annotation|@
name|Ignore
DECL|method|testWsAddressingActionPrecendence ()
specifier|public
name|void
name|testWsAddressingActionPrecendence
parameter_list|()
throws|throws
name|Exception
block|{
...
name|requestBody
argument_list|(
literal|"direct:precedenceWsAddressingAction"
argument_list|,
name|xmlBody
argument_list|)
decl_stmt|;
...
annotation|@
name|Test
DECL|method|testReplyToPrecedence ()
specifier|public
name|void
name|testReplyToPrecedence
parameter_list|()
throws|throws
name|Exception
block|{
...
name|requestBody
argument_list|(
literal|"direct:precedenceReplyTo"
argument_list|,
name|xmlBody
argument_list|)
expr_stmt|;
...
annotation|@
name|Test
DECL|method|testFaultToPrecedence ()
specifier|public
name|void
name|testFaultToPrecedence
parameter_list|()
throws|throws
name|Exception
block|{
...
name|requestBody
argument_list|(
literal|"direct:precedenceFaultTo"
argument_list|,
name|xmlBody
argument_list|)
expr_stmt|;
...
index|[]
block|{
literal|"org/apache/camel/component/spring/ws/addresing/ProducerParamsPrecedenceTest-context.xml"
block|}
argument_list|)
return|;
block|}
