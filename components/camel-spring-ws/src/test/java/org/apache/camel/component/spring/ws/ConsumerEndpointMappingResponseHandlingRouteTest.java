...
begin_class
DECL|class|ConsumerEndpointMappingResponseHandlingRouteTest
specifier|public
class|class
name|ConsumerEndpointMappingResponseHandlingRouteTest
extends|extends
name|CamelSpringTestSupport
block|{
...
name|sendSourceAndReceiveToResult
argument_list|(
name|getDefaultRequestSource
argument_list|()
argument_list|,
operator|new
name|SoapActionCallback
argument_list|(
literal|"http://www.webserviceX.NET/GetQuote"
argument_list|)
argument_list|,
name|result
argument_list|)
...
name|sendSourceAndReceiveToResult
argument_list|(
literal|"http://localhost:8080/stockquote4/services/test"
argument_list|,
name|getDefaultRequestSource
argument_list|()
argument_list|,
...
name|URI
argument_list|(
literal|"http://action-does-not-matter-here"
argument_list|)
argument_list|,
operator|new
name|Addressing10
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/spring/ws/ConsumerEndpointMappingResponseHandlingRouteTest-context.xml"
argument_list|)
return|;
block|}
DECL|method|getDefaultRequestSource ()
specifier|private
name|Source
name|getDefaultRequestSource
parameter_list|()
