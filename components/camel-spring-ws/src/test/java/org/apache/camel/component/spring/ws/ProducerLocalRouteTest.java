...
annotation|@
name|ContextConfiguration
DECL|class|ProducerLocalRouteTest
specifier|public
class|class
name|ProducerLocalRouteTest
extends|extends
name|AbstractJUnit4SpringContextTests
block|{
...
annotation|@
name|Test
DECL|method|consumeStockQuoteWebserviceInOnly ()
specifier|public
name|void
name|consumeStockQuoteWebserviceInOnly
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|(
literal|"direct:stockQuoteWebserviceInOnly"
argument_list|,
name|xmlRequestForGoogleStockQuote
argument_list|,
literal|"foo"
...
name|assertEquals
argument_list|(
literal|"The header value should have been preserved"
argument_list|,
literal|"bar"
argument_list|,
name|bar
