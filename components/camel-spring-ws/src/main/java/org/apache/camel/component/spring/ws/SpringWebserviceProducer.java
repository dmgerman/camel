...
name|configuration
decl_stmt|;
DECL|method|CamelHttpUrlConnectionMessageSender (SpringWebserviceConfiguration configuration, HttpUrlConnectionMessageSender webServiceMessageSender)
name|CamelHttpUrlConnectionMessageSender
parameter_list|(
name|SpringWebserviceConfiguration
name|configuration
...
name|configuration
expr_stmt|;
comment|// Populate the single acceptGzipEncoding property
...
name|configuration
decl_stmt|;
DECL|method|CamelHttpsUrlConnectionMessageSender (SpringWebserviceConfiguration configuration, final HttpsUrlConnectionMessageSender webServiceMessageSender)
name|CamelHttpsUrlConnectionMessageSender
parameter_list|(
name|SpringWebserviceConfiguration
name|configuration
...
name|configuration
expr_stmt|;
comment|// Populate the single acceptGzipEncoding property beforehand as we have got a proper set/is API for it
name|setAcceptGzipEncoding
argument_list|(
name|webServiceMessageSender
operator|.
