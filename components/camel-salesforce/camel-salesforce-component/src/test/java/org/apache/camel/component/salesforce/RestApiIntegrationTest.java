...
name|Exception
block|{
name|doTestCreateUpdateDeleteTasks
argument_list|(
literal|""
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|doTestCreateUpdateDeleteTasks (String suffix)
specifier|private
name|void
name|doTestCreateUpdateDeleteTasks
parameter_list|(
...
block|{
comment|// reset response content buffer size
block|}
block|}
...
expr_stmt|;
block|}
DECL|method|doTestQueryAll (String suffix)
specifier|private
name|void
name|doTestQueryAll
parameter_list|(
...
name|error
argument_list|(
literal|"Make sure test REST resource MerchandiseRestResource.apxc has been loaded: "
operator|+
name|e
operator|.
name|getMessage
...
block|}
block|}
DECL|method|doTestApexCall (String suffix)
specifier|private
name|void
name|doTestApexCall
parameter_list|(
...
name|merchandise
decl_stmt|;
DECL|method|MerchandiseRequest (Merchandise__c merchandise)
specifier|public
name|MerchandiseRequest
parameter_list|(
name|Merchandise__c
...
return|;
block|}
DECL|method|setMerchandise (Merchandise__c merchandise)
specifier|public
name|void
name|setMerchandise
parameter_list|(
...
literal|"response"
argument_list|)
DECL|class|MerchandiseXmlResponse
specifier|public
specifier|static
class|class
name|MerchandiseXmlResponse
extends|extends
name|Merchandise__c
block|{
...
expr_stmt|;
block|}
DECL|method|doTestStatus300 (String suffix)
specifier|private
name|void
name|doTestStatus300
parameter_list|(
...
name|Exception
block|{
comment|// clone test merchandise with same external Id
if|if
condition|(
name|testId
operator|==
...
expr_stmt|;
block|}
DECL|method|doTestStatus400 (String suffix)
specifier|private
name|void
name|doTestStatus400
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|doTestStatus404 (String suffix)
specifier|private
name|void
name|doTestStatus404
parameter_list|(
...
name|to
argument_list|(
literal|"salesforce:deleteSObject?sObjectName=Tasks__c"
argument_list|)
expr_stmt|;
name|from
argument_list|(
literal|"direct:deleteSObjectTakenXml"
argument_list|)
operator|.
name|to
argument_list|(
literal|"salesforce:deleteSObject?format=XML&sObjectName=Tasks__c"
argument_list|)
expr_stmt|;
...
name|from
argument_list|(
literal|"direct:queryAllXml"
argument_list|)
operator|.
name|to
argument_list|(
literal|"salesforce:queryAll?format=XML&sObjectQuery=SELECT name from Line_Item__c&sObjectClass="
operator|+
name|QueryRecordsLine_Item__c
operator|.
name|class
...
name|to
argument_list|(
literal|"salesforce:apexCall?apexMethod=GET&apexUrl=Merchandise/{id}&sObjectName=Merchandise__c"
argument_list|)
expr_stmt|;
name|from
argument_list|(
literal|"direct:apexCallGetXml"
argument_list|)
operator|.
name|to
argument_list|(
literal|"salesforce:apexCall/Merchandise/{id}?format=XML&apexMethod=GET&sObjectClass="
operator|+
name|MerchandiseXmlResponse
operator|.
name|class
...
name|to
argument_list|(
literal|"salesforce:apexCall/Merchandise/?apexMethod=GET&id=dummyId&sObjectClass="
operator|+
name|Merchandise__c
operator|.
name|class
...
name|from
argument_list|(
literal|"direct:apexCallGetWithIdXml"
argument_list|)
operator|.
name|to
argument_list|(
literal|"salesforce:apexCall?format=XML&apexMethod=GET&apexUrl=Merchandise/&id=dummyId&sObjectClass="
operator|+
name|MerchandiseXmlResponse
operator|.
name|class
...
name|to
argument_list|(
literal|"salesforce:apexCall?apexMethod=PATCH&apexUrl=Merchandise/&sObjectName=Merchandise__c"
argument_list|)
expr_stmt|;
name|from
argument_list|(
literal|"direct:apexCallPatchXml"
argument_list|)
operator|.
name|to
argument_list|(
literal|"salesforce:apexCall/Merchandise/?format=XML&apexMethod=PATCH&sObjectClass="
operator|+
name|MerchandiseXmlResponse
operator|.
name|class
