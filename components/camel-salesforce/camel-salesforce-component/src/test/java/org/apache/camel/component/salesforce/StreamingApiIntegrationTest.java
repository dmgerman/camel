...
name|getMockEndpoint
argument_list|(
literal|"mock:RawPayloadCamelTestTopic"
argument_list|)
decl_stmt|;
name|rawPayloadMock
operator|.
...
argument_list|)
expr_stmt|;
comment|// validate raw payload message
name|rawPayloadMock
operator|.
name|assertIsSatisfied
argument_list|()
...
name|assertTrue
argument_list|(
literal|"Expected String message body for Raw Payload"
argument_list|,
name|inRaw
operator|.
name|getBody
...
name|from
argument_list|(
literal|"salesforce:CamelTestTopic?rawPayload=true&notifyForFields=ALL&"
operator|+
literal|"notifyForOperationCreate=true&notifyForOperationDelete=true&notifyForOperationUpdate=true&"
operator|+
literal|"updateTopic=true&sObjectQuery=SELECT Id, Name FROM Merchandise__c"
