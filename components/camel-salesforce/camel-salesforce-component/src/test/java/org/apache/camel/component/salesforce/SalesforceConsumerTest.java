...
annotation|@
name|Mock
DECL|field|mockChangeEvent
specifier|private
name|Message
name|mockChangeEvent
decl_stmt|;
annotation|@
name|Mock
DECL|field|mockChangeEventPayload
specifier|private
name|Map
argument_list|<
name|String
...
name|Object
argument_list|>
name|mockChangeEventPayload
decl_stmt|;
annotation|@
name|Mock
DECL|field|mockChangeEventData
specifier|private
name|Map
argument_list|<
name|String
...
name|Object
argument_list|>
name|mockChangeEventData
decl_stmt|;
annotation|@
name|Mock
DECL|field|mockChangeEventMap
specifier|private
name|Map
argument_list|<
name|String
...
argument_list|()
expr_stmt|;
name|setupMockChangeEvent
argument_list|()
expr_stmt|;
block|}
DECL|method|setupMockChangeEvent ()
specifier|private
name|void
name|setupMockChangeEvent
parameter_list|()
...
argument_list|,
literal|"com/salesforce/api/rest/45.0"
argument_list|)
expr_stmt|;
name|changeEventHeader
operator|.
...
argument_list|,
literal|"000bc577-90c7-0d33-cebb-971bb50d75b8"
argument_list|)
expr_stmt|;
name|changeEventHeader
operator|.
...
name|thenReturn
argument_list|(
literal|"/data/AccountChangeEvent"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
annotation|@
name|Test
DECL|method|shouldProcessChangeEvents ()
specifier|public
name|void
name|shouldProcessChangeEvents
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|processNoReplayIdChangeEventsShouldNotSetReplayIdHeader ()
specifier|public
name|void
name|processNoReplayIdChangeEventsShouldNotSetReplayIdHeader
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|processRawPayloadChangeEventsShouldSetInputMessageAsBody ()
specifier|public
name|void
name|processRawPayloadChangeEventsShouldSetInputMessageAsBody
parameter_list|()
throws|throws
name|Exception
block|{
