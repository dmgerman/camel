...
name|DefaultConsumer
block|{
DECL|enum|MessageKind
specifier|private
enum|enum
name|MessageKind
block|{
DECL|enumConstant|CHANGE_EVENT
DECL|enumConstant|PLATFORM_EVENT
DECL|enumConstant|PUSH_TOPIC
name|CHANGE_EVENT
block|,
name|PLATFORM_EVENT
block|,
name|PUSH_TOPIC
block|;
DECL|method|fromTopicName (final String topicName)
specifier|public
specifier|static
name|MessageKind
name|fromTopicName
...
name|topicName
decl_stmt|;
DECL|method|SalesforceConsumer (final SalesforceEndpoint endpoint, final Processor processor, final SubscriptionHelper helper)
specifier|public
name|SalesforceConsumer
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
DECL|method|processMessage (final ClientSessionChannel channel, final Message message)
specifier|public
name|void
name|processMessage
parameter_list|(
...
name|debug
argument_list|(
literal|"Received event {} on channel {}"
argument_list|,
name|channel
operator|.
name|getId
...
name|PLATFORM_EVENT
case|:
name|createPlatformEventMessage
argument_list|(
name|message
argument_list|,
name|in
...
literal|"unchecked"
argument_list|)
DECL|method|createChangeEventMessage (final Message message, final org.apache.camel.Message in)
name|void
name|createChangeEventMessage
parameter_list|(
specifier|final
...
name|setHeader
argument_list|(
literal|"CamelSalesforceChangeEventSchema"
argument_list|,
name|data
operator|.
name|get
...
name|setHeader
argument_list|(
literal|"CamelSalesforceChangeOrigin"
argument_list|,
name|changeEventHeader
operator|.
name|get
argument_list|(
literal|"changeOrigin"
argument_list|)
argument_list|)
expr_stmt|;
name|in
...
name|setHeader
argument_list|(
literal|"CamelSalesforceTransactionKey"
argument_list|,
name|changeEventHeader
operator|.
name|get
...
name|setHeader
argument_list|(
literal|"CamelSalesforceSequenceNumber"
argument_list|,
name|changeEventHeader
operator|.
name|get
...
name|setHeader
argument_list|(
literal|"CamelSalesforceIsTransactionEnd"
argument_list|,
name|changeEventHeader
operator|.
name|get
argument_list|(
literal|"isTransactionEnd"
argument_list|)
argument_list|)
expr_stmt|;
name|in
...
name|setHeader
argument_list|(
literal|"CamelSalesforceCommitTimestamp"
argument_list|,
name|changeEventHeader
operator|.
name|get
argument_list|(
literal|"commitTimestamp"
argument_list|)
argument_list|)
expr_stmt|;
name|in
...
name|setHeader
argument_list|(
literal|"CamelSalesforceCommitUser"
argument_list|,
name|changeEventHeader
operator|.
name|get
...
name|setHeader
argument_list|(
literal|"CamelSalesforceCommitNumber"
argument_list|,
name|changeEventHeader
operator|.
name|get
argument_list|(
literal|"commitNumber"
argument_list|)
argument_list|)
expr_stmt|;
name|in
...
name|setHeader
argument_list|(
literal|"CamelSalesforceEntityName"
argument_list|,
name|changeEventHeader
operator|.
name|get
...
name|setHeader
argument_list|(
literal|"CamelSalesforceRecordIds"
argument_list|,
name|changeEventHeader
operator|.
name|get
...
block|}
block|}
DECL|method|createPlatformEventMessage (final Message message, final org.apache.camel.Message in)
name|void
name|createPlatformEventMessage
parameter_list|(
specifier|final
...
block|}
block|}
DECL|method|createPushTopicMessage (final Message message, final org.apache.camel.Message in)
name|void
name|createPushTopicMessage
parameter_list|(
specifier|final
...
block|}
block|}
DECL|method|setHeaders (final org.apache.camel.Message in, final Message message)
name|void
name|setHeaders
parameter_list|(
specifier|final
