...
name|warn
argument_list|(
literal|"Retrying on Salesforce InvalidSessionId error: {}"
argument_list|,
name|getRootSalesforceException
argument_list|(
name|exceptionResponse
argument_list|)
operator|.
...
return|;
block|}
DECL|method|getRootSalesforceException (SalesforceException e)
specifier|private
name|SalesforceException
name|getRootSalesforceException
parameter_list|(
...
return|;
block|}
DECL|method|createExceptionResponse ()
specifier|protected
name|SalesforceException
name|createExceptionResponse
parameter_list|()
...
expr_stmt|;
block|}
DECL|method|getExceptionResponse ()
specifier|public
name|SalesforceException
