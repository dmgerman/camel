...
return|;
block|}
DECL|method|formatDate (LocalDate date)
specifier|public
specifier|static
name|String
name|formatDate
...
return|;
block|}
DECL|method|parseDate (String date)
specifier|public
specifier|static
name|LocalDate
name|parseDate
...
return|;
block|}
DECL|method|formatTime (OffsetTime time)
specifier|public
specifier|static
name|String
name|formatTime
...
parameter_list|)
block|{
comment|// Sets the timezone as UTC for the time before sending to salesforce
return|return
name|ISO_LOCAL_TIME
operator|.
name|format
...
return|;
block|}
DECL|method|parseTime (String time)
specifier|public
specifier|static
name|OffsetTime
name|parseTime
...
parameter_list|)
block|{
comment|// Sets the timezone as UTC for the time which comes from salesforce
return|return
name|OffsetTime
operator|.
name|of
