...
return|;
block|}
DECL|method|setBulkOperation (OperationEnum bulkOperation)
specifier|public
name|void
name|setBulkOperation
parameter_list|(
name|OperationEnum
name|bulkOperation
parameter_list|)
