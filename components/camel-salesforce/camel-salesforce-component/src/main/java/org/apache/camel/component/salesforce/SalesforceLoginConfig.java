...
name|Type
block|{
DECL|enumConstant|USERNAME_PASSWORD
DECL|enumConstant|REFRESH_TOKEN
...
expr_stmt|;
block|}
DECL|method|SalesforceLoginConfig (Type type, String loginUrl, String clientId, String clientSecret, String refreshToken, String userName, String password, boolean lazyLogin, KeyStoreParameters keystore)
specifier|private
name|SalesforceLoginConfig
parameter_list|(
name|Type
