...
decl_stmt|;
DECL|field|HTTP_CONNECTION_TIMEOUT
specifier|public
specifier|static
specifier|final
name|String
...
name|description
operator|=
literal|"Timeout used by the HttpClient when waiting for response from the Salesforce server."
argument_list|,
name|label
operator|=
literal|"common"
...
name|description
operator|=
literal|"Connection timeout used by the HttpClient when connecting to the Salesforce server."
argument_list|,
name|label
operator|=
literal|"common"
...
argument_list|)
decl_stmt|;
comment|// set HTTP timeout settings
if|if
condition|(
name|httpIdleTimeout
operator|!=
