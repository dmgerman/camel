...
return|;
block|}
DECL|method|enumTypeName (final String sObjectName, final String name)
specifier|public
name|String
name|enumTypeName
parameter_list|(
...
return|;
block|}
DECL|method|atLeastOneHasExternalIds (final List<String> names)
specifier|public
name|boolean
name|atLeastOneHasExternalIds
parameter_list|(
specifier|final
name|List
argument_list|<
...
argument_list|)
decl_stmt|;
DECL|field|FIELD_DEFINITION_PATTERN
specifier|private
specifier|static
specifier|final
name|Pattern
...
name|packageName
decl_stmt|;
comment|/**      * Names of specific picklist/multipicklist fields, which should be      * converted to Enum (default case) if property      * {@link this#useStringsForPicklists} is set to true. Format:      * SObjectApiName.FieldApiName (e.g. Account.DataSource)      */
annotation|@
name|Parameter
DECL|field|picklistToEnums
name|String
index|[]
name|picklistToEnums
decl_stmt|;
comment|/**      * Names of specific picklist/multipicklist fields, which should be      * converted to String if property {@link this#useStringsForPicklists} is      * set to false. Format: SObjectApiName.FieldApiName (e.g.      * Account.DataSource)      */
annotation|@
name|Parameter
DECL|field|picklistToStrings
name|String
index|[]
...
name|includes
decl_stmt|;
DECL|field|picklistsEnumToSObject
specifier|private
specifier|final
name|Map
argument_list|<
...
argument_list|()
decl_stmt|;
DECL|field|picklistsStringToSObject
specifier|private
specifier|final
name|Map
argument_list|<
...
name|useOptionals
decl_stmt|;
DECL|method|parsePicklistToEnums ()
name|void
name|parsePicklistToEnums
parameter_list|()
block|{
name|parsePicklistOverrideArgs
argument_list|(
name|picklistToEnums
argument_list|,
name|picklistsEnumToSObject
...
expr_stmt|;
block|}
DECL|method|parsePicklistToStrings ()
name|void
...
expr_stmt|;
block|}
DECL|method|processDescription (final File pkgDir, final SObjectDescription description, final GeneratorUtility utility, final Set<String> sObjectNames)
name|void
...
return|;
block|}
DECL|method|parsePicklistOverrideArgs (final String[] picklists, final Map<String, Set<String>> picklistsToSObject)
specifier|private
specifier|static
name|void
name|parsePicklistOverrideArgs
...
argument_list|(
literal|"Invalid format provided for picklistFieldToEnum value - allowed format SObjectName.FieldName"
argument_list|)
throw|;
block|}
name|strings
