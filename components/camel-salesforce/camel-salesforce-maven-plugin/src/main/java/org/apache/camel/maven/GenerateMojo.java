...
name|useStringsForPicklists
decl_stmt|;
comment|/**      * Generator will use java.time.ZonedTimeDate for Date if set to true, else it will default to java.time.LocalDate      */
annotation|@
name|Parameter
argument_list|(
name|property
operator|=
literal|"camelSalesforce.useZonedTimeDateForDate"
argument_list|,
name|defaultValue
operator|=
literal|"false"
argument_list|)
DECL|field|useZonedTimeDateForDate
specifier|private
name|boolean
name|useZonedTimeDateForDate
decl_stmt|;
comment|/**      * Generator will use java.time.ZonedTimeDate for Time if set to true, else it will default to java.time.OffsetTime      */
annotation|@
name|Parameter
argument_list|(
name|property
operator|=
literal|"camelSalesforce.useZonedTimeDateForTime"
argument_list|,
name|defaultValue
operator|=
literal|"false"
argument_list|)
DECL|field|useZonedTimeDateForTime
specifier|private
name|boolean
name|useZonedTimeDateForTime
decl_stmt|;
