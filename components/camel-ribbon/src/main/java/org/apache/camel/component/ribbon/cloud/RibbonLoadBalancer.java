...
name|serviceDiscovery
decl_stmt|;
DECL|method|RibbonServerList (String serviceName, ServiceDiscovery serviceDiscovery)
name|RibbonServerList
parameter_list|(
name|String
name|serviceName
...
name|serviceFilter
decl_stmt|;
DECL|method|RibbonServerFilter (ServiceFilter serviceFilter)
name|RibbonServerFilter
parameter_list|(
name|ServiceFilter
name|serviceFilter
...
expr_stmt|;
block|}
DECL|method|getFilteredListOfServers (List<RibbonServiceDefinition> servers)
specifier|public
name|List
argument_list|<
name|RibbonServiceDefinition
argument_list|>
name|getFilteredListOfServers
parameter_list|(
name|List
argument_list|<
name|RibbonServiceDefinition
