...
name|HttpException
argument_list|(
literal|"Get the exception when processing the exchange"
argument_list|,
name|e
argument_list|)
throw|;
...
condition|)
block|{
comment|// To make sure we set the right content-type here
operator|(
operator|(
name|AbstractHttpEntity
operator|)
...
name|info
argument_list|(
literal|"Get exception when send the reponse"
operator|+
name|e
argument_list|)
expr_stmt|;
