...
argument_list|)
decl_stmt|;
comment|// TODO: Must not rely on dependency injection as it should work out of the box
annotation|@
name|BeanInject
...
name|format
argument_list|(
literal|"HOST provided: %s seem to be invalid. Remember SCHEME has to be excluded."
argument_list|,
name|url
argument_list|)
argument_list|)
