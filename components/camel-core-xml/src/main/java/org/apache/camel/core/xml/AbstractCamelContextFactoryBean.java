...
name|info
argument_list|(
literal|"Using custom HeadersMapFactory: {}"
argument_list|,
name|headersMapFactory
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Using custom JSonSchemaResolver: {}"
argument_list|,
name|jsonSchemaResolver
argument_list|)
expr_stmt|;
...
comment|// -------------------------------------------------------------------------
comment|/**      * Initializes the context      *      * @param context the context      * @throws Exception is thrown if error occurred      */
DECL|method|initCamelContext (T context)
specifier|protected
name|void
name|initCamelContext
parameter_list|(
...
name|info
argument_list|(
literal|"Using custom MessageHistoryFactory: {}"
argument_list|,
name|messageHistoryFactory
argument_list|)
expr_stmt|;
