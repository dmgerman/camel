...
begin_comment
comment|/**  * Integration test to confirm REQUEUE header causes message not to be re-queued when an handled exception occurs.  */
end_comment

begin_class
DECL|class|RabbitMQRequeueHandledExceptionIntTest
specifier|public
class|class
name|RabbitMQRequeueHandledExceptionIntTest
extends|extends
name|CamelTestSupport
block|{
...
name|Exception
argument_list|(
literal|"Simulated handled exception"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
annotation|@
name|Test
DECL|method|testTrueRequeueHeaderWithHandleExceptionNotCausesRequeue ()
specifier|public
name|void
name|testTrueRequeueHeaderWithHandleExceptionNotCausesRequeue
parameter_list|()
throws|throws
name|Exception
block|{
