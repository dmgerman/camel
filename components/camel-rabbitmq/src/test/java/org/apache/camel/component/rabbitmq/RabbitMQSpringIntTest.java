...
argument_list|()
expr_stmt|;
comment|/*         LOGGER.info("Declare exchange queue");         channel.exchangeDeclare("ex2", "direct", true, false, new HashMap<String, Object>());         channel.queueDeclare("q2", true, false, false, null);         channel.queueBind("q2", "ex2", "rk2");         */
block|}
annotation|@
name|After
