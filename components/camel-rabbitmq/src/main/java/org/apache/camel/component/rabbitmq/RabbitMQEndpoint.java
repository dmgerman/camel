...
expr_stmt|;
block|}
comment|/**      * Key/value args for configuring the exchange parameters when declare=true      */
...
return|;
block|}
comment|/**      * Key/value args for configuring the queue parameters when declare=true      */
...
return|;
block|}
comment|/**      * Key/value args for configuring the queue binding parameters when declare=true      */
