...
return|;
block|}
comment|/**      * Key/value args for configuring the exchange parameters when declare=true      *      * @Deprecated Use args instead e.g arg.exchange.x-message-ttl=1000      */
annotation|@
name|Deprecated
DECL|method|setExchangeArgs (Map<String, Object> exchangeArgs)
specifier|public
name|void
name|setExchangeArgs
parameter_list|(
name|Map
argument_list|<
name|String
...
return|;
block|}
comment|/**      * Key/value args for configuring the queue parameters when declare=true      *      * @Deprecated Use args instead e.g arg.queue.x-message-ttl=1000      */
DECL|method|setQueueArgs (Map<String, Object> queueArgs)
specifier|public
name|void
name|setQueueArgs
parameter_list|(
