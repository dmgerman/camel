...
name|configuration
decl_stmt|;
DECL|method|GoogleBigQueryProducer (GoogleBigQueryEndpoint endpoint, GoogleBigQueryConfiguration configuration)
specifier|public
name|GoogleBigQueryProducer
parameter_list|(
...
name|trace
argument_list|(
literal|"uploader thread/id: {} / {} . calling google api"
argument_list|,
name|Thread
operator|.
name|currentThread
