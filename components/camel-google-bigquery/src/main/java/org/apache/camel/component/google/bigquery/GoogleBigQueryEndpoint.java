...
name|executorService
decl_stmt|;
DECL|method|GoogleBigQueryEndpoint (String uri, Bigquery bigquery, GoogleBigQueryConfiguration configuration)
specifier|protected
name|GoogleBigQueryEndpoint
parameter_list|(
name|String
