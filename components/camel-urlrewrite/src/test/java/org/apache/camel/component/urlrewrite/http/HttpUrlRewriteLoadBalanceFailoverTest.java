...
begin_class
DECL|class|HttpUrlRewriteLoadBalanceFailoverTest
specifier|public
class|class
name|HttpUrlRewriteLoadBalanceFailoverTest
extends|extends
name|BaseUrlRewriteTest
block|{
annotation|@
...
name|to
argument_list|(
literal|"http://localhost:{{port2}}/myapp2?bridgeEndpoint=true&throwExceptionOnFailure=true&urlRewrite=#myRewrite"
argument_list|)
operator|.
name|to
argument_list|(
literal|"http://localhost:{{port2}}/myapp3?bridgeEndpoint=true&throwExceptionOnFailure=true&urlRewrite=#myRewrite"
argument_list|)
expr_stmt|;
