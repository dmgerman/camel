...
begin_class
DECL|class|Http4UrlRewriteLoadBalanceRoundRobinTest
specifier|public
class|class
name|Http4UrlRewriteLoadBalanceRoundRobinTest
extends|extends
name|BaseUrlRewriteTest
block|{
annotation|@
...
name|to
argument_list|(
literal|"http4://localhost:{{port2}}/myapp3?bridgeEndpoint=true&throwExceptionOnFailure=false&urlRewrite=#myRewrite"
argument_list|)
expr_stmt|;
name|from
argument_list|(
