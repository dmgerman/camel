...
begin_class
DECL|class|CamelSpringBootRunner
specifier|public
class|class
...
name|SpringJUnit4ClassRunner
block|{
DECL|method|CamelSpringBootRunner (Class<?> clazz)
specifier|public
name|CamelSpringBootRunner
parameter_list|(
name|Class
...
comment|// (ensure to get the current list as we need to re-order that list so Camel comes first)
name|List
argument_list|<
name|TestExecutionListener
argument_list|>
...
expr_stmt|;
block|}
DECL|method|addIfMissingType (List<TestExecutionListener> list, TestExecutionListener listener)
specifier|private
name|void
name|addIfMissingType
parameter_list|(
