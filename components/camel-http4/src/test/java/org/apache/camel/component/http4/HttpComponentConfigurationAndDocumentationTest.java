...
begin_class
DECL|class|HttpComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|HttpComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|(
literal|"http4://www.google.com?proxyAuthHost=myproxy&"
operator|+
literal|"proxyAuthPort=1234&chunked=false"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|contains
argument_list|(
literal|"\"httpMethodRestrict\": { \"type\": \"java.lang.String\" }"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"throwExceptionOnFailure\": { \"type\": \"boolean\" }"
argument_list|)
argument_list|)
expr_stmt|;
block|}
