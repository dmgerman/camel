...
parameter_list|()
function_decl|;
comment|/**      * Sets the header filter strategy to use.      *<p/>      * Will default use {@link org.apache.camel.component.http4.HttpHeaderFilterStrategy}      *      * @param headerFilterStrategy the custom strategy      */
