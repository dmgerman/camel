...
block|}
block|}
comment|/**      * Creates the HttpMethod to use to call the remote server, either its GET or POST.      *      * @param exchange the exchange      * @return the created method as either GET or POST      * @throws URISyntaxException is thrown if the URI is invalid      * @throws CamelExchangeException is thrown if error creating RequestEntity      */
...
throw|;
block|}
comment|// Changed the schema to http4 to normal http by default
name|String
name|schema
init|=
literal|"http"
...
name|debug
argument_list|(
literal|" The uri used by http request is "
operator|+
name|builder
operator|.
name|toString
