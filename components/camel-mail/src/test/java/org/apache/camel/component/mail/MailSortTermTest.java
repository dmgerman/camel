...
name|Exception
block|{
comment|// Two tests also in conjunction with search since mail consumer does sort and search together
return|return
operator|new
name|RouteBuilder
argument_list|()
...
name|from
argument_list|(
literal|"pop3://bill@localhost?password=secret&sortTerm=#sortDescendingDate"
argument_list|)
operator|.
name|to
argument_list|(
