...
begin_class
DECL|class|MailConsumerIdleMessageTest
specifier|public
class|class
name|MailConsumerIdleMessageTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|from
argument_list|(
literal|"pop3://james@localhost?password=foo&initialDelay=100&delay=100&sendEmptyMessageWhenIdle=true"
argument_list|)
operator|.
name|to
argument_list|(
