...
begin_class
DECL|class|MailComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|MailComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|contains
argument_list|(
literal|"\"contentType\": { \"type\": \"java.lang.String\" }"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"debugMode\": { \"type\": \"boolean\" }"
argument_list|)
argument_list|)
expr_stmt|;
block|}
