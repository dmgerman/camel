...
begin_comment
comment|/**  * Unit test to verift that we can have multiple recipients in To, CC and BCC  */
end_comment
...
name|from
argument_list|(
literal|"pop3://claus@localhost?consumer.delay=1000"
argument_list|)
operator|.
name|to
argument_list|(
...
name|from
argument_list|(
literal|"pop3://willem@localhost?consumer.delay=1000"
argument_list|)
operator|.
name|to
argument_list|(
...
name|from
argument_list|(
literal|"pop3://hadrian@localhost?consumer.delay=1000"
argument_list|)
operator|.
name|to
argument_list|(
