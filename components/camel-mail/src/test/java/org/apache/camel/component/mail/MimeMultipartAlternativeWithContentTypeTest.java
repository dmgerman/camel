...
begin_class
DECL|class|MimeMultipartAlternativeWithContentTypeTest
specifier|public
class|class
name|MimeMultipartAlternativeWithContentTypeTest
extends|extends
name|CamelTestSupport
block|{
...
decl_stmt|;
DECL|method|sendMultipartEmail ()
specifier|private
name|void
...
name|getEndpoint
argument_list|(
literal|"smtp://sachin@mymailserver.com?password=secret&contentType=text/html; charset=UTF-8"
argument_list|,
name|MailEndpoint
operator|.
name|class
...
annotation|@
name|Test
DECL|method|testMultipartEmailContentType ()
specifier|public
name|void
name|testMultipartEmailContentType
parameter_list|()
throws|throws
name|Exception
block|{
...
name|from
argument_list|(
literal|"pop3://sachin@mymailserver.com?password=secret&consumer.initialDelay=100&consumer.delay=100&contentType=text/html; charset=UTF-8"
argument_list|)
operator|.
name|to
argument_list|(
