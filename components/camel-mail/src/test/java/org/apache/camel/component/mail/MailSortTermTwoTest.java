...
begin_class
DECL|class|MailSortTermTwoTest
specifier|public
class|class
name|MailSortTermTwoTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|from
argument_list|(
literal|"pop3://bill@localhost?password=secret&sortTerm=#sortDescendingDate&consumer.initialDelay=100&consumer.delay=100"
argument_list|)
operator|.
name|to
argument_list|(
