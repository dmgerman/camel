...
name|resolveMandatoryEndpoint
argument_list|(
literal|"smtp://james@myhost:30/subject?password=secret&from=me@camelriders.org&DeleteProcessedMessages=false&defaultEncoding=iso-8859-1&folderName=riders"
argument_list|)
decl_stmt|;
name|MailConfiguration
name|config
