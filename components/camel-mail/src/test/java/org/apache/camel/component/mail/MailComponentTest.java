...
name|assertEquals
argument_list|(
literal|"processOnlyUnseenMessages"
argument_list|,
literal|true
argument_list|,
name|config
...
operator|+
literal|"&from=me@camelriders.org&deleteProcessedMessages=true&defaultEncoding=iso-8859-1&folderName=riders"
operator|+
literal|"&contentType=text/html&processOnlyUnseenMessages=false"
argument_list|)
decl_stmt|;
name|MailConfiguration
name|config
