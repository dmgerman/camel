...
begin_class
DECL|class|MailMaxMessagesPerPollTest
specifier|public
class|class
name|MailMaxMessagesPerPollTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|from
argument_list|(
literal|"pop3://jones@localhost?password=secret&consumer.initialDelay=100&consumer.delay=100&maxMessagesPerPoll=3"
operator|+
literal|"&delete=true"
argument_list|)
operator|.
