...
begin_class
DECL|class|StringTemplateConcurrentTest
specifier|public
class|class
name|StringTemplateConcurrentTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|to
argument_list|(
literal|"string-template:org/apache/camel/component/stringtemplate/Concurrent.tm"
argument_list|)
operator|.
name|to
argument_list|(
