...
begin_comment
comment|/**  * A Producer which sends messages to the Amazon MSK Service  *<a href="http://aws.amazon.com/msk/">AWS MSK</a>  */
end_comment

begin_class
DECL|class|MSKProducer
specifier|public
class|class
name|MSKProducer
extends|extends
name|DefaultProducer
block|{
DECL|field|mskProducerToString
specifier|private
specifier|transient
name|String
name|mskProducerToString
decl_stmt|;
DECL|method|MSKProducer (Endpoint endpoint)
specifier|public
name|MSKProducer
parameter_list|(
name|Endpoint
...
return|;
block|}
DECL|method|listClusters (AWSKafka mskClient, Exchange exchange)
specifier|private
name|void
name|listClusters
parameter_list|(
