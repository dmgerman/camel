...
expr_stmt|;
block|}
DECL|method|createCluster (AWSKafka mskClient, Exchange exchange)
specifier|private
name|void
name|createCluster
parameter_list|(
...
name|IllegalArgumentException
argument_list|(
literal|"Kafka Version must be specified"
argument_list|)
throw|;
block|}
if|if
...
name|IllegalArgumentException
argument_list|(
literal|"BrokerNodeGroupInfo must be specified"
argument_list|)
throw|;
block|}
name|CreateClusterResult
...
expr_stmt|;
block|}
DECL|method|deleteCluster (AWSKafka mskClient, Exchange exchange)
specifier|private
name|void
name|deleteCluster
parameter_list|(
...
name|IllegalArgumentException
argument_list|(
literal|"Cluster ARN must be specified"
argument_list|)
throw|;
block|}
name|DeleteClusterResult
...
expr_stmt|;
block|}
DECL|method|describeCluster (AWSKafka mskClient, Exchange exchange)
specifier|private
name|void
name|describeCluster
parameter_list|(
