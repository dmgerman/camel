...
name|configuration
decl_stmt|;
DECL|method|MSKEndpoint (String uri, Component component, MSKConfiguration configuration)
specifier|public
name|MSKEndpoint
parameter_list|(
name|String
