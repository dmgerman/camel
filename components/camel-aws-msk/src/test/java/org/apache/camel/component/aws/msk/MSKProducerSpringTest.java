...
begin_class
DECL|class|MSKProducerSpringTest
specifier|public
class|class
name|MSKProducerSpringTest
extends|extends
name|CamelSpringTestSupport
block|{
annotation|@
...
annotation|@
name|Test
DECL|method|mskDescribeClusterTest ()
specifier|public
name|void
name|mskDescribeClusterTest
parameter_list|()
throws|throws
name|Exception
block|{
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/aws/msk/MSKComponentSpringTest-context.xml"
argument_list|)
return|;
block|}
block|}
