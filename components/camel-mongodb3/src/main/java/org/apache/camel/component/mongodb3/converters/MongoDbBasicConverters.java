...
name|warn
argument_list|(
literal|"String -> Document conversion selected, but the following exception occurred. Returning null."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
annotation|@
name|Converter
DECL|method|fromAnyObjectToDocument (Object value)
specifier|public
specifier|static
name|Document
name|fromAnyObjectToDocument
parameter_list|(
name|Object
name|value
parameter_list|)
...
name|warn
argument_list|(
literal|"Conversion has fallen back to generic Object -> Document, but unable to convert type {}. Returning null. {}"
argument_list|,
name|value
operator|.
name|getClass
