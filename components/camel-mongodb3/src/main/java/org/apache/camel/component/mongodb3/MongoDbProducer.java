...
begin_comment
comment|//import org.bson.BsonDocument;
end_comment
...
argument_list|)
decl_stmt|;
comment|// body could not be converted to Document, check to see if it's of type List<Document>
if|if
condition|(
name|insert
operator|==
...
argument_list|)
expr_stmt|;
comment|// if the body of type List was obtained, ensure that all items are of type Document and cast the List to List<Document>
if|if
condition|(
name|insert
operator|!=
