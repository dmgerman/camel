...
expr_stmt|;
block|}
comment|// only delete done file if moveFailed option is enabled, as otherwise on rollback,
comment|// we should leave the done file so we can retry
if|if
condition|(
name|endpoint
operator|.
...
block|}
block|}
DECL|method|handleDoneFile (Exchange exchange)
specifier|protected
name|void
name|handleDoneFile
parameter_list|(
