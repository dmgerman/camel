...
name|IllegalArgumentException
argument_list|(
literal|"The readLock=fileLock option is not supported on Windows"
argument_list|)
throw|;
block|}
if|if
