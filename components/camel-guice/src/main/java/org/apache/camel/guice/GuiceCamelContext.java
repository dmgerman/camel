...
begin_comment
comment|/**  * The default CamelContext implementation for working with Guice.  *  * It is recommended you use this implementation with the  *<a href="http://code.google.com/p/guiceyfruit/wiki/GuiceyJndi">Guicey JNDI Provider</a>  *   * @version $Revision$  */
end_comment
