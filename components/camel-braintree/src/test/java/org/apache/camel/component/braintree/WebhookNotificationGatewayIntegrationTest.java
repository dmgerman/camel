...
annotation|@
name|Test
DECL|method|testParseIdealPayment ()
specifier|public
name|void
name|testParseIdealPayment
parameter_list|()
throws|throws
name|Exception
block|{
name|runParseIdealPaymentTest
argument_list|(
name|WebhookNotification
operator|.
name|Kind
operator|.
name|IDEAL_PAYMENT_COMPLETE
argument_list|)
expr_stmt|;
name|runParseIdealPaymentTest
argument_list|(
...
name|Kind
operator|.
name|IDEAL_PAYMENT_FAILED
argument_list|)
expr_stmt|;
block|}
DECL|method|runParseIdealPaymentTest (WebhookNotification.Kind kind)
specifier|private
name|void
name|runParseIdealPaymentTest
parameter_list|(
...
annotation|@
name|Test
DECL|method|testParsePaymentInstrument ()
specifier|public
name|void
name|testParsePaymentInstrument
parameter_list|()
throws|throws
name|Exception
block|{
name|runParsePaymentInstrumentTest
argument_list|(
name|WebhookNotification
operator|.
name|Kind
operator|.
name|GRANTED_PAYMENT_INSTRUMENT_UPDATE
argument_list|)
expr_stmt|;
block|}
DECL|method|runParsePaymentInstrumentTest (WebhookNotification.Kind kind)
specifier|private
name|void
name|runParsePaymentInstrumentTest
parameter_list|(
...
name|result
operator|.
name|getGrantedPaymentInstrumentUpdate
argument_list|()
operator|.
name|getToken
argument_list|()
