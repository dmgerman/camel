...
return|;
block|}
DECL|method|createExchange (int rangeIndex, ValueRange valueRange)
specifier|public
name|Exchange
name|createExchange
parameter_list|(
...
return|;
block|}
DECL|method|createExchange (int rangeIndex, int valueIndex, String range, String majorDimension, List<Object> values)
specifier|public
name|Exchange
name|createExchange
parameter_list|(
