...
return|;
block|}
comment|/**      * LinkedIn user account name, MUST be provided      * @param userName      */
...
return|;
block|}
comment|/**      * LinkedIn account password      * @param userPassword      */
...
return|;
block|}
comment|/**      * LinkedIn application client ID      * @param clientId      */
...
return|;
block|}
comment|/**      * LinkedIn application client secret      * @param clientSecret      */
...
return|;
block|}
comment|/**      * List of LinkedIn scopes as specified at https://developer.linkedin.com/documents/authentication#granting      * @param scopes      */
...
return|;
block|}
comment|/**      * Application redirect URI, although the component never redirects to this page to avoid having to have a functioning redirect server.      * So for testing one could use https://localhost      * @param redirectUri      */
...
return|;
block|}
comment|/**      * Custom HTTP params, for example proxy host and port, use constants from AllClientPNames      * @param httpParams      */
...
return|;
block|}
comment|/**      * Flag to enable/disable lazy OAuth, default is true. when enabled, OAuth token retrieval or generation is not done until the first REST call      * @param lazyAuth      */
