...
begin_comment
comment|/**  * The LinkedIn consumer.  */
end_comment

begin_class
DECL|class|LinkedInConsumer
specifier|public
class|class
...
argument_list|>
block|{
DECL|method|LinkedInConsumer (LinkedInEndpoint endpoint, Processor processor)
specifier|public
name|LinkedInConsumer
parameter_list|(
...
parameter_list|)
block|{
comment|// do we need to add fields option
if|if
condition|(
operator|!
name|propertyNames
...
block|}
block|}
comment|// all candidates use fields option, so there is no ambiguity
name|propertyNames
operator|.
name|add
argument_list|(
