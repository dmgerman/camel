...
begin_comment
comment|/**  * Abstract base class for LinkedIn Integration tests generated by Camel API component maven plugin.  */
end_comment

begin_class
DECL|class|AbstractLinkedInTestSupport
specifier|public
class|class
...
argument_list|()
decl_stmt|;
comment|// read LinkedIn component configuration from TEST_OPTIONS_PROPERTIES
specifier|final
name|Properties
name|properties
init|=
...
expr_stmt|;
block|}
comment|// TODO save and load token from TEST_OPTIONS_PROPERTIES
specifier|final
...
argument_list|)
expr_stmt|;
comment|// add LinkedInComponent to Camel context
specifier|final
