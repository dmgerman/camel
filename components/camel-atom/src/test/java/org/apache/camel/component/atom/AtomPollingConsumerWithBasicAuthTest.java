...
begin_class
DECL|class|AtomPollingConsumerWithBasicAuthTest
specifier|public
class|class
name|AtomPollingConsumerWithBasicAuthTest
extends|extends
...
name|port
operator|+
literal|"/?splitEntries=false&username=camel&password=camelPass"
argument_list|)
operator|.
name|to
argument_list|(
...
name|from
argument_list|(
literal|"atom:?feedUri=http://localhost:"
operator|+
name|JettyTestServer
operator|.
name|getInstance
