...
begin_class
DECL|class|CaffeineCacheProducerMultiOperationSameCacheTest
specifier|public
class|class
name|CaffeineCacheProducerMultiOperationSameCacheTest
extends|extends
...
name|toF
argument_list|(
literal|"caffeine-cache://%s?cache=#cache&action=PUT&key=1"
argument_list|,
literal|"test"
argument_list|)
operator|.
name|toF
argument_list|(
literal|"caffeine-cache://%s?cache=#cache&key=1&action=GET"
argument_list|,
literal|"test"
argument_list|)
operator|.
