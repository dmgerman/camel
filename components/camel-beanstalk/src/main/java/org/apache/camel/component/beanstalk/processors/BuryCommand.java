...
argument_list|)
decl_stmt|;
DECL|method|BuryCommand (BeanstalkEndpoint endpoint)
specifier|public
name|BuryCommand
parameter_list|(
name|BeanstalkEndpoint
...
name|format
argument_list|(
literal|"Failed to bury job %d (with priority %d)"
argument_list|,
name|jobId
argument_list|,
name|priority
...
name|format
argument_list|(
literal|"Job %d buried with priority %d. Result is %b"
argument_list|,
name|jobId
argument_list|,
name|priority
