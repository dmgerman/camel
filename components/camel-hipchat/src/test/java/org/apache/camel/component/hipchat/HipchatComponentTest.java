...
annotation|@
name|Test
DECL|method|testAuthTokenMandatory ()
specifier|public
name|void
name|testAuthTokenMandatory
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testUriParseNoPort ()
specifier|public
name|void
name|testUriParseNoPort
parameter_list|()
throws|throws
name|Exception
block|{
...
name|createEndpoint
argument_list|(
literal|"hipchat://localhost?authToken=token&protocol=https"
argument_list|,
literal|"localhost"
argument_list|,
name|parameters
...
name|createEndpoint
argument_list|(
literal|"hipchat://localhost:8080?authToken=token&protocol=https@consumeUsers=@auser,@buser"
argument_list|,
