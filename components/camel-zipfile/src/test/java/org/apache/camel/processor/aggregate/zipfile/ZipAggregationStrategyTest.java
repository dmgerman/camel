...
name|assertTrue
argument_list|(
literal|"Result message does not contain GenericFileMessage"
argument_list|,
name|GenericFileMessage
operator|.
name|class
...
name|assertTrue
argument_list|(
literal|"Result file name does not end with .zip"
argument_list|,
name|resultFile
operator|.
name|getName
