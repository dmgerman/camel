...
name|fromF
argument_list|(
literal|"mllp://%s:%d?autoAck=true&connectTimeout=%d&receiveTimeout=%d&validatePayload=%b&requireEndOfData=%b"
argument_list|,
name|mllpClient
operator|.
name|getMllpHost
...
name|Exception
function_decl|;
DECL|method|runMessageContainingEmbeddedEndOfBlock ()
specifier|protected
name|void
