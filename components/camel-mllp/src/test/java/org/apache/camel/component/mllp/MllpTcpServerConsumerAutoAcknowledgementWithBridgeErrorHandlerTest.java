...
begin_class
DECL|class|MllpTcpServerConsumerAutoAcknowledgementWithBridgeErrorHandlerTest
specifier|public
class|class
name|MllpTcpServerConsumerAutoAcknowledgementWithBridgeErrorHandlerTest
extends|extends
...
name|assertNotNull
argument_list|(
literal|"Should have the exception in the exchange property"
argument_list|,
name|ackGenerationEx
operator|.
name|getReceivedExchanges
