...
begin_class
DECL|class|MllpTcpServerConsumerMessageValidationTest
specifier|public
class|class
name|MllpTcpServerConsumerMessageValidationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|fromF
argument_list|(
literal|"mllp://%s:%d?validatePayload=true&autoAck=true&connectTimeout=%d&receiveTimeout=%d"
argument_list|,
name|mllpClient
operator|.
name|getMllpHost
...
name|fail
argument_list|(
literal|"An acknowledgement should not be received for an invalid HL7 message"
argument_list|)
expr_stmt|;
block|}
catch|catch
