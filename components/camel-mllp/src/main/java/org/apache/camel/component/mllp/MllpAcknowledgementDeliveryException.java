...
expr_stmt|;
block|}
DECL|method|MllpAcknowledgementDeliveryException (String message, byte[] hl7Message, byte[] hl7Acknowledgement)
specifier|public
name|MllpAcknowledgementDeliveryException
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|MllpAcknowledgementDeliveryException (String message, byte[] hl7Message, byte[] hl7Acknowledgement, Throwable cause)
specifier|public
name|MllpAcknowledgementDeliveryException
parameter_list|(
name|String
