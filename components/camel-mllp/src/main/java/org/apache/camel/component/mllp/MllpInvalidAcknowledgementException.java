...
begin_comment
comment|/**  * Raised when a MLLP Producer receives a HL7 Acknowledgement for which the HL7 Acknowledgement type cannot be determined.  */
end_comment

begin_class
DECL|class|MllpInvalidAcknowledgementException
specifier|public
class|class
