...
decl_stmt|;
DECL|method|TcpSocketConsumerRunnable (MllpTcpServerConsumer consumer, Socket clientSocket)
specifier|public
name|TcpSocketConsumerRunnable
parameter_list|(
name|MllpTcpServerConsumer
...
name|MllpInvalidMessageException
argument_list|(
literal|"Timeout receiving complete payload"
argument_list|,
name|mllpBuffer
operator|.
name|toByteArray
...
name|error
argument_list|(
literal|"Ingnoring exception encountered processing exchange with exception encounter reading payload"
argument_list|,
name|ignoredEx
argument_list|)
expr_stmt|;
