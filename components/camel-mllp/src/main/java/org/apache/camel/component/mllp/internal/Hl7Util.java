...
return|;
block|}
comment|/**      * Find the String value of MSH-19 (Character set).      *      * @param hl7Message the HL7 binary data to search      *      * @return the String value of MSH-19, or an empty String if not found.      */
...
name|format
argument_list|(
literal|"Insufficient number of fields in MSH-2 in MSH to generate a response - 10 are required but %d were found"
argument_list|,
name|fieldSeparatorIndexes
operator|.
name|size
