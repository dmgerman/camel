...
block|}
block|}
DECL|method|determineCharset (byte[] hl7Bytes, String msh18)
specifier|public
name|Charset
...
name|warn
argument_list|(
literal|"Unsupported Character Set {} configured for component - using default character set {}"
argument_list|,
name|charsetName
argument_list|,
name|MllpProtocolConstants
...
name|warn
argument_list|(
literal|"Unsupported Character Set {} specified for MSH-18 - using default character set {}"
argument_list|,
name|msh18
argument_list|,
name|MllpProtocolConstants
...
name|warn
argument_list|(
literal|"Unsupported Character Set {} found in MSH-18 - using default character set {}"
argument_list|,
name|foundMsh18
argument_list|,
name|MllpProtocolConstants
...
name|debug
argument_list|(
literal|"Character Set not specified and no Character Set found in MSH-18 - using default character set {}"
argument_list|,
name|MllpProtocolConstants
operator|.
name|DEFAULT_CHARSET
...
return|;
block|}
DECL|method|createNewString (byte[] hl7Bytes, String msh18)
specifier|public
name|String
...
name|debug
argument_list|(
literal|"Creating new String using Charset {}"
argument_list|,
name|charset
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|// TODO:  Move this to HL7Util
...
condition|)
block|{
comment|// If the MSH Segment doesn't have a trailing field separator, add one so the field can be extracted into a string
if|if
condition|(
name|fieldSeparator
operator|!=
