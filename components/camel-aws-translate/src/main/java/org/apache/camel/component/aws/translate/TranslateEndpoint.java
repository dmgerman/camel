...
name|translate
operator|.
name|AmazonTranslateClientBuilder
import|;
end_import
...
begin_comment
comment|/**  * The aws-translate component is used for managing Amazon Translate  */
end_comment
...
name|configuration
decl_stmt|;
DECL|method|TranslateEndpoint (String uri, Component component, TranslateConfiguration configuration)
specifier|public
name|TranslateEndpoint
parameter_list|(
name|String
...
return|;
block|}
DECL|method|createTranslateClient ()
name|AmazonTranslate
name|createTranslateClient
parameter_list|()
block|{
