...
begin_class
DECL|class|JdbcProducerOutputTypeStreamListOutputClassTest
specifier|public
class|class
name|JdbcProducerOutputTypeStreamListOutputClassTest
extends|extends
...
name|to
argument_list|(
literal|"jdbc:testdb?outputType=StreamList&outputClass=org.apache.camel.component.jdbc.CustomerModel"
argument_list|)
operator|.
name|to
argument_list|(
