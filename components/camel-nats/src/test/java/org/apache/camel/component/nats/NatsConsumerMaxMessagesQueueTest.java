...
argument_list|)
DECL|class|NatsConsumerMaxMessagesQueueTest
specifier|public
class|class
name|NatsConsumerMaxMessagesQueueTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|from
argument_list|(
literal|"nats://localhost:4222?topic=test&maxMessages=5&queueName=test"
argument_list|)
operator|.
name|routeId
argument_list|(
...
name|from
argument_list|(
literal|"nats://localhost:4222?topic=test&maxMessages=6&queueName=test"
argument_list|)
operator|.
name|routeId
argument_list|(
