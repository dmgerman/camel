...
argument_list|,
literal|"{Subject=test;Reply=null;Payload=<test2>}"
argument_list|,
literal|"{Subject=test;Reply=null;Payload=<test3>}"
argument_list|,
literal|"{Subject=test;Reply=null;Payload=<test4>}"
argument_list|)
expr_stmt|;
name|mockResultEndpoint
operator|.
...
name|from
argument_list|(
literal|"nats://localhost:4222?topic=test&maxMessages=5"
argument_list|)
operator|.
name|to
argument_list|(
