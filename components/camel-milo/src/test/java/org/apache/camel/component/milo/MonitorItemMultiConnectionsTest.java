...
begin_class
DECL|class|MonitorItemMultiConnectionsTest
specifier|public
class|class
name|MonitorItemMultiConnectionsTest
extends|extends
...
init|=
literal|"milo-client:tcp://foo:bar@localhost:12685?nodeId=items-myitem1&namespaceUri="
operator|+
name|MiloServerComponent
operator|.
...
init|=
literal|"milo-client:tcp://foo:bar2@localhost:12685?nodeId=items-myitem1&namespaceUri="
operator|+
name|MiloServerComponent
operator|.
name|DEFAULT_NAMESPACE_URI
...
init|=
literal|"milo-client:tcp://foo2:bar@localhost:12685?nodeId=items-myitem1&namespaceUri="
operator|+
name|MiloServerComponent
operator|.
name|DEFAULT_NAMESPACE_URI
