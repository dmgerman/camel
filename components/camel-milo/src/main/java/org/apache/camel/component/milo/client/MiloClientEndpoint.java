...
name|endpointUri
decl_stmt|;
comment|/** 	 * The node ID as string ID **deprecated** 	 * 	 * @deprecated Use "node" instead 	 */
annotation|@
name|UriParam
annotation|@
name|Deprecated
...
name|nodeId
decl_stmt|;
comment|/** 	 * The namespace as URI **deprecated** 	 * 	 * @deprecated Use "node" instead 	 */
annotation|@
name|UriParam
annotation|@
name|Deprecated
...
name|namespaceUri
decl_stmt|;
comment|/** 	 * The namespace as numeric index **deprecated** 	 * 	 * @deprecated Use "node" instead 	 */
annotation|@
name|UriParam
annotation|@
name|Deprecated
...
return|;
block|}
DECL|method|setNodeId (final String nodeId)
specifier|public
name|void
name|setNodeId
parameter_list|(
...
return|;
block|}
DECL|method|setNamespaceIndex (final int namespaceIndex)
specifier|public
name|void
name|setNamespaceIndex
parameter_list|(
specifier|final
name|int
name|namespaceIndex
