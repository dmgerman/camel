...
name|connection
decl_stmt|;
DECL|method|MiloClientEndpoint (final String uri, final MiloClientComponent component, final String endpointUri)
specifier|public
name|MiloClientEndpoint
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
DECL|method|setConfiguration (MiloClientConfiguration configuration)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|setConnection (MiloClientConnection connection)
specifier|public
name|void
name|setConnection
parameter_list|(
