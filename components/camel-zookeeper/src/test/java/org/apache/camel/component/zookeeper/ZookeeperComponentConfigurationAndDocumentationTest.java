...
begin_class
DECL|class|ZookeeperComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|ZookeeperComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|(
literal|"zookeeper://localhost:39913/somepath/somenode?create=true&createMode=PERSISTENT"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|contains
argument_list|(
literal|"\"createMode\": { \"kind\": \"parameter\", \"type\": \"string\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"backoff\": { \"kind\": \"parameter\", \"type\": \"integer\""
argument_list|)
argument_list|)
expr_stmt|;
block|}
