...
decl_stmt|;
DECL|field|candidateOneContext
specifier|private
name|CamelContext
name|candidateOneContext
decl_stmt|;
DECL|field|candidateTwoContext
specifier|private
name|CamelContext
...
return|;
block|}
DECL|method|createElectionCandidate (final CamelContext context, int masterCount)
specifier|private
name|ZooKeeperElection
name|createElectionCandidate
parameter_list|(
