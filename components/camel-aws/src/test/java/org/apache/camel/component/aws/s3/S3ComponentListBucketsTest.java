...
begin_class
DECL|class|S3ComponentListBucketsTest
specifier|public
class|class
name|S3ComponentListBucketsTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|awsEndpoint
init|=
literal|"aws-s3://mycamelbucket?amazonS3Client=#amazonS3Client&region=us-west-1&operation=listBuckets"
decl_stmt|;
name|from
argument_list|(
literal|"direct:listBuckets"
