...
name|createEndpoint
argument_list|(
literal|"aws-sqs://arn:aws:sqs:region:account:MyQueue?accessKey=xxx&secretKey=yyy"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|createEndpoint
argument_list|(
literal|"aws-sqs://MyQueue?accessKey=xxx&secretKey=yyy&attributeNames=foo,bar"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|createEndpoint
argument_list|(
literal|"aws-sqs://MyQueue?amazonSQSEndpoint=sns.eu-west-1.amazonaws.com&accessKey=xxx&secretKey=yyy&attributeNames=color,size"
operator|+
