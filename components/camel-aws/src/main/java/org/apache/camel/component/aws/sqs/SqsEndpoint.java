...
argument_list|)
expr_stmt|;
comment|// According to the documentation, only one setting can be made at a time, even though they go into a Map.
if|if
condition|(
name|getConfiguration
argument_list|()
...
block|}
block|}
DECL|method|updateAttribute (String attribute, Object value)
specifier|protected
name|void
name|updateAttribute
parameter_list|(
...
name|trace
argument_list|(
literal|"Updating queue [{}] with request: {}"
argument_list|,
name|configuration
operator|.
name|getQueueName
