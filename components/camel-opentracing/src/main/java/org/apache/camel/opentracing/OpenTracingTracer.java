...
expr_stmt|;
block|}
comment|// TODO: In example client, this was required otherwise outbound invocations
comment|// were not instrumented - may be better to reinstate StaticService approach, but
comment|// then need to resolve issue with xml dsl correctly starting service to init
...
name|error
argument_list|(
literal|"Failed to start event notifier"
argument_list|,
name|e
argument_list|)
expr_stmt|;
