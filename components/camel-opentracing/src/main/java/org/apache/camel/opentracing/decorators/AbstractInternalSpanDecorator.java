...
begin_class
DECL|class|AbstractInternalSpanDecorator
specifier|public
specifier|abstract
class|class
...
parameter_list|)
block|{
comment|// Internal communications use descriptive names, so suitable
comment|// as an operation name, but need to strip the scheme and any options
return|return
