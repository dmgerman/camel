...
name|configuration
decl_stmt|;
DECL|method|CommandDispatcher (RedisConfiguration configuration)
name|CommandDispatcher
parameter_list|(
name|RedisConfiguration
name|configuration
...
DECL|method|execute (final RedisClient redisClient, Exchange exchange)
specifier|public
name|void
name|execute
parameter_list|(
...
DECL|method|determineCommand (Exchange exchange)
specifier|private
name|Command
name|determineCommand
parameter_list|(
