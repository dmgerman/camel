...
begin_class
DECL|class|CwComponentRegistryClientTest
specifier|public
class|class
name|CwComponentRegistryClientTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|createEndpoint
argument_list|(
literal|"aws-cw://camel.apache.org/test?name=testMetric&value=2&unit=Count&timestamp=#now"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
