...
annotation|@
name|Test
DECL|method|createEndpointWithComponentEndpointOptionsAndProxy ()
specifier|public
name|void
name|createEndpointWithComponentEndpointOptionsAndProxy
parameter_list|()
throws|throws
name|Exception
block|{
...
name|createEndpoint
argument_list|(
literal|"aws-cw://camel.apache.org/test?accessKey=xxxxxx&secretKey=yyyyy&region=US_EAST_1&proxyHost=localhost&proxyPort=9000"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
