...
begin_comment
comment|/**  * Update document in collection or object in ObjectRepository. If parameter not specified, updates document from message body  */
end_comment
...
name|CommonOperation
block|{
DECL|method|UpdateOperation (Object payload)
specifier|public
name|UpdateOperation
parameter_list|(
name|Object
