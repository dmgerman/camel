...
name|resourceUid
operator|+
literal|"?operation=ADD&treatCollectionsAsCacheObjects=true"
argument_list|,
name|toAdd
argument_list|)
expr_stmt|;
...
name|resourceUid
operator|+
literal|"?operation=CONTAINS&treatCollectionsAsCacheObjects=true"
argument_list|,
name|toAdd
argument_list|,
name|boolean
...
name|resourceUid
operator|+
literal|"?operation=REMOVE&treatCollectionsAsCacheObjects=true"
argument_list|,
name|toAdd
argument_list|)
expr_stmt|;
...
name|resourceUid
operator|+
literal|"?operation=ADD&configuration=#config"
argument_list|,
name|IgniteQueueEndpoint
operator|.
name|class
...
name|resourceUid
operator|+
literal|"?operation=ADD&capacity=100"
argument_list|,
literal|"hello"
operator|+
name|i
...
expr_stmt|;
block|}
comment|// NOTE: Unfortunately the behaviour of IgniteQueue doesn't adhere to
comment|// the overridden ADD method. It should return an Exception.
name|assert_
argument_list|()
operator|.
name|that
...
name|resourceUid
operator|+
literal|"?operation=OFFER&capacity=100"
argument_list|,
literal|"hello101"
argument_list|,
name|boolean
...
name|resourceUid
operator|+
literal|"?operation=PUT&capacity=100"
argument_list|,
literal|"hello101"
argument_list|,
name|boolean
...
name|resourceUid
operator|+
literal|"?operation=PEEK&capacity=100"
argument_list|,
literal|null
argument_list|,
name|String
...
name|resourceUid
operator|+
literal|"?operation=ELEMENT&capacity=100"
argument_list|,
literal|null
argument_list|,
name|String
...
name|resourceUid
operator|+
literal|"?operation=TAKE&capacity=100"
argument_list|,
literal|null
argument_list|,
name|String
...
name|resourceUid
operator|+
literal|"?operation=SIZE&capacity=100"
argument_list|,
literal|null
argument_list|,
name|int
...
name|resourceUid
operator|+
literal|"?operation=DRAIN&capacity=100"
argument_list|,
literal|null
argument_list|,
name|String
...
name|resourceUid
operator|+
literal|"?operation=POLL&capacity=100"
argument_list|,
literal|null
argument_list|,
name|String
...
name|resourceUid
operator|+
literal|"?operation=POLL&timeoutMillis=1000&capacity=100"
argument_list|,
literal|null
argument_list|,
name|String
