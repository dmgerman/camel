...
name|AbstractOpenstackProducer
block|{
DECL|method|SnapshotProducer (CinderEndpoint endpoint, OSClient client)
specifier|public
name|SnapshotProducer
parameter_list|(
name|CinderEndpoint
...
expr_stmt|;
block|}
DECL|method|messageToSnapshot (Message message)
specifier|private
name|VolumeSnapshot
name|messageToSnapshot
parameter_list|(
