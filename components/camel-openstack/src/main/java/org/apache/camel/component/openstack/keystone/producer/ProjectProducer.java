...
block|{
DECL|method|ProjectProducer (KeystoneEndpoint endpoint, OSClient.OSClientV3 client)
specifier|public
name|ProjectProducer
parameter_list|(
name|KeystoneEndpoint
...
expr_stmt|;
block|}
DECL|method|messageToProject (Message message)
specifier|private
name|Project
name|messageToProject
parameter_list|(
