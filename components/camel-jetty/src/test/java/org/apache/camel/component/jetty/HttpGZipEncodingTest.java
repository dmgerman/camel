...
argument_list|(
literal|"http://localhost:9081/gzip"
argument_list|,
operator|new
name|ByteArrayInputStream
argument_list|(
...
name|requestBodyAndHeader
argument_list|(
literal|"http://localhost:9084/route"
argument_list|,
operator|new
name|ByteArrayInputStream
argument_list|(
...
name|from
argument_list|(
literal|"jetty:http://localhost:9081/gzip"
argument_list|)
operator|.
name|process
argument_list|(
...
name|from
argument_list|(
literal|"jetty:http://localhost:9084/route?bridgeEndpoint=true"
argument_list|)
operator|.
name|to
argument_list|(
literal|"http://localhost:9081/gzip?bridgeEndpoint=true"
argument_list|)
expr_stmt|;
block|}
block|}
