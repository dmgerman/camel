...
begin_class
DECL|class|RestJettyDefaultValueTest
specifier|public
class|class
name|RestJettyDefaultValueTest
extends|extends
name|BaseJettyTest
block|{
annotation|@
...
argument_list|()
operator|+
literal|"/users/123/basic?verbose=true"
argument_list|,
literal|null
argument_list|,
name|String
...
name|assertEquals
argument_list|(
literal|"123;Donald Duck;1113 Quack Street Duckburg"
argument_list|,
name|out2
argument_list|)
expr_stmt|;
...
name|id
operator|+
literal|";Donald Duck;1113 Quack Street Duckburg"
argument_list|)
expr_stmt|;
block|}
if|if
