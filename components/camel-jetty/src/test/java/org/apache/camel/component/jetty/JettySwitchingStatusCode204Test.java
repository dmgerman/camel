...
begin_class
DECL|class|JettySwitchingStatusCode204Test
specifier|public
class|class
name|JettySwitchingStatusCode204Test
extends|extends
name|BaseJettyTest
block|{
annotation|@
...
annotation|@
name|Test
DECL|method|testSwitchingNoBodyTo204HttpViaCamel ()
specifier|public
name|void
name|testSwitchingNoBodyTo204HttpViaCamel
parameter_list|()
throws|throws
name|Exception
block|{
...
name|send
argument_list|(
literal|"http://localhost:{{port}}/bar"
argument_list|,
name|inExchange
argument_list|)
decl_stmt|;
...
annotation|@
name|Test
DECL|method|testNoSwitchingNoCodeHttpViaCamel ()
specifier|public
name|void
name|testNoSwitchingNoCodeHttpViaCamel
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testNoSwitchingNoBodyHttpViaCamel ()
specifier|public
name|void
name|testNoSwitchingNoBodyHttpViaCamel
parameter_list|()
throws|throws
name|Exception
block|{
...
name|send
argument_list|(
literal|"http://localhost:{{port}}/foobar"
argument_list|,
name|inExchange
argument_list|)
decl_stmt|;
...
name|from
argument_list|(
literal|"jetty:http://localhost:{{port}}/foobar"
argument_list|)
operator|.
name|setHeader
argument_list|(
