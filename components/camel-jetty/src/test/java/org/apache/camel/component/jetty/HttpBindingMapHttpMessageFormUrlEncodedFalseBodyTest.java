...
begin_class
DECL|class|HttpBindingMapHttpMessageFormUrlEncodedFalseBodyTest
specifier|public
class|class
name|HttpBindingMapHttpMessageFormUrlEncodedFalseBodyTest
extends|extends
name|BaseJettyTest
block|{
annotation|@
...
name|from
argument_list|(
literal|"jetty:http://localhost:{{port}}/myapp/myservice?mapHttpMessageFormUrlEncodedBody=false"
argument_list|)
operator|.
name|process
argument_list|(
