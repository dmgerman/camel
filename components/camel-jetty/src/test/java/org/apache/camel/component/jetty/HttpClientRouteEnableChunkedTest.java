...
begin_class
DECL|class|HttpClientRouteEnableChunkedTest
specifier|public
class|class
name|HttpClientRouteEnableChunkedTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|assertEquals
argument_list|(
literal|"Should get the transfer-encoding as chunked"
argument_list|,
literal|"chunked"
argument_list|,
name|headers
...
name|from
argument_list|(
literal|"jetty:http://localhost:9081/hello"
argument_list|)
operator|.
name|process
argument_list|(
