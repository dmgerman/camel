...
name|PostMethod
argument_list|(
literal|"http://localhost:9080/post"
argument_list|)
decl_stmt|;
name|post
operator|.
...
name|PostMethod
argument_list|(
literal|"http://localhost:9080/post?request=PostParameter&others=bloggs"
argument_list|)
decl_stmt|;
name|StringRequestEntity
name|entity
...
name|from
argument_list|(
literal|"jetty:http://localhost:9080/post"
argument_list|)
operator|.
name|process
argument_list|(
