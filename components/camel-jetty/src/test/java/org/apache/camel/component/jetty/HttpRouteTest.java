...
argument_list|(
literal|"http://localhost:9083/noStreamCache"
argument_list|,
operator|new
name|ByteArrayInputStream
argument_list|(
...
name|requestBodyAndHeader
argument_list|(
literal|"http://localhost:9084/requestBufferSize"
argument_list|,
name|in
argument_list|,
name|Exchange
...
name|from
argument_list|(
literal|"jetty:http://localhost:9083/noStreamCache?disableStreamCache=true"
argument_list|)
operator|.
...
name|from
argument_list|(
literal|"jetty:http://localhost:9084/requestBufferSize"
argument_list|)
operator|.
name|process
argument_list|(
