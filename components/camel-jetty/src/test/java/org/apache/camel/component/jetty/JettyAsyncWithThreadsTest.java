...
begin_class
DECL|class|JettyAsyncWithThreadsTest
specifier|public
class|class
name|JettyAsyncWithThreadsTest
extends|extends
name|CamelTestSupport
block|{
...
name|ENDPOINT_NAME
init|=
literal|"http://localhost:9876/asyncRouteTest"
decl_stmt|;
DECL|field|route
specifier|private
specifier|static
...
argument_list|)
expr_stmt|;
comment|// camel-jetty waits for the future task to complete as it needs to stream a reply
comment|// back to the http client
name|assertEquals
argument_list|(
literal|"BA"
argument_list|,
