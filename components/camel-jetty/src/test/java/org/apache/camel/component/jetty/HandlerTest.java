...
name|from
argument_list|(
literal|"jetty:http://localhost:9080/?handlers=#statisticsHandler1"
argument_list|)
operator|.
name|process
argument_list|(
...
name|from
argument_list|(
literal|"jetty:http://localhost:9081/?handlers=#statisticsHandler2,#statisticsHandler3"
argument_list|)
operator|.
name|process
argument_list|(
