...
name|requestBody
argument_list|(
literal|"http://localhost:9080/hello?foo="
operator|+
name|i
argument_list|,
literal|null
...
name|to
argument_list|(
literal|"http://localhost:9080/bye?throwExceptionOnFailure=false&bridgeEndpoint=true"
argument_list|)
expr_stmt|;
name|from
argument_list|(
literal|"jetty://http://localhost:9080/bye"
argument_list|)
operator|.
name|transform
argument_list|(
