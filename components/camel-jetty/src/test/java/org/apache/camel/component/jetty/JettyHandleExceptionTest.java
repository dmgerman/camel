...
annotation|@
name|Test
DECL|method|testHttpRouteProcessorException ()
specifier|public
name|void
name|testHttpRouteProcessorException
parameter_list|()
throws|throws
name|Exception
block|{
...
name|to
argument_list|(
literal|"http://localhost:8125/router?throwExceptionOnFailure=false"
argument_list|)
operator|.
name|to
argument_list|(
...
name|from
argument_list|(
literal|"jetty://http://localhost:8124/server"
argument_list|)
operator|.
name|process
argument_list|(
...
name|Exception
block|{
comment|// set the out message directly
name|exchange
operator|.
name|getOut
argument_list|()
...
name|from
argument_list|(
literal|"jetty://http://localhost:8125/router"
argument_list|)
operator|.
name|to
argument_list|(
literal|"http://localhost:8124/server?bridgeEndpoint=true"
argument_list|)
operator|.
name|process
argument_list|(
