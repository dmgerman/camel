...
expr_stmt|;
block|}
comment|/**      * Factory method used by producers and consumers to create a new {@link org.apache.commons.httpclient.HttpClient} instance      */
DECL|method|getJettyHttpClient ()
specifier|public
name|HttpClient
...
expr_stmt|;
block|}
comment|// TODO: allow jetty producer configuration from uri
name|answer
operator|.
name|start
argument_list|()
