...
name|ce
decl_stmt|;
DECL|method|JettyContentExchange (Exchange exchange, JettyHttpBinding jettyBinding, final HttpClient client)
specifier|public
name|JettyContentExchange
parameter_list|(
name|Exchange
...
condition|)
block|{
comment|// there may be another parameter as well, we only want the charset parameter
name|String
name|extra
init|=
literal|""
