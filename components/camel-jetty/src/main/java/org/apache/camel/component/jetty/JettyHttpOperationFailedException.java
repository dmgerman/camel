...
name|responseBody
decl_stmt|;
DECL|method|JettyHttpOperationFailedException (String url, int statusCode, Map<String, Object> headers, String responseBody)
specifier|public
name|JettyHttpOperationFailedException
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|JettyHttpOperationFailedException (String url, int statusCode, String location, Map<String, Object> headers, String responseBody)
specifier|public
name|JettyHttpOperationFailedException
parameter_list|(
name|String
