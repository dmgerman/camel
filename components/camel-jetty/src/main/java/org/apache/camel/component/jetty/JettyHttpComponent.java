...
condition|)
block|{
comment|// As the server is started, we need to stop the server for a while to add the new handler
name|connectorRef
operator|.
name|server
operator|.
...
return|;
block|}
DECL|method|createConnectorJetty9 (Server server, JettyHttpEndpoint endpoint, SslContextFactory sslcf, String hosto, int porto)
specifier|protected
name|AbstractConnector
name|createConnectorJetty9
parameter_list|(
...
return|;
block|}
DECL|method|createConnectorJetty8 (Server server, JettyHttpEndpoint endpoint, SslContextFactory sslcf, String hosto, int porto)
specifier|protected
name|AbstractConnector
name|createConnectorJetty8
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|//httpClient.setExecutor(qtp);
block|}
if|if
condition|(
name|LOG
