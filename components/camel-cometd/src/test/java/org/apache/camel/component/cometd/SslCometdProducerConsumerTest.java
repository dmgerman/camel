...
begin_class
DECL|class|SslCometdProducerConsumerTest
specifier|public
class|class
name|SslCometdProducerConsumerTest
extends|extends
name|ContextTestSupport
block|{
DECL|field|URI
...
name|URI
init|=
literal|"cometds://localhost:8080/service/test?resourceBase=./target/test-classes/webapp&"
operator|+
