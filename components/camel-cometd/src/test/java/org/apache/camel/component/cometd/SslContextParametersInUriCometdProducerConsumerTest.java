...
begin_class
DECL|class|SslContextParametersInUriCometdProducerConsumerTest
specifier|public
class|class
name|SslContextParametersInUriCometdProducerConsumerTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|port
...
argument_list|)
DECL|method|addSslContextParameters ()
specifier|public
name|SSLContextParameters
name|addSslContextParameters
parameter_list|()
block|{
name|KeyStoreParameters
name|ksp
...
name|Exception
block|{
comment|// setup SSL on the component
