...
annotation|@
name|Test
DECL|method|testRestletProducerGetWithPathQueryParams ()
specifier|public
name|void
name|testRestletProducerGetWithPathQueryParams
parameter_list|()
throws|throws
name|Exception
block|{
...
name|requestBodyAndHeader
argument_list|(
literal|"direct:startWithPathQueryParams"
argument_list|,
literal|null
argument_list|,
literal|"id"
...
name|portNum
operator|+
literal|"/users/{id}/basic?id=1235"
argument_list|)
operator|.
name|to
argument_list|(
