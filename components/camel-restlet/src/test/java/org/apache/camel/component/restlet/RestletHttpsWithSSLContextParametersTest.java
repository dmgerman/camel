...
begin_class
DECL|class|RestletHttpsWithSSLContextParametersTest
specifier|public
class|class
name|RestletHttpsWithSSLContextParametersTest
extends|extends
...
name|portNum
operator|+
literal|"/users/?restletMethods=post&sslContextParameters=#mySSLContextParameters"
argument_list|)
operator|.
name|process
argument_list|(
