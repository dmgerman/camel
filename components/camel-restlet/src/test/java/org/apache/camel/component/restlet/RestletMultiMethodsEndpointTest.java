...
argument_list|)
decl_stmt|;
comment|// delete is not allowed so we return 405
name|assertEquals
argument_list|(
name|Status
operator|.
...
name|assertTrue
argument_list|(
literal|"POST should be allowed"
argument_list|,
name|value
operator|.
name|contains
...
name|portNum
operator|+
literal|"/users/{username}?restletMethods=post,get,put"
argument_list|)
operator|.
name|process
argument_list|(
