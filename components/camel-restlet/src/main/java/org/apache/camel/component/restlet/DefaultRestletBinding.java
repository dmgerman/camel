...
argument_list|)
expr_stmt|;
name|configureRestletRequestStandardHeaders
argument_list|(
name|exchange
argument_list|,
name|request
...
block|}
block|}
DECL|method|configureRestletRequestStandardHeaders (Exchange exchange, Request request, Series standardHeaders)
specifier|private
name|void
name|configureRestletRequestStandardHeaders
parameter_list|(
...
condition|)
block|{
comment|// assume only accepting one encoding
name|ClientInfo
name|clientInfo
init|=
name|request
...
block|}
block|}
DECL|method|configureRestletResponseStandardHeaders (Exchange exchange, Response response, Series standardHeaders)
specifier|private
name|void
name|configureRestletResponseStandardHeaders
parameter_list|(
name|Exchange
name|exchange
parameter_list|,
...
argument_list|)
expr_stmt|;
comment|// if empty response and status is OK, then set it to NO_CONTENT which is more correct
if|if
condition|(
name|Status
operator|.
...
argument_list|)
expr_stmt|;
comment|// include the extension headers on the response
if|if
condition|(
name|extensionHeaders
operator|.
