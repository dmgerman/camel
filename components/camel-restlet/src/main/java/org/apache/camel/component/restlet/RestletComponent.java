...
condition|)
block|{
name|deattachUriPatternFrimRestlet
argument_list|(
name|router
operator|.
name|getUriPattern
...
block|}
block|}
DECL|method|createServer (RestletEndpoint endpoint)
specifier|protected
name|Server
name|createServer
parameter_list|(
...
return|;
block|}
DECL|method|stringArrayToString (String[] strings)
specifier|protected
name|String
...
return|;
block|}
DECL|method|setupServerWithSSLContext (Series<Parameter> params, SSLContextParameters scp)
specifier|protected
name|void
...
block|}
block|}
DECL|method|deattachUriPatternFrimRestlet (String uriPattern, RestletEndpoint endpoint, Restlet target)
specifier|private
name|void
name|deattachUriPatternFrimRestlet
parameter_list|(
...
name|debug
argument_list|(
literal|"Deattached methodRouter uriPattern: {}"
argument_list|,
name|uriPattern
argument_list|)
expr_stmt|;
...
name|format
argument_list|(
literal|"restlet:%s/%s/%s?restletMethods=%s"
argument_list|,
name|host
argument_list|,
name|basePath
...
name|format
argument_list|(
literal|"restlet:%s/%s?restletMethods=%s"
argument_list|,
name|host
argument_list|,
name|basePath
