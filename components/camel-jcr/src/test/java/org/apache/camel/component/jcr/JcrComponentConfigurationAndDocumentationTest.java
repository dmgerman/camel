...
begin_class
DECL|class|JcrComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|JcrComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|uri
init|=
literal|"jcr://gregor:secret@repo/home/gregor?deep=true&eventTypes=3&noLocal=false"
decl_stmt|;
name|EndpointConfiguration
name|configuration
init|=
...
name|contains
argument_list|(
literal|"\"deep\": { \"kind\": \"parameter\", \"type\": \"boolean\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"eventTypes\": { \"kind\": \"parameter\", \"type\": \"integer\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"noLocal\": { \"kind\": \"parameter\", \"type\": \"boolean\""
argument_list|)
argument_list|)
expr_stmt|;
block|}
