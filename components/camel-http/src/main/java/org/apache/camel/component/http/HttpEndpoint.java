...
begin_comment
comment|/**  * For calling out to external HTTP servers using Apache HTTP Client 3.x.  */
end_comment
...
literal|true
argument_list|)
DECL|field|httpConnectionManagerOptions
specifier|private
name|Map
argument_list|<
name|String
...
expr_stmt|;
block|}
DECL|method|getHttpConnectionManagerOptions ()
specifier|public
name|Map
argument_list|<
name|String
...
name|Object
argument_list|>
name|getHttpConnectionManagerOptions
parameter_list|()
block|{
return|return
name|httpConnectionManagerOptions
return|;
block|}
comment|/**      * To configure the HttpConnectionManager using the key/values from the Map.      */
DECL|method|setHttpConnectionManagerOptions (Map<String, Object> httpConnectionManagerOptions)
specifier|public
name|void
name|setHttpConnectionManagerOptions
parameter_list|(
name|Map
argument_list|<
name|String
