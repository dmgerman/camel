...
argument_list|)
expr_stmt|;
comment|// the http server will not provide body on HTTP DELETE so we cannot test the server side
block|}
annotation|@
name|Test
DECL|method|httpGetWithBody ()
specifier|public
name|void
name|httpGetWithBody
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// the http server will not provide body on HTTP GET so we cannot test the server side
block|}
annotation|@
name|Test
