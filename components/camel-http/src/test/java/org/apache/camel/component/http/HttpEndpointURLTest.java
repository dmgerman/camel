...
name|getEndpoint
argument_list|(
literal|"https://www.google.com?test=parameter&proxyAuthHost=myotherproxy&proxyAuthPort=2345"
argument_list|,
name|HttpEndpoint
operator|.
name|class
...
name|getEndpoint
argument_list|(
literal|"https://http://www.google.com"
argument_list|,
name|HttpEndpoint
operator|.
name|class
...
name|getEndpoint
argument_list|(
literal|"http://www.google.com?maxTotalConnections=40&connectionsPerRoute=5"
argument_list|,
name|HttpEndpoint
operator|.
name|class
...
name|getEndpoint
argument_list|(
literal|"http://www.google.com?authenticationPreemptive=true&authPassword=RAW(foo%bar)&authUsername=RAW(username)"
argument_list|,
name|HttpEndpoint
operator|.
name|class
