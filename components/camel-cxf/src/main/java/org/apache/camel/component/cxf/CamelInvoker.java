...
condition|)
block|{
comment|// The exception will be send back to the soap client
name|CxfMessage
name|fault
init|=
name|result
...
expr_stmt|;
block|}
comment|// Copy the outMessage back if we set the out's body
name|org
operator|.
name|apache
operator|.
...
expr_stmt|;
block|}
comment|// set the CXF outMessage back to the exchange
name|exchange
operator|.
name|setOutMessage
argument_list|(
