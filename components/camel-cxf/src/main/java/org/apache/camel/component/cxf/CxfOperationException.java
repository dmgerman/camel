...
begin_class
DECL|class|CxfOperationException
specifier|public
class|class
...
name|responseBody
decl_stmt|;
DECL|method|CxfOperationException (String uri, int statusCode, String statusText, String location, Map<String, String> responseHeaders, String responseBody)
specifier|public
name|CxfOperationException
parameter_list|(
name|String
...
name|super
argument_list|(
literal|"JAXRS operation failed invoking "
operator|+
name|uri
operator|+
