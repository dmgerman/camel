...
expr_stmt|;
block|}
comment|/*String acceptContentType = inMessage.getHeader(Exchange.ACCEPT_CONTENT_TYPE, String.class);         if (acceptContentType != null) {                         client.accept(acceptContentType);                     }*/
name|Object
name|response
init|=
literal|null
...
throw|;
block|}
DECL|method|checkRequestObject (Object request)
specifier|private
name|Object
name|checkRequestObject
parameter_list|(
