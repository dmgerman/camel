...
expr_stmt|;
block|}
DECL|method|CxfClientCallback (Client client, AsyncCallback callback, Exchange camelExchange, org.apache.cxf.message.Exchange cxfExchange, BindingOperationInfo boi, CxfBinding binding)
specifier|public
name|CxfClientCallback
parameter_list|(
name|Client
