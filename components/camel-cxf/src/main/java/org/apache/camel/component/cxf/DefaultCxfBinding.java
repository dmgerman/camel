...
expr_stmt|;
block|}
comment|/**      * @param cxfMessage      * @param camelMessage      */
DECL|method|propagateHeadersFromCxfToCamel (Message cxfMessage, org.apache.camel.Message camelMessage)
specifier|protected
name|void
name|propagateHeadersFromCxfToCamel
parameter_list|(
...
continue|continue;
block|}
comment|// put content type in exchange
if|if
condition|(
name|CamelTransportConstants
operator|.
