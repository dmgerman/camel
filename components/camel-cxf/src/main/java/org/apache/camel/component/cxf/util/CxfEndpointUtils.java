...
return|;
block|}
DECL|method|getServiceClass (CxfEndpoint cxfEndpoint)
specifier|public
specifier|static
name|Class
...
name|ClassNotFoundException
argument_list|(
literal|"Can't find serviceClass instace with name"
operator|+
name|cxfEndpoint
operator|.
name|getServiceClassInstance
argument_list|()
operator|+
literal|" from CamelContext registry."
argument_list|)
throw|;
block|}
block|}
...
block|}
block|}
DECL|method|getSetDefaultBus (CxfEndpoint endpoint)
specifier|public
specifier|static
name|boolean
...
literal|null
decl_stmt|;
comment|// check the value of cxfEndpointBean's property
name|CxfEndpointBean
name|cxfEndpointBean
init|=
name|endpoint
...
expr_stmt|;
block|}
comment|// We will get the value from the cxfEndpontBean's properties
if|if
condition|(
name|isSetDefaultBus
operator|!=
...
block|{
comment|// return the default value false
return|return
literal|false
return|;
block|}
block|}
DECL|method|getCxfEndpointPropertyValue (CxfEndpoint endpoint, String property)
specifier|public
specifier|static
name|String
name|getCxfEndpointPropertyValue
...
expr_stmt|;
block|}
comment|// return the default value if nothing is set
if|if
condition|(
name|dataFormatString
operator|==
