...
return|;
block|}
DECL|method|incoming (org.apache.camel.Exchange exchange)
specifier|protected
name|void
name|incoming
parameter_list|(
...
parameter_list|()
block|{
comment|// setup the endpoint infor here
block|}
...
name|IOException
block|{
comment|// put the output stream into the message
name|CachedOutputStream
name|outputStream
init|=
operator|(
...
argument_list|)
decl_stmt|;
comment|// send out the request message here
name|ex
operator|.
name|getIn
argument_list|()
