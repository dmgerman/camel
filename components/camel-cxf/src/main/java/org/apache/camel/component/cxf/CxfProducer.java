...
begin_comment
comment|/**  * CxfProducer binds a Camel exchange to a CXF exchange, acts an a CXF   * client, and sends the request to a CXF to a server.  Any response will   * be bound to Camel exchange.   *  * @version $Revision$  */
end_comment
