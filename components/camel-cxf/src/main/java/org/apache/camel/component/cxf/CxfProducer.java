...
return|;
block|}
DECL|method|prepareBindingOperation (Exchange camelExchange, org.apache.cxf.message.Exchange cxfExchange, Client client)
specifier|private
name|BindingOperationInfo
name|prepareBindingOperation
parameter_list|(
...
return|;
block|}
DECL|method|checkParameterSize (CxfEndpoint endpoint, Exchange exchange, Object[] parameters, Client client)
specifier|private
name|void
...
DECL|method|getParams (CxfEndpoint endpoint, Exchange exchange, Client client)
specifier|private
name|Object
index|[]
name|getParams
...
DECL|method|getBindingOperationInfo (Exchange ex, Client client)
specifier|private
name|BindingOperationInfo
name|getBindingOperationInfo
parameter_list|(
...
return|;
block|}
comment|// only invoked by unit test
...
return|;
block|}
comment|/**      * Cache contains {@link org.apache.cxf.endpoint.Client}      */
...
name|cache
decl_stmt|;
DECL|method|ClientCache (final int maxCacheSize)
specifier|public
name|ClientCache
parameter_list|(
specifier|final
...
name|trace
argument_list|(
literal|"Created CXF client and add to cache for address '"
operator|+
name|address
operator|+
literal|"'"
...
name|trace
argument_list|(
literal|"Retrieved CXF client from cache for address '"
operator|+
name|address
operator|+
literal|"'"
