...
begin_comment
comment|/**  * Default strategy  to bind between Camel and CXF exchange for RESTful resources.  *  *  * @version $Revision$  */
end_comment
...
name|trace
argument_list|(
literal|"Propagate Camel header: "
operator|+
name|entry
operator|.
name|getKey
...
name|trace
argument_list|(
literal|"Populate external header "
operator|+
name|entry
operator|.
name|getKey
