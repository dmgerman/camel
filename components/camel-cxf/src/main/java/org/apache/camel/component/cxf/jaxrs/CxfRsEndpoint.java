...
return|;
block|}
DECL|method|addServiceBean (Object bean)
specifier|public
name|void
name|addServiceBean
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * The service beans which you want to export as REST service. Multiple beans can be separated by comma.      */
DECL|method|setServiceBeans (List<?> beans)
specifier|public
name|void
name|setServiceBeans
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setServiceBeans (Object... beans)
specifier|public
name|void
name|setServiceBeans
parameter_list|(
