...
expr_stmt|;
block|}
comment|// To work around the invoke reenter issue
DECL|method|invoke (Exchange exchange, Object request)
specifier|public
name|Object
name|invoke
parameter_list|(
...
block|}
block|}
DECL|method|getServiceObject (Exchange exchange)
specifier|public
name|Object
name|getServiceObject
parameter_list|(
...
block|}
block|}
DECL|method|getResourceProvider (Exchange exchange)
specifier|private
name|ResourceProvider
name|getResourceProvider
parameter_list|(
...
block|}
block|}
DECL|method|isServiceObjectRequestScope (Message inMessage)
specifier|private
name|boolean
name|isServiceObjectRequestScope
parameter_list|(
