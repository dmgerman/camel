...
argument_list|)
decl_stmt|;
comment|// TODO we need to use the CXF 2.3.0 new Continuation API in CAMEL 3.0.0
comment|// The below code should work for CXF 2.2.x and CXF 2.3.x at the same time
