...
begin_class
DECL|class|CxfConsumerResponseTest
specifier|public
class|class
name|CxfConsumerResponseTest
extends|extends
name|CamelTestSupport
block|{
...
expr_stmt|;
name|int
name|afterCallingPing
init|=
name|pingCounter
decl_stmt|;
name|assertTrue
argument_list|(
literal|"The ping operation doesn't be called"
argument_list|,
name|afterCallingPing
operator|-
name|beforeCallingPing
