...
argument_list|)
expr_stmt|;
comment|// This route is for checking camel-cxf producer throwing exception
name|from
argument_list|(
...
name|to
argument_list|(
literal|"cxf://http://localhost:10000/false?serviceClass=org.apache.camel.component.cxf.HelloService"
argument_list|)
operator|.
name|doCatch
argument_list|(
...
annotation|@
name|Test
DECL|method|testCannotSendRequest ()
specifier|public
name|void
name|testCannotSendRequest
parameter_list|()
throws|throws
name|Exception
block|{
