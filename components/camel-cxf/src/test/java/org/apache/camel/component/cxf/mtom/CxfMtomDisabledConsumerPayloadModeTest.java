...
begin_comment
comment|/** * Unit test for exercising SOAP with Attachment (SwA) feature of a CxfConsumer in PAYLOAD mode.   * That is, testing attachment with MTOM optimization off. *  * @version $Revision$ */
end_comment
