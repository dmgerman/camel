...
annotation|@
name|Test
DECL|method|testInvokingJaxWsServerWithCxfEndpointWithConfigurer ()
specifier|public
name|void
name|testInvokingJaxWsServerWithCxfEndpointWithConfigurer
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|(
literal|"cxf://bean:springEndpoint?cxfEndpointConfigurer=#myConfigurer"
argument_list|)
decl_stmt|;
comment|// we don't expect the exception here
name|assertFalse
argument_list|(
literal|"We don't expect the exception here"
argument_list|,
name|reply
operator|.
name|isFailed
...
annotation|@
name|Test
DECL|method|testInvokingFromCamelRoute ()
specifier|public
name|void
name|testInvokingFromCamelRoute
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testDoCatchWithTimeOutException ()
specifier|public
name|void
name|testDoCatchWithTimeOutException
parameter_list|()
throws|throws
name|Exception
block|{
...
return|;
block|}
DECL|class|MyCxfEndpointConfigurer
specifier|public
specifier|static
class|class
name|MyCxfEndpointConfigurer
...
parameter_list|)
block|{
comment|// reset the timeout option to override the spring configuration one
name|HTTPConduit
name|conduit
init|=
operator|(
