...
annotation|@
name|Test
DECL|method|testBusInjectionOnURI ()
specifier|public
name|void
name|testBusInjectionOnURI
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getEndpoint
argument_list|(
literal|"cxf:bean:serviceEndpoint?bus=#cxf1"
argument_list|,
name|CxfEndpoint
operator|.
name|class
...
name|port1
operator|+
literal|"/CxfEndpointBeanBusSettingTest/router1?bus=#cxf1"
argument_list|,
name|CxfEndpoint
operator|.
name|class
