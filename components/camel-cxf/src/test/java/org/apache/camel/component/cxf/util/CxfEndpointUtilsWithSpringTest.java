...
name|createEndpoint
argument_list|(
literal|"cxf:bean:helloServiceEndpoint?serviceClassInstance=helloServiceImpl"
argument_list|)
decl_stmt|;
name|Class
name|clazz
...
name|assertNotNull
argument_list|(
literal|"The service calss should not be null "
argument_list|,
name|clazz
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
literal|"The service class should be the instance of HelloServiceImpl"
argument_list|,
name|clazz
operator|.
name|equals
...
expr_stmt|;
block|}
DECL|method|testGetURIOverCxfEndpointProperties ()
specifier|public
name|void
name|testGetURIOverCxfEndpointProperties
parameter_list|()
throws|throws
name|Exception
block|{
