...
block|{
return|return
literal|"cxf://http://localhost:9000/simple?serviceClass=org.apache.camel.component.cxf.HelloService"
return|;
block|}
annotation|@
name|Override
...
block|{
return|return
literal|"cxf://http://localhost:9000/jaxws?serviceClass=org.apache.hello_world_soap_http.Greeter"
return|;
block|}
annotation|@
name|Override
