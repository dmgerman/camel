...
begin_class
DECL|class|CxfGreeterWSDLOnlyRouterTest
specifier|public
class|class
name|CxfGreeterWSDLOnlyRouterTest
extends|extends
...
argument_list|()
operator|+
literal|"/CxfGreeterWSDLOnlyRouterTest/SoapContext/SoapPort"
decl_stmt|;
name|endpoint
operator|=
name|Endpoint
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/cxf/GreeterEndpointWSDLOnlyBeans.xml"
argument_list|)
return|;
block|}
block|}
