...
condition|)
block|{
comment|// the parameter is required but there is no header with the value
name|exchange
operator|.
name|setException
argument_list|(
...
expr_stmt|;
block|}
DECL|method|createHttpProducer (Exchange exchange, Operation operation, String verb, String path, String queryParameters)
specifier|protected
name|Producer
name|createHttpProducer
parameter_list|(
