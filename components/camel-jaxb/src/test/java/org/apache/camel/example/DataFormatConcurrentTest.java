...
literal|10000
decl_stmt|;
comment|//final String payload = "<purchaseOrder name='Wine' amount='123.45' price='2.22'/>";
specifier|final
name|String
name|payload
init|=
...
argument_list|()
decl_stmt|;
comment|//System.out.println("Length: " + payload.length());
specifier|final
name|CountDownLatch
name|latch
init|=
