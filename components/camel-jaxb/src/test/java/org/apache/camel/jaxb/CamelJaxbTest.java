...
annotation|@
name|Test
DECL|method|testFilterNonXmlChars ()
specifier|public
name|void
name|testFilterNonXmlChars
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testMarshalWithoutContentType ()
specifier|public
name|void
name|testMarshalWithoutContentType
parameter_list|()
throws|throws
name|Exception
block|{
...
name|sendBody
argument_list|(
literal|"direct:marshalWithoutContentType"
argument_list|,
name|person
argument_list|)
expr_stmt|;
...
expr_stmt|;
name|JaxbDataFormat
name|dataFormatWithoutContentType
init|=
operator|new
name|JaxbDataFormat
argument_list|(
