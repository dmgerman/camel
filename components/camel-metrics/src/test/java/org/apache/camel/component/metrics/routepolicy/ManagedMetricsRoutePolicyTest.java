...
begin_class
DECL|class|ManagedMetricsRoutePolicyTest
specifier|public
class|class
name|ManagedMetricsRoutePolicyTest
extends|extends
name|CamelTestSupport
block|{
...
name|format
argument_list|(
literal|"org.apache.camel:context=%s,type=services,name=MetricsRegistryService"
argument_list|,
name|context
operator|.
