...
name|from
argument_list|(
literal|"grpc://org.apache.camel.component.grpc.PingPong?synchronous=true&host=localhost&port="
operator|+
name|GRPC_ASYNC_REQUEST_TEST_PORT
argument_list|)
operator|.
...
argument_list|)
decl_stmt|;
comment|// As user agent name is prepended the library's user agent information it's necessary to extract this value (before first space)
name|PongResponse
name|pongResponse
init|=
name|PongResponse
