...
name|from
argument_list|(
literal|"direct:prefix"
argument_list|)
operator|.
name|to
argument_list|(
literal|"hazelcast:error:foo"
argument_list|)
expr_stmt|;
block|}
block|}
...
operator|+
literal|"'hazelcast:[map:|multimap:|atomicvalue:|instance:|queue:|seda:|list:|replicatedmap:|set:|ringbuffer:]name' but is 'hazelcast://error:foo"
argument_list|)
argument_list|)
expr_stmt|;
block|}
