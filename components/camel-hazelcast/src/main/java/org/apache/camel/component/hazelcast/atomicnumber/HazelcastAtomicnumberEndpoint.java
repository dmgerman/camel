...
begin_comment
comment|/**  * The hazelcast-atomicvalue component is used to access<a href="http://www.hazelcast.com/">Hazelcast</a> atomic number, which  * is an object that simply provides a grid wide number (long).  */
end_comment
...
name|title
operator|=
literal|"Hazelcast Atomic Number"
argument_list|,
name|syntax
operator|=
literal|"hazelcast-atomicvalue:cacheName"
argument_list|,
name|producerOnly
operator|=
literal|true
...
argument_list|)
DECL|class|HazelcastAtomicnumberEndpoint
specifier|public
class|class
