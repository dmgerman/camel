...
expr_stmt|;
block|}
DECL|method|PgEventEndpoint (String uri)
specifier|public
name|PgEventEndpoint
parameter_list|(
name|String
...
name|InvalidAttributesException
argument_list|(
literal|"The provided URL does not "
operator|+
literal|"match the acceptable patterns."
argument_list|)
throw|;
block|}
block|}
...
operator|+
literal|"not set when creating this Endpoint (channel)"
argument_list|)
throw|;
block|}
if|if
...
operator|+
literal|"pgjdbc-ng library. See: "
operator|+
literal|"https://github.com/impossibl/pgjdbc-ng"
argument_list|)
throw|;
block|}
block|}
...
literal|"A required parameter was "
operator|+
literal|"not set when creating this Endpoint (pgUser or "
operator|+
