...
begin_class
DECL|class|JavaspacesXPathTest
specifier|public
class|class
name|JavaspacesXPathTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|latch
...
name|str1
init|=
literal|"<person name='David' city='Rome'/>"
decl_stmt|;
name|message
operator|.
name|setBody
...
name|from
argument_list|(
literal|"javaspace:jini://localhost?spaceName=mySpace&verb=take&concurrentConsumers=1&transactional=false"
argument_list|)
operator|.
name|filter
argument_list|()
