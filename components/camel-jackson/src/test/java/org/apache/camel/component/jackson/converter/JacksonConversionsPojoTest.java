...
begin_class
DECL|class|JacksonConversionsPojoTest
specifier|public
class|class
name|JacksonConversionsPojoTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
annotation|@
name|Test
DECL|method|shouldConvertPojoToString ()
specifier|public
name|void
name|shouldConvertPojoToString
parameter_list|()
block|{
name|Order
name|order
...
name|assertEquals
argument_list|(
literal|"{\"id\":0,\"partName\":\"Camel\",\"amount\":1,\"customerName\":\"Acme\"}"
argument_list|,
name|json
argument_list|)
expr_stmt|;
