...
block|{
name|boolean
name|objectMapperFoundRegistry
init|=
literal|false
decl_stmt|;
if|if
...
name|warn
argument_list|(
literal|"The option autoDiscoverObjectMapper is set to false, Camel won't search in the registry"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|debug
argument_list|(
literal|"Setting timezone to Object Mapper: {}"
argument_list|,
name|timezone
argument_list|)
expr_stmt|;
