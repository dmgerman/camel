...
begin_class
DECL|class|Jt400ComponentDefaultSecureConnectionPoolTest
specifier|public
class|class
name|Jt400ComponentDefaultSecureConnectionPoolTest
extends|extends
...
name|createEndpoint
argument_list|(
literal|"jt400://user:password@host/qsys.lib/library.lib/program.xxx?secured=true"
argument_list|)
expr_stmt|;
name|Assert
operator|.
