...
annotation|@
name|Test
DECL|method|testRsaFilePKCS8 ()
specifier|public
name|void
name|testRsaFilePKCS8
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testEncryptedRsaFile ()
specifier|public
name|void
name|testEncryptedRsaFile
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testECFilePKCS8 ()
specifier|public
name|void
name|testECFilePKCS8
parameter_list|()
throws|throws
name|Exception
block|{
...
name|sendBody
argument_list|(
literal|"direct:ssh-ecFilepkcs8"
argument_list|,
name|msg
argument_list|)
expr_stmt|;
...
name|port
operator|+
literal|"?certResource=file:src/test/resources/rsa.pem"
argument_list|)
operator|.
name|to
argument_list|(
...
name|port
operator|+
literal|"?certResource=file:src/test/resources/encrsa.pem&certResourcePassword=security"
argument_list|)
operator|.
name|to
argument_list|(
...
name|port
operator|+
literal|"?certResource=file:src/test/resources/ecpkcs8.pem"
argument_list|)
operator|.
name|to
argument_list|(
