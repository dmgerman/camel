...
begin_comment
comment|/**  * Unit test for the HL7MLLP Codec using different start and end bytes.  */
end_comment

begin_class
DECL|class|HL7MLLPCodecStandAndEndBytesTest
specifier|public
class|class
name|HL7MLLPCodecStandAndEndBytesTest
extends|extends
name|HL7TestSupport
block|{
annotation|@
...
argument_list|)
expr_stmt|;
comment|// to test with different start and end bytes.
name|codec
operator|.
name|setStartByte
argument_list|(
