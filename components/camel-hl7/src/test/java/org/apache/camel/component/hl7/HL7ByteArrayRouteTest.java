...
begin_comment
comment|/**  * Unit test for HL7 routing where the mina endpoint passes on a byte array  * instead of a string and leaves charset interpretation to the dataformat.  */
end_comment

begin_class
DECL|class|HL7ByteArrayRouteTest
specifier|public
class|class
name|HL7ByteArrayRouteTest
extends|extends
name|HL7TestSupport
block|{
annotation|@
...
literal|"hl7service"
argument_list|)
DECL|method|addHl7MllpService ()
specifier|public
name|MyHL7BusinessLogic
name|addHl7MllpService
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"MSH|^~\\&|MYSENDER||||200701011539||ADR^A19||||123|||||UNICODE UTF-8"
argument_list|,
name|lines
index|[
literal|0
...
name|line1
init|=
literal|"MSH|^~\\&|MYSENDER|MYSENDERAPP|MYCLIENT|MYCLIENTAPP|200612211200||ADT^A01|123|P|2.4||||||UNICODE UTF-8"
decl_stmt|;
name|String
name|line2
init|=
literal|"PID|||123456||D̦e^John"
decl_stmt|;
name|StringBuilder
name|in
init|=
...
name|assertEquals
argument_list|(
literal|"MSH|^~\\&|MYSENDER||||200701011539||ADT^A01||||123|||||UNICODE UTF-8"
argument_list|,
name|lines
index|[
literal|0
