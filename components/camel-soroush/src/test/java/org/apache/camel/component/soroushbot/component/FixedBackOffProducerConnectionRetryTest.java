...
begin_class
DECL|class|FixedBackOffProducerConnectionRetryTest
specifier|public
class|class
name|FixedBackOffProducerConnectionRetryTest
extends|extends
name|SoroushBotTestSupport
block|{
annotation|@
...
operator|+
literal|"&retryWaitingTime=500&backOffStrategy=fixed"
argument_list|)
operator|.
name|to
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//cause this thread to sleep 4*.5 second. even in this time,no message should be sent
name|beforeAllRetry
operator|.
...
argument_list|)
expr_stmt|;
comment|//cause this thread to sleep an addition of .6 second, during this time,the message must be sent to the server
name|afterAllRetry
operator|.
name|setAssertPeriod
argument_list|(
