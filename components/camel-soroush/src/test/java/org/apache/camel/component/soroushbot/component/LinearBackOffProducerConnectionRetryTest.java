...
begin_class
DECL|class|LinearBackOffProducerConnectionRetryTest
specifier|public
class|class
name|LinearBackOffProducerConnectionRetryTest
extends|extends
name|SoroushBotTestSupport
block|{
annotation|@
...
operator|+
literal|"&retryWaitingTime=500&retryLinearIncrement=1000&backOffStrategy=linear"
argument_list|)
operator|.
name|to
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//cause this thread to sleep .5+1.5+2.5+3.5 second. even in this time,no message should be sent
name|beforeAllRetry
operator|.
