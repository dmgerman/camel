...
begin_class
DECL|class|ExponentialBackOffProducerConnectionRetryTest
specifier|public
class|class
name|ExponentialBackOffProducerConnectionRetryTest
extends|extends
name|SoroushBotTestSupport
block|{
annotation|@
...
operator|+
literal|"&retryWaitingTime=500&retryExponentialCoefficient=2&backOffStrategy=exponential"
argument_list|)
operator|.
name|to
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//cause this thread to sleep .5+1+2+4 second. even in this time,no message should be sent
name|beforeAllRetry
operator|.
