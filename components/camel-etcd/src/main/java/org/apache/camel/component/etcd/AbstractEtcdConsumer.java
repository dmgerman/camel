...
name|client
decl_stmt|;
DECL|method|AbstractEtcdConsumer (AbstractEtcdEndpoint endpoint, Processor processor, EtcdConfiguration configuration, EtcdNamespace namespace, String path)
specifier|protected
name|AbstractEtcdConsumer
parameter_list|(
