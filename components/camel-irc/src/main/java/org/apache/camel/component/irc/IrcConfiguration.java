...
name|RuntimeCamelException
argument_list|(
literal|"The IRC channel name is required but not configured"
argument_list|)
throw|;
block|}
name|String
...
condition|)
block|{
comment|//Need to strip off the query string from this fragment
name|channel
operator|=
name|ObjectHelper
operator|.
...
expr_stmt|;
block|}
DECL|method|setTrustManagerClass (String trustManagerClass)
specifier|public
name|void
name|setTrustManagerClass
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|getTrustManagerClass ()
specifier|public
name|String
