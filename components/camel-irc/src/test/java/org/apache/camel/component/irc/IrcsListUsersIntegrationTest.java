...
begin_class
DECL|class|IrcsListUsersIntegrationTest
specifier|public
class|class
name|IrcsListUsersIntegrationTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|LOGGER
...
name|PRODUCER_URI
init|=
literal|"ircs:{{test.user}}@{{test.server}}/{{test.room}}"
decl_stmt|;
annotation|@
name|EndpointInject
argument_list|(
...
name|properties
decl_stmt|;
DECL|method|IrcsListUsersIntegrationTest ()
specifier|public
name|IrcsListUsersIntegrationTest
parameter_list|()
throws|throws
...
argument_list|(
literal|"/it-list-users.properties"
argument_list|)
decl_stmt|;
name|properties
operator|.
