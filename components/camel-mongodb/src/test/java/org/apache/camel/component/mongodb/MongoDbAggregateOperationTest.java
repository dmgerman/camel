...
name|assertEquals
argument_list|(
literal|"First result DBOject._id should be Darwin"
argument_list|,
literal|"Darwin"
argument_list|,
name|resultList
...
name|assertEquals
argument_list|(
literal|"First result DBOject.count should be 100"
argument_list|,
literal|100
argument_list|,
name|resultList
...
name|assertEquals
argument_list|(
literal|"Second result DBOject._id should be Einstein"
argument_list|,
literal|"Einstein"
argument_list|,
name|resultList
...
name|assertEquals
argument_list|(
literal|"Second result DBOject.count should be 100"
argument_list|,
literal|100
argument_list|,
name|resultList
...
annotation|@
name|Test
DECL|method|testAggregateDBCursorBatchSize ()
specifier|public
name|void
name|testAggregateDBCursorBatchSize
parameter_list|()
block|{
comment|// Test that the collection has 0 documents in it
name|assertEquals
...
name|to
argument_list|(
literal|"mongodb:myDb?database={{mongodb.testDb}}&collection={{mongodb.testCollection}}&operation=aggregate&dynamicity=true&outputType=DBCursor"
argument_list|)
operator|.
name|to
argument_list|(
