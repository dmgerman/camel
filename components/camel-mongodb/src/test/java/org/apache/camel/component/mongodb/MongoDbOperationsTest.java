...
annotation|@
name|Test
DECL|method|testMultiInsertStringFromDBListNoHeader ()
specifier|public
name|void
name|testMultiInsertStringFromDBListNoHeader
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"direct:insert"
argument_list|,
literal|"[{\"_id\":\"testInsertString2\", \"scientist\":\"Einstein\"}, "
operator|+
literal|"{\"_id\":\"testInsertString3\", \"scientist\":\"Einstein Too\"}]"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|assertNotNull
argument_list|(
literal|"No record with 'testInsertString2' _id"
argument_list|,
name|b
argument_list|)
expr_stmt|;
...
name|assertNotNull
argument_list|(
literal|"No record with 'testInsertString3' _id"
argument_list|,
name|b
argument_list|)
expr_stmt|;
...
annotation|@
name|Test
DECL|method|testMultiInsertStringFromListNoHeader ()
specifier|public
name|void
name|testMultiInsertStringFromListNoHeader
parameter_list|()
throws|throws
name|Exception
block|{
...
name|newArrayList
argument_list|(
literal|"{\"_id\":\"testInsertString4\", \"scientist\":\"Einstein\"}"
argument_list|,
literal|"{\"_id\":\"testInsertString5\", \"scientist\":\"Einstein Too\"}"
argument_list|)
argument_list|)
decl_stmt|;
name|assertTrue
...
name|assertNotNull
argument_list|(
literal|"No record with 'testInsertString4' _id"
argument_list|,
name|b
argument_list|)
expr_stmt|;
...
name|assertNotNull
argument_list|(
literal|"No record with 'testInsertString5' _id"
argument_list|,
name|b
argument_list|)
expr_stmt|;
...
annotation|@
name|Test
DECL|method|testMultiInsertStringFromDBListHeader ()
specifier|public
name|void
name|testMultiInsertStringFromDBListHeader
parameter_list|()
throws|throws
name|Exception
block|{
...
name|requestBody
argument_list|(
literal|"direct:multiinsert"
argument_list|,
literal|"[{\"_id\":\"testInsertString6\", \"scientist\":\"Einstein\"}, "
operator|+
literal|"{\"_id\":\"testInsertString7\", \"scientist\":\"Einstein Too\"}]"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|assertNotNull
argument_list|(
literal|"No record with 'testInsertString6' _id"
argument_list|,
name|b
argument_list|)
expr_stmt|;
...
name|assertNotNull
argument_list|(
literal|"No record with 'testInsertString7' _id"
argument_list|,
name|b
argument_list|)
expr_stmt|;
...
annotation|@
name|Test
DECL|method|testMultiInsertStringFromListHeader ()
specifier|public
name|void
name|testMultiInsertStringFromListHeader
parameter_list|()
throws|throws
name|Exception
block|{
...
name|newArrayList
argument_list|(
literal|"{\"_id\":\"testInsertString8\", \"scientist\":\"Einstein\"}"
argument_list|,
literal|"{\"_id\":\"testInsertString9\", \"scientist\":\"Einstein Too\"}"
argument_list|)
argument_list|)
decl_stmt|;
name|assertTrue
...
name|assertNotNull
argument_list|(
literal|"No record with 'testInsertString8' _id"
argument_list|,
name|b
argument_list|)
expr_stmt|;
...
name|assertNotNull
argument_list|(
literal|"No record with 'testInsertString9' _id"
argument_list|,
name|b
argument_list|)
expr_stmt|;
