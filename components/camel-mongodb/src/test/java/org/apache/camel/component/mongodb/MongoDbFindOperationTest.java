...
name|assertEquals
argument_list|(
literal|"DBOject.scientist should only be Einstein"
argument_list|,
literal|"Einstein"
argument_list|,
name|dbObject
...
name|assertTrue
argument_list|(
literal|"The ID of the retrieved DBObject should be ObjectId"
argument_list|,
name|result
operator|.
name|get
...
name|assertEquals
argument_list|(
literal|"The ID of the retrieved DBObject should equal to the inserted"
argument_list|,
name|id
argument_list|,
name|result
