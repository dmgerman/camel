...
name|startsWith
argument_list|(
literal|"No match for read preference"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|createMongoDbEndpoint
argument_list|(
literal|"mongodb:myDb?database={{mongodb.testDb}}&readPreference=primaryPreferred"
argument_list|)
expr_stmt|;
name|assertSame
argument_list|(
...
name|createMongoDbEndpoint
argument_list|(
literal|"mongodb:myDb?database={{mongodb.testDb}}&readPreference=secondaryPreferred"
argument_list|)
expr_stmt|;
name|assertSame
argument_list|(
