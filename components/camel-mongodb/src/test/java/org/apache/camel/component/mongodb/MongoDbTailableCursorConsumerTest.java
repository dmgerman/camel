...
argument_list|)
expr_stmt|;
comment|//BasicDBObjectBuilder.start().add("capped", true).add("size", 1000000000).add("max", 1000).get()
...
name|from
argument_list|(
literal|"mongodb:myDb?database={{mongodb.testDb}}&collection={{mongodb.cappedTestCollection}}&tailTrackIncreasingField=increasing&readPreference=primary"
argument_list|)
operator|.
name|id
argument_list|(
