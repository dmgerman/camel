...
argument_list|)
decl_stmt|;
comment|//TODO Manage the read preference
name|result
operator|=
name|db
operator|.
...
name|processAndTransferDeleteResult
argument_list|(
name|result
argument_list|,
name|exchange
...
name|processAndTransferUpdateResult
argument_list|(
name|result
argument_list|,
name|exchange
...
argument_list|)
expr_stmt|;
comment|//TODO: insertOne doesn't return a WriteResult
comment|// we always return the WriteResult, because whether the getLastError was called or not, the user will have the means to call it or
comment|// obtain the cached CommandResult
name|processAndTransferUpdateResult
argument_list|(
...
expr_stmt|;
block|}
DECL|method|processAndTransferResult (Object result, Exchange exchange)
specifier|private
name|void
...
return|;
block|}
DECL|method|processAndTransferDeleteResult (DeleteResult result, Exchange exchange)
specifier|private
name|void
name|processAndTransferDeleteResult
parameter_list|(
...
block|}
block|}
DECL|method|processAndTransferUpdateResult (UpdateResult result, Exchange exchange)
specifier|private
name|void
name|processAndTransferUpdateResult
parameter_list|(
