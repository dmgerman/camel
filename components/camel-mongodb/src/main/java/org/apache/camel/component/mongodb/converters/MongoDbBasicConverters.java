...
annotation|@
name|Converter
DECL|method|fromStringToBasicDBList (String s)
specifier|public
specifier|static
name|BasicDBList
name|fromStringToBasicDBList
parameter_list|(
name|String
name|s
parameter_list|)
...
name|warn
argument_list|(
literal|"String -> BasicDBList conversion selected, but the following exception occurred. Returning null."
argument_list|,
name|e
argument_list|)
expr_stmt|;
