...
begin_comment
comment|/**  * Abstract base class for Box Integration tests generated by Camel API component maven plugin.  */
end_comment
...
argument_list|()
decl_stmt|;
comment|// read Box component configuration from TEST_OPTIONS_PROPERTIES
specifier|final
name|Properties
name|properties
init|=
...
argument_list|)
expr_stmt|;
comment|//initialize flag, whether is box configuration JWT
name|String
