...
annotation|@
name|Test
DECL|method|testUploadOverwriteFile ()
specifier|public
name|void
name|testUploadOverwriteFile
parameter_list|()
throws|throws
name|Exception
block|{
...
name|requestBodyAndHeaders
argument_list|(
literal|"direct://UPLOADFILEOVERWRITE"
argument_list|,
literal|null
argument_list|,
name|headers
...
name|assertNotNull
argument_list|(
literal|"uploadFile overwrite result"
argument_list|,
name|result
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// test route for uploadFile to overwrite
name|from
argument_list|(
literal|"direct://UPLOADFILEOVERWRITE"
argument_list|)
