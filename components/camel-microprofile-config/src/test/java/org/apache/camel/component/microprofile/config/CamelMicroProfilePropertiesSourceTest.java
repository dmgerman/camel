...
argument_list|)
expr_stmt|;
comment|// should auto-detect this JAR on the classpath and use it (but this can only be tested outside this component)
name|CamelContext
name|context
init|=
name|super
...
argument_list|()
decl_stmt|;
comment|// ... so we add the source manually
name|PropertiesComponent
name|pc
init|=
operator|(
