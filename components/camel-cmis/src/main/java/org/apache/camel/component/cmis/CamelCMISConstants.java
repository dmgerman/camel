...
decl_stmt|;
DECL|field|CMIS_OBJECT_ID
name|String
name|CMIS_OBJECT_ID
init|=
literal|"CamelCMISObjectId"
decl_stmt|;
DECL|field|CMIS_DESTIONATION_FOLDER_ID
name|String
name|CMIS_DESTIONATION_FOLDER_ID
init|=
literal|"CamelCMISDestinationFolderId"
decl_stmt|;
DECL|field|CMIS_SOURCE_FOLDER_ID
name|String
name|CMIS_SOURCE_FOLDER_ID
init|=
literal|"CamelCMISSourceFolderId"
decl_stmt|;
DECL|field|CMIS_DOCUMENT_PATH
name|String
name|CMIS_DOCUMENT_PATH
init|=
literal|"CamelCMISDocumentPath"
decl_stmt|;
