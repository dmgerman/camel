...
expr_stmt|;
block|}
comment|// In netty we need to call channel flush to send out the message
name|future
operator|=
name|channel
operator|.
...
block|}
block|}
comment|/**      * Creates a {@link DefaultEventExecutorGroup} with the given name and maximum thread pool size.      */
DECL|method|createExecutorGroup (CamelContext camelContext, String name, int threads)
specifier|public
specifier|static
name|EventExecutorGroup
