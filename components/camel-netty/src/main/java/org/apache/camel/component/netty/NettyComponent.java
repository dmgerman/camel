...
return|;
block|}
comment|/**      * Whether to use ordered thread pool, to ensure events are processed orderly on the same channel.      * See details at the netty javadoc of org.jboss.netty.handler.execution.OrderedMemoryAwareThreadPoolExecutor for more details.      * @param orderedThreadPoolExecutor      */
...
return|;
block|}
comment|/**      * If the useChannelBuffer is true, netty producer will turn the message body into {@link ChannelBuffer} before sending it out.      * @param useChannelBuffer      */
...
return|;
block|}
comment|/**      * The maximum total size of the queued events per channel when using orderedThreadPoolExecutor.      * Specify 0 to disable.      * @param maxChannelMemorySize      */
...
return|;
block|}
comment|/**      * The maximum total size of the queued events for this pool when using orderedThreadPoolExecutor.      * Specify 0 to disable.      * @param maxTotalMemorySize      */
...
return|;
block|}
comment|/**      * To use a custom ServerPipelineFactory      * @param serverPipelineFactory      */
...
return|;
block|}
comment|/**      * To use a explicit org.jboss.netty.channel.socket.nio.BossPool as the boss thread pool.      * For example to share a thread pool with multiple consumers. By default each consumer has their own boss pool with 1 core thread.      * @param bossPool      */
...
expr_stmt|;
block|}
comment|/**      * To use a explicit org.jboss.netty.channel.socket.nio.WorkerPool as the worker thread pool.      * For example to share a thread pool with multiple consumers. By default each consumer has their own worker pool with 2 x cpu count core threads.      * @param workerPool      */
...
return|;
block|}
comment|/**      * A custom ChannelHandler class that can be used to perform special marshalling of outbound payloads. Must override org.jboss.netty.channel.ChannelDownStreamHandler.      * @param encoder      */
...
return|;
block|}
comment|/**      * A custom ChannelHandler class that can be used to perform special marshalling of inbound payloads. Must override org.jboss.netty.channel.ChannelUpStreamHandler.      * @param decoder      */
...
expr_stmt|;
block|}
comment|/**      * To use a custom ClientPipelineFactory      * @param clientPipelineFactory      */
