...
begin_comment
comment|/**  * A builder to create Netty {@link org.jboss.netty.channel.socket.nio.BossPool} which can be used for sharing boss pools  * with multiple Netty {@link org.apache.camel.component.netty.NettyServerBootstrapFactory} server bootstrap configurations.  */
end_comment
...
return|;
block|}
DECL|class|CamelNioServerBossPool
class|class
name|CamelNioServerBossPool
extends|extends
name|NioServerBossPool
...
name|executor
decl_stmt|;
DECL|method|CamelNioServerBossPool (Executor bossExecutor, int bossCount, ThreadNameDeterminer determiner)
name|CamelNioServerBossPool
parameter_list|(
name|Executor
name|bossExecutor
