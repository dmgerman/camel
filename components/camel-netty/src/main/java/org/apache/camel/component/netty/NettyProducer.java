...
try|try
block|{
comment|// allow to reuse channel, on this producer, to avoid creating a new connection
comment|// for each message being sent
if|if
condition|(
name|channelFuture
operator|==
...
name|trace
argument_list|(
literal|"Created new TCP client bootstrap connecting to {}:{}"
argument_list|,
name|configuration
operator|.
name|getHost
...
name|trace
argument_list|(
literal|"Created new UDP client bootstrap connecting to {}:{}"
argument_list|,
name|configuration
operator|.
name|getHost
...
condition|)
block|{
comment|// clear channel as we did not connect
name|channel
operator|=
literal|null
expr_stmt|;
