...
name|util
operator|.
name|ExternalResourceReleasable
import|;
end_import
...
condition|)
block|{
comment|// this will first invoke workerPool#shutdown() internally (e.g. org.jboss.netty.channel.socket.nio.AbstractNioWorkerPool)
operator|(
operator|(
name|ExternalResourceReleasable
operator|)
...
condition|)
block|{
comment|// this will first invoke channelFactory#shutdown() internally (see it's javadoc)
name|channelFactory
operator|.
name|releaseExternalResources
argument_list|()
...
condition|)
block|{
comment|// this will first invoke datagramChannelFactory#shutdown() internally (see it's javadoc)
name|datagramChannelFactory
operator|.
name|releaseExternalResources
argument_list|()
