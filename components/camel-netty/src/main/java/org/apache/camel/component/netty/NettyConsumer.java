...
expr_stmt|;
block|}
comment|// TODO: use ChannelGroup to keep track on open connections etc to be closed on stopping
comment|// and then releasing channel factory would be faster
comment|//        if (channelFactory != null) {
comment|//            channelFactory.releaseExternalResources();
comment|//        }
name|super
operator|.
name|doStop
