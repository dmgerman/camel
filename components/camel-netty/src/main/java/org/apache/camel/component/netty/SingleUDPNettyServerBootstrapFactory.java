...
name|workerExecutor
decl_stmt|;
DECL|method|SingleUDPNettyServerBootstrapFactory (CamelContext camelContext, NettyConfiguration nettyConfiguration, ServerPipelineFactory pipelineFactory)
specifier|public
name|SingleUDPNettyServerBootstrapFactory
parameter_list|(
name|CamelContext
