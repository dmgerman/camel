...
begin_class
DECL|class|NettyConsumerClientModeReuseChannelTest
specifier|public
class|class
name|NettyConsumerClientModeReuseChannelTest
extends|extends
name|BaseNettyTest
block|{
DECL|field|channels
...
name|from
argument_list|(
literal|"netty:tcp://localhost:{{port}}?textline=true&clientMode=true&reuseChannel=true"
argument_list|)
operator|.
name|id
argument_list|(
