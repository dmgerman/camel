...
name|requestBody
argument_list|(
literal|"netty:tcp://localhost:5110?clientPipelineFactory=#cpf&sync=true&textline=true"
argument_list|,
...
name|from
argument_list|(
literal|"netty:tcp://localhost:5110?serverPipelineFactory=#spf&sync=true&textline=true"
argument_list|)
operator|.
name|process
argument_list|(
...
argument_list|()
decl_stmt|;
comment|// In Sync mode,adding a read timeout handler to handle timeout while waiting for a remote reply
if|if
condition|(
name|producer
operator|.
