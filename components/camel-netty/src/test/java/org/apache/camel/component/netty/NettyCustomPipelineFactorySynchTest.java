...
name|from
argument_list|(
literal|"netty:tcp://localhost:{{port}}?serverInitializerFactory=#spf&sync=true&textline=true"
argument_list|)
operator|.
name|process
argument_list|(
...
name|requestBody
argument_list|(
literal|"netty:tcp://localhost:{{port}}?clientInitializerFactory=#cpf&sync=true&textline=true"
argument_list|,
