...
begin_class
DECL|class|JpaWithNativeQueryTest
specifier|public
class|class
name|JpaWithNativeQueryTest
extends|extends
name|JpaWithNamedQueryTest
block|{
comment|/**      * We receive an object array, because we call entityManager.createNativeQuery(nativeQuery)      * and not entityManager.createNativeQuery(nativeQuery, MultiSteps.class)      */
annotation|@
name|Override
