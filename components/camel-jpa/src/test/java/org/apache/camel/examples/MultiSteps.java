...
annotation|@
name|PreConsumed
DECL|method|beforeGoToNextStep (Exchange exchange)
specifier|public
name|void
name|beforeGoToNextStep
parameter_list|(
name|Exchange
name|exchange
parameter_list|)
block|{
comment|// we could do some thing to update the entity by using the exchange property
name|Assert
operator|.
name|assertNotNull
argument_list|(
...
name|info
argument_list|(
literal|"Calling beforeGoToNextStep"
argument_list|)
expr_stmt|;
block|}
