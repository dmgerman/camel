...
begin_class
DECL|class|JpaProducerPassingEntityManagerTest
specifier|public
class|class
name|JpaProducerPassingEntityManagerTest
extends|extends
...
argument_list|()
decl_stmt|;
comment|// The entity instance is different if it is retrieved from different EntityManager instance
name|EntityManager
name|entityManager
init|=
name|emf
...
argument_list|()
expr_stmt|;
comment|// The same EntityManager returns same entity instance from its 1st level cache
name|entityManager
operator|=
name|emf
operator|.
