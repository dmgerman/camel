...
annotation|@
name|Test
DECL|method|testPollingConsumerHandlesLockedEntity ()
specifier|public
name|void
name|testPollingConsumerHandlesLockedEntity
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
operator|+
literal|"?joinTransaction=true&consumeLockEntity=true&query=select c from Customer c where c.name like '${header.name}'"
argument_list|)
operator|.
name|aggregationStrategy
argument_list|(
...
argument_list|()
operator|+
literal|"?joinTransaction=true&usePassedInEntityManager=true"
argument_list|)
operator|.
name|setBody
argument_list|()
