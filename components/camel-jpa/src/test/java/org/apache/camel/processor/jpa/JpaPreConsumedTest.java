...
begin_class
DECL|class|JpaPreConsumedTest
specifier|public
class|class
name|JpaPreConsumedTest
extends|extends
...
annotation|@
name|Test
DECL|method|testPreConsumed ()
specifier|public
name|void
name|testPreConsumed
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// @PreConsumed should change the dummy address
name|SendEmail
name|email
init|=
name|mock
