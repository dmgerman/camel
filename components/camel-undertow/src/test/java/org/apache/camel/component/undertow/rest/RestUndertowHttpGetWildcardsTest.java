...
begin_class
DECL|class|RestUndertowHttpGetWildcardsTest
specifier|public
class|class
name|RestUndertowHttpGetWildcardsTest
extends|extends
name|BaseUndertowTest
block|{
annotation|@
...
name|requestBody
argument_list|(
literal|"undertow:http://localhost:{{port}}/users/123/basic"
argument_list|,
literal|null
argument_list|,
name|String
...
name|requestBody
argument_list|(
literal|"undertow:http://localhost:{{port}}/users/456/name=g*"
argument_list|,
literal|null
argument_list|,
name|String
