...
begin_class
DECL|class|RestUndertowHttpGetCorsTest
specifier|public
class|class
name|RestUndertowHttpGetCorsTest
extends|extends
name|BaseUndertowTest
block|{
annotation|@
name|Test
DECL|method|testCorsGet ()
specifier|public
name|void
name|testCorsGet
parameter_list|()
...
argument_list|)
expr_stmt|;
comment|// send PUT request which should be routed
name|String
name|out2
init|=
name|fluentTemplate
