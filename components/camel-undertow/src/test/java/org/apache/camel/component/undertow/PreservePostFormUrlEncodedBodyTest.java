...
begin_class
DECL|class|PreservePostFormUrlEncodedBodyTest
specifier|public
class|class
name|PreservePostFormUrlEncodedBodyTest
extends|extends
name|BaseUndertowTest
block|{
annotation|@
name|Test
DECL|method|testSendToUndertow ()
specifier|public
name|void
name|testSendToUndertow
parameter_list|()
throws|throws
name|Exception
block|{
...
name|from
argument_list|(
literal|"undertow:http://localhost:{{port}}/myapp/myservice?map"
argument_list|)
operator|.
name|process
argument_list|(
