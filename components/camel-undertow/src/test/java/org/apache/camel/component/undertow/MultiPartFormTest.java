...
name|assertNotNull
argument_list|(
literal|"Should get the DataHandler log4j2.properties"
argument_list|,
name|data
argument_list|)
expr_stmt|;
...
name|assertTrue
argument_list|(
literal|"We should get the data from the DataHandler"
argument_list|,
name|data
operator|.
name|getDataSource
...
argument_list|)
expr_stmt|;
comment|// form data should also be available as a body
name|Map
name|body
init|=
name|in
