...
begin_comment
comment|/**  * Box2 Folders Manager  *   *<p>  * Provides operations to manage Box folders.  *   * @author<a href="mailto:punkhornsw@gmail.com">William Collins</a>  *  */
end_comment

begin_class
DECL|class|Box2FoldersManager
specifier|public
class|class
...
DECL|method|Box2FoldersManager (BoxAPIConnection boxConnection)
specifier|public
name|Box2FoldersManager
parameter_list|(
name|BoxAPIConnection
