...
begin_comment
comment|/**  * Box2 Search Manager  *   *<p>  * Provides operations to manage Box searches.  *   * @author<a href="mailto:punkhornsw@gmail.com">William Collins</a>  *  */
end_comment

begin_class
DECL|class|Box2SearchManager
specifier|public
class|class
...
DECL|method|Box2SearchManager (BoxAPIConnection boxConnection)
specifier|public
name|Box2SearchManager
parameter_list|(
name|BoxAPIConnection
