...
name|internal
operator|.
name|Box2GroupsManagerApiMethod
import|;
end_import
...
begin_comment
comment|/**  * Test class for {@link org.apache.camel.component.box2.api.Box2GroupsManager}  * APIs.  */
end_comment

begin_class
DECL|class|Box2GroupsManagerIntegrationTest
specifier|public
class|class
name|Box2GroupsManagerIntegrationTest
extends|extends
...
name|put
argument_list|(
literal|"CamelBox2.groupMemebershipId"
argument_list|,
name|info
operator|.
name|getID
