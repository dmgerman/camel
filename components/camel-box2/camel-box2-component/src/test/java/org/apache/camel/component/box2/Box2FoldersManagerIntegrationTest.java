...
name|internal
operator|.
name|Box2FoldersManagerApiMethod
import|;
end_import
...
begin_comment
comment|/**  * Test class for {@link org.apache.camel.component.box2.api.Box2FoldersManager}  * APIs.  */
end_comment

begin_class
DECL|class|Box2FoldersManagerIntegrationTest
specifier|public
class|class
name|Box2FoldersManagerIntegrationTest
extends|extends
...
name|put
argument_list|(
literal|"CamelBox2.parentFolderId"
argument_list|,
literal|"0"
argument_list|)
expr_stmt|;
...
name|put
argument_list|(
literal|"CamelBox2.destinationFolderId"
argument_list|,
name|CAMEL_TEST_DESTINATION_FOLDER_ID
argument_list|)
expr_stmt|;
...
name|put
argument_list|(
literal|"CamelBox2.newFolderName"
argument_list|,
name|CAMEL_TEST_RENAME_FOLDER
argument_list|)
expr_stmt|;
