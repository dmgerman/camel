...
name|internal
operator|.
name|Box2CollaborationsManagerApiMethod
import|;
end_import
...
begin_comment
comment|/**  * Test class for  * {@link org.apache.camel.component.box2.api.Box2CollaborationsManager} APIs.  */
end_comment

begin_class
DECL|class|Box2CollaborationsManagerIntegrationTest
specifier|public
class|class
name|Box2CollaborationsManagerIntegrationTest
extends|extends
...
name|put
argument_list|(
literal|"CamelBox2.collaborator"
argument_list|,
name|user
argument_list|)
expr_stmt|;
...
name|put
argument_list|(
literal|"CamelBox2.collaborationId"
argument_list|,
name|testCollaboration
operator|.
name|getID
