...
begin_class
DECL|class|EhcacheAggregationRepositoryRoutesTest
specifier|public
class|class
name|EhcacheAggregationRepositoryRoutesTest
extends|extends
name|EhcacheTestSupport
block|{
...
name|to
argument_list|(
literal|"log:org.apache.camel.component.ehcache.processor.aggregate^level=INFO%showAll=true&mulltiline=true"
argument_list|)
operator|.
name|to
argument_list|(
