...
block|}
block|}
DECL|method|internalRebuildNode (String fullPath)
specifier|private
name|void
name|internalRebuildNode
parameter_list|(
name|String
name|fullPath
parameter_list|)
...
parameter_list|)
block|{
comment|// node no longer exists - remove it
name|currentData
operator|.
name|remove
argument_list|(
...
expr_stmt|;
block|}
comment|/**      * Returns an indication that the sequential, ephemeral node may be registered more than once for this group      * @return      */
