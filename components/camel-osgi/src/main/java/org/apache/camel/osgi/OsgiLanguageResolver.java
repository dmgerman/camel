...
return|;
block|}
comment|// we do not throw the exception here and try to auto create a Language from OSGI bundle
block|}
...
name|IllegalArgumentException
argument_list|(
literal|"Type is not a Lanaguage implementation. Found: "
operator|+
name|type
operator|.
name|getName
...
throw|;
block|}
DECL|method|getLanaguage (String name)
specifier|protected
name|Class
name|getLanaguage
parameter_list|(
...
return|;
block|}
DECL|method|getLanaguageResolver (String name)
specifier|protected
name|Class
name|getLanaguageResolver
parameter_list|(
