...
name|bean
operator|.
name|EndpointInjectWrongContextRoute
import|;
end_import
...
name|class
argument_list|)
DECL|class|UnsatisfiedContextForEndpointInjectTest
specifier|public
class|class
name|UnsatisfiedContextForEndpointInjectTest
block|{
annotation|@
name|ClassRule
...
name|containsString
argument_list|(
literal|"No Camel context with name [foo] is deployed!"
argument_list|)
argument_list|)
decl_stmt|;
annotation|@
