...
annotation|@
name|Test
DECL|method|verifyNoTCCLFallbackClassLoader ()
specifier|public
name|void
name|verifyNoTCCLFallbackClassLoader
parameter_list|()
block|{
name|assertThat
argument_list|(
...
parameter_list|)
block|{
comment|// Nullify TCCL before CamelContext creation
name|Thread
operator|.
name|currentThread
argument_list|()
