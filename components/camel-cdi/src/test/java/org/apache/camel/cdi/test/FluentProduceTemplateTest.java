...
name|class
argument_list|)
DECL|class|FluentProduceTemplateTest
specifier|public
class|class
name|FluentProduceTemplateTest
block|{
annotation|@
name|Deployment
...
literal|2
argument_list|)
DECL|method|sendMessageToInbound (@riR) FluentProducerTemplate in, @Uri(R) MockEndpoint out)
specifier|public
name|void
