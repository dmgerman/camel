...
name|bean
operator|.
name|FirstCamelContextProduceTemplateBean
import|;
end_import
...
name|bean
operator|.
name|SecondCamelContextProduceTemplateBean
import|;
end_import
...
name|class
argument_list|)
DECL|class|MultiContextProduceTemplateTest
specifier|public
class|class
name|MultiContextProduceTemplateTest
block|{
annotation|@
name|Inject
