...
argument_list|)
DECL|class|XmlErrorHandlerPolicyTest
specifier|public
class|class
name|XmlErrorHandlerPolicyTest
block|{
annotation|@
name|ClassRule
DECL|field|verifier
...
name|matchesPattern
argument_list|(
literal|"Failed delivery for \\(MessageId: .+\\). "
operator|+
literal|"On delivery attempt: 3 "
operator|+
...
name|matchesPattern
argument_list|(
literal|"(?s)Failed delivery for \\(MessageId: .+\\). "
operator|+
literal|"Exhausted after delivery attempt: 4 "
operator|+
literal|"caught: org.apache.camel.CamelException: failure message!.*"
argument_list|)
argument_list|)
...
name|get
argument_list|(
literal|"src/test/resources/camel-context-errorHandler-policy.xml"
argument_list|)
operator|.
name|toFile
argument_list|()
