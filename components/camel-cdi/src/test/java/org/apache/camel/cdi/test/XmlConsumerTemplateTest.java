...
argument_list|)
DECL|class|XmlConsumerTemplateTest
specifier|public
class|class
name|XmlConsumerTemplateTest
block|{
annotation|@
name|Inject
annotation|@
...
name|get
argument_list|(
literal|"src/test/resources/camel-context-consumer.xml"
argument_list|)
operator|.
name|toFile
argument_list|()
...
annotation|@
name|Test
DECL|method|verifyConsumerTemplate ()
specifier|public
name|void
name|verifyConsumerTemplate
parameter_list|()
block|{
name|assertThat
argument_list|(
literal|"Consumer template Camel context is incorrect!"
argument_list|,
name|consumer
operator|.
...
name|assertThat
argument_list|(
literal|"Consumer template cache size is incorrect!"
argument_list|,
name|consumer
operator|.
