...
name|class
argument_list|)
DECL|class|EventEndpointTest
specifier|public
class|class
name|EventEndpointTest
block|{
annotation|@
name|Inject
annotation|@
...
argument_list|)
expr_stmt|;
comment|//assertIsSatisfied(2L, TimeUnit.SECONDS, consumeObject, consumeString, consumeStringPayload, consumeIntegerPayload, consumeFooQualifier, consumeBarQualifier);
name|assertIsSatisfied
argument_list|(
literal|2L
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// assertThat(observer.getStringEvents(), contains("string", "test"));
name|assertThat
argument_list|(
name|observer
operator|.
...
expr_stmt|;
block|}
DECL|method|collectStringPayloadEvents (@bserves EventPayloadString event)
name|void
...
expr_stmt|;
block|}
DECL|method|collectIntegerPayloadEvents (@bserves EventPayloadInteger event)
name|void
