...
argument_list|)
DECL|class|XmlThreadPoolTest
specifier|public
class|class
name|XmlThreadPoolTest
block|{
annotation|@
name|Inject
annotation|@
...
name|get
argument_list|(
literal|"src/test/resources/camel-context-threadPool.xml"
argument_list|)
operator|.
name|toFile
argument_list|()
...
annotation|@
name|Test
DECL|method|verifyThreadPool (@amedR) ExecutorService executor)
specifier|public
name|void
name|verifyThreadPool
parameter_list|(
annotation|@
name|Named
argument_list|(
...
name|assertThat
argument_list|(
literal|"Thread pool is incorrect!"
argument_list|,
name|executor
argument_list|,
name|is
...
name|matchesPattern
argument_list|(
literal|"^Processed \\[message] with \\[Camel \\(test\\) thread #\\d+ - Thread Name]$"
argument_list|)
argument_list|)
expr_stmt|;
block|}
