...
begin_comment
comment|/**  * The&lt;proxy&gt; tag element.  * */
end_comment

begin_comment
comment|// FIXME: to remove when getters are added to org.apache.camel.core.xml.CamelProxyFactoryDefinition
end_comment
...
literal|"proxy"
argument_list|)
DECL|class|ProxyFactoryDefinition
specifier|public
class|class
