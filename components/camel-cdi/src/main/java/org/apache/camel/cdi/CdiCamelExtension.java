...
parameter_list|)
block|{
comment|// The set of programmatic beans to be added
name|Set
argument_list|<
name|SyntheticBean
argument_list|<
...
block|}
block|}
comment|// The set of all the Camel context beans
name|Set
argument_list|<
name|Bean
argument_list|<
...
argument_list|()
decl_stmt|;
comment|// From the discovered annotated types
name|contextBeans
operator|.
name|stream
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// From the imported Camel XML
name|beans
operator|.
name|stream
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// From the @ContextName qualifiers on RoutesBuilder beans
name|contextNames
operator|.
name|stream
argument_list|()
