...
block|}
block|}
DECL|method|routeBuilderBeans (@bserves ProcessBean<T> pb)
specifier|private
parameter_list|<
name|T
extends|extends
...
parameter_list|)
block|{
comment|// Missing @ContextName Camel context qualifiers
name|contextNames
operator|.
name|removeAll
argument_list|(
...
condition|)
block|{
comment|// Add a @Default Camel context bean if any
name|abd
operator|.
name|addBean
argument_list|(
...
condition|)
block|{
comment|// Add a @ContextName and @Default Camel context bean if only one
name|abd
operator|.
name|addBean
argument_list|(
...
block|{
comment|// Add missing @ContextName Camel context beans
for|for
control|(
name|ContextName
name|name
...
block|}
block|}
comment|// Update @ContextName Camel context qualifiers
name|contextQualifiers
operator|.
name|addAll
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Then update the Camel producer beans
for|for
control|(
name|Map
operator|.
...
block|}
block|}
DECL|method|camelContextBean (BeanManager manager, Annotation... qualifiers)
specifier|private
name|Bean
argument_list|<
name|?
