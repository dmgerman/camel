...
DECL|method|disableDefaultContext (@bserves ProcessAnnotatedType<? extends CamelContext> process)
specifier|protected
name|void
...
return|;
block|}
DECL|method|getPostProcessor (String context, BeanManager beanManager)
specifier|protected
name|DefaultCamelBeanPostProcessor
...
block|}
block|}
DECL|method|getCamelContext (String context, BeanManager beanManager)
specifier|protected
name|CamelContext
name|getCamelContext
parameter_list|(
...
condition|)
block|{
comment|//camelContextMap = BeanProvider.getContextualReference(CamelContextMap.class);
name|Set
argument_list|<
name|Bean
argument_list|<
