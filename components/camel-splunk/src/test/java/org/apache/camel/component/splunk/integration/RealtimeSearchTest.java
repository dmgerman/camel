...
argument_list|)
DECL|class|RealtimeSearchTest
specifier|public
class|class
name|RealtimeSearchTest
extends|extends
name|SplunkTest
block|{
annotation|@
name|Test
DECL|method|testRealtimeSearch ()
specifier|public
name|void
name|testRealtimeSearch
parameter_list|()
throws|throws
name|Exception
block|{
...
name|from
argument_list|(
literal|"splunk://realtime?delay=5s&username="
operator|+
name|SPLUNK_USERNAME
operator|+
literal|"&password="
...
name|SPLUNK_PASSWORD
operator|+
literal|"&initEarliestTime=rt-10s&search=search index="
operator|+
name|INDEX
operator|+
literal|" sourcetype=testSource"
argument_list|)
operator|.
name|to
argument_list|(
