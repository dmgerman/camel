...
argument_list|)
DECL|class|SavedSearchTest
specifier|public
class|class
name|SavedSearchTest
extends|extends
name|SplunkTest
block|{
comment|// before run there should be created a saved search 'junit' in splunk
annotation|@
name|Test
DECL|method|testSavedSearch ()
specifier|public
name|void
...
name|from
argument_list|(
literal|"splunk://savedsearch?delay=5s&username="
operator|+
name|SPLUNK_USERNAME
operator|+
literal|"&password="
