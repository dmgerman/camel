...
begin_comment
comment|/*    TODO:  This file is a copy of KarafTestSupport.java from the Karaf 4 repository.      Eventually there will be a karaf-test module that contains this class, and we'll    be able to use that.  For now, use this as a starting point. */
end_comment
