...
block|{
name|String
name|resolvedUriParam
init|=
name|resolveHeaderPlaceholders
argument_list|(
name|a
argument_list|,
name|inMessage
argument_list|)
decl_stmt|;
comment|// Backward compatibility: if one of the path params is fully resolved,
comment|// then it is assumed that whole uri is resolved.
if|if
condition|(
operator|!
name|a
...
block|}
block|}
comment|/**      * Replaces placeholders "{}" with message header values      * @param str string with placeholders      * @param msg message with headers      * @return filled string      */
DECL|method|resolveHeaderPlaceholders (String str, Message msg)
specifier|private
name|String
name|resolveHeaderPlaceholders
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// remove any dangling& caused by the absence of optional parameters
while|while
condition|(
name|query
operator|.
