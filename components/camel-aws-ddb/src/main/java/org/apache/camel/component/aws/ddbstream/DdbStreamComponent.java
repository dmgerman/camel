...
name|IllegalArgumentException
argument_list|(
literal|"amazonDDBStreamsClient or accessKey and secretKey must be specified"
argument_list|)
throw|;
block|}
...
DECL|method|setConfiguration (DdbStreamConfiguration configuration)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|checkAndSetRegistryClient (DdbStreamConfiguration configuration)
specifier|private
name|void
name|checkAndSetRegistryClient
parameter_list|(
