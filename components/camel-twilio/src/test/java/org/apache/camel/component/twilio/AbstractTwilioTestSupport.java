...
begin_comment
comment|/**  * Abstract base class for Twilio Integration tests generated by Camel API component maven plugin.  */
end_comment

begin_class
DECL|class|AbstractTwilioTestSupport
specifier|public
class|class
...
argument_list|()
decl_stmt|;
comment|// read Twilio component configuration from TEST_OPTIONS_PROPERTIES
specifier|final
name|Properties
name|properties
init|=
...
argument_list|)
expr_stmt|;
comment|// add TwilioComponent to Camel context
specifier|final
