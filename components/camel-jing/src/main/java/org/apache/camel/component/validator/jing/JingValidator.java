...
begin_comment
comment|/**  * A validator which uses the<a href="http://www.thaiopensource.com/relaxng/jing.html">Jing</a>  * library to validate XML against RelaxNG  *  * @version $Revision: 1.1 $  */
end_comment
...
argument_list|(
literal|"No schemaResource or inputSource specified"
argument_list|)
throw|;
block|}
else|else
...
name|IllegalArgumentException
argument_list|(
literal|"No inputStream available for: "
operator|+
name|resource
argument_list|)
throw|;
