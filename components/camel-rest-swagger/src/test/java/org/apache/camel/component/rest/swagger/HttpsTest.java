...
annotation|@
name|Test
DECL|method|swaggerJsonOverHttps ()
specifier|public
name|void
name|swaggerJsonOverHttps
parameter_list|()
throws|throws
name|Exception
block|{
...
name|requestBodyAndHeader
argument_list|(
literal|"direct:httpsJsonGetPetById"
argument_list|,
name|NO_BODY
argument_list|,
literal|"petId"
...
name|to
argument_list|(
literal|"petStore:https://localhost:"
operator|+
name|petstore
operator|.
name|httpsPort
argument_list|()
operator|+
literal|"/swagger.json#getPetById"
argument_list|)
operator|.
name|unmarshal
argument_list|(
