...
name|specificationUri
argument_list|,
name|resolveSslContextParameters
argument_list|()
argument_list|)
decl_stmt|;
specifier|final
...
throw|;
block|}
DECL|method|resolveSslContextParameters ()
specifier|private
name|SSLContextParameters
name|resolveSslContextParameters
parameter_list|()
...
DECL|method|loadSpecificationFrom (final CamelContext camelContext, final URI uri, SSLContextParameters sslContextParameters)
specifier|static
name|Swagger
name|loadSpecificationFrom
parameter_list|(
...
block|{
return|return
name|loadSpecificationFallback
argument_list|(
name|swaggerParser
argument_list|,
name|uriAsString
...
block|}
block|}
DECL|method|loadSpecificationFallback (SwaggerParser swaggerParser, String uriAsString, Exception originalException)
specifier|static
name|Swagger
name|loadSpecificationFallback
parameter_list|(
...
throw|;
block|}
DECL|method|parseInputStream (SwaggerParser swaggerParser, ObjectMapper mapper, InputStream stream)
specifier|static
name|Swagger
name|parseInputStream
parameter_list|(
