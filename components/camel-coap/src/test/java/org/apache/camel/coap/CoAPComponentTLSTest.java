...
name|fromF
argument_list|(
literal|"coaps+tcp://localhost:%d/TestResource?sslContextParameters=#serviceSSLContextParameters"
argument_list|,
name|PORT9
argument_list|)
operator|.
...
name|toF
argument_list|(
literal|"coaps+tcp://localhost:%d/TestResource?sslContextParameters=#clientSSLContextParameters"
argument_list|,
name|PORT9
argument_list|)
operator|.
