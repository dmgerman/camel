...
begin_class
DECL|class|CoAPComponentTLSTestBase
specifier|abstract
class|class
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?sslContextParameters=#serviceSSLContextParameters"
argument_list|,
name|PORT
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?alias=selfsigned&sslContextParameters=#selfSignedServiceSSLContextParameters"
argument_list|,
name|PORT2
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?sslContextParameters=#clientAuthServiceSSLContextParameters"
argument_list|,
name|PORT3
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?sslContextParameters=#serviceSSLContextParameters&cipherSuites=TLS_ECDHE_ECDSA_WITH_AES_128_CCM_8"
argument_list|,
name|PORT4
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?sslContextParameters=#clientSSLContextParameters"
argument_list|,
name|PORT
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource"
argument_list|,
name|PORT
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?sslContextParameters=#clientSSLContextParameters2"
argument_list|,
name|PORT
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?sslContextParameters=#selfSignedClientSSLContextParameters"
argument_list|,
name|PORT2
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?sslContextParameters=#clientAuthClientSSLContextParameters"
argument_list|,
name|PORT3
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?sslContextParameters=#clientAuthClientSSLContextParameters2"
argument_list|,
name|PORT3
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?sslContextParameters=#clientSSLContextParameters&cipherSuites=TLS_ECDHE_ECDSA_WITH_AES_128_CCM_8"
argument_list|,
name|PORT4
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?privateKey=#privateKey&publicKey=#publicKey"
argument_list|,
name|PORT5
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?privateKey=#privateKey&publicKey=#publicKey&clientAuthentication=REQUIRE&trustedRpkStore=#trustedRpkStore"
argument_list|,
name|PORT6
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?trustedRpkStore=#trustedRpkStore"
argument_list|,
name|PORT5
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?trustedRpkStore=#failedTrustedRpkStore"
argument_list|,
name|PORT5
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?trustedRpkStore=#trustedRpkStore&privateKey=#privateKey&publicKey=#publicKey"
argument_list|,
name|PORT6
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?pskStore=#pskStore"
argument_list|,
name|PORT7
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?sslContextParameters=#serviceSSLContextParameters&pskStore=#pskStore"
argument_list|,
name|PORT8
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?pskStore=#pskStore&cipherSuites=TLS_PSK_WITH_AES_128_CBC_SHA256"
argument_list|,
name|PORT7
argument_list|)
operator|.
...
argument_list|()
operator|+
literal|"://localhost:%d/TestResource?pskStore=#pskStore&sslContextParameters=#clientSSLContextParameters"
argument_list|,
name|PORT8
argument_list|)
operator|.
