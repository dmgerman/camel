...
parameter_list|)
function_decl|;
DECL|method|extractBodyValueFromValueStruct (final Schema schema, final Object value)
specifier|protected
name|Object
name|extractBodyValueFromValueStruct
parameter_list|(
...
parameter_list|)
block|{
comment|// by default, we will extract the value from field `after`, however if other connector needs different field, this method needs to be overriden
return|return
...
return|;
block|}
DECL|method|extractFieldValueFromValueStruct (final Schema schema, final Object value, final String fieldName)
specifier|protected
name|Object
name|extractFieldValueFromValueStruct
parameter_list|(
