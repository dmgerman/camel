...
name|avroPortReflection
operator|+
literal|"/setAge?protocolClassName=org.apache.camel.avro.test.TestReflection"
argument_list|)
operator|.
name|process
argument_list|(
...
name|avroPortReflection
operator|+
literal|"/setTestPojo?protocolClassName=org.apache.camel.avro.test.TestReflection&singleParameter=true"
argument_list|)
operator|.
name|process
argument_list|(
...
name|avroPortReflection
operator|+
literal|"/getTestPojo?protocolClassName=org.apache.camel.avro.test.TestReflection"
argument_list|)
operator|.
name|process
argument_list|(
