...
begin_comment
comment|/**  * A faster {@link HeadersMapFactory} which is using the {@link com.cedarsoftware.util.CaseInsensitiveMap} map implementation.  */
end_comment

begin_class
DECL|class|FastHeadersMapFactory
specifier|public
class|class
