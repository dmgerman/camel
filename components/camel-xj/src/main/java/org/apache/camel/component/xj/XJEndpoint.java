...
begin_comment
comment|// todo?: This class is just a copy of XsltEndpoint because of minor but important different requirements. Refactoring of XsltComponent so that we can extend it?
end_comment
...
return|;
block|}
comment|/**      * The transform direction. Either XML2JSON or JSON2XML      */
...
name|IOException
argument_list|(
literal|"Cannot load xsl resource "
operator|+
name|resourceUri
argument_list|)
throw|;
...
argument_list|)
expr_stmt|;
comment|// we rely on stax so always to true. No issues so far with jdk 1.8 and saxon xslt.
name|xslt
operator|.
name|setDeleteOutputFile
argument_list|(
...
block|}
block|}
DECL|method|configureXmlOutput (XsltBuilder xslt, String output)
specifier|protected
name|void
name|configureXmlOutput
parameter_list|(
...
block|}
block|}
DECL|method|configureJsonOutput (XsltBuilder xslt, String output)
specifier|protected
name|void
name|configureJsonOutput
parameter_list|(
