...
begin_comment
comment|// todo?: This class is just a copy from the XsltComponent because of minor but important different requirements. Refactoring of XsltComponent so that we can extend it?
end_comment
...
return|;
block|}
comment|/**      * Uses a custom {@link ErrorListener}.      */
