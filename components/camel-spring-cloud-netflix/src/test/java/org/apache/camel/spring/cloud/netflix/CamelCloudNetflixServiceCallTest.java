...
name|class
block|,
name|CamelCloudNetflixServiceCallConfiguration
operator|.
name|class
block|,
name|RibbonClientConfiguration
...
operator|=
block|{
literal|"camel.cloud.load-balancer.enabled=true"
block|,
...
block|,
literal|"ribbon.enabled=true"
block|,
literal|"ribbon.client.name=custom-svc-list"
block|,
...
block|}
argument_list|)
DECL|class|CamelCloudNetflixServiceCallTest
specifier|public
class|class
name|CamelCloudNetflixServiceCallTest
block|{
annotation|@
name|Autowired
DECL|field|template
