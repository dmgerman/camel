...
begin_class
DECL|class|JsonPathSplitWriteAsStringMapTest
specifier|public
class|class
name|JsonPathSplitWriteAsStringMapTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|)
decl_stmt|;
comment|// we only get 1 map (because we split via: $.content) but each entry is converted to a json string
name|mock
operator|.
...
name|File
argument_list|(
literal|"src/test/resources/content-map.json"
argument_list|)
argument_list|)
expr_stmt|;
