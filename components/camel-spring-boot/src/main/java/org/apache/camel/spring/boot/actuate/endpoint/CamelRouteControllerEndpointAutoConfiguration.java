...
begin_comment
comment|/**  * Auto configuration for the {@link CamelRouteControllerEndpoint}.  */
end_comment
...
name|class
argument_list|)
DECL|class|CamelRouteControllerEndpointAutoConfiguration
specifier|public
class|class
...
annotation|@
name|ConditionalOnWebApplication
DECL|method|routeControllerMvcEndpoint (CamelRouteControllerEndpoint delegate)
specifier|public
