...
name|info
argument_list|(
literal|"CamelMainRunController will terminate after processing maximum {} messages"
argument_list|,
name|configurationProperties
operator|.
name|getMainRunControllerMaxDurationMessages
...
name|info
argument_list|(
literal|"CamelMainRunController will terminate after {} seconds"
argument_list|,
name|configurationProperties
operator|.
name|getMainRunControllerMaxDurationSeconds
...
name|this
argument_list|,
literal|"CamelMainRunControllerTerminateTaks"
argument_list|)
decl_stmt|;
name|Runnable
name|task
...
name|info
argument_list|(
literal|"CamelMainRunController max seconds triggering shutdown of the JVM."
argument_list|)
expr_stmt|;
try|try
block|{
