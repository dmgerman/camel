...
return|;
block|}
DECL|method|setMyFooClass (MyFooClass myFooClass)
specifier|public
name|void
name|setMyFooClass
parameter_list|(
...
annotation|@
name|Test
DECL|method|testSetCamelPropertiesAutowired ()
specifier|public
name|void
name|testSetCamelPropertiesAutowired
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testSetCamelPropertiesType ()
specifier|public
name|void
name|testSetCamelPropertiesType
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"camelContext"
argument_list|,
literal|"#type:org.apache.camel.CamelContext"
argument_list|)
expr_stmt|;
name|CamelPropertiesHelper
operator|.
...
annotation|@
name|Test
DECL|method|testSetCamelPropertiesClass ()
specifier|public
name|void
name|testSetCamelPropertiesClass
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// must use linked hash map as we must create foo first before we set its name as nested property
name|Map
argument_list|<
name|String
argument_list|,
...
literal|"myFooClass"
argument_list|,
literal|"#class:org.apache.camel.spring.boot.util.MyFooClass"
argument_list|)
expr_stmt|;
name|map
operator|.
