...
operator|=
block|{
literal|"camel.health.enabled = false"
block|}
argument_list|)
DECL|class|CamelHealthDisabledTest
specifier|public
class|class
name|CamelHealthDisabledTest
extends|extends
name|Assert
block|{
annotation|@
...
annotation|@
name|Test
DECL|method|shouldNotHaveHealth ()
specifier|public
name|void
name|shouldNotHaveHealth
parameter_list|()
throws|throws
name|Exception
block|{
