...
begin_class
DECL|class|ChunkComponentLayersTest
specifier|public
class|class
name|ChunkComponentLayersTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
decl_stmt|;
comment|/**      * Test using themeLayer parameter without Resource URI header defined      */
annotation|@
name|Test
DECL|method|testChunkLayer ()
specifier|public
name|void
name|testChunkLayer
parameter_list|()
