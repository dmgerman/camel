...
begin_class
DECL|class|ChunkDifferentThemeFolderTest
specifier|public
class|class
name|ChunkDifferentThemeFolderTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
decl_stmt|;
comment|/**      * Test using themeFolder parameter      */
annotation|@
name|Test
DECL|method|testChunkSingleLayer ()
specifier|public
name|void
name|testChunkSingleLayer
parameter_list|()
throws|throws
name|Exception
block|{
...
name|to
argument_list|(
literal|"chunk:file_example?themeFolder=folderexample"
argument_list|)
operator|.
name|to
argument_list|(
