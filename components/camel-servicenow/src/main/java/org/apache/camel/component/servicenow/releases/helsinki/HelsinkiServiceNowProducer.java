...
begin_comment
comment|/**  * The Helsinki ServiceNow producer.  */
end_comment

begin_class
DECL|class|HelsinkiServiceNowProducer
specifier|public
class|class
...
name|AbstractServiceNowProducer
block|{
DECL|method|HelsinkiServiceNowProducer (ServiceNowEndpoint endpoint)
specifier|public
name|HelsinkiServiceNowProducer
parameter_list|(
name|ServiceNowEndpoint
...
argument_list|,
operator|new
name|HelsinkiServiceNowMiscProcessor
argument_list|(
name|endpoint
argument_list|)
argument_list|)
