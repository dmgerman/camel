...
begin_package
DECL|package|org.apache.camel.component.sjms2.support
package|package
name|org
operator|.
name|apache
...
begin_class
DECL|class|Jms2TestSupport
specifier|public
class|class
name|Jms2TestSupport
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|brokerUri
operator|+
literal|"?protocols=CORE,AMQP,HORNETQ,OPENWIRE"
argument_list|)
operator|.
name|addAcceptorConfiguration
argument_list|(
...
argument_list|()
decl_stmt|;
comment|//Currently AMQP and HORENTQ don't operate in exactly the same way on artemis as OPENWIRE
comment|//and CORE so its not possible to write protocol agnostic tests but in the future releases
comment|//of artemis we may be able test against them in an agnostic way.
switch|switch
condition|(
name|protocol
condition|)
