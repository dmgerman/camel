...
begin_package
DECL|package|org.apache.camel.component.sjms2.consumer
package|package
name|org
operator|.
name|apache
...
begin_class
DECL|class|InOnlyTopicSharedConsumerTest
specifier|public
class|class
name|InOnlyTopicSharedConsumerTest
extends|extends
name|Jms2TestSupport
block|{
...
init|=
literal|"sjms2:topic:in.only.topic.consumer.test"
decl_stmt|;
annotation|@
name|Override
DECL|method|useJmx ()
...
name|TEST_DESTINATION_NAME
operator|+
literal|"?subscriptionId=sharedTest&shared=true"
argument_list|)
operator|.
name|to
argument_list|(
