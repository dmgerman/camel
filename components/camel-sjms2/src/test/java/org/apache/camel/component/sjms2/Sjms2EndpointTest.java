...
begin_class
DECL|class|Sjms2EndpointTest
specifier|public
class|class
name|Sjms2EndpointTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|getEndpoint
argument_list|(
literal|"sjms2:/jms/test/hov.t1.dev:topic"
argument_list|,
name|Sjms2Endpoint
operator|.
name|class
...
name|getEndpoint
argument_list|(
literal|"sjms2:queue:test?transacted=true"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
name|getEndpoint
argument_list|(
literal|"sjms2:queue:test?synchronous=true"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
name|getEndpoint
argument_list|(
literal|"sjms2:queue:test?namedReplyTo="
operator|+
name|namedReplyTo
argument_list|)
decl_stmt|;
...
name|getEndpoint
argument_list|(
literal|"sjms2:queue:test?exchangePattern="
operator|+
name|ExchangePattern
operator|.
name|InOnly
...
name|getEndpoint
argument_list|(
literal|"sjms2:queue:test?namedReplyTo=reply.to.queue&exchangePattern="
operator|+
name|ExchangePattern
operator|.
name|InOnly
...
name|getEndpoint
argument_list|(
literal|"sjms2:queue:test?transacted=true&transactionBatchCount=10"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
name|getEndpoint
argument_list|(
literal|"sjms2:queue:test?transacted=true&transactionBatchTimeout=3000"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
