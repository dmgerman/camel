...
name|transactionManager
argument_list|,
literal|"The 'transactionManager' argument cannot be null."
argument_list|)
expr_stmt|;
name|ObjectHelper
operator|.
...
name|repositoryName
argument_list|,
literal|"The 'repositoryName' argument cannot be null."
argument_list|)
expr_stmt|;
name|ObjectHelper
operator|.
...
name|datasource
argument_list|,
literal|"The 'datasource' argument cannot be null."
argument_list|)
expr_stmt|;
name|this
operator|.
...
name|repositoryName
argument_list|,
literal|"The repository name must be specified"
argument_list|)
expr_stmt|;
name|ObjectHelper
operator|.
