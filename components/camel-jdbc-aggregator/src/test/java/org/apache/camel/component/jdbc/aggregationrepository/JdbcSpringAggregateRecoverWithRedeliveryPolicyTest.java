...
begin_class
DECL|class|JdbcSpringAggregateRecoverWithRedeliveryPolicyTest
specifier|public
class|class
name|JdbcSpringAggregateRecoverWithRedeliveryPolicyTest
extends|extends
name|CamelSpringTestSupport
block|{
DECL|field|counter
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/jdbc/aggregationrepository/JdbcSpringAggregateRecoverWithRedeliveryPolicyTest.xml"
argument_list|)
return|;
block|}
annotation|@
name|Test
DECL|method|testJdbcAggregateRecover ()
specifier|public
name|void
name|testJdbcAggregateRecover
parameter_list|()
throws|throws
name|Exception
block|{
