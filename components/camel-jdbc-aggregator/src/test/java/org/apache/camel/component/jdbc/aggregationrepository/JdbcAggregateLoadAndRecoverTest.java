...
begin_class
DECL|class|JdbcAggregateLoadAndRecoverTest
specifier|public
class|class
name|JdbcAggregateLoadAndRecoverTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|LOG
...
annotation|@
name|Test
DECL|method|testLoadAndRecoverJdbcAggregate ()
specifier|public
name|void
name|testLoadAndRecoverJdbcAggregate
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Exception
block|{
comment|//Avoid same message to be discarded twice
if|if
condition|(
name|exchange
operator|.
