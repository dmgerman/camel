...
name|info
argument_list|(
literal|"In PrinterProducer.start()"
argument_list|)
expr_stmt|;
name|super
operator|.
...
name|info
argument_list|(
literal|"In PrinterProducer.stop()"
argument_list|)
expr_stmt|;
name|super
operator|.
...
name|info
argument_list|(
literal|"In printerProducer.print()"
argument_list|)
expr_stmt|;
name|Object
name|body
...
name|error
argument_list|(
literal|"PrintServiceLookup failed. No printer found with the Printer Name: "
operator|+
name|printer
argument_list|)
expr_stmt|;
...
name|PrintException
argument_list|(
literal|"Printer Lookup Failure. Please verify that the host and printer are registered and reachable from this machine"
argument_list|)
throw|;
block|}
name|printService
...
expr_stmt|;
block|}
comment|// LOG.info("PrintServiceLookup succeeded. PrintService located at " + printService.getName());
return|return
name|printService
return|;
block|}
