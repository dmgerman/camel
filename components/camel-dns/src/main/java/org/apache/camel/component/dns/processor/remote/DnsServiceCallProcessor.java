...
begin_class
DECL|class|DnsServiceCallProcessor
specifier|public
class|class
...
argument_list|>
block|{
DECL|method|DnsServiceCallProcessor (String name, String scheme, String uri, ExchangePattern exchangePattern, DnsConfiguration conf)
specifier|public
name|DnsServiceCallProcessor
parameter_list|(
name|String
...
argument_list|(
literal|"ServerListStrategy is not an instance of DnsServiceCallServerListStrategy"
argument_list|)
throw|;
block|}
name|super
