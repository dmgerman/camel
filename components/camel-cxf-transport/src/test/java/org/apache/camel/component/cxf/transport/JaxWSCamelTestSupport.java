...
return|;
block|}
comment|/**      * Create a SampleWS Server with Gzip enabled to a specified route      * @param camelEndpoint      */
DECL|method|publishSampleWSWithGzipEnabled (String camelEndpoint)
specifier|public
name|Endpoint
