...
begin_class
DECL|class|WeatherComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|WeatherComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|contains
argument_list|(
literal|"\"mode\": { \"type\": \"string\", \"javaType\": \"org.apache.camel.component.weather.WeatherMode\", \"enum\": [ \"HTML\", \"JSON\", \"XML\" ]"
argument_list|)
argument_list|)
expr_stmt|;
block|}
