...
begin_class
DECL|class|OpenShiftComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|OpenShiftComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|(
literal|"openshift:myApp?username=foo&password=secret&operation=list"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|contains
argument_list|(
literal|"\"application\": { \"type\": \"java.lang.String\" }"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"clientId\": { \"type\": \"java.lang.String\" }"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
