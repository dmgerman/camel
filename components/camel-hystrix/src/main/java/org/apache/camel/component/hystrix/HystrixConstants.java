...
decl_stmt|;
DECL|field|CAMEL_HYSTRIX_RUN_ENDPOINT_ID
name|String
name|CAMEL_HYSTRIX_RUN_ENDPOINT_ID
init|=
literal|"CamelHystrixRunEndpointId"
decl_stmt|;
DECL|field|CAMEL_HYSTRIX_FALLBACK_ENDPOINT_ID
name|String
name|CAMEL_HYSTRIX_FALLBACK_ENDPOINT_ID
init|=
literal|"CamelHystrixFallbackEndpointId"
decl_stmt|;
DECL|field|CAMEL_HYSTRIX_CORE_POOL_SIZE
name|String
name|CAMEL_HYSTRIX_CORE_POOL_SIZE
init|=
literal|"CamelHystrixCorePoolSize"
decl_stmt|;
...
decl_stmt|;
DECL|field|CAMEL_HYSTRIX_THREAD_POOL_ROLLING_NUMBER_STATISTICAL_WINDOW_IN_MILLISECONDS
name|String
name|CAMEL_HYSTRIX_THREAD_POOL_ROLLING_NUMBER_STATISTICAL_WINDOW_IN_MILLISECONDS
init|=
literal|"CamelHystrixThreadPoolRollingNumberStatisticalWindowInMilliseconds"
decl_stmt|;
