...
argument_list|)
expr_stmt|;
comment|// use our callback that does some cleanup when done
name|AsyncCallback
name|hystrixCallback
init|=
operator|new
name|HystrixAsyncCallback
argument_list|(
name|exchange
argument_list|,
name|callback
...
comment|// noop
block|}
DECL|class|HystrixAsyncCallback
specifier|private
specifier|static
specifier|final
class|class
...
name|delegate
decl_stmt|;
DECL|method|HystrixAsyncCallback (Exchange exchange, AsyncCallback delegate)
specifier|public
name|HystrixAsyncCallback
parameter_list|(
name|Exchange
...
return|return;
block|}
comment|// we are only done when called with false
name|exchange
operator|.
name|removeProperty
argument_list|(
