...
begin_comment
comment|/**  * Hystrix using timeout with Java DSL  */
end_comment

begin_class
DECL|class|HystrixCircutExceptionTest
specifier|public
class|class
name|HystrixCircutExceptionTest
extends|extends
name|CamelTestSupport
block|{
...
annotation|@
name|Test
DECL|method|testCurcuitOpen ()
specifier|public
name|void
name|testCurcuitOpen
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"Instead curcuit open expected"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|info
argument_list|(
literal|"Curcuit will be closed soon "
operator|+
name|e
operator|.
name|toString
