...
name|addConnector
argument_list|(
literal|"mqtt://127.0.0.1:1883?trace=true"
argument_list|)
expr_stmt|;
name|brokerService
operator|.
...
name|to
argument_list|(
literal|"mqtt:sender?publishTopicName=test/topic1&qualityOfService=ExactlyOnce"
argument_list|)
expr_stmt|;
name|from
argument_list|(
literal|"mqtt:reader?subscribeTopicName=test/topic1&qualityOfService=ExactlyOnce"
argument_list|)
operator|.
name|routeId
argument_list|(
...
name|to
argument_list|(
literal|"mqtt:sender?publishTopicName=test/topic2&clientId=sender&qualityOfService=ExactlyOnce"
argument_list|)
expr_stmt|;
name|from
argument_list|(
literal|"mqtt:reader?subscribeTopicName=test/topic2&clientId=receiver&qualityOfService=ExactlyOnce"
argument_list|)
operator|.
name|routeId
argument_list|(
