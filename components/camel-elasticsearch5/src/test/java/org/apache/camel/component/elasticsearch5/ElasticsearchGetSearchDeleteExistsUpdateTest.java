...
annotation|@
name|Test
DECL|method|testSearchWithMapQueryFromAndSize ()
specifier|public
name|void
name|testSearchWithMapQueryFromAndSize
parameter_list|()
throws|throws
name|Exception
block|{
...
name|query
init|=
literal|"{\"query\":{\"match\":{\"content\":\"searchtest\"}}}"
decl_stmt|;
name|SearchResponse
name|response
init|=
...
annotation|@
name|Test
DECL|method|testSearchWithStringQueryFromAndSize ()
specifier|public
name|void
name|testSearchWithStringQueryFromAndSize
parameter_list|()
throws|throws
name|Exception
block|{
...
name|query
init|=
literal|"{\"query\":{\"match\":{\"content\":\"searchtest\"}},\"from\": 0,\"size\": 10}"
decl_stmt|;
name|SearchResponse
name|response
init|=
...
argument_list|()
expr_stmt|;
comment|//now, verify MULTISEARCH
name|headers
operator|.
name|put
argument_list|(
...
name|termQuery
argument_list|(
literal|"test-multisearchkey"
argument_list|,
literal|"test-multisearchvalue"
argument_list|)
argument_list|)
decl_stmt|;
name|List
...
name|assertEquals
argument_list|(
literal|"response should contains three multiSearchResponse object"
argument_list|,
literal|3
argument_list|,
name|response
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=INDEX&ip=localhost&port="
operator|+
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=INDEX&indexName=twitter&indexType=tweet&ip=localhost&port="
operator|+
name|ES_TRANSPORT_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=GET_BY_ID&indexName=twitter&indexType=tweet&ip=localhost&port="
operator|+
name|ES_TRANSPORT_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=MULTIGET&indexName=twitter&indexType=tweet&ip=localhost&port="
operator|+
name|ES_TRANSPORT_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=DELETE&indexName=twitter&indexType=tweet&ip=localhost&port="
operator|+
name|ES_TRANSPORT_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=SEARCH&indexName=twitter&indexType=tweet&ip=localhost&port="
operator|+
name|ES_TRANSPORT_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=UPDATE&indexName=twitter&indexType=tweet&ip=localhost&port="
operator|+
name|ES_TRANSPORT_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=EXISTS&ip=localhost&port="
operator|+
name|ES_TRANSPORT_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=MULTISEARCH&indexName=test&ip=localhost&port="
operator|+
name|ES_TRANSPORT_PORT
argument_list|)
expr_stmt|;
