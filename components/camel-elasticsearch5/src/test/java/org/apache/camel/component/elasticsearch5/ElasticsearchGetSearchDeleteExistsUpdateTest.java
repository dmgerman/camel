...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=INDEX"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=INDEX&indexName=twitter&indexType=tweet"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=GET_BY_ID&indexName=twitter&indexType=tweet"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=MULTIGET&indexName=twitter&indexType=tweet"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=DELETE&indexName=twitter&indexType=tweet"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=SEARCH&indexName=twitter&indexType=tweet"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=UPDATE&indexName=twitter&indexType=tweet"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=EXISTS"
argument_list|)
expr_stmt|;
name|from
argument_list|(
...
name|to
argument_list|(
literal|"elasticsearch5://elasticsearch?operation=MULTISEARCH&indexName=test"
argument_list|)
expr_stmt|;
block|}
block|}
