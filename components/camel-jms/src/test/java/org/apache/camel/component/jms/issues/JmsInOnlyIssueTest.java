...
specifier|public
name|void
name|testInOnlyWithAsyncSendBody
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// need a little sleep to let task exectuor be ready
name|Thread
operator|.
name|sleep
argument_list|(
...
specifier|public
name|void
name|testInOnlyWithSendExchange
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testInOnlyWithAsyncSendExchange
parameter_list|()
throws|throws
name|Exception
block|{
