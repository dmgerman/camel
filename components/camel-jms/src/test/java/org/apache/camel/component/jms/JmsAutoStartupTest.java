...
begin_class
DECL|class|JmsAutoStartupTest
specifier|public
class|class
name|JmsAutoStartupTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|endpoint
...
argument_list|)
decl_stmt|;
comment|// should be stopped by default
name|mock
operator|.
...
argument_list|)
expr_stmt|;
comment|// then start the listener so we can consume the persistent message
name|consumer
operator|.
