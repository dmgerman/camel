...
begin_class
DECL|class|JmsCustomHeaderFilterStrategyTest
specifier|public
class|class
name|JmsCustomHeaderFilterStrategyTest
extends|extends
name|CamelTestSupport
block|{
...
annotation|@
name|Test
DECL|method|testCustomHeaderFilterStrategy ()
specifier|public
name|void
name|testCustomHeaderFilterStrategy
parameter_list|()
throws|throws
name|Exception
block|{
...
name|from
argument_list|(
literal|"activemq:queue:foo?eagerLoadingOfProperties=true"
argument_list|)
operator|.
name|to
argument_list|(
