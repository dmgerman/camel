...
begin_class
DECL|class|JmsRequestReplyExclusiveReplyToComponentTest
specifier|public
class|class
name|JmsRequestReplyExclusiveReplyToComponentTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|()
decl_stmt|;
comment|// mark the reply to type as exclusive on the component
name|JmsComponent
name|jms
init|=
name|jmsComponentAutoAcknowledge
