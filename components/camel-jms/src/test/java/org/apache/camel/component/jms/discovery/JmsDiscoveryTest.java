...
name|from
argument_list|(
literal|"bean:service1?method=status?delay=5000&exchangePattern=InOnly"
argument_list|)
operator|.
name|to
argument_list|(
...
name|from
argument_list|(
literal|"bean:service2?method=status?delay=5000&exchangePattern=InOnly"
argument_list|)
operator|.
name|to
argument_list|(
...
name|from
argument_list|(
literal|"bean:service3?method=status?delay=5000&exchangePattern=InOnly"
argument_list|)
operator|.
name|to
argument_list|(
