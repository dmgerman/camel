...
argument_list|(
literal|"jms:queue:start?jmsMessageType=Text&forceSendOriginalMessage="
operator|+
name|forceSendOriginalMessage
argument_list|,
literal|"Hello World"
...
name|to
argument_list|(
literal|"jms:queue:one?transferException=true&forceSendOriginalMessage="
operator|+
name|forceSendOriginalMessage
argument_list|)
operator|.
name|to
argument_list|(
literal|"jms:queue:two?transferException=true&forceSendOriginalMessage="
operator|+
name|forceSendOriginalMessage
argument_list|)
operator|.
name|to
argument_list|(
literal|"jms:queue:three?transferException=true&forceSendOriginalMessage="
operator|+
name|forceSendOriginalMessage
argument_list|)
operator|.
...
name|from
argument_list|(
literal|"jms:queue:one?transferException=true&mapJmsMessage=false"
argument_list|)
operator|.
name|to
argument_list|(
...
name|from
argument_list|(
literal|"jms:queue:two?transferException=true&mapJmsMessage=false"
argument_list|)
operator|.
name|to
argument_list|(
...
name|from
argument_list|(
literal|"jms:queue:three?transferException=true&mapJmsMessage=false"
argument_list|)
operator|.
name|to
argument_list|(
