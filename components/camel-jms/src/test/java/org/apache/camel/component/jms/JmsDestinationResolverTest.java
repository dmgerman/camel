...
begin_comment
comment|/**  * @version $Revision: 786464 $  */
end_comment

begin_class
DECL|class|JmsDestinationResolverTest
specifier|public
class|class
name|JmsDestinationResolverTest
extends|extends
name|CamelTestSupport
block|{
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/jms/jmsDestinationResolver.xml"
argument_list|)
return|;
block|}
annotation|@
...
name|to
argument_list|(
literal|"activemq:queue:logicalNameForTestBQueue"
argument_list|)
expr_stmt|;
name|from
argument_list|(
