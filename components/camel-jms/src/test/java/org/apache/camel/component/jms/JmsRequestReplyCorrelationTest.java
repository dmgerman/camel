...
expr_stmt|;
block|}
comment|/**      * As the correlationID should be unique when receiving the reply message,       * now we just expect to get an exception here.      */
annotation|@
name|Test
DECL|method|testRequestReplyCorrelationWithDuplicateId ()
specifier|public
name|void
name|testRequestReplyCorrelationWithDuplicateId
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertNotNull
argument_list|(
literal|"We are expecting the exception here!"
argument_list|,
name|out
operator|.
name|getException
...
annotation|@
name|Test
DECL|method|testRequestReplyCorrelationByMessageIdWithGivenCorrelationId ()
specifier|public
name|void
name|testRequestReplyCorrelationByMessageIdWithGivenCorrelationId
parameter_list|()
throws|throws
name|Exception
block|{
