...
annotation|@
name|Test
DECL|method|testDurableSharedSubscriber ()
specifier|public
name|void
name|testDurableSharedSubscriber
parameter_list|()
throws|throws
name|Exception
block|{
...
name|resolveMandatoryEndpoint
argument_list|(
literal|"jms:topic:Foo.Bar?subscriptionDurable=true&subscriptionShared=true&subscriptionName=James"
argument_list|,
name|JmsEndpoint
operator|.
name|class
...
annotation|@
name|Test
DECL|method|testNonDurableSharedSubscriber ()
specifier|public
name|void
name|testNonDurableSharedSubscriber
parameter_list|()
throws|throws
name|Exception
block|{
...
name|resolveMandatoryEndpoint
argument_list|(
literal|"jms:topic:Foo.Bar?subscriptionShared=true&subscriptionName=James"
argument_list|,
name|JmsEndpoint
operator|.
name|class
...
annotation|@
name|Test
DECL|method|testSessionTransacted ()
specifier|public
name|void
name|testSessionTransacted
parameter_list|()
throws|throws
name|Exception
block|{
...
name|resolveMandatoryEndpoint
argument_list|(
literal|"jms:queue:Foo?transacted=true&lazyCreateTransactionManager=false"
argument_list|,
name|JmsEndpoint
operator|.
name|class
...
name|resolveMandatoryEndpoint
argument_list|(
literal|"jms:queue:Foo?transacted=true"
argument_list|,
name|JmsEndpoint
operator|.
name|class
