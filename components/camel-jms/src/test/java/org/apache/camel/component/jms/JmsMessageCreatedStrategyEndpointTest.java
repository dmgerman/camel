...
begin_class
DECL|class|JmsMessageCreatedStrategyEndpointTest
specifier|public
class|class
name|JmsMessageCreatedStrategyEndpointTest
extends|extends
name|CamelTestSupport
block|{
...
name|sendBody
argument_list|(
literal|"activemq:queue:foo?messageCreatedStrategy=#myStrategy"
argument_list|,
literal|"Hello World"
argument_list|)
expr_stmt|;
