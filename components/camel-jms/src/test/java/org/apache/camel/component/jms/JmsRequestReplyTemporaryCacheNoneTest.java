...
begin_class
DECL|class|JmsRequestReplyTemporaryCacheNoneTest
specifier|public
class|class
name|JmsRequestReplyTemporaryCacheNoneTest
extends|extends
name|CamelTestSupport
block|{
...
name|to
argument_list|(
literal|"activemq:queue:hello?replyToCacheLevelName=CACHE_NONE"
argument_list|)
expr_stmt|;
name|from
argument_list|(
