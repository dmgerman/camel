...
name|cid
decl_stmt|;
DECL|method|testRequetLateReply ()
specifier|public
name|void
name|testRequetLateReply
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// TODO: We should get this late reply to work
comment|//assertEquals("Late Reply", out.getOut().getBody());
block|}
