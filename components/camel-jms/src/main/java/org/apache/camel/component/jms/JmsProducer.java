...
annotation|@
name|Deprecated
comment|// We need to look the message header to override the ReplyTo option of the JMS endpoint
comment|// So please use initReplyManager(org.apache.camel.Message camelMessage)
...
block|}
block|}
DECL|method|initReplyManager (org.apache.camel.Message camelMessage)
specifier|protected
name|void
name|initReplyManager
parameter_list|(
