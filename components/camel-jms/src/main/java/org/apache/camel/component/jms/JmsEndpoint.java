...
expr_stmt|;
block|}
comment|// TODO: Why is this destination resolver disabled for producer? Its enable for consumer!
comment|/*             else {                 DestinationResolver resolver = getDestinationResolver();                 if (resolver != null) {                     jmsTemplate.setDestinationResolver(resolver);                 }                 else {                     throw new IllegalArgumentException("Neither destination, destinationName or destinationResolver are specified on this endpoint!");                 }             }             */
block|}
name|answer
operator|.
...
condition|)
block|{
comment|// TODO get the scheme of the component?
block|}
if|if
condition|(
name|destination
