...
argument_list|(
literal|"Could not create a QueueBrowseStrategy, maybe you are using spring 2.0.x? Cause: "
operator|+
name|e
argument_list|,
name|e
...
name|IllegalArgumentException
argument_list|(
literal|"Could not create a QueueBrowseStrategy, maybe you are using spring 2.0.x?"
argument_list|)
throw|;
block|}
return|return
