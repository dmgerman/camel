...
argument_list|)
DECL|class|SqsProducerBatchSendFifoIntegrationTest
specifier|public
class|class
name|SqsProducerBatchSendFifoIntegrationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|from
argument_list|(
literal|"aws-sqs://camel-1.fifo?accessKey=RAW(xxx)&secretKey=RAW(xxxx)&region=EU_WEST_1&deleteAfterRead=false"
argument_list|)
operator|.
name|startupOrder
argument_list|(
