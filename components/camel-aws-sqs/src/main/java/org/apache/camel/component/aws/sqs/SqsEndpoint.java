...
return|;
block|}
comment|/*      If using a different AWS host, do not assume specific parts of the AWS host      and, instead, just return whatever is provided as the host.      */
DECL|method|getFullyQualifiedAWSHost ()
specifier|private
name|String
name|getFullyQualifiedAWSHost
parameter_list|()
block|{
name|String
name|host
...
name|trace
argument_list|(
literal|"Configuring AWS-SQS for HTTP protocol"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|debug
argument_list|(
literal|"Creating endpoint for host {} on region {}"
argument_list|,
name|host
argument_list|,
name|region
