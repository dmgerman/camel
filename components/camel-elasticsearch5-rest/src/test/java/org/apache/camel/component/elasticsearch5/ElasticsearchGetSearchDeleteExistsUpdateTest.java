...
argument_list|)
expr_stmt|;
comment|//now, verify Search succeeded
name|String
name|query
init|=
literal|"{\"query\":{\"match\":{\"testsearchwithstringquery-key\":\"testsearchwithstringquery-value\"}}}"
decl_stmt|;
name|SearchHits
name|response
init|=
...
name|to
argument_list|(
literal|"elasticsearch5-rest://elasticsearch?operation=Index&hostAddresses=localhost:"
operator|+
...
name|to
argument_list|(
literal|"elasticsearch5-rest://elasticsearch?operation=GetById&indexName=twitter&indexType=tweet&hostAddresses=localhost:"
operator|+
name|ES_BASE_HTTP_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5-rest://elasticsearch?operation=MultiGet&indexName=twitter&indexType=tweet&hostAddresses=localhost:"
operator|+
name|ES_BASE_HTTP_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5-rest://elasticsearch?operation=Delete&indexName=twitter&indexType=tweet&hostAddresses=localhost:"
operator|+
name|ES_BASE_HTTP_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5-rest://elasticsearch?operation=Search&indexName=twitter&indexType=tweet&hostAddresses=localhost:"
operator|+
name|ES_BASE_HTTP_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5-rest://elasticsearch?operation=Update&indexName=twitter&indexType=tweet&hostAddresses=localhost:"
operator|+
name|ES_BASE_HTTP_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5-rest://elasticsearch?operation=Exists&hostAddresses=localhost:"
operator|+
name|ES_BASE_HTTP_PORT
argument_list|)
expr_stmt|;
