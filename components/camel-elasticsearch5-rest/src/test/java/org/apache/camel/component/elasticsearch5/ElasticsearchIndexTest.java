...
name|to
argument_list|(
literal|"elasticsearch5-rest://elasticsearch?hostAddresses=localhost:"
operator|+
...
name|to
argument_list|(
literal|"elasticsearch5-rest://elasticsearch?operation=Index&indexName=twitter&indexType=tweet&hostAddresses=localhost:"
operator|+
name|ES_BASE_HTTP_PORT
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"elasticsearch5-rest://elasticsearch?operation=DeleteIndex&indexName=twitter&indexType=tweet&hostAddresses=localhost:"
operator|+
name|ES_BASE_HTTP_PORT
argument_list|)
expr_stmt|;
