...
name|jobRegistry
decl_stmt|;
DECL|method|SpringBatchProducer (SpringBatchEndpoint endpoint, JobLauncher jobLauncher, Job job, JobRegistry jobRegistry)
specifier|public
name|SpringBatchProducer
parameter_list|(
...
name|CamelExchangeException
argument_list|(
literal|"jobName was not specified in the endpoint construction "
operator|+
literal|" and header "
operator|+
name|SpringBatchConstants
