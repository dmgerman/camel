...
begin_comment
comment|/**  * A useful base class which creates a {@link org.apache.camel.CamelContext}  * with some routes along with a {@link org.apache.camel.ProducerTemplate} for  * use in the test case Do<tt>not</tt> use this class for Spring Boot testing.  */
end_comment
...
annotation|@
name|RegisterExtension
DECL|field|camelTestSupportExtension
specifier|protected
name|CamelTestSupport
name|camelTestSupportExtension
init|=
name|this
decl_stmt|;
...
annotation|@
name|Override
DECL|method|afterTestExecution (ExtensionContext context)
specifier|public
name|void
...
annotation|@
name|Override
DECL|method|beforeTestExecution (ExtensionContext context)
specifier|public
name|void
...
annotation|@
name|Override
DECL|method|beforeEach (ExtensionContext context)
specifier|public
name|void
name|beforeEach
parameter_list|(
...
annotation|@
name|Override
DECL|method|afterAll (ExtensionContext context)
specifier|public
name|void
name|afterAll
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// jmx is enabled if we have configured to use it, or if dump route
comment|// coverage is enabled (it requires JMX)
name|boolean
name|jmx
init|=
name|useJmx
...
argument_list|)
expr_stmt|;
comment|// when stopping CamelContext it will automatic remove the
comment|// breakpoint
block|}
name|template
operator|=
...
return|;
block|}
comment|/**      * Whether to ignore missing locations with the {@link PropertiesComponent}.      * For example when unit testing you may want to ignore locations that are      * not available in the environment used for testing.      *      * @return<tt>true</tt> to ignore,<tt>false</tt> to not ignore, and      *<tt>null</tt> to leave as configured on the      *         {@link PropertiesComponent}      */
...
name|Exception
block|{
comment|// use the bean post processor if the test class is not dependency
comment|// injected already by Spring Framework
name|boolean
name|spring
init|=
name|hasClassAnnotation
