...
begin_class
DECL|class|IsMockEndpointsAndSkipJUnit5Test
specifier|public
class|class
name|IsMockEndpointsAndSkipJUnit5Test
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|Exception
block|{
comment|// notice we have automatic mocked the direct:foo endpoints and the name
comment|// of the endpoints is "mock:uri"
