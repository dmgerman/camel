...
argument_list|)
expr_stmt|;
comment|// add service name to the parameters
name|parameters
operator|.
name|put
argument_list|(
...
literal|"unchecked"
argument_list|)
DECL|method|computeServiceParameters (Map<String, Object> parameters)
specifier|private
name|ServiceParameters
name|computeServiceParameters
parameter_list|(
...
parameter_list|)
block|{
comment|// Extract service definition related parameter from uri
specifier|final
name|String
name|serviceId
init|=
