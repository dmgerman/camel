...
name|CharacterCodingException
block|{
comment|// for fast convertions try this first instead of type converter registry
name|String
name|value
init|=
literal|null
...
block|{
comment|// try to lookup if there is a string converter
name|TypeConverter
name|tc
init|=
name|context
...
condition|)
block|{
comment|// use the slower converter that throws exception
try|try
block|{
name|value
operator|=
...
return|;
block|}
comment|// failback if ther is a byte buffer type converter, in case there is a fallback converter as well
return|return
name|context
operator|.
name|getTypeConverter
