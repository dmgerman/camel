...
begin_class
DECL|class|Mina2SslContextParametersVmTest
specifier|public
class|class
name|Mina2SslContextParametersVmTest
extends|extends
name|BaseMina2Test
block|{
annotation|@
...
name|fromF
argument_list|(
literal|"mina:vm://localhost:%s?sync=false&minaLogger=true&sslContextParameters=#sslContextParameters"
argument_list|,
name|getPort
argument_list|()
argument_list|)
