...
begin_class
DECL|class|MinaDisconnectRaceConditionTest
specifier|public
class|class
name|MinaDisconnectRaceConditionTest
extends|extends
name|BaseMinaTest
block|{
...
name|format
argument_list|(
literal|"mina:tcp://localhost:%1$s?sync=true&textline=true&disconnect=true&minaLogger=true"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina:tcp://localhost:%1$s?sync=true&textline=true"
argument_list|,
name|getPort
argument_list|()
argument_list|)
