...
begin_class
DECL|class|MinaSslContextParametersTcpTest
specifier|public
class|class
name|MinaSslContextParametersTcpTest
extends|extends
name|BaseMinaTest
block|{
annotation|@
...
name|fromF
argument_list|(
literal|"mina:tcp://localhost:%s?sync=false&minaLogger=true&sslContextParameters=#sslContextParameters"
argument_list|,
name|getPort
argument_list|()
argument_list|)
