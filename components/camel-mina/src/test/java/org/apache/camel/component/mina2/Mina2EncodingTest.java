...
name|format
argument_list|(
literal|"mina:tcp://localhost:%1$s?encoding=UTF-8&sync=false"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina:tcp://localhost:%1$s?textline=true&encoding=UTF-8&sync=false"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina:udp://localhost:%1$s?encoding=UTF-8&sync=false"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina:udp://localhost:%1$s?sync=true&encoding=UTF-8"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina:tcp://localhost:%1$s?textline=true&encoding=XXX&sync=false"
argument_list|,
name|getPort
argument_list|()
argument_list|)
