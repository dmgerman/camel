...
begin_comment
comment|/**  * {@link IoHandler} implementation of reverser server protocol.  *   * @author The Apache Directory Project (mina-dev@directory.apache.org)  * @version $Rev: 555855 $, $Date: 2007-07-12 20:19:00 -0700 (Thu, 12 Jul 2007) $,  */
end_comment

begin_class
DECL|class|ReverseProtocolHandler
specifier|public
class|class
name|ReverseProtocolHandler
extends|extends
name|IoHandlerAdapter
block|{
