...
name|format
argument_list|(
literal|"mina:tcp://localhost:%1$s?sync=true&codec=#myCodec"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina:tcp://localhost:%1$s?sync=true&codec=#failingCodec"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina:tcp://localhost:%1$s?sync=true&codec=#XXX"
argument_list|,
name|getPort
argument_list|()
argument_list|)
