...
name|testFilter
argument_list|(
literal|"mina:tcp://localhost:{{port}}?textline=true&minaLogger=true&sync=false&filters=#myFilters"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|testFilter
argument_list|(
literal|"mina:tcp://localhost:{{port}}?textline=true&minaLogger=true&sync=false&filters=#myFilter"
argument_list|)
expr_stmt|;
block|}
annotation|@
