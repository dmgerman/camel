...
name|format
argument_list|(
literal|"mina:vm://localhost:%1$s?sync=true&codec=#myCodec"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina:vm://localhost:%1$s?encoding=UTF-8&sync=false"
argument_list|,
name|getNextPort
argument_list|()
argument_list|)
...
name|format
argument_list|(
literal|"mina:vm://localhost:%1$s?sync=true&codec=#XXX"
argument_list|,
name|getPort
argument_list|()
argument_list|)
