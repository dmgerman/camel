...
expr_stmt|;
block|}
comment|/**      * Lookup or create a new registry if none exists with the given name      */
DECL|method|getHttpRegistry (String name)
specifier|public
specifier|static
...
return|;
block|}
comment|/**      * Removes the http registry with the given name      */
DECL|method|removeHttpRegistry (String name)
specifier|public
specifier|static
specifier|synchronized
name|void
...
name|debug
argument_list|(
literal|"Unregistering CamelServlet with name {}"
argument_list|,
name|provider
operator|.
name|getServletName
