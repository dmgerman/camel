...
expr_stmt|;
block|}
comment|/**      * Strategy to get the {@link CamelServletService} for the given endpoint.      *      * @param endpoint  the http endpoint.      * @return the service      */
DECL|method|getCamelServletService (ServletEndpoint endpoint, HttpConsumer consumer)
specifier|public
