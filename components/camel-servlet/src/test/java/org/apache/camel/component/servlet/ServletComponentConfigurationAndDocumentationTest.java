...
begin_class
DECL|class|ServletComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|ServletComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|contains
argument_list|(
literal|"\"servletName\": { \"type\": \"java.lang.String\" }"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
