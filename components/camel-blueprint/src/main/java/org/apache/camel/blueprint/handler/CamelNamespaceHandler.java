...
argument_list|)
expr_stmt|;
comment|// setup the BeanPostProcessor
name|createBeansReference
argument_list|(
name|context
argument_list|,
name|contextId
...
return|;
block|}
DECL|method|createBeansReference (ParserContext context, String contextId, List beans)
specifier|private
name|void
name|createBeansReference
parameter_list|(
...
parameter_list|)
block|{
comment|// need to check the beanPostProcessor first
name|MutableBeanMetadata
name|metadata
init|=
name|context
...
name|info
argument_list|(
literal|"**** create the beanPostProcessor"
argument_list|)
expr_stmt|;
name|context
operator|.
