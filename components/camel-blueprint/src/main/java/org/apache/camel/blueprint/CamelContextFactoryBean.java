...
begin_comment
comment|/**  * A bean to create and initialize a {@link BlueprintCamelContext}  * and install routes either explicitly configured in  * Blueprint XML or found by searching the classpath for Java classes which extend  * {@link RouteBuilder} using the nested {@link #setPackages(String[])}.  */
end_comment
...
name|name
operator|=
literal|"defaultResilience4jConfiguration"
argument_list|)
DECL|field|defaultResilience4jConfiguration
specifier|private
name|Resilience4jConfigurationDefinition
name|defaultResilience4jConfiguration
decl_stmt|;
annotation|@
name|XmlElement
argument_list|(
...
name|class
argument_list|)
DECL|field|resilience4jConfigurations
specifier|private
name|List
argument_list|<
name|Resilience4jConfigurationDefinition
argument_list|>
name|resilience4jConfigurations
decl_stmt|;
annotation|@
name|XmlElement
argument_list|(
...
annotation|@
name|XmlTransient
DECL|field|osgiCamelContextPublisher
specifier|private
name|OsgiCamelContextPublisher
name|osgiCamelContextPublisher
decl_stmt|;
...
condition|)
block|{
comment|// no blueprint locations has been set, so auto-detect the blueprint property placeholders to use (convention over configuration)
name|ids
operator|=
...
block|}
block|}
comment|/**      * Lookup the ids of the Blueprint property placeholder services in the      * Blueprint container.      *      * @return the ids, will be an empty if none found.      */
...
annotation|@
name|Override
DECL|method|getDefaultResilience4jConfiguration ()
specifier|public
name|Resilience4jConfigurationDefinition
name|getDefaultResilience4jConfiguration
parameter_list|()
block|{
return|return
name|defaultResilience4jConfiguration
return|;
block|}
DECL|method|setDefaultResilience4jConfiguration (Resilience4jConfigurationDefinition defaultResilience4jConfiguration)
specifier|public
name|void
name|setDefaultResilience4jConfiguration
parameter_list|(
name|Resilience4jConfigurationDefinition
name|defaultResilience4jConfiguration
parameter_list|)
...
annotation|@
name|Override
DECL|method|getResilience4jConfigurations ()
specifier|public
name|List
argument_list|<
name|Resilience4jConfigurationDefinition
argument_list|>
name|getResilience4jConfigurations
parameter_list|()
block|{
return|return
name|resilience4jConfigurations
return|;
block|}
DECL|method|setResilience4jConfigurations (List<Resilience4jConfigurationDefinition> resilience4jConfigurations)
specifier|public
name|void
