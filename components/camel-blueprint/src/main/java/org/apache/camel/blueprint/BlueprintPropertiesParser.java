...
argument_list|(
operator|new
name|AbstractPropertyPlaceholderExtWrapper
argument_list|(
name|placeholder
argument_list|)
argument_list|)
...
argument_list|(
operator|new
name|AbstractPropertyPlaceholderWrapper
argument_list|(
name|placeholder
argument_list|)
argument_list|)
...
return|;
block|}
DECL|interface|PropertyPlaceholderWrapper
specifier|private
interface|interface
name|PropertyPlaceholderWrapper
block|{
comment|/**          * Retrieves the String value (or {@code null}) from underlying placeholder          * @param key          * @return          */
...
function_decl|;
block|}
DECL|class|AbstractPropertyPlaceholderExtWrapper
specifier|private
class|class
name|AbstractPropertyPlaceholderExtWrapper
...
name|delegate
decl_stmt|;
DECL|method|AbstractPropertyPlaceholderExtWrapper (AbstractPropertyPlaceholderExt delegate)
specifier|public
name|AbstractPropertyPlaceholderExtWrapper
parameter_list|(
name|AbstractPropertyPlaceholderExt
...
block|}
block|}
DECL|class|AbstractPropertyPlaceholderWrapper
specifier|private
class|class
name|AbstractPropertyPlaceholderWrapper
implements|implements
...
name|delegate
decl_stmt|;
DECL|method|AbstractPropertyPlaceholderWrapper (AbstractPropertyPlaceholder delegate)
specifier|public
name|AbstractPropertyPlaceholderWrapper
parameter_list|(
name|AbstractPropertyPlaceholder
