...
name|om
operator|.
name|AllElementsSpaceStrippingRule
import|;
end_import
...
name|om
operator|.
name|IgnorableSpaceStrippingRule
import|;
end_import
...
return|;
block|}
DECL|method|xquery (final InputStream in)
specifier|public
specifier|static
name|XQueryBuilder
name|xquery
...
literal|"unchecked"
argument_list|)
DECL|method|getAsParameter (Object value)
specifier|protected
name|Item
name|getAsParameter
parameter_list|(
...
name|configuration
operator|.
name|getParseOptions
argument_list|()
operator|.
name|setSpaceStrippingRule
argument_list|(
name|isStripsAllWhiteSpace
argument_list|()
condition|?
...
argument_list|()
decl_stmt|;
comment|// skip invalid prefix or uri according to XQuery spec
name|boolean
name|invalid
init|=
literal|"xml"
...
name|debug
argument_list|(
literal|"Declaring namespace [prefix: {}, uri: {}]"
argument_list|,
name|prefix
argument_list|,
name|uri
