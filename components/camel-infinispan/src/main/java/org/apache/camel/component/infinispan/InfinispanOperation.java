...
expr_stmt|;
block|}
DECL|method|getOperation (Message message, InfinispanConfiguration configuration)
specifier|private
specifier|static
name|Operation
name|getOperation
...
name|warn
argument_list|(
literal|"You'll need to enable statistics to obtain meaningful data from your cache"
argument_list|)
expr_stmt|;
name|setResult
argument_list|(
...
argument_list|()
decl_stmt|;
DECL|method|setResult (InfinispanConfiguration configuration, Object result, Message message)
name|void
name|setResult
parameter_list|(
name|InfinispanConfiguration
...
return|;
block|}
DECL|method|getOldValue (Message message)
name|Object
name|getOldValue
parameter_list|(
name|Message
...
return|;
block|}
DECL|method|getQuery (InfinispanConfiguration configuration, BasicCache<Object, Object> cache, Message message)
name|Query
name|getQuery
parameter_list|(
name|InfinispanConfiguration
...
return|;
block|}
DECL|method|execute (InfinispanConfiguration configuration, BasicCache<Object, Object> cache, Message message)
specifier|abstract
name|void
name|execute
parameter_list|(
...
parameter_list|)
function_decl|;
DECL|method|fromOperation (String operation)
specifier|public
specifier|static
name|Operation
name|fromOperation
...
argument_list|(
literal|"Unknown Operation for string: "
operator|+
name|operation
argument_list|)
throw|;
