...
begin_class
DECL|class|InfinispanComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|InfinispanComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|contains
argument_list|(
literal|"\"command\": { \"type\": \"java.lang.String\" }"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
