...
annotation|@
name|Test
DECL|method|computeAsyncOperation ()
specifier|public
name|void
name|computeAsyncOperation
parameter_list|()
throws|throws
name|Exception
block|{
...
name|to
argument_list|(
literal|"infinispan?cacheContainer=#cacheContainer&operation=COMPUTEASYNC&remappingFunction=#mappingFunction"
argument_list|)
expr_stmt|;
block|}
block|}
