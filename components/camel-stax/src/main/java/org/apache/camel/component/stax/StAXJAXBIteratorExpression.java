...
expr_stmt|;
block|}
comment|/**      * Creates this expression.      *      * @param handled          the class which has JAXB annotations to bind POJO.      * @param isNamespaceAware sets the namespace awareness of the xml reader      */
DECL|method|StAXJAXBIteratorExpression (Class<T> handled, boolean isNamespaceAware)
specifier|public
name|StAXJAXBIteratorExpression
parameter_list|(
name|Class
...
expr_stmt|;
block|}
comment|/**      * Creates this expression.      *      * @param handledName      the FQN name of the class which has JAXB annotations to bind POJO.      * @param isNamespaceAware sets the namespace awareness of the xml reader      */
DECL|method|StAXJAXBIteratorExpression (String handledName, boolean isNamespaceAware)
specifier|public
name|StAXJAXBIteratorExpression
parameter_list|(
name|String
