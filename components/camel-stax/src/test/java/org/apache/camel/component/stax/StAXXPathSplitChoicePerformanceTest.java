...
name|Ignore
argument_list|(
literal|"this is a manual test"
argument_list|)
DECL|class|StAXXPathSplitChoicePerformanceTest
specifier|public
class|class
name|StAXXPathSplitChoicePerformanceTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|size
...
annotation|@
name|Test
DECL|method|testXPathSTaXPerformanceRoute ()
specifier|public
name|void
name|testXPathSTaXPerformanceRoute
parameter_list|()
throws|throws
name|Exception
block|{
...
name|write
argument_list|(
literal|"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><orders>\n"
operator|.
name|getBytes
argument_list|()
argument_list|)
