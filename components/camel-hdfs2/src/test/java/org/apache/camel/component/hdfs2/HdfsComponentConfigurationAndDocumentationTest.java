...
begin_class
DECL|class|HdfsComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|HdfsComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|(
literal|"hdfs2://localhost/tmp/simple-file?"
operator|+
literal|"splitStrategy=IDLE:1000,BYTES:5&fileSystemType=LOCAL&fileType=ARRAY_FILE&initialDelay=0"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|contains
argument_list|(
literal|"\"initialDelay\": { \"kind\": \"parameter\", \"type\": \"integer\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"checkIdleInterval\": { \"kind\": \"parameter\", \"type\": \"integer\""
argument_list|)
argument_list|)
expr_stmt|;
block|}
