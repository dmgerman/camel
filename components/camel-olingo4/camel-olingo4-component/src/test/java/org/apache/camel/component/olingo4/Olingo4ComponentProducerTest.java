...
begin_class
DECL|class|Olingo4ComponentProducerTest
specifier|public
class|class
name|Olingo4ComponentProducerTest
extends|extends
...
name|requestBody
argument_list|(
literal|"direct:unbound-action-ResetDataSource"
argument_list|,
literal|null
argument_list|)
decl_stmt|;
...
name|requestBody
argument_list|(
literal|"direct:bound-action-people"
argument_list|,
name|clientEntity
argument_list|)
decl_stmt|;
...
name|to
argument_list|(
literal|"olingo4://action/ResetDataSource"
argument_list|)
expr_stmt|;
name|from
argument_list|(
