...
name|requestBodyAndHeaders
argument_list|(
literal|"direct:readcollectionprop"
argument_list|,
literal|null
argument_list|,
name|headers
...
name|PEOPLE
operator|+
literal|"?filterAlreadySeen=true&consumer.delay=2&consumer.sendEmptyMessageWhenIdle=true&consumer.splitResult=false"
decl_stmt|;
name|int
...
name|PEOPLE
operator|+
literal|"?$top=5&$orderby=FirstName asc"
argument_list|)
expr_stmt|;
name|from
argument_list|(
