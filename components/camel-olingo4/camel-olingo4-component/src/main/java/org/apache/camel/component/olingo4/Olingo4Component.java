...
begin_comment
comment|/**  * Represents the component that manages {@link Olingo4Endpoint}.  */
end_comment
...
expr_stmt|;
block|}
DECL|method|Olingo4Component (CamelContext context)
specifier|public
name|Olingo4Component
parameter_list|(
name|CamelContext
...
annotation|@
name|Override
DECL|method|createEndpoint (String uri, String methodName, Olingo4ApiName apiName, Olingo4Configuration endpointConfiguration)
specifier|protected
name|Endpoint
name|createEndpoint
parameter_list|(
...
annotation|@
name|Override
DECL|method|setConfiguration (Olingo4Configuration configuration)
specifier|public
name|void
...
return|;
block|}
DECL|method|createApiProxy (Olingo4Configuration endpointConfiguration)
specifier|public
name|Olingo4AppWrapper
name|createApiProxy
parameter_list|(
...
return|;
block|}
DECL|method|createOlingo4App (Olingo4Configuration configuration)
specifier|private
name|Olingo4AppWrapper
name|createOlingo4App
parameter_list|(
