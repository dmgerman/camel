...
begin_comment
comment|/**  * Communicates with OData 4.0 services using Apache Olingo OData API.  */
end_comment
...
name|apiProxy
decl_stmt|;
DECL|method|Olingo4Endpoint (String uri, Olingo4Component component, Olingo4ApiName apiName, String methodName, Olingo4Configuration endpointConfiguration)
specifier|public
name|Olingo4Endpoint
parameter_list|(
name|String
