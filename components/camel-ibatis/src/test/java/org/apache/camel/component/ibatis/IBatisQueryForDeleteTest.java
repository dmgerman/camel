...
begin_class
DECL|class|IBatisQueryForDeleteTest
specifier|public
class|class
name|IBatisQueryForDeleteTest
extends|extends
...
argument_list|()
expr_stmt|;
comment|// there should be 1 rows now
name|Integer
name|rows
init|=
name|template
...
name|assertEquals
argument_list|(
literal|"There should be 1 rows"
argument_list|,
literal|1
argument_list|,
name|rows
...
name|to
argument_list|(
literal|"ibatis:deleteAccountById?statementType=Delete"
argument_list|)
operator|.
name|to
argument_list|(
