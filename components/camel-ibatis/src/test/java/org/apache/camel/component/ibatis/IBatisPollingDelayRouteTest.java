...
begin_class
DECL|class|IBatisPollingDelayRouteTest
specifier|public
class|class
name|IBatisPollingDelayRouteTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
comment|// run this timer every 2nd second, that will select data from the database and send it to the mock endpiont
name|from
argument_list|(
