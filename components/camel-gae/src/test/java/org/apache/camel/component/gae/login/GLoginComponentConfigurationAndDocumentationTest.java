...
begin_class
DECL|class|GLoginComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|GLoginComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|contains
argument_list|(
literal|"\"hostName\": { \"kind\": \"path\", \"type\": \"string\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"clientName\": { \"kind\": \"path\", \"type\": \"string\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"devMode\": { \"kind\": \"parameter\", \"type\": \"boolean\""
argument_list|)
argument_list|)
expr_stmt|;
block|}
