...
begin_class
DECL|class|GTaskComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|GTaskComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|(
literal|"gtask:default?workerRoot=camel"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|contains
argument_list|(
literal|"\"workerRoot\": { \"kind\": \"parameter\", \"type\": \"string\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"disableStreamCache\": { \"kind\": \"parameter\", \"type\": \"boolean\""
argument_list|)
argument_list|)
expr_stmt|;
block|}
