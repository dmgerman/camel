...
begin_class
DECL|class|GHttpComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|GHttpComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
operator|+
literal|"bridgeEndpoint=false&throwExceptionOnFailure=false"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
