...
block|,
literal|"camel.cloud.servicecall.load-balancer.enabled=true"
block|,
literal|"camel.cloud.servicecall.server-list-strategy.enabled=false"
block|}
argument_list|)
...
name|getProperty
argument_list|(
literal|"camel.cloud.servicecall.server-list-strategy.enabled"
argument_list|,
name|Boolean
operator|.
name|class
