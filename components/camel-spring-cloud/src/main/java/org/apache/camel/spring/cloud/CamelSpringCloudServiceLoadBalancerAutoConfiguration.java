...
annotation|@
name|ConditionalOnMissingBean
DECL|method|cloudLoadBalancer ( LoadBalancerClient loadBalancerClient, Optional<CamelSpringCloudServiceLoadBalancer.LoadBalancerClientAdapter> clientAdapter)
specifier|public
name|ServiceLoadBalancer
