...
begin_package
DECL|package|org.apache.camel.component.validator.relaxng
package|package
name|org
operator|.
name|apache
...
expr_stmt|;
block|}
comment|/*     public void testValidMessageUsingRelaxNGCompactSyntax() throws Exception {         assertValidMessage("direct:rnc");     }      public void testInvalidMessageUsingRelaxNGCompactSyntax() throws Exception {         assertInvalidMessage("direct:rnc");     }  */
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/component/validator/relaxng/camelContext.xml"
argument_list|)
return|;
block|}
block|}
