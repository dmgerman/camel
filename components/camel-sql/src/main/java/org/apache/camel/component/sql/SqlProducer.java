...
decl_stmt|;
DECL|field|producerSSPTHelper
specifier|private
specifier|final
name|ProducerSSPTHelper
name|producerSSPTHelper
decl_stmt|;
DECL|method|SqlProducer (SqlEndpoint endpoint, String query, JdbcTemplate jdbcTemplate, SqlPrepareStatementStrategy sqlPrepareStatementStrategy, boolean batch, boolean alwaysPopulateStatement, boolean useMessageBodyForSql, ProducerSSPTHelper producerSSPTHelper)
specifier|public
name|SqlProducer
parameter_list|(
name|SqlEndpoint
