...
return|;
block|}
comment|/**      * Sets propagation behavior to use with spring transaction templates which are used for database access.      * The default is TransactionDefinition.PROPAGATION_REQUIRED.      */
...
expr_stmt|;
block|}
comment|/**      * Sets propagation behavior to use with spring transaction templates which are used for database access.      * The default is TransactionDefinition.PROPAGATION_REQUIRED. This setter accepts names of the constants, like      * "PROPAGATION_REQUIRED".      * @param propagationBehaviorName      */
...
argument_list|(
literal|"Only propagation constants allowed"
argument_list|)
throw|;
block|}
name|setPropagationBehavior
