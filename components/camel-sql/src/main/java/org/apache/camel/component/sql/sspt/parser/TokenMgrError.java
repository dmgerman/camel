...
DECL|method|addEscapes (String str)
specifier|protected
specifier|static
specifier|final
name|String
...
DECL|method|LexicalError (boolean EOFSeen, int lexState, int errorLine, int errorColumn, String errorAfter, char curChar)
specifier|protected
specifier|static
name|String
name|LexicalError
...
DECL|method|TokenMgrError (String message, int reason)
specifier|public
name|TokenMgrError
parameter_list|(
name|String
...
DECL|method|TokenMgrError (boolean EOFSeen, int lexState, int errorLine, int errorColumn, String errorAfter, char curChar, int reason)
specifier|public
name|TokenMgrError
parameter_list|(
name|boolean
...
begin_comment
comment|/* JavaCC - OriginalChecksum=40bf525b6801e308b2ddf5874ae68024 (do not edit this line) */
end_comment
