...
argument_list|)
decl_stmt|;
DECL|field|NAME_IN_PATTERN
specifier|private
specifier|static
specifier|final
name|Pattern
name|NAME_IN_PATTERN
init|=
name|Pattern
operator|.
name|compile
...
condition|)
block|{
comment|// turn on in mode, so we only match using in matcher next time
name|in
operator|=
literal|true
expr_stmt|;
...
condition|)
block|{
comment|// turn on name mode, so we only match using name matcher next time
name|name
operator|=
literal|true
expr_stmt|;
