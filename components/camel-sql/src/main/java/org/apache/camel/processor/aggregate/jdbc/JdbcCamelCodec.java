...
return|;
block|}
DECL|method|marshallExchange (CamelContext camelContext, Exchange exchange, boolean allowSerializedHeaders, OutputStream outputStream)
specifier|public
name|void
name|marshallExchange
parameter_list|(
...
return|;
block|}
DECL|method|unmarshallExchange (CamelContext camelContext, InputStream inputStream)
specifier|public
name|Exchange
name|unmarshallExchange
parameter_list|(
...
return|;
block|}
DECL|method|encode (Object object, OutputStream bytesOut)
specifier|private
name|void
name|encode
parameter_list|(
...
block|}
block|}
DECL|method|decode (CamelContext camelContext, InputStream bytesIn)
specifier|private
name|DefaultExchangeHolder
name|decode
parameter_list|(
