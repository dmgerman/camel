...
begin_class
DECL|class|SqlConsumerDeleteBatchCompleteTest
specifier|public
class|class
name|SqlConsumerDeleteBatchCompleteTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|db
...
name|from
argument_list|(
literal|"sql:select * from projects order by id?consumer.onConsumeBatchComplete=delete from projects"
argument_list|)
operator|.
name|to
argument_list|(
