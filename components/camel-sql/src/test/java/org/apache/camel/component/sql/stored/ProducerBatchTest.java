...
begin_class
DECL|class|ProducerBatchTest
specifier|public
class|class
name|ProducerBatchTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|db
...
annotation|@
name|Test
DECL|method|shouldExecuteBatch ()
specifier|public
name|void
name|shouldExecuteBatch
parameter_list|()
throws|throws
...
name|to
argument_list|(
literal|"sql-stored:BATCHFN(INTEGER :#num)?batch=true"
argument_list|)
operator|.
name|to
argument_list|(
