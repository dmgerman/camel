...
begin_class
DECL|class|JdbcMessageIdRepositoryTest
specifier|public
class|class
name|JdbcMessageIdRepositoryTest
extends|extends
name|CamelSpringTestSupport
block|{
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/processor/idempotent/jdbc/spring.xml"
argument_list|)
return|;
block|}
...
parameter_list|)
block|{
comment|// noop if table already exists
block|}
name|jdbcTemplate
operator|.
name|update
...
argument_list|(
literal|"JdbcMessageIdRepositoryTest"
argument_list|)
decl_stmt|;
name|routeDefinition
operator|.
