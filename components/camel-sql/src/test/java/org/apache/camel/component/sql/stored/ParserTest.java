...
name|parseTemplate
argument_list|(
literal|"FOO('p_instance_id' 2 'p_2' ${header.foo})"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|parseTemplate
argument_list|(
literal|"FOO(OUT 'p_error_cd' 1 header1)"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|parseTemplate
argument_list|(
literal|"FOO(OUT 'p_error_cd' org.apache.camel.component.sql.stored.CustomType.INTEGER header1)"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
