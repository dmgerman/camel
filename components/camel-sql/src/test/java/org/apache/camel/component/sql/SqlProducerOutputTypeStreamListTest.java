...
begin_class
DECL|class|SqlProducerOutputTypeStreamListTest
specifier|public
class|class
name|SqlProducerOutputTypeStreamListTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|db
...
name|to
argument_list|(
literal|"sql:select * from projects order by id?outputType=StreamList"
argument_list|)
operator|.
name|to
argument_list|(
...
name|to
argument_list|(
literal|"sql:select * from projects order by id?outputType=StreamList&outputClass=org.apache.camel.component.sql.ProjectModel"
argument_list|)
operator|.
name|to
argument_list|(
