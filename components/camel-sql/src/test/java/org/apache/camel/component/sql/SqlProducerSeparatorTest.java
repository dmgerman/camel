...
begin_class
DECL|class|SqlProducerSeparatorTest
specifier|public
class|class
name|SqlProducerSeparatorTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|db
...
name|to
argument_list|(
literal|"sql:insert into projects (id, project, license) values (#, #, #)?separator=;"
argument_list|)
operator|.
name|to
argument_list|(
