...
begin_class
DECL|class|ProducerInOutTest
specifier|public
class|class
name|ProducerInOutTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|db
...
annotation|@
name|Test
DECL|method|testInOutStoredProcedure ()
specifier|public
name|void
name|testInOutStoredProcedure
parameter_list|()
throws|throws
...
name|to
argument_list|(
literal|"sql-stored:INOUTDEMO(INTEGER ${headers.in1},INOUT INTEGER ${headers.in2} out1,OUT INTEGER out2)"
argument_list|)
operator|.
name|to
argument_list|(
