...
begin_class
DECL|class|SqlFunctionDataSourceTest
specifier|public
class|class
name|SqlFunctionDataSourceTest
extends|extends
name|CamelTestSupport
block|{
DECL|field|db
...
name|to
argument_list|(
literal|"sql-stored:SUBNUMBERS_FUNCTION(OUT INTEGER resultofsub, INTEGER ${header.num1},INTEGER ${header.num2})?function=true"
argument_list|)
operator|.
name|to
argument_list|(
