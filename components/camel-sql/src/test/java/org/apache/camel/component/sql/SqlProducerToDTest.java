...
begin_class
DECL|class|SqlProducerToDTest
specifier|public
class|class
name|SqlProducerToDTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|constant
argument_list|(
literal|"select * from projects where project = :#foo order by id"
argument_list|)
argument_list|)
operator|.
name|toD
argument_list|(
literal|"sql:${header.myQuery}?dataSource=#myDS"
argument_list|)
operator|.
name|to
argument_list|(
