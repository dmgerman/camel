...
annotation|@
name|Test
DECL|method|testResultConverterString ()
specifier|public
name|void
name|testResultConverterString
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test print in stdout from threads.      *       * @see ExecutableJavaProgram#THREADS      * @throws Exception      */
annotation|@
name|Test
...
expr_stmt|;
block|}
comment|/**      * Test if the process will be terminate in about a second      *       * @see ExecutableJavaProgram#SLEEP_WITH_TIMEOUT      * @throws Exception      */
annotation|@
name|Test
...
expr_stmt|;
block|}
comment|/**      * Test reading of input lines from the executable's stdin      *       * @see ExecutableJavaProgram#READ_INPUT_LINES_AND_PRINT_THEM      * @throws Exception      */
annotation|@
name|Test
...
return|;
block|}
DECL|method|sendExchange (final Object commandArgument, final long timeout, final String body)
specifier|protected
name|Exchange
name|sendExchange
parameter_list|(
