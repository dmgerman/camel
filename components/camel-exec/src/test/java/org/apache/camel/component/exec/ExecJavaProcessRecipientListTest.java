...
begin_comment
comment|/**  * Tests the functionality of the {@link org.apache.camel.component.exec.ExecComponent}, executing<br>  *<i>java org.apache.camel.component.exec.ExecutableJavaProgram</i><br>  * command.<b>Note, that the tests assume, that the JAVA_HOME system variable  * is set.</b> This is a more credible assumption, than assuming that java is in  * the path, because the Maven scripts build the path to java with the JAVA_HOME  * environment variable.  *  * @see {@link org.apache.camel.component.exec.ExecutableJavaProgram}  */
end_comment

begin_class
DECL|class|ExecJavaProcessRecipientListTest
specifier|public
class|class
name|ExecJavaProcessRecipientListTest
extends|extends
name|CamelTestSupport
block|{
...
annotation|@
name|Test
DECL|method|testExecJavaProcessExitCode1Direct ()
specifier|public
name|void
name|testExecJavaProcessExitCode1Direct
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|sendExchange (final String endpoint, final Object commandArgument, final long timeout)
specifier|protected
name|Exchange
name|sendExchange
parameter_list|(
...
return|;
block|}
DECL|method|sendExchange (final String endpoint, final Object commandArgument, final long timeout, final String body, final boolean useStderrOnEmptyStdout)
specifier|protected
name|Exchange
name|sendExchange
parameter_list|(
