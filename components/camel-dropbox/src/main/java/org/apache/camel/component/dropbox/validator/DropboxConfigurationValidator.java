...
parameter_list|()
block|{ }
comment|/**      * Validate the parameters passed in the incoming url.      * @param configuration object containing the parameters.      * @throws DropboxException      */
DECL|method|validate (DropboxConfiguration configuration)
specifier|public
specifier|static
name|void
name|validate
...
block|}
block|}
DECL|method|validateGetOp (DropboxConfiguration configuration)
specifier|private
specifier|static
name|void
name|validateGetOp
...
expr_stmt|;
block|}
DECL|method|validatePutOp (DropboxConfiguration configuration)
specifier|private
specifier|static
name|void
name|validatePutOp
...
block|}
block|}
DECL|method|validateSearchOp (DropboxConfiguration configuration)
specifier|private
specifier|static
name|void
name|validateSearchOp
...
expr_stmt|;
block|}
DECL|method|validateDelOp (DropboxConfiguration configuration)
specifier|private
specifier|static
name|void
name|validateDelOp
...
expr_stmt|;
block|}
DECL|method|validateMoveOp (DropboxConfiguration configuration)
specifier|private
specifier|static
name|void
name|validateMoveOp
