...
name|DropboxTestSupport
block|{
DECL|method|DropboxProducerPutSingleFileTest ()
specifier|public
name|DropboxProducerPutSingleFileTest
parameter_list|()
throws|throws
...
name|to
argument_list|(
literal|"dropbox://put?accessToken={{accessToken}}&clientIdentifier={{clientIdentifier}}&uploadMode=add&localPath=/XXX"
argument_list|)
operator|.
name|to
argument_list|(
