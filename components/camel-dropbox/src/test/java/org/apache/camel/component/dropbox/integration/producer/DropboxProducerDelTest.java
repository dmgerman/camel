...
begin_class
DECL|class|DropboxProducerDelTest
specifier|public
class|class
name|DropboxProducerDelTest
extends|extends
name|DropboxTestSupport
block|{
DECL|method|DropboxProducerDelTest ()
specifier|public
name|DropboxProducerDelTest
parameter_list|()
throws|throws
...
name|to
argument_list|(
literal|"dropbox://del?accessToken={{accessToken}}&clientIdentifier={{clientIdentifier}}&remotePath=/XXX"
argument_list|)
operator|.
name|to
argument_list|(
...
name|to
argument_list|(
literal|"dropbox://del?accessToken={{accessToken}}&clientIdentifier={{clientIdentifier}}"
argument_list|)
operator|.
name|to
argument_list|(
