...
begin_class
DECL|class|CamelJmxConsumerObserveAttributeMatchStringTest
specifier|public
class|class
name|CamelJmxConsumerObserveAttributeMatchStringTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|fromF
argument_list|(
literal|"jmx:platform?objectDomain=org.apache.camel&key.context=%s&key.type=routes&key.name=\"foo\"&observedAttribute=Tracing&stringToCompare=false"
argument_list|,
name|id
argument_list|)
operator|.
