...
argument_list|()
decl_stmt|;
comment|// load from file system by default
if|if
condition|(
operator|!
name|name
...
name|GenericFileOperationFailedException
argument_list|(
literal|"Cannot load private keyfile: "
operator|+
name|config
operator|.
name|getPrivateKeyFile
...
name|trace
argument_list|(
literal|"Using private key bytes: {}"
argument_list|,
name|config
operator|.
name|getPrivateKeyBytes
...
expr_stmt|;
block|}
comment|// load file as input stream which can then load from classpath etc
if|if
condition|(
name|ObjectHelper
operator|.
...
name|GenericFileOperationFailedException
argument_list|(
literal|"Cannot load known host file: "
operator|+
name|knownHostsFile
argument_list|,
name|e
