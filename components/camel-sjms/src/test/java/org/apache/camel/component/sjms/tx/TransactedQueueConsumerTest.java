...
begin_class
DECL|class|TransactedQueueConsumerTest
specifier|public
class|class
name|TransactedQueueConsumerTest
extends|extends
...
name|BROKER_URI
init|=
literal|"vm://tqc_test_broker?broker.persistent=false&broker.useJmx=true"
decl_stmt|;
...
init|=
literal|"sjms:queue:one.consumer.one.route.tx.test"
decl_stmt|;
name|int
name|routeCount
init|=
