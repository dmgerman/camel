...
begin_class
DECL|class|AsyncConsumerInOutTest
specifier|public
class|class
name|AsyncConsumerInOutTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|inOut
argument_list|(
literal|"sjms:queue:in.out.test?namedReplyTo=response.queue&synchronous=false"
argument_list|)
operator|.
name|to
argument_list|(
...
name|from
argument_list|(
literal|"sjms:queue:in.out.test?exchangePattern=InOut&synchronous=false"
argument_list|)
operator|.
name|to
argument_list|(
