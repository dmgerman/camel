...
begin_class
DECL|class|TransactedTopicConsumerTest
specifier|public
class|class
name|TransactedTopicConsumerTest
extends|extends
...
name|BROKER_URI
init|=
literal|"vm://ttc_test_broker?broker.persistent=false&broker.useJmx=false"
decl_stmt|;
...
init|=
literal|"sjms:topic:one.consumer.one.route.tx.test"
decl_stmt|;
name|int
name|routeCount
init|=
