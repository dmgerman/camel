...
annotation|@
name|Test
DECL|method|testConsumptionCompletionAware ()
specifier|public
name|void
name|testConsumptionCompletionAware
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fromF
argument_list|(
literal|"sjms-batch:%s?completionSize=%s&aggregationStrategy=#groupedStrategy"
argument_list|,
name|queueName
argument_list|,
name|completionSize
