...
begin_class
DECL|class|InOutQueueProducerAsyncLoadTest
specifier|public
class|class
name|InOutQueueProducerAsyncLoadTest
extends|extends
name|JmsTestSupport
block|{
...
name|mc2
decl_stmt|;
DECL|method|InOutQueueProducerAsyncLoadTest ()
specifier|public
name|InOutQueueProducerAsyncLoadTest
parameter_list|()
block|{     }
...
name|TEST_DESTINATION_NAME
operator|+
literal|".response&consumerCount=10&producerCount=20&synchronous=false"
argument_list|)
operator|.
name|threads
argument_list|(
