...
begin_class
DECL|class|BatchTransactedTopicConsumerMultipleRouteTest
specifier|public
class|class
name|BatchTransactedTopicConsumerMultipleRouteTest
extends|extends
...
name|BROKER_URI
init|=
literal|"vm://bttcmr_test_broker?broker.persistent=false&broker.useJmx=false"
decl_stmt|;
...
init|=
literal|"sjms:topic:one.consumer.two.route.batch.tx.test"
decl_stmt|;
name|int
name|routeCount
init|=
