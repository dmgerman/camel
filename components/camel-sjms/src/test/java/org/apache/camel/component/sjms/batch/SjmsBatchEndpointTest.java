...
name|from
argument_list|(
literal|"sjmsbatch:in?aggregationStrategy=#aggStrategy&pollDuration=-1"
argument_list|)
operator|.
name|to
argument_list|(
...
name|from
argument_list|(
literal|"sjmsbatch:in?aggregationStrategy=#aggStrategy&consumerCount=-1"
argument_list|)
operator|.
name|to
argument_list|(
