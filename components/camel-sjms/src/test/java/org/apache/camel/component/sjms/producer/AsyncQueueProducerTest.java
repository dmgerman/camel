...
begin_class
DECL|class|AsyncQueueProducerTest
specifier|public
class|class
name|AsyncQueueProducerTest
extends|extends
name|CamelTestSupport
block|{
...
annotation|@
name|Test
DECL|method|testAsyncJmsProducerEndpoint ()
specifier|public
name|void
name|testAsyncJmsProducerEndpoint
parameter_list|()
throws|throws
name|Exception
block|{
...
name|to
argument_list|(
literal|"sjms:queue:foo?synchronous=false"
argument_list|)
expr_stmt|;
name|from
argument_list|(
