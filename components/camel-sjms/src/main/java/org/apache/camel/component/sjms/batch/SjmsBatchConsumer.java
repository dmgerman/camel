...
block|}
block|}
DECL|method|consumeBatchesOnLoop (final Session session, final MessageConsumer consumer, final AtomicBoolean timeoutInterval)
specifier|private
name|void
name|consumeBatchesOnLoop
parameter_list|(
...
name|batch
label|:
comment|// loop while no timeout or interval triggered and while we have room still for messages in the batch
while|while
condition|(
operator|!
name|timeout
