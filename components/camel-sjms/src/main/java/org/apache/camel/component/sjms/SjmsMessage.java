...
begin_comment
comment|/**  * Represents a {@link org.apache.camel.Message} for working with JMS  */
end_comment
...
name|binding
decl_stmt|;
DECL|method|SjmsMessage (Exchange exchange, Message jmsMessage, Session jmsSession, JmsBinding binding)
specifier|public
name|SjmsMessage
parameter_list|(
name|Exchange
