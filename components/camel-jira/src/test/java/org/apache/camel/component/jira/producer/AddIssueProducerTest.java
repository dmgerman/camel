...
name|class
argument_list|)
DECL|class|AddIssueProducerTest
specifier|public
class|class
name|AddIssueProducerTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
annotation|@
name|Test
DECL|method|verifyIssueAdded ()
specifier|public
name|void
name|verifyIssueAdded
parameter_list|()
throws|throws
...
argument_list|(
literal|"Minha descri̤̣o jira "
operator|+
operator|(
operator|new
name|Date
...
annotation|@
name|Test
DECL|method|verifyIssueAddedWithIds ()
specifier|public
name|void
name|verifyIssueAddedWithIds
parameter_list|()
throws|throws
name|InterruptedException
block|{
