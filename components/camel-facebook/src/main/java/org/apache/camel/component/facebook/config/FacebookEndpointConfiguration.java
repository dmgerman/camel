...
return|;
block|}
comment|/**      * To configure {@link Reading} using key/value pairs from the Map.      */
DECL|method|setReadingOptions (Map<String, Object> readingOptions)
specifier|public
name|void
