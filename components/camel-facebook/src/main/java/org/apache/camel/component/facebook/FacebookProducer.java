...
argument_list|()
decl_stmt|;
comment|// lock out the underlying Facebook object from other threads
...
return|;
block|}
DECL|method|hasReadingParameters (Map<String, Object> properties)
specifier|private
name|boolean
name|hasReadingParameters
parameter_list|(
name|Map
argument_list|<
name|String
