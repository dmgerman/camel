...
begin_class
DECL|class|NettyHttpProducerSessionTest
specifier|public
class|class
name|NettyHttpProducerSessionTest
extends|extends
name|BaseNettyTest
block|{
annotation|@
...
name|toF
argument_list|(
literal|"netty4-http:http://127.0.0.1:%d/session"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|toF
argument_list|(
literal|"netty4-http:http://127.0.0.1:%d/session?cookieHandler=#instanceCookieHandler"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|toF
argument_list|(
literal|"netty4-http:http://127.0.0.1:%d/session?cookieHandler=#exchangeCookieHandler"
argument_list|,
name|getPort
argument_list|()
argument_list|)
...
name|fromF
argument_list|(
literal|"jetty:http://127.0.0.1:%d/session?sessionSupport=true"
argument_list|,
name|getPort
argument_list|()
argument_list|)
