...
begin_class
DECL|class|NettyHttpBasicAuthConstraintMapperTest
specifier|public
class|class
name|NettyHttpBasicAuthConstraintMapperTest
extends|extends
name|BaseNettyTest
block|{
annotation|@
...
name|requestBody
argument_list|(
literal|"netty4-http:http://localhost:{{port}}/foo/public/hello.txt"
argument_list|,
literal|"Hello Public"
argument_list|,
name|String
...
name|from
argument_list|(
literal|"netty4-http:http://0.0.0.0:{{port}}/foo?matchOnUriPrefix=true&securityConfiguration=#mySecurityConfig"
argument_list|)
operator|.
name|to
argument_list|(
