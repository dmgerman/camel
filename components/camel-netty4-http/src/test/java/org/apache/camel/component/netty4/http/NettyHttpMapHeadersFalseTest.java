...
begin_class
DECL|class|NettyHttpMapHeadersFalseTest
specifier|public
class|class
name|NettyHttpMapHeadersFalseTest
extends|extends
name|BaseNettyTest
block|{
annotation|@
...
name|from
argument_list|(
literal|"netty4-http:http://localhost:{{port}}/myapp/mytest?mapHeaders=false"
argument_list|)
operator|.
name|process
argument_list|(
...
name|Exception
block|{
comment|// these headers is not mapped
name|assertNull
argument_list|(
name|exchange
operator|.
...
argument_list|)
expr_stmt|;
comment|// but we can find them in the http request from netty
name|assertEquals
argument_list|(
literal|"fooBAR"
argument_list|,
