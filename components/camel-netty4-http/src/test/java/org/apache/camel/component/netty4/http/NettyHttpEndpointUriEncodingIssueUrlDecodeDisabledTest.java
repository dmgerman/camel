...
begin_class
DECL|class|NettyHttpEndpointUriEncodingIssueUrlDecodeDisabledTest
specifier|public
class|class
name|NettyHttpEndpointUriEncodingIssueUrlDecodeDisabledTest
extends|extends
name|BaseNettyTest
block|{
annotation|@
...
name|assertEquals
argument_list|(
literal|"We got claus%2Cs%C3%B8ren columns"
argument_list|,
name|out
argument_list|)
expr_stmt|;
...
name|from
argument_list|(
literal|"netty4-http:http://localhost:{{port}}/myapp/mytest?urlDecodeHeaders=false"
argument_list|)
operator|.
name|process
argument_list|(
