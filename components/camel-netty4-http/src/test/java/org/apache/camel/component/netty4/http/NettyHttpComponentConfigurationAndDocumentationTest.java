...
begin_class
DECL|class|NettyHttpComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|NettyHttpComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|(
literal|"netty4-http:tcp://localhost:5150?sync=true"
operator|+
literal|"&httpMethodRestrict=POST&traceEnabled=true"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|contains
argument_list|(
literal|"\"traceEnabled\": { \"kind\": \"parameter\", \"type\": \"boolean\""
argument_list|)
argument_list|)
expr_stmt|;
block|}
