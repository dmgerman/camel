...
begin_class
DECL|class|ElasticsearchComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|ElasticsearchComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|contains
argument_list|(
literal|"\"indexName\": { \"kind\": \"parameter\", \"type\": \"string\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"\"local\": { \"kind\": \"parameter\", \"type\": \"boolean\""
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|assertTrue
argument_list|(
literal|"Expected entry for clusterName"
argument_list|,
name|html
operator|.
name|contains
argument_list|(
literal|"<td>clusterName</td>"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
literal|"Expected entry for protocolType"
argument_list|,
name|html
operator|.
name|contains
argument_list|(
literal|"<td>protocolType</td>"
argument_list|)
argument_list|)
expr_stmt|;
block|}
