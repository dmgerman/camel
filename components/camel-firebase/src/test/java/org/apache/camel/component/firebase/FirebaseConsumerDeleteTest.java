...
annotation|@
name|Test
DECL|method|whenDelete_DeleteMessageShouldBeIntercepted ()
specifier|public
name|void
name|whenDelete_DeleteMessageShouldBeIntercepted
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|createAndDeleteContent (FirebaseConfig firebaseConfig)
specifier|private
name|void
name|createAndDeleteContent
parameter_list|(
