...
begin_class
DECL|class|MyBatisExecutorTypeTest
specifier|public
class|class
name|MyBatisExecutorTypeTest
extends|extends
name|MyBatisTestSupport
block|{
annotation|@
name|Test
DECL|method|testUpdateBatch ()
specifier|public
name|void
name|testUpdateBatch
parameter_list|()
throws|throws
name|Exception
block|{
...
name|to
argument_list|(
literal|"mybatis:updateAccount?statementType=Update&executorType=batch"
argument_list|)
operator|.
name|to
argument_list|(
