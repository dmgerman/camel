...
begin_class
DECL|class|MyBatisComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|MyBatisComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
...
argument_list|(
literal|"mybatis:insertAccount?statementType=Insert&maxMessagesPerPoll=5"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|contains
argument_list|(
literal|"\"maxMessagesPerPoll\": { \"kind\": \"parameter\", \"type\": \"integer\""
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
