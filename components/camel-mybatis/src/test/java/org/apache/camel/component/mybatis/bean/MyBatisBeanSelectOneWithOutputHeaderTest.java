...
begin_class
DECL|class|MyBatisBeanSelectOneWithOutputHeaderTest
specifier|public
class|class
name|MyBatisBeanSelectOneWithOutputHeaderTest
extends|extends
name|MyBatisTestSupport
block|{
...
name|to
argument_list|(
literal|"mybatis-bean:AccountService:selectBeanAccountById?outputHeader="
operator|+
name|TEST_CASE_HEADER_NAME
argument_list|)
operator|.
