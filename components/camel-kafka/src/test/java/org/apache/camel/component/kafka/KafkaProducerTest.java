...
argument_list|)
expr_stmt|;
comment|// the header is preserved
name|assertNotNull
argument_list|(
name|in
operator|.
...
annotation|@
name|Test
DECL|method|processSendsMessageWithOverrideTopicHeaderAndEndPoint ()
specifier|public
name|void
name|processSendsMessageWithOverrideTopicHeaderAndEndPoint
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// the header is now removed
name|assertNull
argument_list|(
name|in
operator|.
...
annotation|@
name|Test
DECL|method|processSendMessageWithTopicHeader ()
specifier|public
name|void
name|processSendMessageWithTopicHeader
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|processSendsMessageWithListOfExchangesWithOverrideTopicHeaderOnEveryExchange ()
specifier|public
name|void
name|processSendsMessageWithListOfExchangesWithOverrideTopicHeaderOnEveryExchange
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// we set the initial topic
name|in
operator|.
name|setHeader
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// we add our exchanges in order to aggregate
specifier|final
name|List
argument_list|<
name|Exchange
argument_list|>
name|nestedExchanges
init|=
name|createListOfExchangesWithTopics
argument_list|(
name|Arrays
operator|.
name|asList
argument_list|(
literal|"overridenTopic1"
argument_list|,
literal|"overridenTopic2"
argument_list|,
literal|"overridenTopic3"
argument_list|)
argument_list|)
decl_stmt|;
comment|// aggregate
specifier|final
name|Exchange
name|finalAggregatedExchange
init|=
name|aggregateExchanges
argument_list|(
name|nestedExchanges
argument_list|,
operator|new
...
annotation|@
name|Test
DECL|method|processSendsMessageWithListOfMessagesWithOverrideTopicHeaderOnEveryExchange ()
specifier|public
name|void
name|processSendsMessageWithListOfMessagesWithOverrideTopicHeaderOnEveryExchange
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
argument_list|)
DECL|method|verifySendMessages (final List<String> expectedTopics)
specifier|protected
name|void
name|verifySendMessages
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|assertRecordMetadataExists (final int numMetadata)
specifier|private
name|void
name|assertRecordMetadataExists
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|aggregateExchanges (final List<Exchange> exchangesToAggregate, final AggregationStrategy strategy)
specifier|private
name|Exchange
name|aggregateExchanges
parameter_list|(
...
return|;
block|}
DECL|method|createListOfExchangesWithTopics (final List<String> topics)
specifier|private
name|List
argument_list|<
name|Exchange
