...
name|uri
init|=
literal|"kafka:dev1:12345,dev2:12566"
decl_stmt|;
name|String
name|remaining
init|=
literal|"dev1:12345,dev2:12566"
decl_stmt|;
name|KafkaEndpoint
name|endpoint
init|=
...
expr_stmt|;
block|}
comment|// the URL format should include the topic name like the ActiiveMQ& AMQP endpoints
comment|// kafka:serverName:port/topicName
comment|// kafka:serverName/topicName
annotation|@
name|Test
DECL|method|testSimpleKakfaUriEndpoint ()
specifier|public
name|void
name|testSimpleKakfaUriEndpoint
parameter_list|()
throws|throws
name|Exception
block|{
...
name|uri
init|=
literal|"kafka:broker1:9999/topic2One.33"
decl_stmt|;
name|String
name|remaining
init|=
literal|"broker1:9999/topic2One.33"
decl_stmt|;
name|KafkaEndpoint
name|endpoint
init|=
...
argument_list|)
expr_stmt|;
comment|// port not provided in the URI
name|uri
operator|=
literal|"kafka:broker1/click-Topic"
expr_stmt|;
name|remaining
operator|=
literal|"broker1/click-Topic"
expr_stmt|;
name|endpoint
operator|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// IP Address provided instead of hostname
name|uri
operator|=
literal|"kafka:10.10.10.3/click-Topic"
expr_stmt|;
name|remaining
operator|=
literal|"10.10.10.3/click-Topic"
expr_stmt|;
name|endpoint
operator|=
operator|new
