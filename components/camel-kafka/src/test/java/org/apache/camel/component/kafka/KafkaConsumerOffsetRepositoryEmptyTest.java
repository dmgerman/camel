...
specifier|public
class|class
name|KafkaConsumerOffsetRepositoryEmptyTest
extends|extends
...
decl_stmt|;
comment|// FIXME lifecycle issue here
annotation|@
name|Override
...
expr_stmt|;
block|}
comment|/**      * Given an empty offset repository      * When consuming with this repository      * Then we consume according to the {@code autoOffsetReset} setting      */
annotation|@
name|Test
