...
annotation|@
name|Ignore
DECL|class|KafkaConsumerManualCommitTest
specifier|public
class|class
name|KafkaConsumerManualCommitTest
extends|extends
...
argument_list|)
expr_stmt|;
comment|// The LAST_RECORD_BEFORE_COMMIT header should include a value as we use manual commit
name|to
operator|.
name|allMessages
argument_list|()
