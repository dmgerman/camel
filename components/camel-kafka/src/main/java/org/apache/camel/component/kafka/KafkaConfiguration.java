...
literal|5
decl_stmt|;
comment|//metadata.fetch.timeout.ms
annotation|@
name|UriParam
argument_list|(
name|label
...
literal|"60000"
argument_list|)
DECL|field|metadataFetchTimeoutMs
specifier|private
name|Integer
...
name|ProducerConfig
operator|.
name|BLOCK_ON_BUFFER_FULL_CONFIG
argument_list|,
...
name|ProducerConfig
operator|.
name|METADATA_FETCH_TIMEOUT_CONFIG
argument_list|,
...
return|;
block|}
comment|/**      * The first time data is sent to a topic we must fetch metadata about that topic to know which servers host the topic's partitions.      * This fetch to succeed before throwing an exception back to the client.      */
