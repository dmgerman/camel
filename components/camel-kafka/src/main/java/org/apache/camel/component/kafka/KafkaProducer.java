...
return|;
block|}
DECL|method|getPropagatedHeaders (Exchange exchange, HeaderFilterStrategy headerFilterStrategy)
specifier|private
name|List
argument_list|<
name|Header
...
return|;
block|}
DECL|method|getRecordHeader (Map.Entry<String, Object> entry)
specifier|private
name|RecordHeader
name|getRecordHeader
parameter_list|(
...
return|;
block|}
DECL|method|getHeaderValue (Object value)
specifier|private
name|byte
index|[]
name|getHeaderValue
