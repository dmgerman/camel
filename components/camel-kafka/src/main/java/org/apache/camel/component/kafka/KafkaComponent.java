...
name|UriEndpointComponent
block|{
comment|// Topic name validation as per Kafka documentation [a-zA-Z0-9\\._\\-] as of 0.10
comment|// hostname and port are extracted as per pattern. IP and hostname syntax is not validated using regex.
DECL|field|SIMPLE_KAFKA_URI_PATTERN
specifier|static
specifier|final
name|Pattern
name|SIMPLE_KAFKA_URI_PATTERN
init|=
name|Pattern
operator|.
name|compile
argument_list|(
literal|"([a-z0-9\\.]*)(:?)([0-9]*)/([a-zA-Z0-9\\._\\-]*)"
argument_list|,
name|Pattern
operator|.
