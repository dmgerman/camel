...
name|debug
argument_list|(
literal|"Auto commitSync {} from topic {} with offset: {}"
argument_list|,
name|threadId
argument_list|,
name|topicName
...
block|}
block|}
DECL|method|propagateHeaders (ConsumerRecord<Object, Object> record, Exchange exchange, HeaderFilterStrategy headerFilterStrategy)
specifier|private
name|void
name|propagateHeaders
parameter_list|(
