...
name|format
argument_list|(
literal|"Dear Ibsen, Claus%s%sThanks for the order of Camel in Action.%s%sRegards Camel Riders Bookstore%sPS: Next beer is on me, James"
argument_list|,
name|System
operator|.
name|lineSeparator
...
name|to
argument_list|(
literal|"velocity:org/apache/camel/component/velocity/letter.vm"
argument_list|)
operator|.
name|to
argument_list|(
