...
begin_class
DECL|class|JavaDslBlackBoxWithVerboseUriTest
specifier|public
class|class
name|JavaDslBlackBoxWithVerboseUriTest
extends|extends
...
name|to
argument_list|(
literal|"context:accounts:direct://purchaseOrder"
argument_list|)
expr_stmt|;
name|from
argument_list|(
literal|"context:accounts:direct://invoice"
argument_list|)
operator|.
name|to
argument_list|(
