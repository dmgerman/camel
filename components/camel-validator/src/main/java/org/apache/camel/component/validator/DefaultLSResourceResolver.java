...
name|resourcePath
decl_stmt|;
DECL|field|relatedURI
specifier|private
name|String
name|relatedURI
decl_stmt|;
DECL|field|relatedURIMap
specifier|private
name|Map
argument_list|<
name|String
...
expr_stmt|;
block|}
DECL|method|getUri (String systemId)
specifier|private
name|String
name|getUri
parameter_list|(
...
literal|null
decl_stmt|;
comment|// Build up the relative path for using relatedURI and baseURI
if|if
condition|(
name|baseURI
operator|==
...
name|uri
decl_stmt|;
DECL|method|DefaultLSInput (String publicId, String systemId, String basedURI, String relatedURI)
specifier|private
name|DefaultLSInput
parameter_list|(
name|String
