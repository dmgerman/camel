...
annotation|@
name|Override
DECL|method|uread (final Edm edm, final String resourcePath, final Map<String, String> queryParams, final Olingo2ResponseHandler<InputStream> responseHandler)
specifier|public
name|void
name|uread
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|readContent (UriInfoWithType uriInfo, InputStream content, Olingo2ResponseHandler<T> responseHandler)
specifier|private
parameter_list|<
name|T
parameter_list|>
...
return|;
block|}
DECL|method|writeContent (final Edm edm, HttpEntityEnclosingRequestBase httpEntityRequest, final UriInfoWithType uriInfo, final Object content, final Olingo2ResponseHandler<T> responseHandler)
specifier|private
parameter_list|<
name|T
parameter_list|>
