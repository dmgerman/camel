...
begin_comment
comment|/**  * For working with Amazon ECS.  */
end_comment
...
expr_stmt|;
block|}
DECL|method|ECSComponent (CamelContext context)
specifier|public
name|ECSComponent
parameter_list|(
name|CamelContext
...
argument_list|(
operator|new
name|ECSComponentVerifierExtension
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
argument_list|(
literal|"Amazon ecs client or accessKey and secretKey must be specified"
argument_list|)
throw|;
block|}
name|ECSEndpoint
...
expr_stmt|;
block|}
DECL|method|checkAndSetRegistryClient (ECSConfiguration configuration)
specifier|private
name|void
name|checkAndSetRegistryClient
parameter_list|(
