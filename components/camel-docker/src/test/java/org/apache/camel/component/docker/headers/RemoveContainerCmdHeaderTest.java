...
begin_comment
comment|/**  * Validates Remove Container Request headers are applied properly  */
end_comment

begin_class
DECL|class|RemoveContainerCmdHeaderTest
specifier|public
class|class
name|RemoveContainerCmdHeaderTest
extends|extends
...
annotation|@
name|Test
DECL|method|removeContainerHeaderTest ()
specifier|public
name|void
name|removeContainerHeaderTest
parameter_list|()
block|{
name|String
name|containerId
