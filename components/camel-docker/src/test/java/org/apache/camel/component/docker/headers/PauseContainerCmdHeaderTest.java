...
begin_comment
comment|/**  * Validates Pause Container Request headers are applied properly  */
end_comment

begin_class
DECL|class|PauseContainerCmdHeaderTest
specifier|public
class|class
name|PauseContainerCmdHeaderTest
extends|extends
...
annotation|@
name|Test
DECL|method|pauseHeaderTest ()
specifier|public
name|void
name|pauseHeaderTest
parameter_list|()
block|{
name|String
name|containerId
