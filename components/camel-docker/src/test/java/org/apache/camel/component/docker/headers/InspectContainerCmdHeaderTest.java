...
begin_comment
comment|/**  * Validates Inspect Container Request headers are applied properly  */
end_comment

begin_class
DECL|class|InspectContainerCmdHeaderTest
specifier|public
class|class
name|InspectContainerCmdHeaderTest
extends|extends
...
annotation|@
name|Test
DECL|method|inspectContainerHeaderTest ()
specifier|public
name|void
name|inspectContainerHeaderTest
parameter_list|()
block|{
name|String
name|containerId
