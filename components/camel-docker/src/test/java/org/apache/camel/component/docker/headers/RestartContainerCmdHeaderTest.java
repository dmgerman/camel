...
begin_comment
comment|/**  * Validates Restart Container Request headers are applied properly  */
end_comment

begin_class
DECL|class|RestartContainerCmdHeaderTest
specifier|public
class|class
name|RestartContainerCmdHeaderTest
extends|extends
...
annotation|@
name|Test
DECL|method|restartContainerHeaderTest ()
specifier|public
name|void
name|restartContainerHeaderTest
parameter_list|()
block|{
name|String
name|containerId
