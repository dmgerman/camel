...
begin_comment
comment|/**  * Validates Copy File from Container Request headers are applied properly  */
end_comment

begin_class
DECL|class|CopyFileContainerCmdHeaderTest
specifier|public
class|class
name|CopyFileContainerCmdHeaderTest
extends|extends
...
annotation|@
name|Test
DECL|method|copyFileFromContainerHeaderTest ()
specifier|public
name|void
name|copyFileFromContainerHeaderTest
parameter_list|()
block|{
name|String
name|containerId
