...
begin_comment
comment|/**  * Validates Create Image Request headers are parsed properly  */
end_comment

begin_class
DECL|class|CreateImageCmdHeaderTest
specifier|public
class|class
name|CreateImageCmdHeaderTest
extends|extends
