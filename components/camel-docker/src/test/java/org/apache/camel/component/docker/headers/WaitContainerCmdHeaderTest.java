...
begin_comment
comment|/**  * Validates Wait Container Request headers are applied properly  */
end_comment

begin_class
DECL|class|WaitContainerCmdHeaderTest
specifier|public
class|class
name|WaitContainerCmdHeaderTest
extends|extends
...
annotation|@
name|Test
DECL|method|waitContainerHeaderTest ()
specifier|public
name|void
name|waitContainerHeaderTest
parameter_list|()
block|{
name|String
name|containerId
