...
name|server
operator|.
name|MultiPartFormDataCompliance
import|;
end_import
...
literal|true
decl_stmt|;
DECL|field|defaultQueuedThreadPool
specifier|private
name|QueuedThreadPool
name|defaultQueuedThreadPool
decl_stmt|;
...
argument_list|()
expr_stmt|;
comment|//must register the MultipartConfig to make jetty server multipart aware
name|holder
operator|.
...
argument_list|)
expr_stmt|;
comment|//must make RFC7578 as default to avoid using the deprecated MultiPartInputStreamParser
name|connector
operator|.
...
argument_list|()
operator|.
name|setMultiPartFormDataCompliance
argument_list|(
name|MultiPartFormDataCompliance
operator|.
name|RFC7578
...
block|{
comment|//need an error handler that won't leak information about the exception back to the client.
name|ErrorHandler
name|eh
init|=
operator|new
