...
begin_class
DECL|class|S3ComponentCopyObjectEncryptionTest
specifier|public
class|class
name|S3ComponentCopyObjectEncryptionTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|awsEndpoint
init|=
literal|"aws-s3://mycamelbucket?amazonS3Client=#amazonS3Client&region=us-west-1&operation=copyObject"
decl_stmt|;
name|from
argument_list|(
literal|"direct:start"
