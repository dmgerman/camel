...
annotation|@
name|Test
DECL|method|iamOptimizedAWSS3ClientImplWithProxy ()
specifier|public
name|void
name|iamOptimizedAWSS3ClientImplWithProxy
parameter_list|()
block|{
name|S3ClientIAMOptimizedImpl
name|iamOptimizedAWSS3Client
...
name|S3ClientIAMOptimizedImpl
argument_list|(
name|getS3ConfigurationUseProxy
argument_list|()
argument_list|,
name|MAX_CONNECTIONS
argument_list|)
...
return|;
block|}
DECL|method|getS3ConfigurationUseProxy ()
specifier|private
name|S3Configuration
name|getS3ConfigurationUseProxy
parameter_list|()
