...
begin_class
DECL|class|S3ComponentDownloadLinkTest
specifier|public
class|class
name|S3ComponentDownloadLinkTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
name|awsEndpoint
init|=
literal|"aws-s3://mycamelbucket?amazonS3Client=#amazonS3Client&region=us-west-1&operation=downloadLink"
decl_stmt|;
name|from
argument_list|(
literal|"direct:downloadLink"
