...
annotation|@
name|Test
DECL|method|createEndpointWithAutocreateOption ()
specifier|public
name|void
name|createEndpointWithAutocreateOption
parameter_list|()
throws|throws
name|Exception
block|{
...
name|createEndpoint
argument_list|(
literal|"aws-s3://MyBucket?forceGlobalBucketAccessEnabled=true&accessKey=xxx&secretKey=yyy&region=US_WEST_1&autoCreateBucket=false"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
