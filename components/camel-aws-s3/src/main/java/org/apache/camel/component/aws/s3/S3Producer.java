...
expr_stmt|;
block|}
DECL|method|getObjectRange (AmazonS3 s3Client, Exchange exchange)
specifier|private
name|void
name|getObjectRange
parameter_list|(
...
name|IllegalArgumentException
argument_list|(
literal|"A Range start and range end header must be configured to perform a range get operation."
argument_list|)
throw|;
block|}
name|GetObjectRequest
