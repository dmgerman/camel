...
begin_class
DECL|class|JettyHttpComponentConfigurationAndDocumentationTest
specifier|public
class|class
name|JettyHttpComponentConfigurationAndDocumentationTest
extends|extends
name|CamelTestSupport
block|{
annotation|@
...
argument_list|(
literal|"jetty://http://localhost:8080/myapp?"
operator|+
literal|"httpClientMinThreads=4&httpClientMaxThreads=8"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|contains
argument_list|(
literal|"\"sessionSupport\": { \"kind\": \"parameter\", \"type\": \"boolean\", \"javaType\": \"boolean\""
argument_list|)
argument_list|)
expr_stmt|;
block|}
