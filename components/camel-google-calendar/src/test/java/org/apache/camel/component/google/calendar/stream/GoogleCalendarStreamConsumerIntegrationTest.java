...
begin_class
DECL|class|GoogleCalendarStreamConsumerIntegrationTest
specifier|public
class|class
name|GoogleCalendarStreamConsumerIntegrationTest
extends|extends
...
name|from
argument_list|(
literal|"google-calendar-stream://test?delay=5000&maxResults=5"
argument_list|)
operator|.
name|to
argument_list|(
