...
name|instantiate
argument_list|(
literal|"org.apache.camel.component.debezium.configuration.MySqlConnectorEmbeddedDebeziumConfiguration"
argument_list|,
name|MySqlConnectorEmbeddedDebeziumConfiguration
operator|.
name|class
...
return|;
block|}
comment|/**      * Allow pre-configured Configurations to be set, you will need to extend      * {@link MySqlConnectorEmbeddedDebeziumConfiguration} in order to create the configuration      * for the component      *      * @return {@link MySqlConnectorEmbeddedDebeziumConfiguration}      */
...
block|}
block|}
DECL|method|instantiate (final String className, final Class<T> type)
specifier|private
parameter_list|<
name|T
parameter_list|>
