...
begin_comment
comment|/**  * A copy of {@code org.apache.camel.http.common.HttpHeaderFilterStrategy}. Keep in sync or refactor  * {@code camel-http-common} not to depend on {@code javax.servlet-api} and then use the  * {@code HttpHeaderFilterStrategy}  * from there.  */
end_comment

begin_class
DECL|class|PlatformHttpHeaderFilterStrategy
specifier|public
class|class
...
name|DefaultHeaderFilterStrategy
block|{
DECL|method|PlatformHttpHeaderFilterStrategy ()
specifier|public
name|PlatformHttpHeaderFilterStrategy
parameter_list|()
block|{
