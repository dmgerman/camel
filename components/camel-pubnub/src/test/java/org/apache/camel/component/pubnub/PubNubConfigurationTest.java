...
name|createEndpoint
argument_list|(
literal|"pubnub://pubsub:xxx?subscriberKey=mysubkey"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|createEndpoint
argument_list|(
literal|"pubnub://pubsub:xxx?subscriberKey=mysubkey&publisherKey=mypubkey&secretKey=secrets&uuid=myuuid&operation=PUBLISH&ssl=false"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
