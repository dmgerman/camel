...
block|}
block|}
comment|/*      * set the HTTP status code      * NOTE: this is similar to the Netty-Http and Undertow approach      * TODO: we may want to refactor this class so that       * the status code is determined in one place      */
