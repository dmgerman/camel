...
name|RuntimeCamelException
argument_list|(
literal|"SoapDataFormat does not work with "
operator|+
literal|"Beaninvocations that contain more than 1 parameter"
argument_list|)
throw|;
block|}
block|}
...
condition|)
block|{
comment|// This can happen if a method has no parameter or return type
return|return
literal|null
return|;
block|}
