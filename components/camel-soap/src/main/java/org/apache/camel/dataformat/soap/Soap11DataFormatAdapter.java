...
begin_comment
comment|/**  * Marshaling from Objects to<b>SOAP 1.1</b> and back by using JAXB. The classes to be  * processed need to have JAXB annotations. For marshaling a ElementNameStrategy  * is used to determine how the top level elements in SOAP are named as this can  * not be extracted from JAXB.  */
end_comment

begin_class
DECL|class|Soap11DataFormatAdapter
specifier|public
class|class
...
name|objectFactory
decl_stmt|;
DECL|method|Soap11DataFormatAdapter (SoapJaxbDataFormat dataFormat)
specifier|public
name|Soap11DataFormatAdapter
parameter_list|(
name|SoapJaxbDataFormat
