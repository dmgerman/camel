...
return|;
block|}
DECL|method|nsqlookupdContainer ()
specifier|public
specifier|static
name|GenericContainer
argument_list|<
...
argument_list|,
literal|4161
comment|//getContainerHost(CONTAINER_NSQLOOKUPD_NAME),
comment|//getContainerPort(CONTAINER_NSQLOOKUPD_NAME, NsqConstants.NSQ_DEFAULT_LOOKUP_PORT_HTTP)
argument_list|)
decl_stmt|;
return|return
name|format
...
argument_list|,
literal|4150
comment|//getContainerHost(CONTAINER_NSQD_NAME),
comment|//getContainerPort(CONTAINER_NSQD_NAME, NsqConstants.NSQ_DEFAULT_PORT)
argument_list|)
decl_stmt|;
return|return
name|format
