...
name|test
decl_stmt|;
comment|// TODO: Maybe some way of having CamelContextLifecycleSupport using bean parameter binding
comment|// so ppl can build their Camel app without camel-servletlistener dependency on the codebase
comment|// TODO: add example and add documentation page
annotation|@
name|Override
