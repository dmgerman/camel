...
name|createEndpoint
argument_list|(
literal|"aws-ses://from@example.com?amazonSESClient=#amazonSESClient&accessKey=xxx&secretKey=yyy"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|createEndpoint
argument_list|(
literal|"aws-ses://from@example.com?amazonSESClient=#amazonSESClient&accessKey=xxx"
operator|+
literal|"&secretKey=yyy&to=to1@example.com,to2@example.com&subject=Subject"
operator|+
literal|"&returnPath=bounce@example.com&replyToAddresses=replyTo1@example.com,replyTo2@example.com"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|createEndpoint
argument_list|(
literal|"aws-ses://from@example.com?accessKey=xxxxxx&secretKey=yyyyy&region=US_EAST_1"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|createEndpoint
argument_list|(
literal|"aws-ses://label?accessKey=xxxxxx&secretKey=yyyyy&region=US_EAST_1&proxyHost=localhost&proxyPort=9000&proxyProtocol=HTTP"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|createEndpoint
argument_list|(
literal|"aws-ses://from@example.com?amazonSESClient=#amazonSESClient"
argument_list|)
expr_stmt|;
block|}
block|}
