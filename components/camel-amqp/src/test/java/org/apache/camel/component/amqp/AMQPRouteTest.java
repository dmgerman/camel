...
name|options
operator|.
name|setConfigurationStoreType
argument_list|(
literal|"memory"
argument_list|)
expr_stmt|;
name|options
operator|.
name|setInitialConfigurationLocation
argument_list|(
literal|"src/test/resources/config.json"
argument_list|)
expr_stmt|;
name|options
operator|.
name|setLogConfigFileLocation
argument_list|(
