...
begin_class
DECL|class|SpringCamelContextNoDependsOnTest
specifier|public
class|class
name|SpringCamelContextNoDependsOnTest
extends|extends
name|SpringTestSupport
block|{
annotation|@
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/spring/config/SpringCamelContextNoDependsOnTest.xml"
argument_list|)
return|;
block|}
DECL|method|testNoDependsOn ()
specifier|public
name|void
name|testNoDependsOn
parameter_list|()
throws|throws
name|Exception
block|{
