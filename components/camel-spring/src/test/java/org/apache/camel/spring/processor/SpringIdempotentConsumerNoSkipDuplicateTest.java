...
begin_class
DECL|class|SpringIdempotentConsumerNoSkipDuplicateTest
specifier|public
class|class
name|SpringIdempotentConsumerNoSkipDuplicateTest
extends|extends
name|SpringTestSupport
block|{
annotation|@
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/spring/processor/SpringIdempotentConsumerNoSkipDuplicateTest.xml"
argument_list|)
return|;
block|}
annotation|@
