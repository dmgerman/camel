...
begin_class
DECL|class|MyMultiArgumentSpringRemotingPojoDirectTest
specifier|public
class|class
name|MyMultiArgumentSpringRemotingPojoDirectTest
extends|extends
name|SpringTestSupport
block|{
annotation|@
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/spring/remoting/my-multi-argument-pojo-direct.xml"
argument_list|)
return|;
block|}
annotation|@
...
name|getBean
argument_list|(
literal|"myMultiArgumentPojoDirect"
argument_list|,
name|MyMultiArgument
operator|.
name|class
