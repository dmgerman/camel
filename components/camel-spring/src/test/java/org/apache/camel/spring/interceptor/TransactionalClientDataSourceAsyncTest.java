...
begin_class
DECL|class|TransactionalClientDataSourceAsyncTest
specifier|public
class|class
name|TransactionalClientDataSourceAsyncTest
extends|extends
...
name|log
argument_list|(
literal|"Before thread ${threadName}"
argument_list|)
operator|.
name|to
argument_list|(
...
name|log
argument_list|(
literal|"After thread ${threadName}"
argument_list|)
operator|.
name|setBody
argument_list|(
