...
begin_class
DECL|class|RouteAutoStartupPropertiesTest
specifier|public
class|class
name|RouteAutoStartupPropertiesTest
extends|extends
name|TestCase
block|{
DECL|field|ac
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/spring/config/RouteAutoStartupFalseTest.xml"
argument_list|)
expr_stmt|;
name|SpringCamelContext
name|camel
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/camel/spring/config/RouteAutoStartupTrueTest.xml"
argument_list|)
expr_stmt|;
name|SpringCamelContext
name|camel
