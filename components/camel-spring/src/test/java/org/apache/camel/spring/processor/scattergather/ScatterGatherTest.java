...
name|put
argument_list|(
literal|"listOfVendors"
argument_list|,
literal|"bean:vendor1, bean:vendor2, bean:vendor3"
argument_list|)
expr_stmt|;
name|headers
operator|.
name|put
argument_list|(
literal|"quoteRequestId"
argument_list|,
literal|"quoteRequest-1"
argument_list|)
expr_stmt|;
name|template
operator|.
...
argument_list|,
literal|"<quote_request item=\"beer\"/>"
argument_list|,
name|headers
argument_list|)
expr_stmt|;
...
name|this
argument_list|,
literal|"org/apache/camel/spring/processor/scattergather/scatter-gather.xml"
argument_list|)
return|;
block|}
block|}
