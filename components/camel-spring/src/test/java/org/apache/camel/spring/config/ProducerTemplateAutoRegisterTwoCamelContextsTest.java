...
annotation|@
name|ContextConfiguration
DECL|class|ProducerTemplateAutoRegisterTwoCamelContextsTest
specifier|public
class|class
name|ProducerTemplateAutoRegisterTwoCamelContextsTest
extends|extends
name|SpringRunWithTestSupport
block|{
annotation|@
...
name|assertNull
argument_list|(
literal|"Should NOT lookup producer template"
argument_list|,
name|lookup
argument_list|)
expr_stmt|;
