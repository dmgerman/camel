...
begin_comment
comment|/**  * A Spring {@link org.springframework.beans.factory.FactoryBean} for creating a new  * {@link org.apache.camel.component.properties.PropertiesComponent} instance with a minimum of XML  *  * @version $Revision$  */
end_comment
...
name|FIELD
argument_list|)
DECL|class|CamelPropertiesComponentFactoryBean
specifier|public
class|class
...
name|IllegalArgumentException
argument_list|(
literal|"A component already exists with the name "
operator|+
name|getId
argument_list|()
argument_list|)
