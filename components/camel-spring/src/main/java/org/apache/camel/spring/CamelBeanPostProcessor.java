...
begin_comment
comment|/**  * A post processor to perform injection of {@link Endpoint} and  * {@link Producer} instances together with binding methods annotated with  * {@link MessageDriven @MessageDriven} to a Camel consumer.  *  * @version $Revision$  */
end_comment
