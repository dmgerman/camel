...
literal|"aggregate"
argument_list|,
name|aggregateSpringCamelContext
argument_list|(
name|applicationContext
argument_list|)
argument_list|,
...
block|}
block|}
DECL|method|generateDot (String name, SpringCamelContext camelContext, int size)
specifier|protected
name|void
name|generateDot
parameter_list|(
...
block|}
block|}
comment|/**      * Used for aggregate dot generation      *      * @param applicationContext      * @return      * @throws Exception      */
DECL|method|aggregateSpringCamelContext (ApplicationContext applicationContext)
specifier|private
specifier|static
name|SpringCamelContext
name|aggregateSpringCamelContext
...
argument_list|()
block|{
comment|/**              *  Don't actually start this, it is merely fabricated for dot generation.              * @see org.apache.camel.impl.DefaultCamelContext#shouldStartRoutes()              */
specifier|protected
name|boolean
...
block|}
decl_stmt|;
comment|// look up all configured camel contexts
name|String
index|[]
name|names
init|=
...
argument_list|)
decl_stmt|;
comment|//            aggregateCamelContext.addRoutes( next.getRoutes() );
name|aggregateCamelContext
operator|.
...
expr_stmt|;
block|}
comment|// Don't actually start this, it is merely fabricated for dot generation.
comment|//        answer.setApplicationContext( applicationContext );
comment|//        answer.afterPropertiesSet();
return|return
name|aggregateCamelContext
return|;
block|}
