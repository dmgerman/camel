...
expr_stmt|;
block|}
comment|// register the bean post processor on camel context
if|if
condition|(
name|beanPostProcessor
operator|instanceof
...
argument_list|)
expr_stmt|;
comment|// use the bridge as property source
name|pc
operator|.
...
expr_stmt|;
block|}
comment|/**      * Hystrix Circuit Breaker EIP configurations      */
...
return|;
block|}
comment|/**      * Resilience4j EIP default configuration      */
...
return|;
block|}
comment|/**      * Resilience4j Circuit Breaker EIP configurations      */
