...
name|IllegalArgumentException
argument_list|(
literal|"Attribute deadLetterHandleNewException can only be used if type is "
operator|+
name|ErrorHandlerType
operator|.
name|DeadLetterChannel
...
name|IllegalArgumentException
argument_list|(
literal|"Attribute onPrepareFailureRef is not supported by error handler type: "
operator|+
name|type
operator|.
name|name
...
name|deadLetter
decl_stmt|;
DECL|method|RedeliveryPolicyDefinitionParser (Class<?> type, boolean deadLetter)
specifier|public
name|RedeliveryPolicyDefinitionParser
parameter_list|(
name|Class
...
argument_list|)
expr_stmt|;
comment|// if dead letter then set logExhaustedMessageHistory default false if not explicit configured
name|boolean
name|hasLogExhaustedMessageHistory
init|=
name|element
operator|.
name|hasAttribute
