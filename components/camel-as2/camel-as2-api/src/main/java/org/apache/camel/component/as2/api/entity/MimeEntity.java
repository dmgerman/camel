...
return|;
block|}
comment|/**      * Specifies the Content-Transfer-Encoding header.      * The default implementation sets the value of the      * {@link #contentTranferEncoding contentTransferEncoding} attribute.      *      * @param contentEncoding   the new Content-Transfer-Encoding header, or      *                          {@code null} to unset      */
DECL|method|setContentTranserEncoding (final Header contentEncoding)
specifier|public
name|void
