...
return|;
block|}
DECL|method|extractEdiPayload (HttpEntityEnclosingRequest request, PrivateKey privateKey)
specifier|public
specifier|static
name|HttpEntity
...
name|HttpException
argument_list|(
literal|"Failed to get EDI message from encrypted request: private key is null"
argument_list|)
throw|;
block|}
name|ApplicationPkcs7MimeEnvelopedDataEntity
...
name|HttpException
argument_list|(
literal|"Failed to create MIC: unknown "
operator|+
name|AS2MimeType
operator|.
name|APPLICATION_PKCS7_MIME
...
name|HttpException
argument_list|(
literal|"Failed to create MIC: invalid content type '"
operator|+
name|contentType
operator|.
name|getMimeType
...
name|HttpException
argument_list|(
literal|"Failed to create MIC: content type missing from encrypted entity"
argument_list|)
throw|;
block|}
name|ContentType
