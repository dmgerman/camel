...
argument_list|)
expr_stmt|;
comment|// Extract content from stream
name|CharArrayBuffer
name|lineBuffer
init|=
operator|new
...
block|}
comment|// Build application EDI entity
name|applicationEDIEntity
operator|=
name|EntityUtils
operator|.
...
decl_stmt|;
name|String
name|previousContentTransferEncoding
init|=
name|inbuffer
operator|.
...
return|;
block|}
DECL|method|parseBodyPartFields (final AS2SessionInputBuffer inbuffer, final String boundary, final LineParser parser, final List<CharArrayBuffer> headerLines)
specifier|public
specifier|static
name|List
argument_list|<
