...
begin_comment
comment|/**  * Abstract base class for AS2 Integration tests generated by Camel API component maven plugin.  */
end_comment

begin_class
DECL|class|AbstractAS2TestSupport
specifier|public
class|class
...
argument_list|()
decl_stmt|;
comment|// read AS2 component configuration from TEST_OPTIONS_PROPERTIES
specifier|final
name|Properties
name|properties
init|=
...
argument_list|)
expr_stmt|;
comment|// add AS2Component to Camel context
specifier|final
name|AS2Component
name|component
init|=
