...
annotation|@
name|Test
DECL|method|testCreateSuspendAndResumeNode ()
specifier|public
name|void
name|testCreateSuspendAndResumeNode
parameter_list|()
throws|throws
name|InterruptedException
block|{
...
return|;
block|}
comment|/**      * Returns a {@Map} with the suspend headers.      *      * @param nodeId The id of the node to resume.      * @param group  The group of the node to resume.      */
DECL|method|resumeHeaders (String nodeId, String group)
specifier|protected
name|Map
argument_list|<
name|String
