...
expr_stmt|;
block|}
DECL|method|testHeaderMapNotMap ()
specifier|public
name|void
name|testHeaderMapNotMap
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Header foo cannot be converted to a Map on headerAsMap(foo)[bar]"
argument_list|,
name|e
operator|.
name|getMessage
...
block|}
block|}
DECL|method|testHeaderMapIllegalSyntax ()
specifier|public
name|void
name|testHeaderMapIllegalSyntax
parameter_list|()
throws|throws
name|Exception
block|{
