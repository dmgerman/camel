...
specifier|public
name|void
name|testSimpleExpressionOrPredicate
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testExchangeOgnlExpression
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testBodyExpressionWithArray
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertExpression
argument_list|(
literal|"${in.body?.get('list')[0].toString}"
argument_list|,
literal|null
argument_list|)
expr_stmt|;
...
name|assertPredicate
argument_list|(
literal|"${bodyAs(String)} == 'hello world'"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
name|assertPredicate
argument_list|(
literal|"${bodyAs(String).toUpperCase()} == 'HELLO WORLD'"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
comment|// and body on exchange should not be changed
name|assertSame
argument_list|(
name|body
argument_list|,
...
specifier|public
name|void
name|testOGNLMandatoryBodyAsExpression
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertPredicate
argument_list|(
literal|"${mandatoryBodyAs(String)} == 'hello world'"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
name|assertPredicate
argument_list|(
literal|"${mandatoryBodyAs(String).toUpperCase()} == 'HELLO WORLD'"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
...
name|assertExpression
argument_list|(
literal|"date:header.birthday+24h:yyyyMMdd"
argument_list|,
literal|"19740421"
argument_list|)
expr_stmt|;
...
name|assertExpression
argument_list|(
literal|"date:header.birthday - 10s:yyyy-MM-dd'T'HH:mm:ss:SSS"
argument_list|,
literal|"1974-04-20T08:55:37:123"
argument_list|)
expr_stmt|;
name|assertExpression
argument_list|(
...
name|assertExpression
argument_list|(
literal|"date-with-timezone:header.birthday:GMT+8:yyyy-MM-dd'T'HH:mm:ss:SSS"
argument_list|,
literal|"1974-04-20T08:55:47:123"
argument_list|)
expr_stmt|;
name|assertExpression
argument_list|(
literal|"date-with-timezone:header.birthday:GMT:yyyy-MM-dd'T'HH:mm:ss:SSS"
argument_list|,
literal|"1974-04-20T00:55:47:123"
argument_list|)
expr_stmt|;
block|}
...
name|assertPredicate
argument_list|(
literal|"${date:now}< ${date:now+60s}"
argument_list|)
expr_stmt|;
name|assertPredicate
argument_list|(
literal|"${date:now-2s+2s} == ${date:now}"
argument_list|)
expr_stmt|;
block|}
...
name|assertExpression
argument_list|(
literal|"${headerAs(fool,String).test}"
argument_list|,
literal|null
argument_list|)
expr_stmt|;
...
name|startsWith
argument_list|(
literal|"Valid syntax: ${headerAs(key, type)} was: headerAs(fool,String).test"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|setBody
argument_list|(
literal|"tel:+97444549697"
argument_list|)
expr_stmt|;
name|assertPredicate
argument_list|(
literal|"${body} regex '^(tel:\\+)(974)(44)(\\d+)|^(974)(44)(\\d+)'"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
...
literal|0
decl_stmt|;
comment|/*        for (i = 0; i< iterations; i++) {             Expression expression = SimpleLanguage.simple("${random(1,10)}", Integer.class);             assertTrue(min<= expression.evaluate(exchange, Integer.class)&& expression.evaluate(exchange, Integer.class)< max);         }         for (i = 0; i< iterations; i++) {             Expression expression = SimpleLanguage.simple("${random(10)}", Integer.class);             assertTrue(0<= expression.evaluate(exchange, Integer.class)&& expression.evaluate(exchange, Integer.class)< max);         }         Expression expression = SimpleLanguage.simple("${random(1, 10)}", Integer.class);         assertTrue(min<= expression.evaluate(exchange, Integer.class)&& expression.evaluate(exchange, Integer.class)< max);                  Expression expression1 = SimpleLanguage.simple("${random( 10)}", Integer.class);         assertTrue(0<= expression1.evaluate(exchange, Integer.class)&& expression1.evaluate(exchange, Integer.class)< max);                  try {             assertExpression("${random(10,21,30)}", null);             fail("Should have thrown exception");         } catch (Exception e) {             assertEquals("Valid syntax: ${random(min,max)} or ${random(max)} was: random(10,21,30)", e.getCause().getMessage());         }         try {             assertExpression("${random()}", null);             fail("Should have thrown exception");         } catch (Exception e) {             assertEquals("Valid syntax: ${random(min,max)} or ${random(max)} was: random()", e.getCause().getMessage());         }         */
name|exchange
operator|.
name|getIn
argument_list|()
...
specifier|public
name|void
name|testBodyOgnlOnAnimalWithOgnlParams
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertExpression
argument_list|(
literal|"${body.setFriend(${header.friend})}"
argument_list|,
literal|null
argument_list|)
expr_stmt|;
...
name|exp
init|=
literal|"${exchangeProperty.${type:org.apache.camel.Exchange.AUTHENTICATION}.toString()}"
decl_stmt|;
name|assertExpression
argument_list|(
name|exp
...
name|exp
operator|=
literal|"${exchangeProperty.${type:org.apache.camel.Exchange.${header.whichOne}}.toString()}"
expr_stmt|;
name|assertExpression
argument_list|(
name|exp
