...
name|assertEquals
argument_list|(
literal|"The sub messages should have unique message ids"
argument_list|,
literal|4
argument_list|,
name|ids
...
name|assertEquals
argument_list|(
literal|"The sub messages should have unique exchange ids"
argument_list|,
literal|4
argument_list|,
name|ids2
...
specifier|public
name|void
name|testSplitterParallelAggregate
parameter_list|()
throws|throws
name|Exception
block|{
...
name|request
argument_list|(
literal|"direct:parallelAggregate"
argument_list|,
operator|new
name|Processor
argument_list|()
