...
begin_comment
comment|/**  * @version $Revision: 937165 $  */
end_comment
...
return|;
block|}
DECL|method|wrap (final RouteContext routeContext, final Processor processor, final ProcessorDefinition<?> processorDefinition)
specifier|public
name|Processor
name|wrap
parameter_list|(
...
parameter_list|)
block|{
comment|// alter the child definition
name|SetBodyDefinition
name|bodyDef
init|=
operator|(
...
argument_list|)
expr_stmt|;
comment|// make sure the normal "wrap" still works.
return|return
operator|new
name|Processor
argument_list|()
