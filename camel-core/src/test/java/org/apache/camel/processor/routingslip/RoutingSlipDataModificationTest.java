...
name|ROUTING_SLIP_HEADER
argument_list|,
literal|"mock:x,bean:myBean?method=modifyData,mock:y,mock:z"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|MyBean
block|{
DECL|field|routingSlipHeader
specifier|private
name|String
name|routingSlipHeader
decl_stmt|;
DECL|method|MyBean ()
specifier|public
name|MyBean
parameter_list|()
block|{         }
DECL|method|MyBean (String routingSlipHeader)
specifier|public
name|MyBean
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|modifyData ( @ody String body, @Headers Map<String, Object> headers, @OutHeaders Map<String, Object> outHeaders)
specifier|public
name|String
name|modifyData
parameter_list|(
