...
begin_class
DECL|class|SplitterWithDualMulticastTest
specifier|public
class|class
name|SplitterWithDualMulticastTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
name|Test
DECL|method|testSplitterWithDualMulticast ()
specifier|public
name|void
name|testSplitterWithDualMulticast
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// should have the beer which was set on the 2nd multicast
name|getMockEndpoint
argument_list|(
literal|"mock:split2"
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// and no foo header at all
name|getMockEndpoint
argument_list|(
literal|"mock:split2"
argument_list|)
...
name|to
argument_list|(
literal|"log:split2?showHeaders=true"
argument_list|,
literal|"mock:split2"
argument_list|)
operator|.
