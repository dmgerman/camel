...
begin_class
DECL|class|TraceInterceptorWithOutBodyTraceTest
specifier|public
class|class
...
argument_list|)
expr_stmt|;
comment|// we configure the default trace formatter where we can
comment|// specify which fields we want in the output
name|DefaultTraceFormatter
name|formatter
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// set to use our formatter
name|tracer
operator|.
name|setFormatter
argument_list|(
