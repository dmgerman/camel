...
begin_class
DECL|class|FailoverStickyTest
specifier|public
class|class
name|FailoverStickyTest
extends|extends
name|ContextTestSupport
block|{
DECL|method|testFailoverSticky ()
specifier|public
name|void
name|testFailoverSticky
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// as its sticky based it remembers that last good endpoint
