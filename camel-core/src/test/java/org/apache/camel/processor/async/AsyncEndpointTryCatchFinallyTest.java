...
begin_class
DECL|class|AsyncEndpointTryCatchFinallyTest
specifier|public
class|class
name|AsyncEndpointTryCatchFinallyTest
extends|extends
name|ContextTestSupport
block|{
...
name|Exception
block|{
comment|// TODO: try catch finally need to support async routing engine
...
argument_list|)
expr_stmt|;
comment|//getMockEndpoint("mock:after").expectedBodiesReceived("Bye Camel");
comment|//getMockEndpoint("mock:result").expectedBodiesReceived("Bye Camel");
name|String
name|reply
init|=
name|template
...
argument_list|)
decl_stmt|;
comment|//assertEquals("Bye Camel", reply);
