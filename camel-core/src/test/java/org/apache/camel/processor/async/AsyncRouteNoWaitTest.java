...
expr_stmt|;
block|}
DECL|method|testAsyncNoWaitRouteExchange ()
specifier|public
name|void
name|testAsyncNoWaitRouteExchange
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// send an in out to the direct endpoint using the classic API
name|Exchange
name|exchange
init|=
name|template
...
literal|"A"
expr_stmt|;
comment|// as it turns into a async route later we get a Future in the IN body
name|Object
name|out
init|=
name|exchange
...
expr_stmt|;
block|}
DECL|method|testAsyncNoWaitRoute ()
specifier|public
name|void
name|testAsyncNoWaitRoute
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testAsyncRouteNoWaitWithTypeConverted ()
specifier|public
name|void
name|testAsyncRouteNoWaitWithTypeConverted
parameter_list|()
throws|throws
name|Exception
block|{
...
comment|// future type converter that will wait for the response, even though the async
comment|// is set to not wait. As the type converter will wait for us
name|String
name|response
init|=
name|template
