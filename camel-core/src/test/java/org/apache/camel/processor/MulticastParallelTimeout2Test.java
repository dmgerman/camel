...
begin_class
DECL|class|MulticastParallelTimeout2Test
specifier|public
class|class
name|MulticastParallelTimeout2Test
extends|extends
name|ContextTestSupport
block|{
...
argument_list|)
expr_stmt|;
comment|// wait at least longer than the delay in B so we can ensure its being cancelled
