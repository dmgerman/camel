...
specifier|public
name|void
name|testBacklogTracerNotRemoveOnDump
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// and if we get again they are still there
name|events
operator|=
operator|(
name|List
...
argument_list|()
expr_stmt|;
comment|// and now we should have 3 more messages
name|events
operator|=
operator|(
name|List
...
specifier|public
name|void
name|testBacklogTracerNotRemoveOnDumpPattern
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// and bar should also have 3 traced messages
name|events
operator|=
operator|(
name|List
...
specifier|public
name|void
name|testBacklogTracerNotRemoveOverflow
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// change size to 2 x 10 (as we need for first as well)
name|mbeanServer
operator|.
name|setAttribute
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// the first should be 0 and the last 9
name|String
name|xml
init|=
name|events
...
argument_list|)
expr_stmt|;
comment|// and we are shifted one now
name|xml
operator|=
name|events
operator|.
...
argument_list|)
expr_stmt|;
comment|// and we are shifted +4 now
name|xml
operator|=
name|events
operator|.
