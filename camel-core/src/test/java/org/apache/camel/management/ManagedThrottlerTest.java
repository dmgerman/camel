...
name|throttlerName
argument_list|,
literal|"ThrottledCount"
argument_list|)
decl_stmt|;
comment|// we are expecting this to be> 0
name|assertTrue
argument_list|(
name|throttledMessages
operator|.
...
name|assertEquals
argument_list|(
literal|"Should not be any throttled messages left, found: "
operator|+
name|throttledMessages
argument_list|,
operator|(
...
argument_list|()
expr_stmt|;
comment|// we shouldn't have ane leaked throttler counts
name|Integer
name|throttledMessages
init|=
operator|(
