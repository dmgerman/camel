...
name|File
argument_list|(
literal|"src/test/resources/jndi.properties"
argument_list|)
decl_stmt|;
annotation|@
name|Override
...
argument_list|)
expr_stmt|;
comment|// crete jndi.properties file
name|FileOutputStream
name|fos
init|=
operator|new
...
name|Exception
block|{
comment|// create jndi registry to use in Camel, using the default initial contex (which will read jndi.properties)
comment|// (instead of what test-support offers normally)
name|JndiRegistry
name|jndi
init|=
operator|new
