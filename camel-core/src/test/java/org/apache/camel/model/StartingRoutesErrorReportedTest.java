...
name|startsWith
argument_list|(
literal|"Failed to create route route1: Route[[From[direct:start?foo=bar]]"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|startsWith
argument_list|(
literal|"Failed to create route route2 at:>>> To[mock:result?foo=bar]"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|startsWith
argument_list|(
literal|"Failed to create route route3 at:>>> Bean[ref:]<<< in route: Route[[From[direct://start]] -> [To[mock:foo], Bean[ref:]]] because of"
argument_list|)
argument_list|)
expr_stmt|;
block|}
