...
begin_class
DECL|class|ValidatorIncludeRouteTest
specifier|public
class|class
...
name|body
init|=
literal|"<p:person user=\"james\" xmlns:p=\"org.person\" xmlns:h=\"org.health.check.person\">\n"
operator|+
...
name|body
init|=
literal|"<p:person user=\"hiram\"  xmlns:p=\"org.person\" xmlns:h=\"org.health.check.person\">\n"
operator|+
literal|"<p:firstName>Hiram</p:firstName>\n"
operator|+
literal|"<p:lastName>Chirino</p:lastName>\n"
operator|+
literal|"<p:city>Tampa</p:city>\n"
operator|+
literal|"</p:person>"
decl_stmt|;
name|template
...
specifier|public
name|void
name|testValidMessageNoHealthNoNamespace
parameter_list|()
throws|throws
name|Exception
block|{
...
name|body
init|=
literal|"<p:person user=\"hiram\"  xmlns:p=\"org.person\">\n"
operator|+
literal|"<p:firstName>Hiram</p:firstName>\n"
operator|+
literal|"<p:lastName>Chirino</p:lastName>\n"
...
specifier|public
name|void
name|testInvalidMessageNoHealth
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testInvalidMessageNoHealthNoNamespace
parameter_list|()
throws|throws
name|Exception
block|{
...
name|body
init|=
literal|"<p:person user=\"james\" xmlns:p=\"org.person\">\n"
operator|+
literal|"<p:firstName>James</p:firstName>\n"
operator|+
literal|"<p:lastName>Strachan</p:lastName>\n"
...
name|to
argument_list|(
literal|"validator:org/apache/camel/component/validator/person.xsd"
argument_list|)
operator|.
name|to
argument_list|(
