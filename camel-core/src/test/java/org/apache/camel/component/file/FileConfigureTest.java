...
argument_list|(
literal|"newfile://target/foo/bar"
argument_list|,
name|EXPECT_PATH
argument_list|)
expr_stmt|;
name|assertFileEndpoint
argument_list|(
literal|"newfile://target/foo/bar?delete=true"
argument_list|,
name|EXPECT_PATH
argument_list|)
expr_stmt|;
...
argument_list|(
literal|"newfile://target/foo/bar?recursive=true"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
name|createFileConsumer
argument_list|(
literal|"newfile://target/foo/bar?recursiv=true"
argument_list|)
expr_stmt|;
name|fail
argument_list|(
