...
begin_class
DECL|class|FileSortByExpressionTest
specifier|public
class|class
name|FileSortByExpressionTest
extends|extends
name|ContextTestSupport
block|{
DECL|field|fileUrl
...
name|fileUrl
operator|+
literal|"a/?sortBy=file:name.ext&initialDelay=1000"
argument_list|)
operator|.
name|to
argument_list|(
...
name|fileUrl
operator|+
literal|"b/?sortBy=reverse:file:name.ext&initialDelay=1000"
argument_list|)
operator|.
name|to
argument_list|(
