...
name|fileUrl
init|=
literal|"file://target/multidir/?consumer.recursive=true&delete=true&consumer.delay=5000&sortBy=file:path"
decl_stmt|;
annotation|@
name|Override
DECL|method|setUp ()
...
expr_stmt|;
block|}
DECL|method|assertFilePath (String expected, String actual)
specifier|private
specifier|static
name|void
name|assertFilePath
