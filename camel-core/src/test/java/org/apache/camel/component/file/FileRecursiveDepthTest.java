...
name|sendBodyAndHeader
argument_list|(
literal|"file:target/depth/3/foo"
argument_list|,
literal|"a2"
argument_list|,
name|Exchange
...
name|sendBodyAndHeader
argument_list|(
literal|"file:target/depth/3/foo/bar"
argument_list|,
literal|"a3"
argument_list|,
name|Exchange
...
name|sendBodyAndHeader
argument_list|(
literal|"file:target/depth/3/bar"
argument_list|,
literal|"b2"
argument_list|,
name|Exchange
...
name|sendBodyAndHeader
argument_list|(
literal|"file:target/depth/3/bar/foo"
argument_list|,
literal|"b3"
argument_list|,
name|Exchange
...
name|from
argument_list|(
literal|"file:target/depth/3?recursive=true&noop=true&minDepth=1&maxDepth=1"
argument_list|)
operator|.
name|convertBodyTo
argument_list|(
