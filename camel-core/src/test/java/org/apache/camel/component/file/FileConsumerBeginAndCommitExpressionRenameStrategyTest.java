...
name|getEndpoint
argument_list|(
literal|"newfile://target?expression=../done/${file:name}&delete=true"
argument_list|)
operator|.
name|createConsumer
argument_list|(
...
name|from
argument_list|(
literal|"newfile://target/reports?preMoveExpression=../inprogress/${file:name.noext}.bak&expression=../done/${file:name}&consumer.delay=5000"
argument_list|)
operator|.
name|process
argument_list|(
