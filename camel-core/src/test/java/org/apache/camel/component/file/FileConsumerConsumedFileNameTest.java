...
begin_comment
comment|/**  * Unit test that checks for the existence of the CamelFileNameConsumed header.  */
end_comment

begin_class
DECL|class|FileConsumerConsumedFileNameTest
specifier|public
class|class
name|FileConsumerConsumedFileNameTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
