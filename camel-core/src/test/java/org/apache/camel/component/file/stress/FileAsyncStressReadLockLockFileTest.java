...
begin_class
DECL|class|FileAsyncStressReadLockLockFileTest
specifier|public
class|class
name|FileAsyncStressReadLockLockFileTest
extends|extends
...
name|from
argument_list|(
literal|"file:target/filestress?maxMessagesPerPoll=50&readLock=lockFile"
argument_list|)
operator|.
name|routeId
argument_list|(
