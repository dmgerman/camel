...
begin_class
DECL|class|SedaConcurrentTest
specifier|public
class|class
name|SedaConcurrentTest
extends|extends
name|ContextTestSupport
block|{
...
specifier|public
name|void
name|testSedaConcurrentInOnlyWithAsync
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSedaConcurrentInOutWithAsync
parameter_list|()
throws|throws
name|Exception
block|{
...
name|from
argument_list|(
literal|"seda:bar?concurrentConsumers=10"
argument_list|)
operator|.
name|to
argument_list|(
