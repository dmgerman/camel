...
begin_class
DECL|class|SameSedaQueueSizeAndNoSizeTest
specifier|public
class|class
name|SameSedaQueueSizeAndNoSizeTest
extends|extends
name|ContextTestSupport
block|{
...
name|assertEquals
argument_list|(
literal|"Cannot use existing queue seda://foo as the existing queue size 100 does not match given queue size 200"
argument_list|,
name|ise
operator|.
name|getMessage
