...
name|assertEquals
argument_list|(
literal|"mock://result No header with name bar found."
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"mock://result Header with name bar. Expected:<cheese> but was:<beer>"
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"mock://result No property with name bar found."
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"mock://result Property with name bar. Expected:<cheese> but was:<beer>"
argument_list|,
name|e
operator|.
name|getMessage
...
block|}
block|}
DECL|method|testMessageIndex ()
specifier|public
name|void
name|testMessageIndex
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Assertion error at index 1 on mock mock://result with predicate: header(bar) == 444 on Exchange[Message: Hello World]"
argument_list|,
name|e
operator|.
name|getMessage
