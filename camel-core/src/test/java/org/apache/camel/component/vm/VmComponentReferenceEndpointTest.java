...
begin_class
DECL|class|VmComponentReferenceEndpointTest
specifier|public
class|class
name|VmComponentReferenceEndpointTest
extends|extends
name|ContextTestSupport
block|{
DECL|method|testVmComponentReference ()
specifier|public
name|void
name|testVmComponentReference
parameter_list|()
throws|throws
name|Exception
block|{
...
name|from
argument_list|(
literal|"vm:foo?blockWhenFull=true"
argument_list|)
operator|.
name|routeId
argument_list|(
...
return|;
block|}
DECL|method|numberOfReferences (VmComponent vm)
specifier|private
name|int
name|numberOfReferences
parameter_list|(
