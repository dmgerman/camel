...
name|getEndpoint
argument_list|(
literal|"file://target?expression=${file:name.noext}.bak&delete=true"
argument_list|)
operator|.
name|createConsumer
argument_list|(
...
name|from
argument_list|(
literal|"file://target/reports?preMoveNamePrefix=../inprogress/&moveNamePrefix=../done/&consumer.delay=5000"
argument_list|)
operator|.
name|process
argument_list|(
