...
begin_class
DECL|class|FilerConsumerDoneFileNamePrefixTest
specifier|public
class|class
name|FilerConsumerDoneFileNamePrefixTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
name|from
argument_list|(
literal|"file:target/done?doneFileName=done-${file:name}&initialDelay=0&delay=10"
argument_list|)
operator|.
name|to
argument_list|(
