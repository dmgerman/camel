...
begin_class
DECL|class|DirectVmNoPropertyPropagationTest
specifier|public
class|class
name|DirectVmNoPropertyPropagationTest
extends|extends
name|ContextTestSupport
block|{
...
name|sendBody
argument_list|(
literal|"direct-vm:start.noprops"
argument_list|,
literal|"Hello World"
argument_list|)
expr_stmt|;
...
name|to
argument_list|(
literal|"direct-vm:foo.props?propagateProperties=true"
argument_list|)
expr_stmt|;
name|from
argument_list|(
