...
begin_class
DECL|class|FileMarkerFileRecursiveDoNotDeleteOldLockFilesTest
specifier|public
class|class
name|FileMarkerFileRecursiveDoNotDeleteOldLockFilesTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
argument_list|)
expr_stmt|;
comment|// and a new file that has no lock
name|template
operator|.
name|sendBodyAndHeader
argument_list|(
