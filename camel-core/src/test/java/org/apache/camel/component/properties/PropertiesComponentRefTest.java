...
begin_class
DECL|class|PropertiesComponentRefTest
specifier|public
class|class
name|PropertiesComponentRefTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
name|to
argument_list|(
literal|"properties:{{cool.result}}"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|to
argument_list|(
literal|"properties:{{bar.end}}?locations=ref:coolBar"
argument_list|)
expr_stmt|;
block|}
block|}
