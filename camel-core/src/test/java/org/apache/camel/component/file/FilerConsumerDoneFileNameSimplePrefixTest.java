...
begin_class
DECL|class|FilerConsumerDoneFileNameSimplePrefixTest
specifier|public
class|class
name|FilerConsumerDoneFileNameSimplePrefixTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
name|from
argument_list|(
literal|"file:target/done?doneFileName=done-$simple{file:name}&initialDelay=0&delay=10"
argument_list|)
operator|.
name|to
argument_list|(
