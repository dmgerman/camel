...
begin_class
DECL|class|ValidatorDtdAccessOffTest
specifier|public
class|class
name|ValidatorDtdAccessOffTest
extends|extends
name|ValidatorDtdAccessAbstractTest
block|{
DECL|method|ValidatorDtdAccessOffTest ()
specifier|public
name|ValidatorDtdAccessOffTest
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/** Tests that no external DTD call is executed for StringSource. */
annotation|@
name|Test
...
expr_stmt|;
block|}
comment|/** Tests that XXE is not possible for StreamSource. */
annotation|@
name|Test
