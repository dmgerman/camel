...
argument_list|)
expr_stmt|;
comment|// should have stopped all 3
name|assertEquals
argument_list|(
literal|3
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// should have shutdown all 3
name|assertEquals
argument_list|(
literal|3
argument_list|,
...
argument_list|()
expr_stmt|;
comment|// no more stop after stopping the cache
name|assertEquals
argument_list|(
literal|3
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// no more shutdown after stopping the cache
name|assertEquals
argument_list|(
literal|3
argument_list|,
...
name|number
decl_stmt|;
DECL|method|MyEndpoint (boolean isSingleton, int number)
specifier|private
name|MyEndpoint
parameter_list|(
name|boolean
