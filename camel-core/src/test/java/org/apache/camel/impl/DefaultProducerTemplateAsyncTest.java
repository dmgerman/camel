...
expr_stmt|;
block|}
DECL|method|testAsyncProcessWithClassicAPI ()
specifier|public
name|void
name|testAsyncProcessWithClassicAPI
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// produce it async so we use a helper
name|Producer
name|producer
init|=
name|endpoint
...
expr_stmt|;
block|}
DECL|method|testAsyncProcessWithClassicAPIAndTimeout ()
specifier|public
name|void
name|testAsyncProcessWithClassicAPIAndTimeout
parameter_list|()
throws|throws
name|Exception
block|{
