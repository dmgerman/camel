...
begin_class
DECL|class|EndpointRegistryKeepRouteInputEndpointsTest
specifier|public
class|class
name|EndpointRegistryKeepRouteInputEndpointsTest
extends|extends
name|ContextTestSupport
block|{
...
name|hasEndpoint
argument_list|(
literal|"seda://start?multipleConsumers=true"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testEndpointRegistryKeepRouteEndpointsContextStop ()
specifier|public
name|void
name|testEndpointRegistryKeepRouteEndpointsContextStop
parameter_list|()
throws|throws
name|Exception
block|{
