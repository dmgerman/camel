...
name|Ignore
argument_list|(
literal|"Fails due CAMEL-5183"
argument_list|)
DECL|method|testConfigurationPortParameter ()
specifier|public
name|void
name|testConfigurationPortParameter
parameter_list|()
throws|throws
name|Exception
block|{
...
name|createConfiguration
argument_list|(
literal|"mapped://foo:8080?one=true&two=2&port=123"
argument_list|,
name|context
argument_list|)
decl_stmt|;
...
name|assertEquals
argument_list|(
literal|"mapped://foo:8080?one=true&port=123&two=2"
argument_list|,
name|uri1
argument_list|)
expr_stmt|;
