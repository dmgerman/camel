...
argument_list|)
expr_stmt|;
comment|// and the dynamic cache only keeps the last 20
name|assertFalse
argument_list|(
name|context
operator|.
...
name|hasEndpoint
argument_list|(
literal|"mock://unknown49"
argument_list|)
operator|!=
literal|null
argument_list|)
expr_stmt|;
comment|// we should have 24
name|assertEquals
argument_list|(
literal|24
argument_list|,
