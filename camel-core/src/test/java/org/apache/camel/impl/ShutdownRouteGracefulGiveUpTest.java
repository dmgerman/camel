...
begin_class
DECL|class|ShutdownRouteGracefulGiveUpTest
specifier|public
class|class
name|ShutdownRouteGracefulGiveUpTest
extends|extends
name|ContextTestSupport
block|{
DECL|field|foo
...
comment|// timeout after 2 seconds, then give up
name|foo
operator|=
name|foo
operator|+
...
name|assertEquals
argument_list|(
literal|"Seda should still be running"
argument_list|,
literal|true
argument_list|,
name|context
