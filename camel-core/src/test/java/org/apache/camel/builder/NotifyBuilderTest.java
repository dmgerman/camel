...
expr_stmt|;
block|}
DECL|method|testSedaWhenExchangeDoneSimple ()
specifier|public
name|void
name|testSedaWhenExchangeDoneSimple
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"from(seda:beer).whenDone(1)"
argument_list|,
name|notify
operator|.
name|toString
...
argument_list|)
expr_stmt|;
comment|// wait up till 5 sec as it should be routed completed now
name|assertEquals
argument_list|(
literal|true
argument_list|,
