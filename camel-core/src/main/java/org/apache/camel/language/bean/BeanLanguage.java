...
block|{
comment|//first check case :: because of my.own.Bean::method
name|int
name|doubleColonIndex
init|=
name|expression
operator|.
name|indexOf
...
argument_list|)
decl_stmt|;
comment|//need to check that not inside params
name|int
name|beginOfParameterDeclaration
init|=
name|expression
operator|.
name|indexOf
