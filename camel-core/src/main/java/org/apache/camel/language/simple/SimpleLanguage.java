...
argument_list|()
decl_stmt|;
comment|/**      * Does the expression have the simple language start token?      *      * @param expression the expression      * @return<tt>true</tt> if the expression contains the start token,<tt>false</tt> otherwise      */
DECL|method|hasStartToken (String expression)
specifier|public
specifier|static
name|boolean
name|hasStartToken
...
parameter_list|)
block|{
comment|// return the expression directly if we can create expression without analyzing the prefix
name|Expression
name|answer
init|=
name|createSimpleExpressionDirectly
