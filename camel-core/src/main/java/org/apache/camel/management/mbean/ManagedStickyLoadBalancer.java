...
name|description
operator|=
literal|"Managed Sticky LoadBalancer"
argument_list|)
DECL|class|ManagedStickyLoadBalancer
specifier|public
class|class
...
name|processor
decl_stmt|;
DECL|method|ManagedStickyLoadBalancer (CamelContext context, StickyLoadBalancer processor, LoadBalanceDefinition definition)
specifier|public
name|ManagedStickyLoadBalancer
parameter_list|(
name|CamelContext
