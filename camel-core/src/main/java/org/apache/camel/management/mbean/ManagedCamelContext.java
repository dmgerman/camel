...
condition|)
block|{
comment|// only include this in full stats as it may be more expensive to compute
name|sb
operator|.
name|append
argument_list|(
...
return|;
block|}
comment|/**      * Number of inflight exchanges at the given processor      *      * @param inflights   all inflight exchanges      * @param processorId the processor id      * @return the number      */
DECL|method|inflightSizeAtProcessor (Collection<InflightRepository.InflightExchange> inflights, String processorId)
specifier|private
name|String
name|inflightSizeAtProcessor
parameter_list|(
