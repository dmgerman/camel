...
name|description
operator|=
literal|"Managed Random LoadBalancer"
argument_list|)
DECL|class|ManagedRandomLoadBalancer
specifier|public
class|class
...
name|processor
decl_stmt|;
DECL|method|ManagedRandomLoadBalancer (CamelContext context, RandomLoadBalancer processor, LoadBalanceDefinition definition)
specifier|public
name|ManagedRandomLoadBalancer
parameter_list|(
name|CamelContext
