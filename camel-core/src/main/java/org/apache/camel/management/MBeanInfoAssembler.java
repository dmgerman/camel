...
begin_comment
comment|/**  * A Camel specific {@link javax.management.MBeanInfo} assembler that reads the  * details from the {@link ManagedResource}, {@link ManagedAttribute}, and {@link ManagedOperation} annotations.  */
end_comment
...
argument_list|)
decl_stmt|;
comment|/**      * Gets the {@link ModelMBeanInfo} for the given managed bean      *      * @param managedBean  the managed bean      * @param objectName   the object name      * @return the model info      * @throws JMException is thrown if error creating the model info      */
DECL|method|getMBeanInfo (Object managedBean, String objectName)
specifier|public
name|ModelMBeanInfo
name|getMBeanInfo
parameter_list|(
...
return|;
block|}
DECL|method|extractMbeanNotifiations (Object managedBean)
specifier|private
name|List
argument_list|<
name|ModelMBeanNotificationInfo
...
return|;
block|}
DECL|method|extractAttributesAndOperations (Object managedBean, Map<String, ManagedAttributeInfo> attributes, List<ManagedOperationInfo> operations)
specifier|private
name|void
name|extractAttributesAndOperations
parameter_list|(
...
block|}
block|}
DECL|method|extractMbeanAttributes (Object managedBean, Map<String, ManagedAttributeInfo> attributes, List<ModelMBeanAttributeInfo> mBeanAttributes, List<ModelMBeanOperationInfo> mBeanOperations)
specifier|private
name|void
name|extractMbeanAttributes
parameter_list|(
...
block|}
block|}
DECL|method|extractMbeanOperations (Object managedBean, List<ManagedOperationInfo> operations, List<ModelMBeanOperationInfo> mBeanOperations)
specifier|private
name|void
name|extractMbeanOperations
parameter_list|(
...
name|operation
decl_stmt|;
DECL|method|ManagedOperationInfo (String description, Method operation)
specifier|private
name|ManagedOperationInfo
parameter_list|(
name|String
