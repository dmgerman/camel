...
expr_stmt|;
block|}
comment|//String id = VALUE_UNKNOWN.equals(cid) ? ObjectName.quote(getEndpointId(ep) : "[" + cid + "]" + ObjectName.quote(getEndpointId(ep);
name|String
name|nodeId
init|=
name|processor
...
argument_list|)
expr_stmt|;
comment|// buffer.append(KEY_ROUTE + "=").append(id).append(",");
name|buffer
operator|.
name|append
argument_list|(
