...
begin_comment
comment|/**  * This strategy class wraps targeted processors with  * {@link InstrumentationProcessor}.  Each InstrumentationProcessor is  * into embeds a {@link PerformanceCounter}.  This class looks up a map  * to determine which PerformanceCounter should go into the  * InstrumentationProcessor for any particular target processor.  *  * @version $Revision$  */
end_comment
