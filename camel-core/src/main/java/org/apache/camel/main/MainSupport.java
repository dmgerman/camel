...
argument_list|,
literal|"Sets the maximum messages duration that the application will process before terminating."
argument_list|,
literal|"durationMaxMessages"
argument_list|)
block|{
...
name|debug
argument_list|(
literal|"Adding DurationRoutePolicyFactory with maxMessages: {}"
argument_list|,
name|durationMaxMessages
argument_list|)
expr_stmt|;
