...
block|}
block|}
comment|/**      * Dumps the {@link MessageHistory} from the {@link Exchange} in a human readable format.      *      * @param exchange       the exchange      * @param logStackTrace  whether to include a header for the stacktrace, to be added (not included in this dump).      * @return a human readable message history as a table      */
DECL|method|dumpMessageHistoryStacktrace (Exchange exchange, boolean logStackTrace)
specifier|public
specifier|static
name|String
