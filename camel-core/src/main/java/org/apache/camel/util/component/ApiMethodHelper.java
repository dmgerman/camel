...
argument_list|()
decl_stmt|;
comment|/**      * Create a helper to work with a {@link ApiMethod}, using optional method aliases.      * @param apiMethodEnum {@link ApiMethod} enumeration class      * @param aliases Aliases mapped to actual method names      */
DECL|method|ApiMethodHelper (Class<T> apiMethodEnum, Map<String, String> aliases)
specifier|public
name|ApiMethodHelper
parameter_list|(
name|Class
