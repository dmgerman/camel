...
literal|"unchecked"
argument_list|)
DECL|field|PRIMITIVE_ARRAY_TYPES
specifier|private
specifier|static
specifier|final
name|List
...
return|;
block|}
comment|/**      * Returns if the given {@code clazz} type is a Java primitive type.      *       * @param clazz the Java type to be checked      * @return {@code true} if the given type is a Java primitive type      */
DECL|method|isPrimitiveType (Class<?> clazz)
specifier|public
specifier|static
name|boolean
