...
return|;
block|}
comment|/**      * Asserts whether the string is<b>not</b> empty.      *      * @param value the string to test      * @param name the key that resolved the value      * @return the passed {@code value} as is      * @throws IllegalArgumentException is thrown if assertion fails      * @deprecated use {@link StringHelper#notEmpty(String, String)} instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * @deprecated use      *             {@link StringHelper#splitOnCharacter(String, String, int)} instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Removes any starting characters on the given text which match the given      * character      *      * @param text the string      * @param ch the initial characters to remove      * @return either the original string or the new substring      * @deprecated use {@link StringHelper#removeStartingCharacters(String, char)} instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * @deprecated use {@link StringHelper#capitalize(String)} instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Returns the string after the given token      *      * @param text  the text      * @param after the token      * @return the text after the token, or<tt>null</tt> if text does not contain the token      * @deprecated use {@link StringHelper#after(String, String)} instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Returns an object after the given token      *      * @param text the text      * @param after the token      * @param mapper a mapping function to convert the string after the token to      *            type T      * @return an Optional describing the result of applying a mapping function      *         to the text after the token.      * @deprecated use {@link StringHelper#after(String, String, Function)      *             StringHelper.after(String, String, Function&lt;String,T&gt;)}      *             instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Returns the string before the given token      *      * @param text  the text      * @param before the token      * @return the text before the token, or<tt>null</tt> if text does not contain the token      * @deprecated use {@link StringHelper#before(String, String)} instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Returns an object before the given token      *      * @param text the text      * @param before the token      * @param mapper a mapping function to convert the string before the token      *            to type T      * @return an Optional describing the result of applying a mapping function      *         to the text before the token.      * @deprecated use {@link StringHelper#before(String, String, Function)      *             StringHelper.before(String, String, Function&lt;String,T&gt;)}      *             instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Returns the string between the given tokens      *      * @param text  the text      * @param after the before token      * @param before the after token      * @return the text between the tokens, or<tt>null</tt> if text does not contain the tokens      * @deprecated use {@link StringHelper#between(String, String, String)} instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Returns true if the given name is a valid java identifier      * @deprecated use {@link StringHelper#isJavaIdentifier(String)} instead      */
annotation|@
name|Deprecated
...
block|}
block|}
comment|/**      * Cleans the string to a pure Java identifier so we can use it for loading      * class names.      *<p/>      * Especially from Spring DSL people can have \n \t or other characters that      * otherwise would result in ClassNotFoundException      *      * @param name the class name      * @return normalized classname that can be load by a class loader.      * @deprecated use {@link StringHelper#normalizeClassName(String)} instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Creates a {@link Scanner} for scanning the given value.      *      * @param exchange  the current exchange      * @param value     the value, typically the message IN body      * @param delimiter the delimiter pattern to use      * @return the scanner, is newer<tt>null</tt>      */
DECL|method|getScanner (Exchange exchange, Object value, String delimiter)
specifier|public
specifier|static
name|Scanner
name|getScanner
