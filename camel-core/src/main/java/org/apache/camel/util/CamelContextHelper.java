...
return|;
block|}
comment|/**      * Returns a list of all singleton endpoints of the given type      *      * @param camelContext the camel context      * @param type the type of the endpoints requested      * @return a list which may be empty of all the endpoint instances of the      *         given type      */
...
return|;
block|}
comment|/**      * Returns a list of all singleton or regular endpoints of the given type      */
DECL|method|getEndpointsImpl (CamelContext camelContext, Class<T> type, boolean singleton)
specifier|private
specifier|static
parameter_list|<
name|T
