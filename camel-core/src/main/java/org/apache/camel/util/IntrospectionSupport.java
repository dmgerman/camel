...
parameter_list|()
block|{     }
comment|/**      * Copies the properties from the source to the target      * @param source source object      * @param target target object      * @param optionPrefix optional option preifx (can be null)      * @return true if properties is copied, false if something went wrong      */
DECL|method|copyProperties (Object source, Object target, String optionPrefix)
specifier|public
specifier|static
name|boolean
name|copyProperties
