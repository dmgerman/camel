...
name|debug
argument_list|(
literal|"Could not open resource as a file, trying as class path resource."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|". Trying as a class path resource with the TCCL (if set)."
argument_list|)
expr_stmt|;
block|}
block|}
