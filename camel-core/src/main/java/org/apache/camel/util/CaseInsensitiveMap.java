...
return|return
operator|new
name|CaseInsensitiveKeySet
argument_list|()
return|;
block|}
comment|/**      * To use the original keys but support checking if a key exist using case insensitive.      */
DECL|class|CaseInsensitiveKeySet
specifier|private
specifier|final
class|class
name|CaseInsensitiveKeySet
...
parameter_list|()
block|{
comment|// use the original case keys, which is stored in as values
return|return
name|originalKeys
operator|.
name|values
