...
expr_stmt|;
block|}
DECL|method|LRUSoftCache (int initialCapacity, int maximumCacheSize, float loadFactor, boolean accessOrder)
specifier|public
name|LRUSoftCache
parameter_list|(
name|int
...
parameter_list|()
block|{
comment|// must use a copy of the keys to avoid concurrent modifications
name|Set
argument_list|<
name|K
argument_list|>
...
argument_list|)
decl_stmt|;
comment|// filter out un referenced values
name|Set
argument_list|<
name|K
argument_list|>
