...
begin_comment
comment|/**  * A default JNDI context  *   * @version $Revision: 1.2 $ $Date: 2005/08/27 03:52:39 $  */
end_comment
...
expr_stmt|;
block|}
DECL|method|JndiContext (Hashtable env)
specifier|public
name|JndiContext
parameter_list|(
name|Hashtable
...
block|}
block|}
DECL|method|createBean (Class<?> type, Map properties, String prefix)
specifier|protected
specifier|static
name|Object
name|createBean
