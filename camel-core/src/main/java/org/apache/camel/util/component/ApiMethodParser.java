...
argument_list|)
decl_stmt|;
DECL|field|GENERIC_ARG_PATTERN
specifier|private
specifier|static
specifier|final
name|Pattern
name|GENERIC_ARG_PATTERN
init|=
name|Pattern
operator|.
name|compile
...
throw|;
block|}
comment|// drop any generic type parameters in result, if any
specifier|final
name|String
name|resultTypeWithArgs
init|=
name|methodMatcher
operator|.
name|group
