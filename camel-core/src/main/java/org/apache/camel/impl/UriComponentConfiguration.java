...
begin_comment
comment|/**  * Implements {@link org.apache.camel.EndpointConfiguration} for Endpoint implementations  * which are annotated with {@link UriEndpoint}  * to use the {@link org.apache.camel.spi.UriParam} and {@link org.apache.camel.spi.UriParams} annotations  * to denote its parameters which can be specified via URI query parameters.  */
end_comment
