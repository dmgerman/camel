...
return|;
block|}
comment|/**      * Is there<b>NOT</b> a type converter registered being able to converter the      * given value to the type      * @param toType  the type to convert to      * @param fromType  the type to convert from      * @return<tt>true</tt> if there is<b>NOT</b> a converter,<tt>false</tt> if there is      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
argument_list|)
DECL|method|hasNoConverterFor (Class toType, Class fromType)
specifier|public
name|boolean
...
argument_list|)
decl_stmt|;
comment|// we must only look in misses and not do the acutal convertions
comment|// as for stream it can be impossible to re-read them and this
comment|// method should not cause any overhead
return|return
name|misses
operator|.
name|containsKey
