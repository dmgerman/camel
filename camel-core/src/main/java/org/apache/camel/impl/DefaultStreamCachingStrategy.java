...
name|StreamCachingStrategy
block|{
comment|// TODO: add easy configuration in XML to add custom should spool tasks
annotation|@
name|Deprecated
...
decl_stmt|;
DECL|field|spoolHeapMemoryWatermarkThreshold
specifier|private
name|int
...
return|;
block|}
DECL|method|setSpoolHeapMemoryWatermarkThreshold (int spoolHeapMemoryWatermarkThreshold)
specifier|public
name|void
...
return|;
block|}
DECL|method|setAnySpoolTasks (boolean anySpoolTasks)
specifier|public
name|void
...
argument_list|(
literal|"SpoolHeapMemoryWatermarkThreshold must be a value between 0 and 100, was: "
operator|+
name|spoolHeapMemoryWatermarkThreshold
argument_list|)
throw|;
...
argument_list|(
operator|new
name|FixedThresholdShouldSpoolTask
argument_list|(
name|spoolThreshold
argument_list|)
argument_list|)
...
argument_list|(
operator|new
name|UsedHeapMemoryShouldSpoolTask
argument_list|(
name|spoolHeapMemoryWatermarkThreshold
argument_list|)
argument_list|)
...
name|info
argument_list|(
literal|"StreamCaching in use with spool directory: {} and thresholds: {}"
argument_list|,
name|spoolDirectory
operator|.
name|getPath
...
name|info
argument_list|(
literal|"StreamCaching in use with thresholds: {}"
argument_list|,
name|spoolTasks
operator|.
name|toString
...
return|;
block|}
DECL|class|FixedThresholdShouldSpoolTask
specifier|private
specifier|static
specifier|final
class|class
...
name|threshold
decl_stmt|;
DECL|method|FixedThresholdShouldSpoolTask (long threshold)
specifier|private
name|FixedThresholdShouldSpoolTask
parameter_list|(
name|long
...
block|}
block|}
DECL|class|UsedHeapMemoryShouldSpoolTask
specifier|private
specifier|final
class|class
name|UsedHeapMemoryShouldSpoolTask
...
name|heapUsage
decl_stmt|;
DECL|field|spoolPercentage
specifier|private
specifier|final
name|int
name|spoolPercentage
decl_stmt|;
DECL|method|UsedHeapMemoryShouldSpoolTask (int spoolPercentage)
specifier|private
name|UsedHeapMemoryShouldSpoolTask
parameter_list|(
name|int
