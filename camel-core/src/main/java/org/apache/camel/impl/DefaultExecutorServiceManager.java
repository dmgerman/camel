...
comment|// TODO: Let ThreadHelper do this on demand
name|String
name|name
init|=
name|threadNamePattern
...
return|;
block|}
comment|// TODO: The lookup methods could possible be removed and replace using other methods/logic
annotation|@
name|Override
...
argument_list|()
decl_stmt|;
comment|// fallback to use values from default profile
name|ExecutorService
name|answer
init|=
name|threadPoolFactory
...
name|debug
argument_list|(
literal|"Created new FixedThreadPool for source: {} with name: {}. -> {}"
argument_list|,
operator|new
name|Object
index|[]
