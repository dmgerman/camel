...
begin_comment
comment|/**  * Template (named like Spring's TransactionTemplate& JmsTemplate  * et al) for working with Camel and sending {@link Message} instances in an  * {@link Exchange} to an {@link Endpoint}.  */
end_comment
...
argument_list|)
argument_list|,
name|createConvertBodyProcessor
argument_list|(
name|type
argument_list|)
argument_list|)
...
return|;
block|}
DECL|method|createBodyAndHeaders (final Object body, final Map<String, Object> headers)
specifier|protected
name|Processor
name|createBodyAndHeaders
parameter_list|(
...
return|;
block|}
DECL|method|createConvertBodyProcessor (final Class<?> type)
specifier|protected
name|Processor
name|createConvertBodyProcessor
parameter_list|(
...
return|;
block|}
DECL|method|createCompletionFunction (Synchronization onCompletion)
specifier|protected
name|Function
argument_list|<
name|Exchange
...
return|;
block|}
DECL|method|asyncRequestBody (final Endpoint endpoint, Processor processor, final Class<T> type)
specifier|protected
parameter_list|<
name|T
parameter_list|>
...
return|;
block|}
DECL|method|asyncRequestBody (final Endpoint endpoint, Processor processor)
specifier|protected
name|CompletableFuture
argument_list|<
name|Object
...
return|;
block|}
DECL|method|asyncRequestBody (final Endpoint endpoint, Processor processor, Processor resultProcessor)
specifier|protected
name|CompletableFuture
argument_list|<
name|Object
...
return|;
block|}
DECL|method|asyncRequest (Endpoint endpoint, Processor processor, Processor resultProcessor)
specifier|protected
name|CompletableFuture
argument_list|<
name|Exchange
...
return|;
block|}
DECL|method|asyncSend ( Endpoint endpoint, ExchangePattern pattern, Processor processor, Processor resultProcessor)
specifier|protected
name|CompletableFuture
argument_list|<
name|Exchange
...
return|;
block|}
DECL|method|asyncSendExchange ( Endpoint endpoint, ExchangePattern pattern, Processor processor, Processor resultProcessor, Exchange inExchange)
specifier|protected
name|CompletableFuture
argument_list|<
name|Exchange
