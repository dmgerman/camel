...
begin_comment
comment|/**  * A useful base class for implementations of {@link PullConsumer}  *  * @version $Revision: 1.1 $  */
end_comment

begin_class
DECL|class|PullConsumerSupport
specifier|public
specifier|abstract
class|class
...
name|exceptionHandler
decl_stmt|;
DECL|method|PullConsumerSupport (Endpoint<E> endpoint)
specifier|public
name|PullConsumerSupport
parameter_list|(
name|Endpoint
