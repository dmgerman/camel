...
expr_stmt|;
block|}
DECL|method|find (PackageScanFilter test, String packageName, ClassLoader loader, Set<Class<?>> classes, Map<String, List<String>> jarCache)
specifier|protected
name|void
name|find
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|doCacheJar (InputStream stream, String urlPath)
specifier|private
name|List
argument_list|<
name|String
