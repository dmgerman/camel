...
comment|// Helpers
comment|// *********************************
DECL|method|doStopRoute (CamelContext context, Route route, boolean checker, ThrowingConsumer<Route, Exception> consumer)
specifier|private
name|void
name|doStopRoute
parameter_list|(
...
block|}
block|}
DECL|method|doStartRoute (CamelContext context, Route route, boolean checker, ThrowingConsumer<Route, Exception> consumer)
specifier|private
name|void
name|doStartRoute
parameter_list|(
...
try|try
block|{
comment|// remove the route from any queue
name|stoppedRoutes
operator|.
name|remove
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// route started successfully
name|startedRoutes
operator|.
name|add
argument_list|(
...
expr_stmt|;
block|}
DECL|method|release (Route route)
name|boolean
name|release
parameter_list|(
name|Route
...
expr_stmt|;
block|}
DECL|method|isSupervising (Route route)
name|boolean
name|isSupervising
parameter_list|(
name|Route
...
name|debug
argument_list|(
literal|"Context is started: add route {} to startable routes"
argument_list|,
name|route
operator|.
name|getId
