...
name|class
argument_list|)
DECL|method|configureSerializationDataFormat ( CamelContext camelContext, SerializationDataFormatConfiguration configuration)
specifier|public
name|SerializationDataFormat
name|configureSerializationDataFormat
parameter_list|(
name|CamelContext
name|camelContext
parameter_list|,
