...
return|;
block|}
DECL|method|prepareInternalProcessor (Producer producer, Processor resultProcessor)
specifier|protected
name|CamelInternalProcessor
name|prepareInternalProcessor
parameter_list|(
...
parameter_list|)
block|{
comment|// if we have a result processor then wrap in pipeline to execute both of them in sequence
name|Processor
name|target
decl_stmt|;
if|if
