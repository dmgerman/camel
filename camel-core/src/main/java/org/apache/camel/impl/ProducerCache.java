...
return|;
block|}
comment|/**      * Sends an exchange to an endpoint using a supplied      * {@link Processor} to populate the exchange      *      * @param endpoint the endpoint to send the exchange to      * @param pattern the message {@link ExchangePattern} such as      *   {@link ExchangePattern#InOnly} or {@link ExchangePattern#InOut}      * @param processor the transformer used to populate the new exchange      * @param onCompletion  callback invoked when exchange has been completed      * @return the exchange      */
DECL|method|send (Endpoint endpoint, ExchangePattern pattern, Processor processor, Synchronization onCompletion)
specifier|public
name|Exchange
name|send
parameter_list|(
...
return|;
block|}
DECL|method|sendExchange (final Endpoint endpoint, ExchangePattern pattern, final Processor processor, Exchange exchange, final Synchronization onCompletion)
specifier|protected
name|Exchange
name|sendExchange
parameter_list|(
