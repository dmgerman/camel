...
begin_comment
comment|/**  * Optimised type converter for performing the most common conversions using the type converters  * from camel-core.  */
end_comment
...
block|{
comment|/**      * Attempts to convert the value to the given type      *      * @param type  the type to convert to      * @param exchange the exchange, may be null      * @param value the value      * @return the converted value, or null if no core type converter exists to convert      */
