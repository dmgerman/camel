...
DECL|method|stopRouteService (String key)
specifier|protected
specifier|synchronized
name|void
name|stopRouteService
...
return|;
block|}
DECL|method|setFactoryFinderClass (Class<? extends FactoryFinder> finderClass)
specifier|public
name|void
