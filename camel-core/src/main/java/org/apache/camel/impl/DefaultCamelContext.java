...
name|debug
argument_list|(
literal|"Loading component documentation for: {} using class resolver: {} -> {}"
argument_list|,
operator|new
name|Object
index|[]
...
parameter_list|)
block|{
comment|// the ftp components are in a special package
if|if
condition|(
literal|"ftp"
operator|.
...
argument_list|)
expr_stmt|;
comment|// if we have the json schema then use that to get the descriptions
name|String
name|description
init|=
literal|null
...
name|debug
argument_list|(
literal|"Using ClassResolver={}, PackageScanClassResolver={}, ApplicationContextClassLoader={}"
argument_list|,
operator|new
name|Object
index|[]
