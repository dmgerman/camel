...
comment|// TODO: leverage shutdown strategy to let it run in suspend mode, so it can suspend routes in correct order
for|for
control|(
name|Map
operator|.
...
expr_stmt|;
block|}
comment|// TODO: suspended/resumed notification events
comment|// TODO: more unit test to ensure suspend/resume with startup ordering is as expected
name|watch
operator|.
name|stop
argument_list|()
...
argument_list|()
decl_stmt|;
comment|// check multiple consumer violation
if|if
condition|(
operator|!
