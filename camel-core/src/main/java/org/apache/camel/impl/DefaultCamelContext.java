...
argument_list|()
decl_stmt|;
DECL|field|routeDefinitionsFromRegistry
specifier|private
specifier|final
name|Map
argument_list|<
...
name|RouteDefinition
argument_list|>
name|routeDefinitionsFromRegistry
init|=
operator|new
name|HashMap
argument_list|<>
...
expr_stmt|;
block|}
DECL|method|doWithDefinedClassLoader (Callable<T> callable)
specifier|private
parameter_list|<
name|T
parameter_list|>
...
argument_list|)
expr_stmt|;
comment|// Remove routes definition previously found on the registry so in case
comment|// context restart new routes eventually removed from the registry won't
comment|// stay as zombie.
name|removeRouteDefinitions
argument_list|(
name|routeDefinitionsFromRegistry
operator|.
...
condition|)
block|{
comment|// If routes do not have an id, use the bean name
name|entry
operator|.
name|getValue
argument_list|()
