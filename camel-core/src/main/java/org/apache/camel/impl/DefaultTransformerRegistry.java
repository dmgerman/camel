...
expr_stmt|;
block|}
DECL|method|DefaultTransformerRegistry (CamelContext context, Map<TransformerKey, Transformer> transformers)
specifier|public
name|DefaultTransformerRegistry
parameter_list|(
name|CamelContext
...
annotation|@
name|Override
DECL|method|putAll (Map<? extends TransformerKey, ? extends Transformer> map)
specifier|public
name|void
name|putAll
parameter_list|(
