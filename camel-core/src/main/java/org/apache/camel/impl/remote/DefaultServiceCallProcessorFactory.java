...
block|}
block|}
DECL|method|createProcessor ( String name, String component, String uri, ExchangePattern mep, Map<String, Object> parameters, ServiceCallLoadBalancer lb, ServiceCallServerListStrategy sl)
specifier|protected
name|Processor
name|createProcessor
parameter_list|(
