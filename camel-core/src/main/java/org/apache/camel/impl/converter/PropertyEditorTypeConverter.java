...
begin_comment
comment|/**  * Uses the {@link java.beans.PropertyEditor} conversion system to convert Objects to  * and from String values.  *  * @deprecated should be removed as it can cause side-effects when using 3rd party property editors  *  * @version   */
end_comment
