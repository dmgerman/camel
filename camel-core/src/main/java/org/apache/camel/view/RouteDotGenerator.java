...
expr_stmt|;
block|}
comment|/*         writer.print(r);         writer.print(" -> ");         if (r instanceof EventDrivenConsumerRoute) {             EventDrivenConsumerRoute consumerRoute = (EventDrivenConsumerRoute)r;             Processor p = consumerRoute.getProcessor();             writer.println(p);         } */
block|}
...
name|image
operator|=
literal|"http://www.enterpriseintegrationpatterns.com/img/MessageFilterIcon.gif"
expr_stmt|;
name|nodeData
operator|.
name|label
...
return|;
block|}
DECL|method|getImageUrl (ProcessorType node)
specifier|protected
name|String
name|getImageUrl
parameter_list|(
