...
begin_comment
comment|/**  * Represents a server that host a service for the Service Call EIP.  *  * @see ServiceCallServiceChooser  * @see ServiceCallServiceDiscovery  */
end_comment

begin_interface
DECL|interface|ServiceCallService
specifier|public
interface|interface
