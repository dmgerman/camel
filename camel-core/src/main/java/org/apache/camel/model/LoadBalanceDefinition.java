...
return|;
block|}
comment|/**      * Uses weighted load balancer      *      * @param roundRobin               used to set the processor selection algorithm.      * @param distributionRatioList    ArrayList<Long> of weighted ratios for distribution of messages.      * @return the builder      */
DECL|method|weighted (boolean roundRobin, ArrayList<Integer> distributionRatioList)
specifier|public
name|LoadBalanceDefinition
name|weighted
parameter_list|(
