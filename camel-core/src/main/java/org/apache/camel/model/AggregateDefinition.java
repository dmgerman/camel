...
return|;
block|}
DECL|method|getConfiguredScheduledExecutorService (RouteContext routeContext)
specifier|private
name|ScheduledExecutorService
name|getConfiguredScheduledExecutorService
parameter_list|(
...
parameter_list|)
block|{
comment|// TODO: maybe rather than this one-off method to support an executorService& scheduledExecutorService for the aggregator,
comment|// create ScheduledExecutorServiceAwareDefinition and the change other definitions that currently use ScheduledExecutorServices to
comment|// use that one instead of the more generic ExecutorServiceAwareDefinition
name|ScheduledExecutorService
name|answer
init|=
name|routeContext
