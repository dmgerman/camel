...
begin_comment
comment|/**  * Removes a named property from the message exchange  */
end_comment
...
name|FIELD
argument_list|)
DECL|class|RemovePropertyDefinition
specifier|public
class|class
...
name|propertyName
decl_stmt|;
DECL|method|RemovePropertyDefinition ()
specifier|public
name|RemovePropertyDefinition
parameter_list|()
block|{     }
DECL|method|RemovePropertyDefinition (String propertyName)
specifier|public
name|RemovePropertyDefinition
parameter_list|(
name|String
