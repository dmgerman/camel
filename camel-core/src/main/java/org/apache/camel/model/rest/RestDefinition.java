...
return|;
block|}
DECL|method|addApiRouteDefinition (CamelContext camelContext, List<RouteDefinition> answer, RestConfiguration configuration)
specifier|private
name|void
name|addApiRouteDefinition
parameter_list|(
