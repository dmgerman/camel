...
comment|// skip error handlers in on exception and try .. catch .. finally routes
if|if
condition|(
name|this
operator|instanceof
...
condition|)
block|{
comment|// also use error handler for on exception
name|Processor
name|errorHandler
init|=
...
condition|)
block|{
comment|// TODO: special error handler, where we have a local error handler with onlly the catch definitions
return|return
name|channel
return|;
block|}
