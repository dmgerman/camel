...
return|;
block|}
comment|/**      * Sends the exchange to the given endpoint using asynchronous mode.      *      * @param uri  the endpoint to send to      * @return the builder      * @see org.apache.camel.processor.SendAsyncProcessor      * @deprecated will be replaced with a new async routing engine in Camel 2.4      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Sends the exchange to the given endpoint using asynchronous mode.      *      * @param uri  the endpoint to send to      * @param poolSize the core pool size      * @return the builder      * @see org.apache.camel.processor.SendAsyncProcessor      * @deprecated will be replaced with a new async routing engine in Camel 2.4      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Sends the exchange to the given endpoint using asynchronous mode.      *      * @param endpoint  the endpoint to send to      * @return the builder      * @see org.apache.camel.processor.SendAsyncProcessor      * @deprecated will be replaced with a new async routing engine in Camel 2.4      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Sends the exchange to the given endpoint using asynchronous mode.      *      * @param endpoint  the endpoint to send to      * @param poolSize the core pool size      * @return the builder      * @see org.apache.camel.processor.SendAsyncProcessor      * @deprecated will be replaced with a new async routing engine in Camel 2.4      */
annotation|@
name|Deprecated
