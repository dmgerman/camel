...
return|;
block|}
comment|/**      *<a href="http://camel.apache.org/message-translator.html">Message Translator EIP:</a>      * Adds a bean which is invoked which could be a final destination, or could be a transformation in a pipeline      *      * @param bean  the bean to invoke      * @param method  the method name to invoke on the bean (can be used to avoid ambiguty)      * @param parameterType the method parameter type to invoke on the bean (can be used to avoid ambiguty)      * @return the builder      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
argument_list|)
DECL|method|bean (Object bean, String method, Class parameterType)
specifier|public
name|Type
name|bean
parameter_list|(
...
return|;
block|}
comment|/**      *<a href="http://camel.apache.org/message-translator.html">Message Translator EIP:</a>      * Adds a bean which is invoked which could be a final destination, or could be a transformation in a pipeline      *      * @param  beanType  the bean class, Camel will instantiate an object at runtime      * @param method  the method name to invoke on the bean (can be used to avoid ambiguty)      * @param parameterType the method parameter type to invoke on the bean (can be used to avoid ambiguty)      * @return the builder      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
argument_list|)
DECL|method|bean (Class beanType, String method, Class parameterType)
specifier|public
name|Type
name|bean
parameter_list|(
...
return|;
block|}
comment|/**      *<a href="http://camel.apache.org/message-translator.html">Message Translator EIP:</a>      * Adds a bean which is invoked which could be a final destination, or could be a transformation in a pipeline      *      * @param ref  reference to a bean to lookup in the registry      * @param method  the method name to invoke on the bean (can be used to avoid ambiguty)      * @param method  the method parameter type to invoke on the bean (can be used to avoid ambiguty)      * @return the builder      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
argument_list|)
DECL|method|beanRef (String ref, String method, Class parameterType)
specifier|public
name|Type
name|beanRef
parameter_list|(
