...
literal|"unchecked"
argument_list|)
DECL|method|pollEnrich (String resourceUri, long timeout, boolean pollMultiple)
specifier|public
name|Type
name|pollEnrich
parameter_list|(
