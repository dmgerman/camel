...
begin_comment
comment|/**  * Kubernetes remote service call configuration  */
end_comment
...
name|FIELD
argument_list|)
DECL|class|KubernetesConfigurationDefinition
specifier|public
class|class
...
name|trustCerts
decl_stmt|;
DECL|method|KubernetesConfigurationDefinition ()
specifier|public
name|KubernetesConfigurationDefinition
parameter_list|()
block|{     }
DECL|method|KubernetesConfigurationDefinition (ServiceCallDefinition parent)
specifier|public
name|KubernetesConfigurationDefinition
parameter_list|(
