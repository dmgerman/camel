...
block|}
block|}
DECL|method|initInterceptors (RouteDefinition route, List<ProcessorDefinition> upper, List<InterceptDefinition> intercepts, List<InterceptFromDefinition> interceptFromDefinitions, List<InterceptSendToEndpointDefinition> interceptSendToEndpointDefinitions)
specifier|private
specifier|static
name|void
name|initInterceptors
