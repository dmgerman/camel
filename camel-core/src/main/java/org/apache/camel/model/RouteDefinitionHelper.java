...
return|;
block|}
comment|/**      * Gather all the endpoint uri's the route is using from the EIPs that has a static or dynamic endpoint defined.      *      * @param route          the route      * @param includeInputs  whether to include inputs      * @param includeOutputs whether to include outputs      * @param includeDynamic whether to include dynamic outputs which has been in use during routing at runtime, gathered from the {@link org.apache.camel.spi.RuntimeEndpointRegistry}.      * @return the endpoints uris      */
DECL|method|gatherAllEndpointUris (CamelContext camelContext, RouteDefinition route, boolean includeInputs, boolean includeOutputs, boolean includeDynamic)
specifier|public
specifier|static
name|Set
argument_list|<
...
block|}
block|}
DECL|method|initRouteInputs (CamelContext camelContext, List<FromDefinition> inputs)
specifier|private
specifier|static
name|void
name|initRouteInputs
...
parameter_list|)
block|{
comment|// resolve property placeholders on route inputs which hasn't been done yet
for|for
control|(
name|FromDefinition
name|input
...
block|}
block|}
comment|/**      * Creates a route definition from uri.      *      * @param uri the uri      * @return the route definition      */
...
return|;
block|}
comment|/**      * Creates a route definition from endpoint.      *      * @param endpoint the endpoint      * @return the route definition      */
