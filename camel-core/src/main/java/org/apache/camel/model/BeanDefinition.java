...
expr_stmt|;
block|}
DECL|method|BeanDefinition (String ref, String method, Class<?> parameterType)
specifier|public
name|BeanDefinition
parameter_list|(
name|String
...
return|;
block|}
comment|/**      * Sets the Class of the method parameter that camel will call      *      * @param parameterType the Class of the method parameter      * @return the builder      */
DECL|method|parameterType (Class<?> parameterType)
specifier|public
name|BeanDefinition
name|parameterType
parameter_list|(
