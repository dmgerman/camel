...
return|;
block|}
comment|/**      * Sends the exchange with certain exchange pattern to the given endpoint      *      * @param uri  the endpoint to send to      * @return the builder      */
DECL|method|to (String uri, ExchangePattern ep)
specifier|public
name|Type
name|to
parameter_list|(
...
return|;
block|}
comment|/**      * Sends the exchange with certain exchange pattern to the given endpoint      *      * @param endpoint  the endpoint to send to      * @return the builder      */
DECL|method|to (Endpoint endpoint, ExchangePattern ep)
specifier|public
name|Type
name|to
parameter_list|(
...
return|;
block|}
comment|/**      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">ExchangePattern:</a>      * set the exchange's ExchangePattern {@link ExchangePattern} to be InOnly      *      * @param uri The endpoint uri which is used for sending the exchange      * @return the builder      */
...
return|;
block|}
comment|/**      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">ExchangePattern:</a>      * set the exchange's ExchangePattern {@link ExchangePattern} to be InOut      *      * @param uri The endpoint uri which is used for sending the exchange      * @return the builder      */
...
return|;
block|}
comment|/**      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">ExchangePattern:</a>      * set the exchange's ExchangePattern {@link ExchangePattern} to be InOnly      *      * @param uri The endpoint which is used for sending the exchange      * @return the builder      */
...
return|;
block|}
comment|/**      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">ExchangePattern:</a>      * set the exchange's ExchangePattern {@link ExchangePattern} to be InOut      *      * @param uri The endpoint which is used for sending the exchange      * @return the builder      */
