...
return|;
block|}
comment|/**      * Sends the message to the given endpoint using an      *<a href="http://activemq.apache.org/camel/event-message.html">Event Message</a> or      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">InOnly exchange pattern</a>      *      * @param uri The endpoint uri which is used for sending the exchange      * @return the builder      */
...
return|;
block|}
comment|/**      * Sends the message to the given endpoint using an      *<a href="http://activemq.apache.org/camel/event-message.html">Event Message</a> or       *<a href="http://activemq.apache.org/camel/exchange-pattern.html">InOnly exchange pattern</a>      *      * @param endpoint The endpoint which is used for sending the exchange      * @return the builder      */
...
return|;
block|}
comment|/**      * Sends the message to the given endpoints using an      *<a href="http://activemq.apache.org/camel/event-message.html">Event Message</a> or      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">InOnly exchange pattern</a>      *      * @param uris  list of endpoints to send to      * @return the builder      */
...
return|;
block|}
comment|/**      * Sends the message to the given endpoints using an      *<a href="http://activemq.apache.org/camel/event-message.html">Event Message</a> or      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">InOnly exchange pattern</a>      *      * @param endpoints  list of endpoints to send to      * @return the builder      */
...
return|;
block|}
comment|/**      * Sends the message to the given endpoint using an      *<a href="http://activemq.apache.org/camel/request-reply.html">Request Reply</a> or      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">InOut exchange pattern</a>      *      * @param uri The endpoint uri which is used for sending the exchange      * @return the builder      */
...
return|;
block|}
comment|/**      * Sends the message to the given endpoint using an      *<a href="http://activemq.apache.org/camel/request-reply.html">Request Reply</a> or      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">InOut exchange pattern</a>      *      * @param endpoint The endpoint which is used for sending the exchange      * @return the builder      */
...
return|;
block|}
comment|/**      * Sends the message to the given endpoints using an      *<a href="http://activemq.apache.org/camel/request-reply.html">Request Reply</a> or      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">InOut exchange pattern</a>      *      * @param uris  list of endpoints to send to      * @return the builder      */
...
return|;
block|}
comment|/**      * Sends the message to the given endpoints using an      *<a href="http://activemq.apache.org/camel/request-reply.html">Request Reply</a> or      *<a href="http://activemq.apache.org/camel/exchange-pattern.html">InOut exchange pattern</a>      *      * @param endpoints  list of endpoints to send to      * @return the builder      */
...
return|;
block|}
comment|/**      *<a href="http://activemq.apache.org/camel/resequencer.html">Resequencer EIP:</a>      * Creates a resequencer allowing you to reorganize messages based on some comparator.      *      * @return the expression clause for the expressions on which to compare messages in order      */
...
return|;
block|}
comment|/**      *<a href="http://activemq.apache.org/camel/resequencer.html">Resequencer EIP:</a>      * Creates a resequencer allowing you to reorganize messages based on some comparator.      *      * @param expression the expression on which to compare messages in order      * @return the builder      */
...
return|;
block|}
comment|/**      *<a href="http://activemq.apache.org/camel/resequencer.html">Resequencer EIP:</a>      * Creates a resequencer allowing you to reorganize messages based on some comparator.      *      * @param expressions the list of expressions on which to compare messages in order      * @return the builder      */
...
return|;
block|}
comment|/**      *<a href="http://activemq.apache.org/camel/aggregator.html">Aggregator EIP:</a>      * Creates an aggregator allowing you to combine a number of messages together into a single message.      *      * @return the expression clause to be used as builder to configure the correlation expression      */
