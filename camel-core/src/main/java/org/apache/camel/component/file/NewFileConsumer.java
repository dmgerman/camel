...
argument_list|>
block|{
DECL|method|NewFileConsumer (GenericFileEndpoint<File> endpoint, Processor processor, GenericFileOperations<File> operations)
specifier|public
name|NewFileConsumer
parameter_list|(
...
block|}
block|}
DECL|method|pollFile (String fileName, List<GenericFile<File>> fileList)
specifier|protected
name|void
name|pollFile
parameter_list|(
