...
begin_comment
comment|/**  * The<a href="http://camel.apache.org/jmx.html">JMX Component</a>  * for monitoring JMX attributes  *  * @version $Revision$  */
end_comment
...
parameter_list|()
block|{     }
DECL|method|JMXComponent (CamelContext context)
specifier|public
name|JMXComponent
parameter_list|(
name|CamelContext
