...
begin_comment
comment|/**  * The<a href="http://camel.apache.org/vm.html">VM component</a> is for asynchronous SEDA exchanges on a {@link BlockingQueue}  *  * @version  */
end_comment
...
expr_stmt|;
block|}
DECL|method|VmComponent (Class<? extends Endpoint> endpointClass)
specifier|public
name|VmComponent
parameter_list|(
name|Class
