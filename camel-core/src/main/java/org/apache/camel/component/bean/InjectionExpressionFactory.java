...
begin_comment
comment|/**  * A factory which creates an {@link Expression} object from an annotation on a field, property or method parameter  * of a specified type.  *  * @version $Revision: 1.1 $  */
end_comment

begin_interface
DECL|interface|InjectionExpressionFactory
specifier|public
interface|interface
