...
block|}
block|}
comment|/**      * Is the given file already in progress.      *      * @param target  the target file      * @param files   the list of files found in the current directory      * @return<tt>true</tt> if the file is already in progress      */
DECL|method|isInProgress (File target, File[] files)
specifier|protected
name|boolean
name|isInProgress
parameter_list|(
