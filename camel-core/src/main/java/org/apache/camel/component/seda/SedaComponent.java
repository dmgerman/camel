...
expr_stmt|;
block|}
comment|/**      * @deprecated use {@link #getOrCreateQueue(String, Integer, Boolean, BlockingQueueFactory)}      */
annotation|@
name|Deprecated
...
return|;
block|}
DECL|method|getOrCreateQueue (String uri, Integer size, Boolean multipleConsumers, BlockingQueueFactory customQueueFactory)
specifier|public
specifier|synchronized
name|QueueReference
name|getOrCreateQueue
