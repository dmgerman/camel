...
comment|// TODO: binding reverse only enabled if outType configured
comment|// TODO move consumer binding processor to this pacakge so they are both the same place
try|try
block|{
