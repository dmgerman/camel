...
argument_list|()
decl_stmt|;
comment|/**      * Registers a pojo and schedules the pojo for execution at the specified time. If the time is in the past, the task      * is scheduled for immediate execution.      *       * @param uri      * @param pojo      * @param schedule      * @throws IllegalArgumentException if<tt>time.getTime()</tt> is negative.      * @throws IllegalStateException if task was already scheduled or cancelled, timer was cancelled, or timer thread      *             terminated.      */
DECL|method|registerAndSchedulePojo (String uri,Object pojo,PollingSchedule schedule)
specifier|public
name|void
