...
argument_list|)
expr_stmt|;
comment|// no relative filename for absolute files
name|setRelativeFileName
argument_list|(
literal|null
argument_list|)
...
return|return;
block|}
comment|// the rest is complex relative path computation
name|setAbsolute
argument_list|(
literal|false
argument_list|)
...
condition|)
block|{
comment|// let java.io.File deal with it as its better than me
return|return
operator|new
name|File
argument_list|(
...
return|;
block|}
comment|// otherwise absolute is considered if we start with the separator
return|return
name|path
operator|.
name|startsWith
