...
block|}
comment|/**      * Bind this GenericFile to an Exchange      */
DECL|method|bindToExchange (Exchange exchange, boolean isProbeContentTypeFromEndpoint)
specifier|public
name|void
name|bindToExchange
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|commonBindToExchange (Exchange exchange)
specifier|private
name|GenericFileMessage
argument_list|<
name|T
...
return|;
block|}
DECL|method|setExtendedAttributes (Map<String, Object> extendedAttributes)
specifier|public
name|void
