...
return|;
block|}
DECL|method|isNestProperty (String uri, String prefixToken, String suffixToken)
specifier|private
name|boolean
name|isNestProperty
parameter_list|(
...
return|;
block|}
DECL|method|takeOffNestTokes (String uri, String prefixToken, String suffixToken)
specifier|private
name|String
name|takeOffNestTokes
parameter_list|(
name|String
name|uri
parameter_list|,
...
return|;
block|}
DECL|method|createPlaceholderPart (String key, Properties properties, List<String> replaced, String prefixToken, String suffixToken)
specifier|private
name|String
name|createPlaceholderPart
parameter_list|(
...
expr_stmt|;
block|}
comment|// we need to check if the propertyValue is nested
comment|// we need to check if there is cycle dependency of the nested properties
name|List
argument_list|<
name|String
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// need to take off the token first
name|String
name|value
init|=
name|takeOffNestTokes
