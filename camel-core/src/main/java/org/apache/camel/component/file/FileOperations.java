...
return|;
block|}
comment|// create directory one part of a time and set permissions
try|try
block|{
name|String
index|[]
...
name|GenericFileOperationFailedException
argument_list|(
literal|"Error setting chmod on directory: "
operator|+
name|dir
argument_list|,
name|e
...
argument_list|)
expr_stmt|;
comment|// set permissions if the chmod option was set
if|if
condition|(
name|ObjectHelper
operator|.
