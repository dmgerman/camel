...
condition|)
block|{
comment|// if the type starts with a quote, then its a parameter value instead
continue|continue;
block|}
...
argument_list|)
decl_stmt|;
comment|// class resolver will return null if not a class
if|if
condition|(
name|qualifyClass
operator|!=
...
block|}
block|}
comment|// maybe its a FQN for simple name
if|if
condition|(
name|qualifyType
operator|.
