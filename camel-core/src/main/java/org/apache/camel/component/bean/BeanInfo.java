...
expr_stmt|;
block|}
DECL|method|BeanInfo (CamelContext camelContext, Class<?> type, boolean voidAsInOnly)
specifier|public
name|BeanInfo
parameter_list|(
name|CamelContext
...
expr_stmt|;
block|}
DECL|method|BeanInfo (CamelContext camelContext, Class<?> type, ParameterMappingStrategy strategy, boolean voidAsInOnly)
specifier|public
name|BeanInfo
parameter_list|(
name|CamelContext
...
return|;
block|}
comment|/**      * Do we have an operation with the given name.      *<p/>      * Shorthand method names for getters is supported, so you can pass in eg 'name' and Camel      * will can find the real 'getName' method instead.      *      * @param methodName the method name      * @return<tt>true</tt> if we have such a method.      */
DECL|method|hasOperations (String methodName)
specifier|private
name|boolean
name|hasOperations
parameter_list|(
