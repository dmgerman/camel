...
return|;
block|}
comment|/**      * Lets try choose one of the available methods to invoke if we can match      * the message body to the body parameter      *      * @param pojo the bean to invoke a method on      * @param exchange the message exchange      * @param name an optional name of the method that must match, use<tt>null</tt> to indicate all methods      * @param parameterType an optional type of the method parameter that must match, use<tt>null</tt> to indicate all types      * @return the method to invoke or null if no definitive method could be matched      * @throws AmbiguousMethodCallException is thrown if cannot chose method due to ambiguous      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"rawtypes"
argument_list|)
DECL|method|chooseMethod (Object pojo, Exchange exchange, String name, Class parameterType)
specifier|protected
name|MethodInfo
name|chooseMethod
parameter_list|(
...
condition|)
block|{
comment|// filter all lists to only include methods with this argument type
name|removeNonMatchingMethods
argument_list|(
name|operationsWithHandlerAnnotation
argument_list|,
...
literal|"rawtypes"
argument_list|)
DECL|method|removeNonMatchingMethods (List<MethodInfo> methods, Class type)
specifier|private
specifier|static
name|void
name|removeNonMatchingMethods
...
condition|)
block|{
comment|// type does not match so remove it
name|it
operator|.
name|remove
argument_list|()
...
return|;
block|}
comment|/**      * Do we have a method with the given name.      *<p/>      * Shorthand method names for getters is supported, so you can pass in eg 'name' and Camel      * will can find the real 'getName' method instead.      *      * @param methodName the method name      * @param parameterTypes the parameter types      * @return<tt>true</tt> if we have such a method.      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"rawtypes"
argument_list|)
DECL|method|hasMethod (String methodName, List<Class> parameterTypes)
specifier|public
name|boolean
name|hasMethod
parameter_list|(
