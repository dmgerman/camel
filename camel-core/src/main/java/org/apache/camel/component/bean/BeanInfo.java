...
name|BeanInfo
block|{
DECL|field|BEAN_INFO_CACHE_REGISTRY_KEY
specifier|public
specifier|static
specifier|final
name|String
...
argument_list|)
expr_stmt|;
comment|// if the class is not public then fallback and use interface methods if possible
comment|// this allow Camel to invoke private beans which implements interfaces
name|List
argument_list|<
name|Method
argument_list|>
...
argument_list|)
decl_stmt|;
comment|// still keep non-accessible class methods to provide more specific Exception if method is non-accessible
name|interfaceMethods
operator|.
name|addAll
argument_list|(
...
name|strategyClass
decl_stmt|;
DECL|method|CacheKey (Class<?> type, Method explicitMethod, ParameterMappingStrategy strategy)
specifier|public
name|CacheKey
parameter_list|(
name|Class
