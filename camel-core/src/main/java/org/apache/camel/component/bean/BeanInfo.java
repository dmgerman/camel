...
return|;
block|}
comment|/**      * Lets try choose one of the available methods to invoke if we can match      * the message body to the body parameter      *      * @param pojo the bean to invoke a method on      * @param exchange the message exchange      * @param name an optional name of the method that must match, use<tt>null</tt> to indicate all methods      * @param type an optional type of the method parameter that must match, use<tt>null</tt> to indicate all types      * @return the method to invoke or null if no definitive method could be matched      * @throws AmbiguousMethodCallException is thrown if cannot chose method due to ambiguous      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"rawtypes"
argument_list|)
DECL|method|chooseMethod (Object pojo, Exchange exchange, String name, Class type)
specifier|protected
name|MethodInfo
name|chooseMethod
parameter_list|(
