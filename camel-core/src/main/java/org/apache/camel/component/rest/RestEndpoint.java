...
block|}
block|}
comment|// TODO: if api-doc is enabled then lookup that swagger factory and use it to create the producer using the factory
comment|// so we can lookup the operation and find its consumes/producers/and other details
if|if
condition|(
name|factory
operator|!=
