...
return|;
block|}
DECL|method|replaceByType (final RouteDefinition route, final Class type, final ProcessorDefinition replace)
specifier|public
specifier|static
name|AdviceWithTask
name|replaceByType
...
return|;
block|}
DECL|method|removeByType (final RouteDefinition route, final Class type)
specifier|public
specifier|static
name|AdviceWithTask
name|removeByType
...
return|;
block|}
DECL|method|beforeByType (final RouteDefinition route, final Class type, final ProcessorDefinition before)
specifier|public
specifier|static
name|AdviceWithTask
name|beforeByType
...
return|;
block|}
DECL|method|afterByType (final RouteDefinition route, final Class type, final ProcessorDefinition after)
specifier|public
specifier|static
name|AdviceWithTask
name|afterByType
