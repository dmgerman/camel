...
return|;
block|}
comment|/**      * Returns an expression processing the exchange to the given endpoint uri.      *      * @param uri   endpoint uri      * @return the builder      * @deprecated not in use, and not available in XML DSL      */
annotation|@
name|Deprecated
