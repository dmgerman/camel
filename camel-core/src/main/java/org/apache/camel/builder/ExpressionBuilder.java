...
DECL|method|regexTokenize (final Expression<E> expression, final String regexTokenizer)
specifier|public
specifier|static
parameter_list|<
name|E
...
return|;
block|}
DECL|method|getScanner (Expression expression, Exchange exchange, Object value)
specifier|private
specifier|static
name|Scanner
name|getScanner
...
DECL|method|regexReplaceAll (final Expression<E> expression, final String regex, final String replacement)
specifier|public
specifier|static
parameter_list|<
name|E
