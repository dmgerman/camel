...
return|;
block|}
comment|/**      * Returns an expression to lookup a key in the header which should be Map based.      *      * @param headerName the name of the header the expression will return      * @param keyName    the name of the key to lookup in the header value      * @return an expression object which will return the key value looked up in the header      */
DECL|method|headerAsMapExpression (final String headerName, final String keyName)
specifier|public
specifier|static
name|Expression
...
name|headerName
operator|+
literal|" cannot be converted to a Map on "
operator|+
name|this
argument_list|,
name|e
