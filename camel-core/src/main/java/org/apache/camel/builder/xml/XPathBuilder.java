...
name|objectModelUri
operator|+
literal|" when creating XPathFactory"
argument_list|)
expr_stmt|;
name|xpathFactory
operator|=
...
name|debug
argument_list|(
literal|"Creating default XPathFactory"
argument_list|)
expr_stmt|;
name|xpathFactory
operator|=
...
argument_list|()
decl_stmt|;
comment|// prefer to use InputSource for well known types
if|if
condition|(
name|in
operator|.
...
condition|)
block|{
comment|// special for streams so we can work with them out of the box
name|answer
operator|=
operator|new
name|InputSource
...
condition|)
block|{
comment|// special for String so we can work with them out of the box
name|answer
operator|=
operator|new
name|InputSource
...
expr_stmt|;
block|}
comment|// try to type convert to the desired type
name|Class
name|type
init|=
name|getDocumentType
