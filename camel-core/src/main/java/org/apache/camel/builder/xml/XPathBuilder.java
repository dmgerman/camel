...
parameter_list|)
block|{
comment|// only evaluate if there is some body
name|Object
name|answer
init|=
name|exchange
...
expr_stmt|;
block|}
comment|// let the type converter have a chance if we for example should convert to a boolean
comment|// which a null body will result in false
if|if
condition|(
name|resultType
operator|!=
...
name|debug
argument_list|(
literal|"Could not evaluate XPath as Exchange cannot be converted to a Document: "
operator|+
name|exchange
operator|+
