...
begin_comment
comment|/**  * A builder of a number of different {@link Processor} implementations  */
end_comment
...
return|;
block|}
comment|/**      * Removes the properties on the exchange      */
DECL|method|removeProperties (final String pattern)
specifier|public
specifier|static
name|Processor
...
return|;
block|}
comment|/**      * Removes all properties on the exchange, except for the ones provided in the<tt>names</tt> parameter      */
DECL|method|removeProperties (final String pattern, final String... exceptionPatterns)
specifier|public
specifier|static
name|Processor
name|removeProperties
