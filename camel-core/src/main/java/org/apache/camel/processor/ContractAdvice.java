...
condition|)
block|{
comment|// use body class as a from type, or do nothing with assuming it's already in expected shape
name|applyTransformerByClass
argument_list|(
name|message
argument_list|,
name|to
...
return|;
block|}
DECL|method|applyTransformerByClass (Message message, DataType to)
specifier|private
name|boolean
name|applyTransformerByClass
parameter_list|(
