...
begin_comment
comment|/**  * A {@code CamelInternalProcessorAdvice} which performs Transformation and Validation  * according to the data type Contract.  *   * @see CamelInternalProcessor, CamelInternalProcessorAdvice  */
end_comment
...
comment|// It means if 'to' is other than Java, it's assumed to be already in expected shape.
