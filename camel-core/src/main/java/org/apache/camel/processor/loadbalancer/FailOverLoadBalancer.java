...
return|;
block|}
DECL|method|processExchange (final int index, final Exchange exchange, final AsyncCallback callback)
specifier|public
name|boolean
name|processExchange
parameter_list|(
...
parameter_list|)
block|{
comment|// check the exchange and call the FailOverProcessor
if|if
condition|(
name|isCheckedException
argument_list|(
