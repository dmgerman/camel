...
condition|)
block|{
comment|// non grouped so process the exchange one at a time
name|processExchange
argument_list|(
name|exchange
argument_list|)
...
block|{
comment|// grouped so add all exchanges into one group
if|if
condition|(
name|grouped
operator|==
...
block|}
block|}
comment|// and after adding process the single grouped exchange
if|if
condition|(
name|grouped
operator|!=
