...
expr_stmt|;
block|}
DECL|method|Splitter (Expression expression, Processor destination, AggregationStrategy aggregationStrategy, boolean parallelProcessing, ThreadPoolExecutor threadPoolExecutor)
specifier|public
name|Splitter
parameter_list|(
name|Expression
