...
name|corsHeaders
decl_stmt|;
DECL|method|RestBindingProcessor (DataFormat jsonDataFormat, DataFormat xmlDataFormat, DataFormat outJsonDataFormat, DataFormat outXmlDataFormat, String consumes, String produces, String bindingMode, boolean skipBindingOnErrorCode, boolean enableCORS, Map<String, String> corsHeaders)
specifier|public
name|RestBindingProcessor
parameter_list|(
name|DataFormat
