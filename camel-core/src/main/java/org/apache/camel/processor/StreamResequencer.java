...
expr_stmt|;
block|}
comment|/**      * Loops over {@link #processExchange()}.      */
DECL|method|run ()
specifier|public
name|void
name|run
...
block|}
block|}
comment|/**      * Processes an exchange received from the this resequencer's      *<code>endpoint</code>. Received exchanges are processed via      * {@link ResequencerEngine#insert(Object)}.      * {@link ResequencerEngine#deliver()} is then called in any case regardless      * whether a message was received or receiving timed out.      *       * @throws Exception      *             if exchange delivery fails.      */
DECL|method|processExchange ()
specifier|protected
name|void
name|processExchange
parameter_list|()
