...
decl_stmt|;
comment|// (throttling grouping) defaulted as 1 because there will be only one queue which is similar to implementation
comment|// when there is no grouping for throttling
DECL|field|NO_CORRELATION_QUEUE_ID
specifier|private
specifier|static
specifier|final
name|Integer
name|NO_CORRELATION_QUEUE_ID
init|=
operator|new
name|Integer
argument_list|(
...
decl_stmt|;
comment|// below 2 fields added for (throttling grouping)
...
block|}
block|}
DECL|method|locateDelayQueue (final Exchange exchange, final boolean doneSync)
specifier|private
name|DelayQueue
argument_list|<
name|ThrottlePermit
...
DECL|method|enqueuePermit (final ThrottlePermit permit, final Exchange exchange, final boolean doneSync)
specifier|protected
name|void
name|enqueuePermit
parameter_list|(
...
DECL|method|calculateAndSetMaxRequestsPerPeriod (final Exchange exchange, final boolean doneSync)
specifier|protected
name|void
name|calculateAndSetMaxRequestsPerPeriod
parameter_list|(
