...
literal|true
decl_stmt|;
DECL|method|Throttler (final CamelContext camelContext, final Processor processor, final Expression maxRequestsPerPeriodExpression, final long timePeriodMillis, final ExecutorService asyncExecutor, final boolean shutdownAsyncExecutor, final boolean rejectExecution)
specifier|public
name|Throttler
parameter_list|(
specifier|final
...
DECL|method|enqueuePermit (final ThrottlePermit permit, final Exchange exchange)
specifier|protected
name|void
name|enqueuePermit
parameter_list|(
