...
argument_list|)
decl_stmt|;
comment|// TODO: Support exchange headers for wait and timeout values, see Exchange constants
if|if
condition|(
name|waitTaskComplete
condition|)
...
argument_list|()
decl_stmt|;
comment|// if we are out capable then set the response on the original exchange
if|if
condition|(
name|ExchangeHelper
operator|.
