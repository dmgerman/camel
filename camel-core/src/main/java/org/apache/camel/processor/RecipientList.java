...
return|;
block|}
DECL|method|sendToRecipientList (Exchange exchange, Object routingSlip)
specifier|public
name|boolean
name|sendToRecipientList
parameter_list|(
...
parameter_list|)
block|{
comment|// this method is invoked from @RecipientList so we bridge with an empty callback
comment|// TODO: Have @RecipientList support async out of the box
return|return
name|sendToRecipientList
argument_list|(
name|exchange
