...
block|}
block|}
comment|/**      * Task for sleeping during redelivery attempts.      *<p/>      * This task is for the synchronous blocking. If using async delayed then a scheduled thread pool      * is used for sleeping and trigger redeliveries.      */
DECL|class|RedeliverSleepTask
specifier|private
specifier|final
class|class
name|RedeliverSleepTask
block|{
DECL|field|policy
specifier|private
specifier|final
...
name|delay
decl_stmt|;
DECL|method|RedeliverSleepTask (RedeliveryPolicy policy, long delay)
name|RedeliverSleepTask
parameter_list|(
name|RedeliveryPolicy
name|policy
