...
name|msg
init|=
literal|"DeadLetterChannel failed processing exchange due new exception: "
operator|+
name|newException
operator|.
name|getMessage
argument_list|()
operator|+
literal|". This new exception is handled and ignored. The option deadLetterChannelHandleNewException can be turned off to not handle new exceptions"
decl_stmt|;
name|logFailedDelivery
argument_list|(
literal|false
