...
begin_comment
comment|/**  * Base redeliverable error handler that also suppors a final dead letter queue in case  * all redelivery attempts fail.  *<p/>  * This implementation should contain all the error handling logic and the sub classes  * should only configure it according to what they support.  *  * @version $Revision$  */
end_comment
