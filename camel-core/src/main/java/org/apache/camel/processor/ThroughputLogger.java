...
expr_stmt|;
block|}
DECL|method|ThroughputLogger (String logName, LoggingLevel level, Integer groupSize)
specifier|public
name|ThroughputLogger
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|ThroughputLogger (CamelContext camelContext, String logName, LoggingLevel level, Long groupInterval, Long groupDelay, Boolean groupActiveOnly)
specifier|public
name|ThroughputLogger
parameter_list|(
name|CamelContext
