...
block|}
block|}
comment|/**      * Advice for data type contract      * TODO add declarative validation      */
...
condition|)
block|{
comment|// Applying exactly matched transformer. Java-Java transformer is also allowed.
name|LOG
operator|.
name|debug
argument_list|(
...
condition|)
block|{
comment|// Java->Java transformation just relies on TypeConverter if no declared transformer
comment|// TODO for better performance it may be better to add TypeConveterTransformer
comment|// into transformer registry to avoid unnecessary scan in transformer registry
name|LOG
operator|.
name|debug
argument_list|(
...
block|{
comment|// Java->Other transformation
name|transformer
operator|=
name|context
operator|.
...
condition|)
block|{
comment|// Other->Java transformation
name|transformer
operator|=
name|context
operator|.
...
block|{
comment|// Other->Other transformation - look for a transformer chain
name|Transformer
