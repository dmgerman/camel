...
block|}
block|}
DECL|method|normalizeDistributionListAgainstProcessors (List<Processor> processors)
specifier|protected
name|void
...
name|warn
argument_list|(
literal|"Listed Load Balance Processors do not match distributionRatio. Best Effort distribution will be attempted"
argument_list|)
expr_stmt|;
name|LOG
operator|.
...
argument_list|()
operator|+
literal|". Number of DistibutionRatioList elements: "
operator|+
name|getDistributionRatioList
argument_list|()
operator|.
