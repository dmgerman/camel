...
name|warn
argument_list|(
literal|"Error stopping DeadLetterChannel error handler on routing slip. This exception is ignored."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// stop error handler if we completed synchronously
if|if
condition|(
name|answer
condition|)
