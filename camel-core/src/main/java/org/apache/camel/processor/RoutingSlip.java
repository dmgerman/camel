...
argument_list|()
decl_stmt|;
comment|/**      * Class that represents prepared fine grained error handlers when processing routingslip/dynamic-router exchanges      *<p/>      * This is similar to how multicast processor does.      */
...
name|debug
argument_list|(
literal|"RoutingSlip {} is not using ProducerCache"
argument_list|,
name|this
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"RoutingSlip {} using ProducerCache with default cache size"
argument_list|,
name|this
argument_list|)
expr_stmt|;
