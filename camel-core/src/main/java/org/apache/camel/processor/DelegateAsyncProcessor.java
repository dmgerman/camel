...
begin_comment
comment|/**  * A Delegate pattern which delegates processing to a nested {@link AsyncProcessor} which can  * be useful for implementation inheritance when writing an {@link org.apache.camel.spi.Policy}  *<p/>  *<b>Important:</b> This implementation<b>does</b> support the asynchronous routing engine.  * If you are implementing a EIP pattern please use this as the delegate.  *  * @version  * @see DelegateSyncProcessor  * @see org.apache.camel.processor.DelegateProcessor  */
end_comment
...
argument_list|)
decl_stmt|;
comment|// call the asynchronous method and wait for it to be done
name|boolean
name|sync
init|=
name|process
