...
name|Exception
block|{
comment|// cannot poll a file endpoint if already consuming from a file endpoint (CAMEL-1895)
if|if
condition|(
name|consumer
operator|instanceof
