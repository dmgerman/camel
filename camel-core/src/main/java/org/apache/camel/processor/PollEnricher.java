...
expr_stmt|;
block|}
comment|/**      * Creates a new {@link PollEnricher}.      *      * @param aggregationStrategy  aggregation strategy to aggregate input data and additional data.      * @param consumer consumer to resource endpoint.      * @param timeout timeout in millis      * @param pollMultiple enabled building a List of multiple exchanges      */
DECL|method|PollEnricher (AggregationStrategy aggregationStrategy, PollingConsumer consumer, long timeout, Boolean pollMultiple)
specifier|public
name|PollEnricher
parameter_list|(
name|AggregationStrategy
...
expr_stmt|;
block|}
DECL|method|setPollMultiple (Boolean value)
specifier|public
name|void
...
name|debug
argument_list|(
literal|"Polling Consumer receiveNoWait: {}"
argument_list|,
name|consumer
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Polling Consumer receive with timeout: {} ms. {}"
argument_list|,
name|timeout
argument_list|,
name|consumer
