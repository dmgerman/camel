...
name|aggregated
decl_stmt|;
DECL|method|ParallelAggregateTask (AtomicExchange result, Exchange subExchange, AtomicInteger aggregated)
specifier|private
name|ParallelAggregateTask
parameter_list|(
name|AtomicExchange
...
name|timedOut
decl_stmt|;
DECL|method|ParallelAggregateTimeoutTask (Exchange original, AtomicExchange result, CompletionService<Exchange> completion, AtomicInteger aggregated, AtomicInteger total, AtomicBoolean timedOut)
specifier|private
name|ParallelAggregateTimeoutTask
parameter_list|(
name|Exchange
