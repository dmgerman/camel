...
condition|)
block|{
comment|// TODO: refactor into smaller methods
comment|// TODO: add code comments about why we do this
name|boolean
name|trace
init|=
literal|true
...
argument_list|)
expr_stmt|;
comment|// log and trace the processor that was onException so we can see it
name|logExchange
argument_list|(
name|exchange
argument_list|)
...
condition|)
block|{
comment|// we should trace the onCompletion route
name|int
name|index
init|=
name|tuow
...
argument_list|)
expr_stmt|;
comment|// log and trace the processor that was onCompletion so we can see it
name|logExchange
argument_list|(
name|exchange
argument_list|)
