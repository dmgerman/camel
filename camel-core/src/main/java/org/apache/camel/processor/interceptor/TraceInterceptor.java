...
comment|// add the onCompletion and then the processor that is invoked next
if|if
condition|(
operator|!
operator|(
...
condition|)
block|{
comment|// only and on completion once when we start the on completion routing
name|traced
operator|.
name|addTraced
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// add the next processor as well
name|traced
operator|.
name|addTraced
argument_list|(
...
block|{
comment|// regular during on completion so add it
name|traced
operator|.
name|addTraced
argument_list|(
