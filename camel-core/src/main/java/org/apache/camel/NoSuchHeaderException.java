...
begin_comment
comment|/**  * An exception caused when a mandatory header is not available on a message  * {@link Exchange}  *  * @see org.apache.camel.util.ExchangeHelper#getMandatoryHeader(Exchange, String, Class)  *  * @version   */
end_comment
