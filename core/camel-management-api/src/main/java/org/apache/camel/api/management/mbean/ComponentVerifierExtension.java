...
begin_class
DECL|class|ComponentVerifierExtension
specifier|public
specifier|final
class|class
name|ComponentVerifierExtension
...
name|UNSUPPORTED
block|}
comment|/**          * Scope of the verification. This is the scope given to the call to {@link ManagedComponentMBean#verify(String, Map)}  and          * can be used for correlation.          *          * @return the scope against which the parameters have been validated.          */
...
parameter_list|()
function_decl|;
comment|/**          * A set of input parameter names which fails the verification. These are keys to the parameter provided          * to {@link ManagedComponentMBean#verify(String, Map)}.          *          * @return the parameter names which are malformed and caused the failure of the validation          */
...
decl_stmt|;
block|}
comment|/**          * Interface defining an attribute which is a key for the detailed error messages.          */
