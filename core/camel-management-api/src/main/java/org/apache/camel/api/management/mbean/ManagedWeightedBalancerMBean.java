...
begin_interface
DECL|interface|ManagedWeightedBalancerMBean
specifier|public
interface|interface
...
name|description
operator|=
literal|"The distribution ratio of integer weights separated by delimiters for example '2,3,5'"
argument_list|)
