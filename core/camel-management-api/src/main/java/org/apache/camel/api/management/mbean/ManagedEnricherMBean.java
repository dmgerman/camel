...
begin_interface
DECL|interface|ManagedEnricherMBean
specifier|public
interface|interface
...
name|description
operator|=
literal|"Expression that computes the endpoint uri to use as the resource endpoint to enrich from"
argument_list|,
name|mask
operator|=
literal|true
...
name|description
operator|=
literal|"Statistics of the endpoints that has been enriched from"
argument_list|)
