...
begin_interface
DECL|interface|ManagedStickyLoadBalancerMBean
specifier|public
interface|interface
name|ManagedStickyLoadBalancerMBean
extends|extends
...
name|description
operator|=
literal|"The correlation expression to use to calculate the correlation key"
argument_list|)
