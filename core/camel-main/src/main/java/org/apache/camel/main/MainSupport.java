...
argument_list|)
expr_stmt|;
comment|// additional advanced configuration which is not configured using DefaultConfigurationProperties
...
DECL|method|afterPropertiesSet (Registry registry, CamelContext camelContext)
specifier|static
name|void
name|afterPropertiesSet
parameter_list|(
