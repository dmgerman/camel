...
expr_stmt|;
block|}
comment|// TODO: Log which options was not set
block|}
...
expr_stmt|;
block|}
comment|// TODO: Better error if setting some property fails
for|for
control|(
name|PropertyOptionKey
name|pok
...
name|warn
argument_list|(
literal|"Property not auto configured: {}={} on object: {}"
argument_list|,
name|pok
operator|.
name|getKey
...
expr_stmt|;
block|}
DECL|method|setPropertiesOnTarget (CamelContext context, Object target, Map<String, Object> properties, boolean failIfNotSet, boolean ignoreCase)
specifier|private
specifier|static
name|boolean
name|setPropertiesOnTarget
...
name|instance
decl_stmt|;
DECL|method|PropertyOptionKey (String key, Object instance)
specifier|private
name|PropertyOptionKey
parameter_list|(
name|String
