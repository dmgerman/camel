...
begin_comment
comment|/**  * An {@link org.apache.camel.language.xtokenizer.XMLTokenizeLanguage} based iterator.  */
end_comment
...
expr_stmt|;
block|}
DECL|method|XMLTokenExpressionIterator (String headerName, String path, char mode, int group)
specifier|public
name|XMLTokenExpressionIterator
parameter_list|(
name|String
