...
argument_list|()
expr_stmt|;
comment|// wait for breakpoint at bar
name|await
argument_list|()
operator|.
name|atMost
...
specifier|public
name|void
name|testBacklogDebuggerUpdateBodyAndHeader
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// update body and header
name|mbeanServer
operator|.
name|invoke
argument_list|(
name|on
argument_list|,
literal|"setMessageBodyOnBreakpoint"
argument_list|,
operator|new
name|Object
index|[]
...
name|on
argument_list|,
literal|"setMessageHeaderOnBreakpoint"
argument_list|,
operator|new
name|Object
index|[]
...
name|assertTrue
argument_list|(
literal|"Should contain our added header"
argument_list|,
name|xml
operator|.
name|contains
argument_list|(
literal|"<header key=\"beer\" type=\"java.lang.String\">Carlsberg</header>"
argument_list|)
argument_list|)
expr_stmt|;
name|resetMocks
...
specifier|public
name|void
name|testBacklogDebuggerUpdateBodyAndHeaderType
parameter_list|()
throws|throws
name|Exception
block|{
...
name|contains
argument_list|(
literal|"<header key=\"beer\" type=\"java.lang.Integer\">123</header>"
argument_list|)
argument_list|)
expr_stmt|;
name|resetMocks
...
specifier|public
name|void
name|testBacklogDebuggerRemoveBodyAndHeader
parameter_list|()
throws|throws
name|Exception
block|{
...
name|on
argument_list|,
literal|"removeMessageBodyOnBreakpoint"
argument_list|,
operator|new
name|Object
index|[]
...
name|on
argument_list|,
literal|"removeMessageHeaderOnBreakpoint"
argument_list|,
operator|new
name|Object
index|[]
...
name|assertTrue
argument_list|(
literal|"Should not contain our body"
argument_list|,
name|xml
operator|.
name|contains
argument_list|(
literal|"<body>[Body is null]</body>"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|assertFalse
argument_list|(
literal|"Should not contain any headers"
argument_list|,
name|xml
operator|.
name|contains
...
argument_list|)
expr_stmt|;
comment|// validate conditional breakpoint (mistake on purpose)
name|Object
name|out
init|=
name|mbeanServer
...
name|on
argument_list|,
literal|"validateConditionalBreakpoint"
argument_list|,
operator|new
name|Object
index|[]
...
name|startsWith
argument_list|(
literal|"Invalid syntax ${body contains 'Camel'"
argument_list|)
argument_list|)
expr_stmt|;
comment|// validate conditional breakpoint (is correct)
name|out
operator|=
name|mbeanServer
operator|.
...
argument_list|)
expr_stmt|;
comment|// should no longer be in step mode
name|stepMode
operator|=
operator|(
name|Boolean
...
specifier|public
name|void
name|testBacklogDebuggerStepCurrentNode
parameter_list|()
throws|throws
name|Exception
block|{
