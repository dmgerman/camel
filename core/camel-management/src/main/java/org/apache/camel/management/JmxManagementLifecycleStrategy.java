...
begin_class
DECL|class|JmxManagementLifecycleStrategy
specifier|public
class|class
...
name|camelContext
decl_stmt|;
DECL|field|camelContextMBean
specifier|private
specifier|volatile
name|ManagedCamelContext
name|camelContextMBean
decl_stmt|;
...
argument_list|()
decl_stmt|;
DECL|field|managedBacklogTracers
specifier|private
specifier|final
name|Map
argument_list|<
...
argument_list|()
decl_stmt|;
DECL|field|managedBacklogDebuggers
specifier|private
specifier|final
name|Map
argument_list|<
...
argument_list|()
decl_stmt|;
DECL|method|JmxManagementLifecycleStrategy ()
specifier|public
name|JmxManagementLifecycleStrategy
parameter_list|()
block|{     }
DECL|method|JmxManagementLifecycleStrategy (CamelContext camelContext)
specifier|public
name|JmxManagementLifecycleStrategy
parameter_list|(
name|CamelContext
...
name|warn
argument_list|(
literal|"Could not register CamelHealth MBean. This exception will be ignored."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Could not register RouteController MBean. This exception will be ignored."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Could not unregister RouteController MBean"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Could not unregister CamelHealth MBean"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// special for backlog tracer
name|BacklogTracer
name|backlogTracer
init|=
operator|(
...
condition|)
block|{
comment|// special for backlog debugger
name|BacklogDebugger
name|backlogDebugger
init|=
operator|(
...
condition|)
block|{
comment|// we need to wrap the counter with the camel context so we get stats updated on the context as well
if|if
condition|(
name|camelContextMBean
operator|!=
...
block|}
block|}
DECL|method|registerPerformanceCounters (RouteContext routeContext, ProcessorDefinition<?> processor, Map<NamedNode, PerformanceCounter> registeredCounters)
specifier|private
name|void
name|registerPerformanceCounters
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// defer starting the timer manager until CamelContext has been fully started
name|camelContext
operator|.
...
expr_stmt|;
block|}
DECL|class|TimerListenerManagerStartupListener
specifier|private
specifier|final
class|class
name|TimerListenerManagerStartupListener
