...
begin_class
DECL|class|ManagedRouteRemoveWireTapTest
specifier|public
class|class
name|ManagedRouteRemoveWireTapTest
extends|extends
...
argument_list|)
expr_stmt|;
comment|// and a number of thread pools
name|Set
argument_list|<
name|ObjectName
argument_list|>
...
name|assertTrue
argument_list|(
literal|"Should have a wire tap thread pool"
argument_list|,
name|wireTap
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// and a thread pool less
name|set
operator|=
name|mbeanServer
operator|.
