...
begin_class
DECL|class|ManagedProcessTest
specifier|public
class|class
name|ManagedProcessTest
extends|extends
...
annotation|@
name|Test
DECL|method|testManageProcess ()
specifier|public
name|void
name|testManageProcess
parameter_list|()
throws|throws
name|Exception
block|{
...
name|on
argument_list|,
literal|"ProcessorClassName"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
literal|"org.apache.camel.management.MyDummyProcessor"
argument_list|,
name|processorClassName
argument_list|)
expr_stmt|;
