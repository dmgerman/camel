...
argument_list|)
expr_stmt|;
comment|// is disabled by default
name|Boolean
name|enabled
init|=
operator|(
...
argument_list|)
expr_stmt|;
comment|// need to enable statistics
name|mbeanServer
operator|.
name|setAttribute
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// we have more than 150 converters out of the box
name|Integer
name|converters
init|=
operator|(
...
name|name
argument_list|,
literal|"NumberOfTypeConverters"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
literal|"Should be more than 150 converters, was: "
operator|+
name|converters
argument_list|,
name|converters
...
name|assertTrue
argument_list|(
literal|"Should have type converter"
argument_list|,
name|has
operator|.
name|booleanValue
...
name|assertFalse
argument_list|(
literal|"Should not have type converter"
argument_list|,
name|has
operator|.
name|booleanValue
