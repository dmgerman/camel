...
name|engine
operator|.
name|DefaultPackageScanResourceResolver
import|;
end_import
...
name|engine
operator|.
name|PropertiesComponentFactoryResolver
import|;
end_import
...
annotation|@
name|Override
DECL|method|createPropertiesComponent ()
specifier|protected
name|PropertiesComponent
...
annotation|@
name|Override
DECL|method|createPackageScanResourceResolver ()
specifier|protected
name|PackageScanResourceResolver
name|createPackageScanResourceResolver
parameter_list|()
block|{
return|return
operator|new
...
annotation|@
name|Override
DECL|method|createBeanIntrospection ()
specifier|protected
name|BeanIntrospection
name|createBeanIntrospection
parameter_list|()
block|{
return|return
operator|new
