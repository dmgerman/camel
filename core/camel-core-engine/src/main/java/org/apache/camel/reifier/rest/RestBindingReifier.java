...
return|;
block|}
DECL|method|setupJson (CamelContext context, RestConfiguration config, String type, String outType, DataFormat json, DataFormat outJson)
specifier|protected
name|void
name|setupJson
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|setupJaxb (CamelContext context, RestConfiguration config, String type, String outType, DataFormat jaxb, DataFormat outJaxb)
specifier|protected
name|void
name|setupJaxb
parameter_list|(
