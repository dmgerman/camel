...
parameter_list|>
block|{
comment|// Implementation detail: We must use the specific model.language.xxx
comment|// classes to make the DSL use these specific types
comment|// which ensures that the route model dumped as XML uses these types, eg
comment|//<header> instead of<language name="header"> etc.
DECL|field|result
specifier|private
name|T
name|result
...
parameter_list|()
block|{
comment|// reuse simple as this allows the model to represent this as a known
comment|// JAXB type
return|return
name|expression
argument_list|(
...
return|;
block|}
comment|/**      * Evaluates a token expression on the given header      *      * @param token the token      * @param headerName name of header to tokenize      * @param regex whether the token is a regular expression or not      * @param group to group by number of parts      * @param groupDelimiter delimiter to use when grouping      * @param skipFirst whether to skip the very first element      * @return the builder to continue processing the DSL      */
DECL|method|tokenize (String token, String headerName, boolean regex, String group, String groupDelimiter, boolean skipFirst)
specifier|public
name|T
name|tokenize
parameter_list|(
