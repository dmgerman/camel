...
literal|false
function_decl|;
comment|/**      * Sets the maximum size used by the {@link org.apache.camel.spi.ProducerCache} which is used      * to cache and reuse producers when using this routing slip, when uris are reused.      */
