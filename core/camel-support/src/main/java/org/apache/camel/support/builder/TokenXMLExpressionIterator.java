...
literal|"<*>"
decl_stmt|;
DECL|field|NAMESPACE_SEPERATOR
specifier|private
specifier|static
specifier|final
name|String
...
name|rootTokenNamespaces
operator|=
name|getNamespacesFromNamespaceTokenSplitter
argument_list|(
name|scanner
operator|.
...
argument_list|)
decl_stmt|;
comment|// build result with inherited namespaces and skip the prefixes that are declared within the child itself.
name|next
operator|=
name|sb
operator|.
...
name|append
argument_list|(
name|getMissingInherritNamespaces
argument_list|(
name|head
argument_list|)
argument_list|)
...
return|;
block|}
DECL|method|getMissingInherritNamespaces (final String text)
specifier|private
name|String
name|getMissingInherritNamespaces
parameter_list|(
...
literal|true
expr_stmt|;
comment|// already existing namespace in child were found we need a separator, so we set first = false
if|if
condition|(
name|first
condition|)
...
return|;
block|}
DECL|method|getNamespacesFromNamespaceTokenSplitter (final String text)
specifier|private
name|String
index|[]
name|getNamespacesFromNamespaceTokenSplitter
