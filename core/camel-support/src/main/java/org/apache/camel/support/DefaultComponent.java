...
decl_stmt|;
DECL|field|componentPropertyConfigurer
specifier|private
specifier|volatile
name|GeneratedPropertyConfigurer
name|componentPropertyConfigurer
decl_stmt|;
DECL|field|endpointPropertyConfigurer
specifier|private
specifier|volatile
name|GeneratedPropertyConfigurer
...
expr_stmt|;
block|}
comment|// extract these global options and infer their value based on global/component level configuration
name|boolean
name|basic
init|=
...
argument_list|)
expr_stmt|;
comment|// and setup those global options afterwards
if|if
condition|(
name|endpoint
operator|instanceof
...
expr_stmt|;
block|}
comment|// configure remainder of the parameters
name|endpoint
operator|.
...
name|trace
argument_list|(
literal|"Discovering optional component property configurer class for component: {}"
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Discovered component property configurer: {} -> {}"
argument_list|,
name|name
argument_list|,
name|componentPropertyConfigurer
...
name|trace
argument_list|(
literal|"Discovering optional endpoint property configurer class for component: {}"
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Discovered endpoint property configurer: {} -> {}"
argument_list|,
name|name
argument_list|,
name|endpointPropertyConfigurer
