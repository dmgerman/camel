...
name|Exception
block|{
comment|// does the property name include a mapped key, then we need to set the property as a map
if|if
condition|(
name|name
operator|.
...
condition|)
block|{
comment|// it was supposed to be a map, but its null, so lets create a new map and set it automatically
name|obj
operator|=
operator|new
name|LinkedHashMap
...
name|name
operator|+
literal|" as a Map because target bean is not a Map: "
operator|+
name|target
argument_list|)
throw|;
