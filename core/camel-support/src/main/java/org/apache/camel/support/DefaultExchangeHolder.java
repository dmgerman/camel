...
return|;
block|}
comment|/**      * Creates a payload object with the information from the given exchange.      *      * @param exchange the exchange, must<b>not</b> be<tt>null</tt>      * @param includeProperties whether or not to include exchange properties      * @param allowSerializedHeaders whether or not to include serialized headers      * @param preserveExchangeId whether to preserve exchange id      * @return the holder object with information copied form the exchange      */
DECL|method|marshal (Exchange exchange, boolean includeProperties, boolean allowSerializedHeaders, boolean preserveExchangeId)
specifier|public
specifier|static
name|DefaultExchangeHolder
name|marshal
