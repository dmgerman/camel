...
decl_stmt|;
return|return
name|doAutowireInterfacePropertiesFromClasspath
argument_list|(
name|camelContext
argument_list|,
name|target
...
condition|)
block|{
comment|// do classpath scanning (TODO: do this only once)
name|Set
argument_list|<
name|String
argument_list|>
...
argument_list|()
decl_stmt|;
comment|// get all JARs on classpath
name|String
name|cp
init|=
name|System
...
block|{
comment|// its a directory such as target, then traverse and find all directory
name|gatherAllDirectories
argument_list|(
operator|new
name|File
argument_list|(
...
specifier|static
name|boolean
name|validPackageForClassloader
parameter_list|(
name|String
name|packageName
parameter_list|,
