...
expr_stmt|;
block|}
DECL|method|configureScheduledPollConsumerProperties (Map<String, Object> options)
specifier|protected
name|void
name|configureScheduledPollConsumerProperties
parameter_list|(
...
block|}
block|}
DECL|method|doConfigureConsumer (Consumer consumer)
specifier|protected
name|void
name|doConfigureConsumer
parameter_list|(
