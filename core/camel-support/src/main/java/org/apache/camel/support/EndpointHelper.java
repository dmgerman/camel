...
name|Exception
block|{
comment|// TODO: Use more advanced bindingDefaultComponentReferencePropertiesTes
...
argument_list|)
expr_stmt|;
comment|//IntrospectionSupport.setProperties(context.getTypeConverter(), bean, parameters);
block|}
