...
argument_list|>
block|{
DECL|method|CaffeineLRUSoftCache (int maximumCacheSize)
specifier|public
name|CaffeineLRUSoftCache
parameter_list|(
name|int
...
expr_stmt|;
block|}
DECL|method|CaffeineLRUSoftCache (int initialCapacity, int maximumCacheSize)
specifier|public
name|CaffeineLRUSoftCache
parameter_list|(
name|int
...
expr_stmt|;
block|}
DECL|method|CaffeineLRUSoftCache (int initialCapacity, int maximumCacheSize, boolean stopOnEviction)
specifier|public
name|CaffeineLRUSoftCache
parameter_list|(
name|int
