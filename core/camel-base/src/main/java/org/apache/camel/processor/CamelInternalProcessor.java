...
name|first
decl_stmt|;
DECL|method|BacklogTracerAdvice (BacklogTracer backlogTracer, NamedNode processorDefinition, NamedRoute routeDefinition, boolean first)
specifier|public
name|BacklogTracerAdvice
parameter_list|(
name|BacklogTracer
...
block|}
block|}
comment|/**      * Advice for tracing      */
DECL|class|TracingAdvice
specifier|public
specifier|static
class|class
name|TracingAdvice
...
name|routeDefinition
decl_stmt|;
DECL|field|tracingAfterRoute
specifier|private
specifier|final
name|Synchronization
name|tracingAfterRoute
decl_stmt|;
DECL|field|added
specifier|private
name|boolean
name|added
decl_stmt|;
DECL|method|TracingAdvice (Tracer tracer, NamedNode processorDefinition, NamedRoute routeDefinition, boolean first)
specifier|public
name|TracingAdvice
parameter_list|(
name|Tracer
...
condition|)
block|{
comment|// add before route and after route tracing but only once per route, so check if there is already an existing
name|boolean
name|contains
init|=
name|exchange
...
name|routeId
decl_stmt|;
DECL|method|TracingAfterRoute (Tracer tracer, String routeId)
specifier|private
name|TracingAfterRoute
parameter_list|(
name|Tracer
...
parameter_list|)
block|{
comment|// only match equals on route id so we can check this from containsSynchronization
comment|// to avoid adding multiple times for the same route id
if|if
condition|(
name|this
operator|==
