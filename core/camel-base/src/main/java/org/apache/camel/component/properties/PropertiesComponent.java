...
begin_comment
comment|/**  * The properties component allows you to use property placeholders in Camel.  */
end_comment
...
parameter_list|()
block|{
comment|// this method may be replaced by loadProperties(k -> true) but the underlying sources
comment|// may have some optimization for bulk load so let's keep it
name|Properties
name|prop
init|=
operator|new
