...
expr_stmt|;
block|}
comment|// attachments is by default often included
if|if
condition|(
...
return|;
block|}
DECL|method|isAttachmentsEnabled ()
specifier|private
name|boolean
name|isAttachmentsEnabled
parameter_list|()
block|{
comment|// attachments is always enabled unless excluded
name|String
index|[]
name|parts
init|=
...
expr_stmt|;
block|}
comment|// attachments is enabled if we only have exclude patterns
return|return
name|onlyExclude
return|;
block|}
