...
name|TypeConverterRegistry
block|{
DECL|field|META_INF_SERVICES_TYPE_CONVERTER_LOADER
specifier|public
specifier|static
specifier|final
name|String
name|META_INF_SERVICES_TYPE_CONVERTER_LOADER
init|=
literal|"META-INF/services/org/apache/camel/TypeConverterLoader"
decl_stmt|;
DECL|field|META_INF_SERVICES_FALLBACK_TYPE_CONVERTER
specifier|public
specifier|static
specifier|final
name|String
name|META_INF_SERVICES_FALLBACK_TYPE_CONVERTER
init|=
...
argument_list|()
decl_stmt|;
DECL|method|BaseTypeConverterRegistry (CamelContext camelContext, PackageScanClassResolver resolver, Injector injector, FactoryFinder factoryFinder)
specifier|public
name|BaseTypeConverterRegistry
parameter_list|(
name|CamelContext
...
block|}
block|}
comment|/**      * Finds the type converter loader classes from the classpath looking      * for text files on the classpath at the {@link #META_INF_SERVICES_TYPE_CONVERTER_LOADER} location.      */
...
block|}
block|}
comment|/**      * Finds the fallback type converter classes from the classpath looking      * for text files on the classpath at the {@link #META_INF_SERVICES_FALLBACK_TYPE_CONVERTER} location.      */
DECL|method|findFallbackTypeConverterClasses ()
specifier|protected
name|Collection
argument_list|<
name|String
argument_list|>
name|findFallbackTypeConverterClasses
parameter_list|()
throws|throws
name|IOException
block|{
...
name|debug
argument_list|(
literal|"Loading file {} to retrieve list of fallback type converters, from url: {}"
argument_list|,
name|META_INF_SERVICES_FALLBACK_TYPE_CONVERTER
argument_list|,
name|url
...
name|debug
argument_list|(
literal|"Resolving FallbackTypeConverter: {}"
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Adding loaded FallbackTypeConverter: {}"
argument_list|,
name|name
argument_list|)
expr_stmt|;
