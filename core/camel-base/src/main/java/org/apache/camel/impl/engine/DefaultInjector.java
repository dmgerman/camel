...
begin_comment
comment|/**  * A default implementation of {@link Injector} which just uses reflection to  * instantiate new objects using their zero argument constructor,  * and then performing bean post processing using {@link CamelBeanPostProcessor}.  *<p/>  * For more complex implementations try the Spring or Guice implementations.  */
end_comment
