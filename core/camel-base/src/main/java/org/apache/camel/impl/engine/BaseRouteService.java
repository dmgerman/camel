...
argument_list|)
decl_stmt|;
DECL|method|BaseRouteService (Route route)
specifier|public
name|BaseRouteService
parameter_list|(
name|Route
...
block|}
block|}
DECL|method|routePolicyCallback (java.util.function.BiConsumer<RoutePolicy, Route> callback)
specifier|private
name|void
name|routePolicyCallback
parameter_list|(
