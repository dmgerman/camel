...
name|newParameters
decl_stmt|;
DECL|method|AggregationStrategyMethodInfo (Method method, List<AggregationStrategyParameterInfo> oldParameters, List<AggregationStrategyParameterInfo> newParameters)
specifier|public
name|AggregationStrategyMethodInfo
parameter_list|(
name|Method
