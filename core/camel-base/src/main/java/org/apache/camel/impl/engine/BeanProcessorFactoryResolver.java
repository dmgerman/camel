...
begin_comment
comment|/**  * Factory resolver to find the {@link org.apache.camel.spi.BeanProcessorFactory} from the classpath in camel-bean.  */
end_comment

begin_class
DECL|class|BeanProcessorFactoryResolver
specifier|public
class|class
name|BeanProcessorFactoryResolver
block|{
...
name|findFactory
argument_list|(
literal|"bean-processor-factory"
argument_list|,
name|context
argument_list|)
expr_stmt|;
...
argument_list|(
literal|"Type is not a BeanProcessorFactory implementation. Found: "
operator|+
name|type
operator|.
name|getName
...
name|debug
argument_list|(
literal|"Cannot find BeanProcessorFactory. Make sure camel-bean is on the classpath."
argument_list|)
expr_stmt|;
return|return
literal|null
