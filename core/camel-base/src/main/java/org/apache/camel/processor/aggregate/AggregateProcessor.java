...
name|trace
argument_list|(
literal|"Force discarded triggered for correlation key: {}"
argument_list|,
name|key
argument_list|)
expr_stmt|;
comment|// force discarding by setting aggregate failed as true
name|onCompletion
argument_list|(
name|key
argument_list|,
...
name|trace
argument_list|(
literal|"Completed force discarded of group {}"
argument_list|,
name|key
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Forcing discarding of group {} with {} exchanges"
argument_list|,
name|key
argument_list|,
name|total
...
name|warn
argument_list|(
literal|"Cannot start force discarding of all groups because CamelContext({}) has not been started"
argument_list|,
name|camelContext
operator|.
name|getName
...
name|trace
argument_list|(
literal|"Starting force discarding of all groups task"
argument_list|)
expr_stmt|;
comment|// trigger completion for all in the repository
name|Set
...
name|trace
argument_list|(
literal|"Completed force discarding of all groups task"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|debug
argument_list|(
literal|"Forcing discarding of all groups with {} exchanges"
argument_list|,
name|total
argument_list|)
expr_stmt|;
