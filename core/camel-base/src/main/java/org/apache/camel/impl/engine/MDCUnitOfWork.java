...
decl_stmt|;
DECL|method|MDCUnitOfWork (Exchange exchange, String pattern)
specifier|public
name|MDCUnitOfWork
parameter_list|(
name|Exchange
...
return|;
block|}
DECL|method|matchPatterns (String value, String[] patterns)
specifier|private
specifier|static
name|boolean
name|matchPatterns
...
name|custom
decl_stmt|;
DECL|method|MDCCallback (AsyncCallback delegate, String pattern)
specifier|private
name|MDCCallback
parameter_list|(
name|AsyncCallback
