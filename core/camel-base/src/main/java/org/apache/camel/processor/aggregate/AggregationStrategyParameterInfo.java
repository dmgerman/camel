...
begin_class
DECL|class|AggregationStrategyParameterInfo
specifier|public
class|class
name|AggregationStrategyParameterInfo
block|{
DECL|field|index
specifier|private
specifier|final
...
name|expression
decl_stmt|;
DECL|method|AggregationStrategyParameterInfo (int index, Class<?> type, Expression expression)
specifier|public
name|AggregationStrategyParameterInfo
parameter_list|(
name|int
