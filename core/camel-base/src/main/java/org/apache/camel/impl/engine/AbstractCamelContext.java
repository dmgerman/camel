...
name|managementMBeanAssembler
decl_stmt|;
DECL|field|restRegistryFactory
specifier|private
specifier|volatile
name|RestRegistryFactory
name|restRegistryFactory
...
argument_list|(
literal|"Error initializing CamelContext"
argument_list|,
name|e
argument_list|)
throw|;
...
name|trace
argument_list|(
literal|"Getting endpoint with uri: {} and parameters: {}"
argument_list|,
name|uri
argument_list|,
name|parameters
...
name|info
argument_list|(
literal|"MDC logging (keys-pattern: {}) is enabled on CamelContext: {}"
argument_list|,
name|pattern
argument_list|,
name|getName
...
argument_list|)
expr_stmt|;
comment|// we need also to include routes which failed to start to ensure all resources get stopped when stopping Camel
for|for
control|(
name|BaseRouteService
name|routeService
...
name|debug
argument_list|(
literal|"Route: {} which failed to startup will be stopped"
argument_list|,
name|routeService
operator|.
name|getId
...
name|debug
argument_list|(
literal|"No existing PropertiesComponent has been configured, created a new default PropertiesComponent with name: properties"
argument_list|)
expr_stmt|;
name|globalOptions
operator|.
...
argument_list|)
expr_stmt|;
comment|// this adds comp as properties component and sets this.propertiesComponent = comp
block|}
if|if
condition|(
name|propertiesComponent
...
name|IllegalStateException
argument_list|(
literal|"Cannot auto create Properties component"
argument_list|)
throw|;
block|}
block|}
...
block|}
block|}
comment|// preserve any existing event notifiers that may have been already added
name|List
argument_list|<
name|EventNotifier
argument_list|>
...
return|;
block|}
DECL|method|getRestRegistryFactory ()
specifier|public
name|RestRegistryFactory
name|getRestRegistryFactory
parameter_list|()
...
return|;
block|}
DECL|method|setRestRegistryFactory (RestRegistryFactory restRegistryFactory)
specifier|public
name|void
name|setRestRegistryFactory
parameter_list|(
