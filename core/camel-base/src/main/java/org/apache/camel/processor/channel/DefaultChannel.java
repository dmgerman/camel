...
DECL|method|initChannel (RouteContext routeContext, NamedNode definition, NamedNode childDefinition, List<InterceptStrategy> interceptors, Processor nextProcessor, NamedRoute route, boolean first, boolean routeScoped)
specifier|public
name|void
name|initChannel
parameter_list|(
...
condition|)
block|{
comment|// add jmx backlog tracer
name|BacklogTracer
name|backlogTracer
init|=
