...
begin_comment
comment|/**  * Factory resolver to create the {@link org.apache.camel.spi.ReactiveExecutor} to be used.  */
end_comment

begin_class
DECL|class|ReactiveExecutorResolver
specifier|public
class|class
...
name|debug
argument_list|(
literal|"Found ReactiveExecutor: {} via: {}{}"
argument_list|,
name|type
operator|.
name|getName
...
name|debug
argument_list|(
literal|"Detected and using ReactiveExecutor: {}"
argument_list|,
name|answer
argument_list|)
expr_stmt|;
...
argument_list|(
literal|"Type is not a ReactiveExecutor implementation. Found: "
operator|+
name|type
operator|.
name|getName
...
name|debug
argument_list|(
literal|"Creating default ReactiveExecutor"
argument_list|)
expr_stmt|;
return|return
operator|new
