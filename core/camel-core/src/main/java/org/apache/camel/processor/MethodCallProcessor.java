...
begin_comment
comment|/**  * A processor which are used when calling a method and setting the response as the message body  */
end_comment

begin_class
DECL|class|MethodCallProcessor
specifier|public
class|class
...
name|expression
decl_stmt|;
DECL|method|MethodCallProcessor (Expression expression)
specifier|public
name|MethodCallProcessor
parameter_list|(
name|Expression
...
return|;
block|}
comment|// if null/empty response its due to void / no-response, then dont change the body
if|if
condition|(
name|newBody
operator|!=
