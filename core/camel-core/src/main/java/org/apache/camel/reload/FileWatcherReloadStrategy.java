...
begin_package
DECL|package|org.apache.camel.reload
package|package
name|org
operator|.
name|apache
...
argument_list|)
expr_stmt|;
comment|// must have camel-file on classpath
name|Component
name|file
init|=
...
argument_list|(
literal|"FileWatcherReloadStrategy requires camel-file JAR to be on the classpath"
argument_list|)
throw|;
block|}
...
argument_list|)
expr_stmt|;
comment|// must wrap in unit of work producer
name|Map
argument_list|<
name|String
argument_list|,
