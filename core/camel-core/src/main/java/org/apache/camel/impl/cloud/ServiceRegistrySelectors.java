...
begin_class
DECL|class|ServiceRegistrySelectors
specifier|public
specifier|final
class|class
...
argument_list|)
decl_stmt|;
DECL|method|ServiceRegistrySelectors ()
specifier|private
name|ServiceRegistrySelectors
parameter_list|()
block|{     }
...
name|warn
argument_list|(
literal|"Multiple ServiceRegistry instances available (items={})"
argument_list|,
name|services
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Multiple ServiceRegistry instances available for highest priority (order={}, items={})"
argument_list|,
name|highPriorityServices
operator|.
name|get
...
name|type
decl_stmt|;
DECL|method|SelectByType (Class<? extends ServiceRegistry> type)
specifier|public
name|SelectByType
parameter_list|(
name|Class
...
return|;
block|}
DECL|method|type (Class<? extends ServiceRegistry> type)
specifier|public
specifier|static
name|ServiceRegistry
operator|.
