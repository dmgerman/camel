...
argument_list|)
return|;
comment|/*if (answer.getExpressionValue() != null) {                     return answer.getExpressionValue().evaluate(exchange, Object.class);                 } else {                     return answer.getExpressionType().evaluate(exchange);                 }*/
block|}
block|}
decl_stmt|;
