...
name|dataFormat
argument_list|,
literal|"encodeElementsAppliesToResourceTypes"
argument_list|,
name|getEncodeElementsAppliesToResourceTypes
argument_list|()
argument_list|)
...
return|;
block|}
comment|/**      * If provided, tells the parse which resource types to apply {@link #setEncodeElements(Set) encode elements} to. Any      * resource types not specified here will be encoded completely, with no elements excluded.      *      * @param encodeElementsAppliesToResourceTypes resouce types      */
