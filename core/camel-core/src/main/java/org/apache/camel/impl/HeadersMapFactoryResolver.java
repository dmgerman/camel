...
begin_comment
comment|/**  * Factory to create the {@link HeadersMapFactory} implementation to be used.  *  * @see HeadersMapFactory  */
end_comment

begin_class
DECL|class|HeadersMapFactoryResolver
specifier|public
class|class
...
name|debug
argument_list|(
literal|"Found HeadersMapFactory: {} via: {}{}"
argument_list|,
name|type
operator|.
name|getName
...
name|info
argument_list|(
literal|"Detected and using custom HeadersMapFactory: {}"
argument_list|,
name|answer
argument_list|)
expr_stmt|;
...
argument_list|(
literal|"Type is not a HeadersMapFactory implementation. Found: "
operator|+
name|type
operator|.
name|getName
...
name|debug
argument_list|(
literal|"Creating default HeadersMapFactory"
argument_list|)
expr_stmt|;
return|return
operator|new
