...
argument_list|)
expr_stmt|;
comment|// we dont use @XmlValue but the attributes instead
if|if
condition|(
name|beanName
operator|!=
...
block|}
block|}
comment|// special for bean language where we need to configure it first
name|Language
name|lan
init|=
name|camelContext
...
return|;
block|}
DECL|method|configureLanguage (CamelContext camelContext, Language language)
specifier|protected
name|void
name|configureLanguage
parameter_list|(
