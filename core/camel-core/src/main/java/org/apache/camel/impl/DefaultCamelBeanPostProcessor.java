...
block|}
block|}
DECL|method|bindToRegistry (Class<?> clazz, String name, Object bean, String beanName)
specifier|private
name|void
name|bindToRegistry
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|bindToRegistry (Field field, String name, Object bean, String beanName)
specifier|private
name|void
name|bindToRegistry
parameter_list|(
...
block|}
block|}
DECL|method|bindToRegistry (Method method, String name, Object bean, String beanName)
specifier|private
name|void
name|bindToRegistry
parameter_list|(
...
condition|)
block|{
comment|// the parameter can only be one of these types
name|Class
argument_list|<
name|?
argument_list|>
...
condition|)
block|{
comment|// see if we can find a single instance of this type already in the registry
name|Set
argument_list|<
name|?
argument_list|>
...
argument_list|()
operator|+
literal|" cannot lookup the type: "
operator|+
name|type
operator|+
literal|" from the Camel registry."
argument_list|)
throw|;
block|}
block|}
...
argument_list|()
operator|+
literal|" with 2 or more method parameters is not allowed"
argument_list|)
throw|;
block|}
name|Object
