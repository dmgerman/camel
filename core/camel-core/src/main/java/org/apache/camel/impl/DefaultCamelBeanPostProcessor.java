...
throw|;
block|}
comment|// TODO: Add support for some bean parameter bindings, like CamelContext,Registry and auto-lookup of by type in registry
if|if
condition|(
name|method
operator|.
...
argument_list|()
operator|+
literal|" with method parameters is not allowed"
argument_list|)
throw|;
block|}
name|Object
