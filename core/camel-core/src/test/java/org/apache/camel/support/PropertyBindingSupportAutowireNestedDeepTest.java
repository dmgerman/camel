...
begin_class
DECL|class|PropertyBindingSupportAutowireNestedDeepTest
specifier|public
class|class
name|PropertyBindingSupportAutowireNestedDeepTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
annotation|@
name|Test
DECL|method|testAutowirePropertiesDeep ()
specifier|public
name|void
name|testAutowirePropertiesDeep
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// should be auto wired (deep)
name|assertNotNull
argument_list|(
name|foo
operator|.
