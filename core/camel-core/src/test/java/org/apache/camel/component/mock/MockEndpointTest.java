...
specifier|public
name|void
name|testExpectsBodiesInAnyOrderWithDuplicates
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testExpectsPropertiesInAnyOrder
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testExpectsPropertiesInAnyOrderFail
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSetMultipleExpectedHeaders4
parameter_list|()
throws|throws
name|Exception
block|{
comment|// to test the header value with Stream which can only be consumed once
name|InputStream
name|is
init|=
operator|new
