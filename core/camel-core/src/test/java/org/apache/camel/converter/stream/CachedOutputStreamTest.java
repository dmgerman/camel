...
specifier|public
name|void
name|testCachedStreamAccessStreamWhenExchangeOnCompletion
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Get a wrong stream content"
argument_list|,
name|temp
argument_list|,
name|TEST_STRING
...
specifier|public
name|void
name|testCachedOutputStreamEmptyInput
parameter_list|()
throws|throws
name|Exception
block|{
