...
begin_class
DECL|class|FilerConsumerDoneFileNoopTest
specifier|public
class|class
name|FilerConsumerDoneFileNoopTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
argument_list|()
expr_stmt|;
comment|// done file should be kept now
name|File
name|file
init|=
operator|new
...
name|assertTrue
argument_list|(
literal|"Done file should be not be deleted: "
operator|+
name|file
argument_list|,
name|file
...
argument_list|)
expr_stmt|;
comment|// as well the original file should be kept due noop
name|file
operator|=
operator|new
name|File
...
name|assertTrue
argument_list|(
literal|"Original file should be kept: "
operator|+
name|file
argument_list|,
name|file
...
name|from
argument_list|(
literal|"file:target/data/done?initialDelay=0&delay=10&doneFileName=done&noop=true"
argument_list|)
operator|.
name|to
argument_list|(
