...
begin_class
DECL|class|FilerConsumerDoneFileNameSuffixTest
specifier|public
class|class
name|FilerConsumerDoneFileNameSuffixTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
name|from
argument_list|(
literal|"file:target/data/done?doneFileName=${file:name}.ready&initialDelay=0&delay=10"
argument_list|)
operator|.
name|to
argument_list|(
