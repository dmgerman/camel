...
begin_class
DECL|class|FileRecursiveNoopTest
specifier|public
class|class
name|FileRecursiveNoopTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
annotation|@
name|Test
DECL|method|testRecursiveNoop ()
specifier|public
name|void
name|testRecursiveNoop
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// reset mock and send in a new file to be picked up only
name|mock
operator|.
name|reset
argument_list|()
