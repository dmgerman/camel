...
begin_comment
comment|/**  * Unit test for intercepting sending to endpoint with after url  */
end_comment

begin_class
DECL|class|InterceptSendToEndpointAfterTest
specifier|public
class|class
name|InterceptSendToEndpointAfterTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
