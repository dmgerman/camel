...
name|from
argument_list|(
literal|"file:target/data/changed/in?initialDelay=0&delay=10&readLock=idempotent&readLockIdempotentReleaseDelay=1000&readLockIdempotentReleaseAsync=true&idempotentRepository=#myRepo"
argument_list|)
operator|.
name|process
argument_list|(
