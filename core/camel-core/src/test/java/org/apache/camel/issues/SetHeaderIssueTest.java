...
begin_class
DECL|class|SetHeaderIssueTest
specifier|public
class|class
name|SetHeaderIssueTest
extends|extends
name|ContextTestSupport
block|{
...
name|matchingBody
init|=
literal|"<person xmlns='urn:cheese' name='James' city='London'/>"
decl_stmt|;
...
init|=
literal|"<person xmlns='urn:cheese' name='Hiram' city='Tampa'/>"
decl_stmt|;
annotation|@
name|Test
