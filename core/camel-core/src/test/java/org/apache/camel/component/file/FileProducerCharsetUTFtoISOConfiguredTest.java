...
begin_class
DECL|class|FileProducerCharsetUTFtoISOConfiguredTest
specifier|public
class|class
name|FileProducerCharsetUTFtoISOConfiguredTest
extends|extends
name|ContextTestSupport
block|{
DECL|field|utf
...
name|from
argument_list|(
literal|"file:target/data/charset/input?initialDelay=0&delay=10&charset=utf-8&noop=true"
argument_list|)
operator|.
name|to
argument_list|(
literal|"file:target/data/charset/?fileName=output.txt&charset=iso-8859-1"
argument_list|)
expr_stmt|;
block|}
block|}
