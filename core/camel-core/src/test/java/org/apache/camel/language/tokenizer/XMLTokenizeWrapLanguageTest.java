...
begin_class
DECL|class|XMLTokenizeWrapLanguageTest
specifier|public
class|class
name|XMLTokenizeWrapLanguageTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
argument_list|(
literal|"<?xml version='1.0' encoding='UTF-8'?><c:parent xmlns:c='urn:c'><c:child some_attr='a' anotherAttr='a'></c:child></c:parent>"
argument_list|,
literal|"<?xml version='1.0' encoding='UTF-8'?><c:parent xmlns:c='urn:c'><c:child some_attr='b' anotherAttr='b'></c:child></c:parent>"
argument_list|)
expr_stmt|;
name|template
operator|.
...
name|expectedBodiesReceived
argument_list|(
literal|"<?xml version='1.0' encoding='UTF-8'?><c:parent xmlns:c='urn:c'><c:child some_attr='a' anotherAttr='a' /></c:parent>"
argument_list|,
literal|"<?xml version='1.0' encoding='UTF-8'?><c:parent xmlns:c='urn:c'><c:child some_attr='b' anotherAttr='b' /></c:parent>"
argument_list|)
expr_stmt|;
name|template
operator|.
...
name|expectedBodiesReceived
argument_list|(
literal|"<?xml version='1.0' encoding='UTF-8'?><c:parent xmlns:c='urn:c'><c:child some_attr='a' anotherAttr='a'>ha</c:child></c:parent>"
argument_list|,
literal|"<?xml version='1.0' encoding='UTF-8'?><c:parent xmlns:c='urn:c'><c:child some_attr='b' anotherAttr='b' /></c:parent>"
argument_list|,
...
name|expectedBodiesReceived
argument_list|(
literal|"<c:parent xmlns:c='urn:c'><c:child name='child1'><grandchild name='grandchild1'/><grandchild name='grandchild2'/></c:child></c:parent>"
argument_list|,
literal|"<c:parent xmlns:c='urn:c'><c:child name='child2'><grandchild name='grandchild1'></grandchild><grandchild name='grandchild2'></grandchild></c:child></c:parent>"
argument_list|)
expr_stmt|;
name|template
operator|.
...
name|expectedBodiesReceived
argument_list|(
literal|"<?xml version='1.0' encoding='UTF-8'?><c:parent xmlns:c='urn:c'><c:child xmlns:c='urn:c' some_attr='a' anotherAttr='a'></c:child></c:parent>"
argument_list|,
literal|"<?xml version='1.0' encoding='UTF-8'?><c:parent xmlns:c='urn:c'><c:child xmlns:c='urn:c' some_attr='b' anotherAttr='b' /></c:parent>"
argument_list|)
expr_stmt|;
name|template
operator|.
