...
begin_class
DECL|class|FilerConsumerPreMoveDoneFileNameTest
specifier|public
class|class
name|FilerConsumerPreMoveDoneFileNameTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
name|File
argument_list|(
literal|"target/data/done/ready"
argument_list|)
decl_stmt|;
name|assertFalse
argument_list|(
...
name|from
argument_list|(
literal|"file:target/data/done?preMove=work/work-${file:name}&doneFileName=ready&initialDelay=0&delay=10"
argument_list|)
operator|.
name|to
argument_list|(
