...
argument_list|)
expr_stmt|;
comment|// should be null before init
name|assertNull
argument_list|(
name|main
operator|.
...
argument_list|)
expr_stmt|;
comment|// for testing that we can init camel and it has loaded configuration and routes and whatnot
name|main
operator|.
name|init
argument_list|()
expr_stmt|;
comment|// and now its created
name|assertNotNull
argument_list|(
name|main
operator|.
...
argument_list|)
expr_stmt|;
comment|// should be 1 route model
name|assertEquals
argument_list|(
literal|1
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// and the configuration should have registered beans
name|assertNotNull
argument_list|(
name|main
operator|.
