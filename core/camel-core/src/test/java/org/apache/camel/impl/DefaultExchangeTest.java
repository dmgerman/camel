...
specifier|public
name|void
name|testRemovePropertiesWithExclusion
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testRemovePropertiesPatternWithAllExcluded
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Fault property was not copied to IN message"
argument_list|,
name|sourceExchange
operator|.
name|getIn
...
name|assertEquals
argument_list|(
literal|"Fault property was not copied to OUT message"
argument_list|,
name|sourceExchange
operator|.
name|getOut
