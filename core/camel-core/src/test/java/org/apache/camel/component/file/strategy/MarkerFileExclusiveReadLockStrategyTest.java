...
argument_list|(
literal|"target/data/marker/"
argument_list|)
expr_stmt|;
name|createDirectory
argument_list|(
literal|"target/data/marker/in"
argument_list|)
expr_stmt|;
name|super
operator|.
...
argument_list|(
literal|"target/data/marker/out/file1.dat"
argument_list|)
expr_stmt|;
name|mock
operator|.
name|expectedFileExists
argument_list|(
literal|"target/data/marker/out/file2.dat"
argument_list|)
expr_stmt|;
name|writeFiles
argument_list|()
...
argument_list|(
literal|"target/data/marker/in/file1.dat.camelLock"
argument_list|)
expr_stmt|;
name|assertFileDoesNotExists
argument_list|(
literal|"target/data/marker/in/file2.dat.camelLock"
argument_list|)
expr_stmt|;
name|assertFileDoesNotExists
argument_list|(
literal|"target/data/marker/in/file1.dat"
argument_list|)
expr_stmt|;
name|assertFileDoesNotExists
argument_list|(
literal|"target/data/marker/in/file2.dat"
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
...
name|from
argument_list|(
literal|"file:target/data/marker/in?readLock=markerFile&initialDelay=0&delay=10"
argument_list|)
operator|.
name|onCompletion
argument_list|()
...
name|to
argument_list|(
literal|"file:target/data/marker/out"
argument_list|,
literal|"mock:result"
argument_list|)
expr_stmt|;
