...
begin_class
DECL|class|AsyncOnExceptionFailureProcessorWithRedeliveryTest
specifier|public
class|class
name|AsyncOnExceptionFailureProcessorWithRedeliveryTest
extends|extends
name|ContextTestSupport
block|{
...
argument_list|)
expr_stmt|;
comment|// use redelivery up till 5 times
name|errorHandler
argument_list|(
...
block|}
argument_list|)
comment|// invoking the async endpoint could also cause a failure so
comment|// test that we can do redelivery
operator|.
name|to
argument_list|(
