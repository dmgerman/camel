...
annotation|@
name|Test
DECL|method|testSimpleStepId ()
specifier|public
name|void
name|testSimpleStepId
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testSimpleSystemEnvironmentExpressionsIfDash ()
specifier|public
name|void
name|testSimpleSystemEnvironmentExpressionsIfDash
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSimpleSystemEnvironmentExpressionsIfLowercase
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertExpression
argument_list|(
literal|"${date:in.header.birthday}"
argument_list|,
name|inHeaderCalendar
operator|.
name|getTime
...
name|assertExpression
argument_list|(
literal|"${date:in.header.birthday:yyyyMMdd}"
argument_list|,
literal|"19740420"
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"Valid syntax: ${random(min,max)} or ${random(max)} was: random(10,21,30)"
argument_list|,
name|e
operator|.
name|getCause
...
name|assertEquals
argument_list|(
literal|"Valid syntax: ${random(min,max)} or ${random(max)} was: random()"
argument_list|,
name|e
operator|.
name|getCause
...
specifier|public
name|void
name|testListIndexByNestedFunction
parameter_list|()
throws|throws
name|Exception
block|{
...
name|exp
init|=
literal|"${header.ITEMS[${exchangeProperty.CamelLoopIndex}]}"
decl_stmt|;
name|exchange
operator|.
name|setProperty
