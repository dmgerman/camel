...
begin_class
DECL|class|DirectNoConsumerTest
specifier|public
class|class
name|DirectNoConsumerTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
name|to
argument_list|(
literal|"direct:foo?failIfNoConsumers=false"
argument_list|)
expr_stmt|;
block|}
block|}
...
annotation|@
name|Test
DECL|method|testWireTapFailIfNoConsumerFalse ()
specifier|public
name|void
name|testWireTapFailIfNoConsumerFalse
parameter_list|()
throws|throws
name|Exception
block|{
