...
begin_class
DECL|class|BeanParameterValueOverloadedTest
specifier|public
class|class
name|BeanParameterValueOverloadedTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
name|to
argument_list|(
literal|"bean:foo?method=bar(${body},false,true)"
argument_list|)
operator|.
name|to
argument_list|(
...
block|}
block|}
DECL|method|bar (String body, boolean hello, boolean bye)
specifier|public
name|String
name|bar
parameter_list|(
