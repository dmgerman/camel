...
name|expectedBodiesReceived
argument_list|(
literal|"<c:child some_attr='a' anotherAttr='a' xmlns:c=\"urn:c\">\n</c:child>"
argument_list|,
...
name|expectedBodiesReceived
argument_list|(
literal|"<c:child some_attr='a' anotherAttr='a' xmlns:c=\"urn:c\">ha</c:child>"
argument_list|,
literal|"<c:child some_attr='b' anotherAttr='b'  xmlns:c=\"urn:c\"/>"
argument_list|,
literal|"<c:child some_attr='c' xmlns:c=\"urn:c\"></c:child>"
argument_list|)
expr_stmt|;
name|template
operator|.
...
name|expectedBodiesReceived
argument_list|(
literal|"<c:child name='child1' xmlns:c=\"urn:c\"><grandchild name='grandchild1'/><grandchild name='grandchild2'/></c:child>"
argument_list|,
literal|"<c:child name='child2' xmlns:c=\"urn:c\"><grandchild name='grandchild1'></grandchild><grandchild name='grandchild2'></grandchild></c:child>"
argument_list|)
expr_stmt|;
name|template
operator|.
...
name|expectedBodiesReceived
argument_list|(
literal|"<c:child some_attr='a' anotherAttr='a' xmlns:d=\"urn:d\" xmlns:c=\"urn:c\"></c:child>"
argument_list|,
literal|"<c:child some_attr='b' anotherAttr='b' xmlns:d=\"urn:d\" xmlns:c=\"urn:c\"/>"
argument_list|)
expr_stmt|;
name|template
operator|.
