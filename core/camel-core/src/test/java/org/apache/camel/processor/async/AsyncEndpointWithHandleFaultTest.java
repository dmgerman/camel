...
begin_class
DECL|class|AsyncEndpointWithHandleFaultTest
specifier|public
class|class
name|AsyncEndpointWithHandleFaultTest
extends|extends
name|ContextTestSupport
block|{
...
argument_list|)
expr_stmt|;
comment|// enable handle fault to ensure it works using async API
name|from
argument_list|(
literal|"direct:start"
argument_list|)
