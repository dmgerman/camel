...
name|fileUrl
init|=
literal|"file://target/data/tempandrename/?tempFileName=inprogress-${file:name.noext}.tmp"
decl_stmt|;
...
name|parentFileUrl
init|=
literal|"file://target/data/tempandrename/?tempFileName=../work/${file:name.noext}.tmp"
decl_stmt|;
DECL|field|childFileUrl
specifier|private
name|String
name|childFileUrl
init|=
...
argument_list|(
literal|"target/data/tempandrename/inprogress-claus.tmp"
argument_list|,
name|tempFileName
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"The generated file should exist: "
operator|+
name|file
argument_list|,
literal|true
...
annotation|@
name|Test
DECL|method|testParentTempFileName ()
specifier|public
name|void
name|testParentTempFileName
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"The generated temp directory should exist: "
operator|+
name|file
argument_list|,
literal|true
...
annotation|@
name|Test
DECL|method|testChildTempFileName ()
specifier|public
name|void
name|testChildTempFileName
parameter_list|()
throws|throws
name|Exception
block|{
...
name|File
argument_list|(
literal|"target/data/tempandrename/work"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|assertDirectoryEquals
argument_list|(
literal|"target/data/work/claus.tmp"
argument_list|,
name|tempFileName
argument_list|)
expr_stmt|;
