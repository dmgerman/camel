...
annotation|@
name|Test
DECL|method|testForceDiscardingOfGroup ()
specifier|public
name|void
name|testForceDiscardingOfGroup
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// the first 5 messages are discarded
name|getMockEndpoint
argument_list|(
literal|"mock:aggregated"
argument_list|)
...
annotation|@
name|Test
DECL|method|testForceDiscardingOfAll ()
specifier|public
name|void
name|testForceDiscardingOfAll
parameter_list|()
throws|throws
name|Exception
block|{
