...
begin_class
DECL|class|AsyncLoopCopyTest
specifier|public
class|class
name|AsyncLoopCopyTest
extends|extends
name|ContextTestSupport
block|{
...
literal|"mock:loopIterationEnd"
argument_list|)
comment|// Should receive 2x Bye Camel
operator|.
name|end
argument_list|()
operator|.
