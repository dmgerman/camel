...
name|assertPredicate
argument_list|(
literal|"${in.header.strNumNegative} ~~ '123'"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
...
name|assertPredicate
argument_list|(
literal|"${in.body} ends with 'there'"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
...
name|assertPredicate
argument_list|(
literal|"${in.body} ends with 'Hello there'"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
name|assertPredicate
argument_list|(
literal|"${in.body} ends with 'Hello ther'"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
