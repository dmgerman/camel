...
begin_class
DECL|class|LoadRouteFromXmlWithPolicyTest
specifier|public
class|class
name|LoadRouteFromXmlWithPolicyTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
annotation|@
name|Test
DECL|method|testLoadRouteFromXmlWitPolicy ()
specifier|public
name|void
name|testLoadRouteFromXmlWitPolicy
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertNotNull
argument_list|(
literal|"Loaded foo route should be there"
argument_list|,
name|context
operator|.
name|getRoute
