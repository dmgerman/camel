...
begin_class
DECL|class|FileMarkerFileRecursiveDeleteOldLockFilesTest
specifier|public
class|class
name|FileMarkerFileRecursiveDeleteOldLockFilesTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
name|from
argument_list|(
literal|"file:target/data/oldlock?initialDelay=0&delay=10&recursive=true&sortBy=file:name"
argument_list|)
operator|.
name|routeId
argument_list|(
