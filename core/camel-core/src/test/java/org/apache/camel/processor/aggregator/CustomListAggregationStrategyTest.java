...
begin_class
DECL|class|CustomListAggregationStrategyTest
specifier|public
class|class
name|CustomListAggregationStrategyTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
parameter_list|)
block|{
comment|// the message body contains a number, so just return that as-is
return|return
name|exchange
operator|.
name|getIn
