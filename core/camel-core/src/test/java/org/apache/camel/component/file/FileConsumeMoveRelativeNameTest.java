...
name|fileUrl
init|=
literal|"file://target/data/multidir/?initialDelay=0&delay=10&recursive=true&move=.done/${file:name}.old"
decl_stmt|;
annotation|@
name|Override
annotation|@
...
argument_list|(
literal|"target/data/multidir/.done/bye.txt.old"
argument_list|)
expr_stmt|;
name|mock
operator|.
name|expectedFileExists
argument_list|(
literal|"target/data/multidir/.done/sub/hello.txt.old"
argument_list|)
expr_stmt|;
name|mock
operator|.
name|expectedFileExists
argument_list|(
literal|"target/data/multidir/.done/sub/sub2/goodday.txt.old"
argument_list|)
expr_stmt|;
name|template
operator|.
