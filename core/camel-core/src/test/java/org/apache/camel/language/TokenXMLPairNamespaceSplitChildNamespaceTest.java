...
begin_class
DECL|class|TokenXMLPairNamespaceSplitChildNamespaceTest
specifier|public
class|class
name|TokenXMLPairNamespaceSplitChildNamespaceTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
name|isEqualTo
argument_list|(
literal|"<order id=\"4\" xmlns:foo=\"http:foo.com\" xmlns=\"http:acme.com\">DSL in Action</order>"
argument_list|)
expr_stmt|;
name|String
name|body
...
name|append
argument_list|(
literal|" xmlns=\"http:acme.com\">ActiveMQ in Action</order>\n"
argument_list|)
expr_stmt|;
name|sb
operator|.
...
name|append
argument_list|(
literal|"<order id=\"4\" xmlns:foo=\"http:foo.com\">DSL in Action</order>\n"
argument_list|)
expr_stmt|;
name|sb
operator|.
