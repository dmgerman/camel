...
begin_class
DECL|class|CustomListAggregationStrategySplitTest
specifier|public
class|class
name|CustomListAggregationStrategySplitTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
argument_list|)
expr_stmt|;
comment|// the strategy will combine the data into a list of numbers
name|MockEndpoint
name|result
init|=
name|getMockEndpoint
