...
annotation|@
name|Test
DECL|method|matchEndpointsShouldIgnoreQueryParamOrder ()
specifier|public
name|void
name|matchEndpointsShouldIgnoreQueryParamOrder
parameter_list|()
block|{
name|String
name|endpointUri
init|=
literal|"sjms:queue:my-queue?transacted=true&consumerCount=1"
decl_stmt|;
name|String
name|endpointUriShuffled
init|=
literal|"sjms:queue:my-queue?consumerCount=1&transacted=true"
decl_stmt|;
name|String
name|notMatchingEndpointUri
init|=
literal|"sjms:queue:my-queue?consumerCount=1"
decl_stmt|;
name|assertThat
argument_list|(
name|EndpointHelper
...
annotation|@
name|Test
DECL|method|matchEndpointsShouldMatchWildcards ()
specifier|public
name|void
name|matchEndpointsShouldMatchWildcards
parameter_list|()
block|{
name|String
name|endpointUri
...
annotation|@
name|Test
DECL|method|matchEndpointsShouldMatchRegex ()
specifier|public
name|void
name|matchEndpointsShouldMatchRegex
parameter_list|()
block|{
name|String
name|endpointUri
...
name|notMatchingEndpointUri
init|=
literal|"sjms:queue:my-queue?transacted=false&consumerCount=1"
decl_stmt|;
name|String
name|pattern
init|=
literal|"sjms://.*transacted=true.*"
decl_stmt|;
name|assertThat
argument_list|(
name|EndpointHelper
