...
begin_class
DECL|class|LoadRestFromXmlTest
specifier|public
class|class
name|LoadRestFromXmlTest
extends|extends
name|ContextTestSupport
block|{
annotation|@
...
argument_list|()
expr_stmt|;
comment|// load rest from XML and add them to the existing camel context
name|InputStream
name|is
init|=
name|getClass
...
name|assertNotNull
argument_list|(
literal|"Loaded rest route should be there"
argument_list|,
name|context
operator|.
name|getRoute
