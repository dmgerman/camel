...
begin_comment
comment|/**  * The corda component uses corda-rpc to interact with corda nodes.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
block|}
block|}
comment|/**      * Corda (camel-corda)      * The corda component uses corda-rpc to interact with corda nodes.      *       * Category: corda,blockchain      * Since: 2.23      * Maven coordinates: org.apache.camel:camel-corda      *       * Syntax:<code>corda:node</code>      *       * Path parameter: node (required)      * The url for the corda node      */
