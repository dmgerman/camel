...
return|;
block|}
comment|/**          * Type of the endpoint (rdd, dataframe, hive).          * The option is a          *<code>org.apache.camel.component.spark.EndpointType</code> type.          * @group producer          */
...
return|;
block|}
comment|/**          * Type of the endpoint (rdd, dataframe, hive).          * The option will be converted to a          *<code>org.apache.camel.component.spark.EndpointType</code> type.          * @group producer          */
...
block|}
block|}
comment|/**      * Proxy enum for<code>org.apache.camel.component.spark.EndpointType</code>      * enum.      */
...
name|hive
block|;     }
comment|/**      * The spark component can be used to send RDD or DataFrame jobs to Apache      * Spark cluster.      * Maven coordinates: org.apache.camel:camel-spark      */
