...
argument_list|)
DECL|interface|TwitterSearchEndpointBuilderFactory
specifier|public
interface|interface
name|TwitterSearchEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the Twitter Search component.      */
DECL|interface|TwitterSearchEndpointConsumerBuilder
specifier|public
interface|interface
name|TwitterSearchEndpointConsumerBuilder
extends|extends
name|EndpointConsumerBuilder
block|{
DECL|method|advanced ()
specifier|default
name|AdvancedTwitterSearchEndpointConsumerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
return|;
block|}
comment|/**          * The search query, use the keywords AND, OR, - and () to narrow the          * search results.          * The option is a<code>java.lang.String</code> type.          * @group common          */
DECL|method|keywords (String keywords)
specifier|default
name|TwitterSearchEndpointConsumerBuilder
name|keywords
parameter_list|(
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the Twitter Search component.      */
DECL|interface|AdvancedTwitterSearchEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedTwitterSearchEndpointConsumerBuilder
extends|extends
...
DECL|method|advanced ()
specifier|default
name|AdvancedTwitterSearchEndpointProducerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the Twitter Search component.      */
DECL|interface|AdvancedTwitterSearchEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedTwitterSearchEndpointProducerBuilder
extends|extends
...
block|{
class|class
name|TwitterSearchEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
