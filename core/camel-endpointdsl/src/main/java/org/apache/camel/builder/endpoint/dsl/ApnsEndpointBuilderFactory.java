...
argument_list|)
DECL|interface|ApnsEndpointBuilderFactory
specifier|public
interface|interface
name|ApnsEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the APNS component.      */
DECL|interface|ApnsEndpointConsumerBuilder
specifier|public
interface|interface
...
specifier|default
name|AdvancedApnsEndpointConsumerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the APNS component.      */
DECL|interface|AdvancedApnsEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedApnsEndpointConsumerBuilder
extends|extends
...
DECL|method|advanced ()
specifier|default
name|AdvancedApnsEndpointProducerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the APNS component.      */
DECL|interface|AdvancedApnsEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedApnsEndpointProducerBuilder
extends|extends
...
block|}
block|}
comment|/**      * APNS (camel-apns)      * For sending notifications to Apple iOS devices.      *       * Category: eventbus,mobile      * Available as of version: 2.8      * Maven coordinates: org.apache.camel:camel-apns      *       * Syntax:<code>apns:name</code>      *       * Path parameter: name      * Name of the endpoint      */
