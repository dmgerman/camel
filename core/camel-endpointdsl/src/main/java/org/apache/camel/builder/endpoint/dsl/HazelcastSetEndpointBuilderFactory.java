...
begin_comment
comment|/**  * The hazelcast-set component is used to access Hazelcast distributed set.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
name|capacity
block|;     }
comment|/**      * Hazelcast Set (camel-hazelcast)      * The hazelcast-set component is used to access Hazelcast distributed set.      *       * Category: cache,datagrid      * Since: 2.7      * Maven coordinates: org.apache.camel:camel-hazelcast      *       * Syntax:<code>hazelcast-set:cacheName</code>      *       * Path parameter: cacheName (required)      * The name of the cache      */
