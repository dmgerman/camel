...
begin_comment
comment|/**  * The Kubernetes Pods component provides a producer to execute kubernetes pod  * operations and a consumer to consume pod events.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|KubernetesPodsEndpointBuilderFactory
specifier|public
interface|interface
name|KubernetesPodsEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the Kubernetes Pods component.      */
DECL|interface|KubernetesPodsEndpointConsumerBuilder
specifier|public
interface|interface
name|KubernetesPodsEndpointConsumerBuilder
extends|extends
name|EndpointConsumerBuilder
block|{
DECL|method|advanced ()
specifier|default
name|AdvancedKubernetesPodsEndpointConsumerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the Kubernetes Pods      * component.      */
DECL|interface|AdvancedKubernetesPodsEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedKubernetesPodsEndpointConsumerBuilder
extends|extends
...
DECL|method|advanced ()
specifier|default
name|AdvancedKubernetesPodsEndpointProducerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the Kubernetes Pods      * component.      */
DECL|interface|AdvancedKubernetesPodsEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedKubernetesPodsEndpointProducerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Kubernetes Pods (camel-kubernetes)      * The Kubernetes Pods component provides a producer to execute kubernetes      * pod operations and a consumer to consume pod events.      *       * Category: container,cloud,paas      * Since: 2.17      * Maven coordinates: org.apache.camel:camel-kubernetes      *       * Syntax:<code>kubernetes-pods:masterUrl</code>      *       * Path parameter: masterUrl (required)      * Kubernetes Master url      */
...
block|{
class|class
name|KubernetesPodsEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
