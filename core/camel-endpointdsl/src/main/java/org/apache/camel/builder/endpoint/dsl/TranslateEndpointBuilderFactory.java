...
return|;
block|}
comment|/**          * To define a proxy protocol when instantiating the Translate client.          *           * The option is a:<code>com.amazonaws.Protocol</code> type.          *           * Group: producer          */
...
return|;
block|}
comment|/**          * To define a proxy protocol when instantiating the Translate client.          *           * The option will be converted to a<code>com.amazonaws.Protocol</code>          * type.          *           * Group: producer          */
...
name|https
block|;     }
comment|/**      * AWS Translate (camel-aws-translate)      * The aws-translate component is used for managing Amazon Translate      *       * Category: cloud,management      * Since: 3.0      * Maven coordinates: org.apache.camel:camel-aws-translate      *       * Syntax:<code>aws-translate:label</code>      *       * Path parameter: label (required)      * Logical name      */
