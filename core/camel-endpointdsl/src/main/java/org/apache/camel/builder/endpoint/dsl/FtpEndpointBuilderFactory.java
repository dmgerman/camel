...
begin_comment
comment|/**  * The ftp component is used for uploading or downloading files from FTP  * servers.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|FtpEndpointBuilderFactory
specifier|public
interface|interface
name|FtpEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the FTP component.      */
DECL|interface|FtpEndpointConsumerBuilder
specifier|public
interface|interface
name|FtpEndpointConsumerBuilder
extends|extends
name|EndpointConsumerBuilder
block|{
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the FTP component.      */
DECL|interface|AdvancedFtpEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedFtpEndpointConsumerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the FTP component.      */
DECL|interface|AdvancedFtpEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedFtpEndpointProducerBuilder
extends|extends
...
name|TryRename
block|;     }
comment|/**      * FTP (camel-ftp)      * The ftp component is used for uploading or downloading files from FTP      * servers.      *       * Category: file      * Since: 1.1      * Maven coordinates: org.apache.camel:camel-ftp      *       * Syntax:<code>ftp:host:port/directoryName</code>      *       * Path parameter: host (required)      * Hostname of the FTP server      *       * Path parameter: port      * Port of the FTP server      *       * Path parameter: directoryName      * The starting directory      */
