...
block|}
block|}
comment|/**      * OpenStack Glance (camel-openstack)      * The openstack-glance component allows messages to be sent to an OpenStack      * image services.      *       * Category: cloud,paas      * Since: 2.19      * Maven coordinates: org.apache.camel:camel-openstack      *       * Syntax:<code>openstack-glance:host</code>      *       * Path parameter: host (required)      * OpenStack host url      */
DECL|method|openstackGlance (String path)
specifier|default
name|GlanceEndpointBuilder
name|openstackGlance
parameter_list|(
name|String
name|path
parameter_list|)
