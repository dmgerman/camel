...
argument_list|)
DECL|interface|StompEndpointBuilderFactory
specifier|public
interface|interface
name|StompEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the Stomp component.      */
DECL|interface|StompEndpointConsumerBuilder
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the Stomp component.      */
DECL|interface|AdvancedStompEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedStompEndpointConsumerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the Stomp component.      */
DECL|interface|AdvancedStompEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedStompEndpointProducerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Stomp (camel-stomp)      * The stomp component is used for communicating with Stomp compliant      * message brokers.      *       * Category: messaging      * Since: 2.12      * Maven coordinates: org.apache.camel:camel-stomp      *       * Syntax:<code>stomp:destination</code>      *       * Path parameter: destination (required)      * Name of the queue      */
