...
argument_list|)
DECL|interface|HazelcastMultimapEndpointBuilderFactory
specifier|public
interface|interface
name|HazelcastMultimapEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the Hazelcast Multimap component.      */
DECL|interface|HazelcastMultimapEndpointConsumerBuilder
specifier|public
interface|interface
name|HazelcastMultimapEndpointConsumerBuilder
extends|extends
name|EndpointConsumerBuilder
block|{
DECL|method|advanced ()
specifier|default
name|AdvancedHazelcastMultimapEndpointConsumerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the Hazelcast Multimap      * component.      */
DECL|interface|AdvancedHazelcastMultimapEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedHazelcastMultimapEndpointConsumerBuilder
extends|extends
...
DECL|method|advanced ()
specifier|default
name|AdvancedHazelcastMultimapEndpointProducerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the Hazelcast Multimap      * component.      */
DECL|interface|AdvancedHazelcastMultimapEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedHazelcastMultimapEndpointProducerBuilder
extends|extends
...
name|poll
block|;     }
comment|/**      * Hazelcast Multimap (camel-hazelcast)      * The hazelcast-multimap component is used to to access Hazelcast      * distributed multimap.      *       * Syntax:<code>hazelcast-multimap:cacheName</code>      * Category: cache,datagrid      * Available as of version: 2.7      * Maven coordinates: org.apache.camel:camel-hazelcast      */
DECL|method|hazelcastMultimap (String path)
specifier|default
name|HazelcastMultimapEndpointBuilder
name|hazelcastMultimap
parameter_list|(
name|String
name|path
parameter_list|)
block|{
class|class
name|HazelcastMultimapEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
