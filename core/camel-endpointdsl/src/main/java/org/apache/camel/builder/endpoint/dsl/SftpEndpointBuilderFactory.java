...
begin_comment
comment|/**  * The sftp (FTP over SSH) component is used for uploading or downloading files  * from SFTP servers.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|SftpEndpointBuilderFactory
specifier|public
interface|interface
name|SftpEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the SFTP component.      */
DECL|interface|SftpEndpointConsumerBuilder
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the SFTP component.      */
DECL|interface|AdvancedSftpEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedSftpEndpointConsumerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the SFTP component.      */
DECL|interface|AdvancedSftpEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedSftpEndpointProducerBuilder
extends|extends
...
name|TryRename
block|;     }
comment|/**      * SFTP (camel-ftp)      * The sftp (FTP over SSH) component is used for uploading or downloading      * files from SFTP servers.      *       * Category: file      * Available as of version: 1.1      * Maven coordinates: org.apache.camel:camel-ftp      *       * Syntax:<code>sftp:host:port/directoryName</code>      *       * Path parameter: host (required)      * Hostname of the FTP server      *       * Path parameter: port      * Port of the FTP server      *       * Path parameter: directoryName      * The starting directory      */
