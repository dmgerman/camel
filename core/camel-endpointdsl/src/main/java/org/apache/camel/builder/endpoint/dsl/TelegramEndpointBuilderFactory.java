...
begin_comment
comment|/**  * The telegram component provides access to the Telegram Bot API.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|TelegramEndpointBuilderFactory
specifier|public
interface|interface
name|TelegramEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the Telegram component.      */
DECL|interface|TelegramEndpointConsumerBuilder
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Telegram (camel-telegram)      * The telegram component provides access to the Telegram Bot API.      *       * Syntax:<code>telegram:type/authorizationToken</code>      * Category: chat      * Available as of version: 2.18      * Maven coordinates: org.apache.camel:camel-telegram      */
...
block|{
class|class
name|TelegramEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
