...
begin_comment
comment|/**  * The Kubernetes Service Accounts component provides a producer to execute  * service account operations.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|KubernetesServiceAccountsEndpointBuilderFactory
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Kubernetes Service Account (camel-kubernetes)      * The Kubernetes Service Accounts component provides a producer to execute      * service account operations.      *       * Category: container,cloud,paas      * Available as of version: 2.17      * Maven coordinates: org.apache.camel:camel-kubernetes      *       * Syntax:<code>kubernetes-service-accounts:masterUrl</code>      *       * Path parameter: masterUrl (required)      * Kubernetes Master url      */
DECL|method|kubernetesServiceAccounts ( String path)
specifier|default
name|KubernetesServiceAccountsEndpointBuilder
name|kubernetesServiceAccounts
parameter_list|(
name|String
name|path
parameter_list|)
block|{
class|class
name|KubernetesServiceAccountsEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
