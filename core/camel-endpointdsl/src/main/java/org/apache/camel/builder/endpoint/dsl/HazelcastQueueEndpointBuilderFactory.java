...
name|poll
block|;     }
comment|/**      * Hazelcast Queue (camel-hazelcast)      * The hazelcast-queue component is used to access Hazelcast distributed      * queue.      *       * Category: cache,datagrid      * Since: 2.7      * Maven coordinates: org.apache.camel:camel-hazelcast      *       * Syntax:<code>hazelcast-queue:cacheName</code>      *       * Path parameter: cacheName (required)      * The name of the cache      */
