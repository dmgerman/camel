...
argument_list|)
DECL|interface|KubernetesResourcesQuotaEndpointBuilderFactory
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Kubernetes Resources Quota (camel-kubernetes)      * The Kubernetes Resources Quota component provides a producer to execute      * kubernetes resources quota operations.      *       * Category: container,cloud,paas      * Available as of version: 2.17      * Maven coordinates: org.apache.camel:camel-kubernetes      *       * Syntax:<code>kubernetes-resources-quota:masterUrl</code>      *       * Path parameter: masterUrl (required)      * Kubernetes Master url      */
DECL|method|kubernetesResourcesQuota ( String path)
specifier|default
name|KubernetesResourcesQuotaEndpointBuilder
name|kubernetesResourcesQuota
parameter_list|(
name|String
name|path
parameter_list|)
block|{
class|class
name|KubernetesResourcesQuotaEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
