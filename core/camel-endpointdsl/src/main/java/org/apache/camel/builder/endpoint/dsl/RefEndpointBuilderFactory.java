...
block|}
block|}
comment|/**      * Ref (camel-ref)      * The ref component is used for lookup of existing endpoints bound in the      * Registry.      *       * Category: core,endpoint      * Since: 1.2      * Maven coordinates: org.apache.camel:camel-ref      *       * Syntax:<code>ref:name</code>      *       * Path parameter: name (required)      * Name of endpoint to lookup in the registry.      */
