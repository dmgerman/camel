...
return|;
block|}
comment|/**          * To use a custom exchange formatter.          *           * The option is a:<code>org.apache.camel.spi.ExchangeFormatter</code>          * type.          *           * Group: advanced          */
DECL|method|exchangeFormatter ( ExchangeFormatter exchangeFormatter)
specifier|default
name|AdvancedLogEndpointBuilder
name|exchangeFormatter
parameter_list|(
...
return|;
block|}
comment|/**          * To use a custom exchange formatter.          *           * The option will be converted to a          *<code>org.apache.camel.spi.ExchangeFormatter</code> type.          *           * Group: advanced          */
DECL|method|exchangeFormatter ( String exchangeFormatter)
specifier|default
name|AdvancedLogEndpointBuilder
name|exchangeFormatter
parameter_list|(
...
name|Fixed
block|;     }
comment|/**      * Log (camel-log)      * The log component logs message exchanges to the underlying logging      * mechanism.      *       * Category: core,monitoring      * Since: 1.1      * Maven coordinates: org.apache.camel:camel-log      *       * Syntax:<code>log:loggerName</code>      *       * Path parameter: loggerName (required)      * The logger name to use      */
