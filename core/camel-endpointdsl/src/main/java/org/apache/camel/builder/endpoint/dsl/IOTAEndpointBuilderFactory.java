...
block|}
block|}
comment|/**      * IOTA (camel-iota)      * Component for integrate IOTA DLT      *       * Category: dlt      * Since: 2.23      * Maven coordinates: org.apache.camel:camel-iota      *       * Syntax:<code>iota:name</code>      *       * Path parameter: name (required)      * Component name      */
