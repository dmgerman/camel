...
begin_comment
comment|/**  * The Kubernetes Persistent Volumes Claims component provides a producer to  * execute kubernetes persistent volume claim operations.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|KubernetesPersistentVolumesClaimsEndpointBuilderFactory
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * The Kubernetes Persistent Volumes Claims component provides a producer to      * execute kubernetes persistent volume claim operations. Creates a builder      * to build endpoints for the Kubernetes Persistent Volume Claim component.      */
DECL|method|kubernetesPersistentVolumesClaims ( String path)
specifier|default
name|KubernetesPersistentVolumesClaimsEndpointBuilder
name|kubernetesPersistentVolumesClaims
parameter_list|(
name|String
name|path
parameter_list|)
block|{
class|class
name|KubernetesPersistentVolumesClaimsEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
