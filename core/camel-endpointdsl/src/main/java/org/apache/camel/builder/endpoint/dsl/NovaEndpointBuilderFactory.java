...
begin_comment
comment|/**  * The openstack-nova component allows messages to be sent to an OpenStack  * compute services.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|NovaEndpointBuilderFactory
specifier|public
interface|interface
name|NovaEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint for the OpenStack Nova component.      */
DECL|interface|NovaEndpointBuilder
specifier|public
interface|interface
...
specifier|default
name|AdvancedNovaEndpointBuilder
name|advanced
parameter_list|()
block|{
return|return
...
return|;
block|}
comment|/**          * OpenStack Nova subsystem.          *           * The option is a:<code>java.lang.String</code> type.          *           * Required: true          * Group: producer          */
...
block|}
block|}
comment|/**      * Advanced builder for endpoint for the OpenStack Nova component.      */
DECL|interface|AdvancedNovaEndpointBuilder
specifier|public
interface|interface
name|AdvancedNovaEndpointBuilder
extends|extends
...
block|}
block|}
comment|/**      * OpenStack Nova (camel-openstack)      * The openstack-nova component allows messages to be sent to an OpenStack      * compute services.      *       * Category: cloud,paas      * Since: 2.19      * Maven coordinates: org.apache.camel:camel-openstack      *       * Syntax:<code>openstack-nova:host</code>      *       * Path parameter: host (required)      * OpenStack host url      */
DECL|method|openstackNova (String path)
specifier|default
name|NovaEndpointBuilder
name|openstackNova
parameter_list|(
