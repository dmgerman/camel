...
return|;
block|}
comment|/**      * SMPP (camel-smpp)      * To send and receive SMS using a SMSC (Short Message Service Center).      *       * Category: mobile      * Since: 2.2      * Maven coordinates: org.apache.camel:camel-smpp      */
