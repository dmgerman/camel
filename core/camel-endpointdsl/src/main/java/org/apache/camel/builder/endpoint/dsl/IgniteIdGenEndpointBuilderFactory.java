...
block|;     }
comment|/**      * The Ignite ID Generator endpoint is one of camel-ignite endpoints which      * allows you to interact with Ignite Atomic Sequences and ID Generators.      * Maven coordinates: org.apache.camel:camel-ignite      */
