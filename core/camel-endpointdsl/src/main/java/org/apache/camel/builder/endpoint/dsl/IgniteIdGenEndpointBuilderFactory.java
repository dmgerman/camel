...
begin_comment
comment|/**  * The Ignite ID Generator endpoint is one of camel-ignite endpoints which  * allows you to interact with Ignite Atomic Sequences and ID Generators.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|IgniteIdGenEndpointBuilderFactory
specifier|public
interface|interface
...
block|;     }
comment|/**      * Ignite ID Generator (camel-ignite)      * The Ignite ID Generator endpoint is one of camel-ignite endpoints which      * allows you to interact with Ignite Atomic Sequences and ID Generators.      *       * Category: nosql,cache,compute      * Since: 2.17      * Maven coordinates: org.apache.camel:camel-ignite      *       * Syntax:<code>ignite-idgen:name</code>      *       * Path parameter: name (required)      * The sequence name.      */
...
block|{
class|class
name|IgniteIdGenEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
