...
name|NONE
block|;     }
comment|/**      * Google Pubsub (camel-google-pubsub)      * Messaging client for Google Cloud Platform PubSub Service      *       * Category: messaging      * Since: 2.19      * Maven coordinates: org.apache.camel:camel-google-pubsub      *       * Syntax:<code>google-pubsub:projectId:destinationName</code>      *       * Path parameter: projectId (required)      * Project Id      *       * Path parameter: destinationName (required)      * Destination Name      */
