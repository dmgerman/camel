...
block|;     }
comment|/**      * AS2 (camel-as2)      * Component used for transferring data secure and reliable over the      * internet using the AS2 protocol.      *       * Syntax:<code>as2:apiName/methodName</code>      * Category: AS2      * Available as of version: 2.22      * Maven coordinates: org.apache.camel:camel-as2      */
