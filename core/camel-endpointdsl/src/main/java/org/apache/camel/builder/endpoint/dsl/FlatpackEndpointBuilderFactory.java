...
begin_comment
comment|/**  * The flatpack component supports fixed width and delimited file parsing via  * the FlatPack library.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|FlatpackEndpointBuilderFactory
specifier|public
interface|interface
name|FlatpackEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the Flatpack component.      */
DECL|interface|FlatpackEndpointConsumerBuilder
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the Flatpack component.      */
DECL|interface|AdvancedFlatpackEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedFlatpackEndpointConsumerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the Flatpack component.      */
DECL|interface|AdvancedFlatpackEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedFlatpackEndpointProducerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Flatpack (camel-flatpack)      * The flatpack component supports fixed width and delimited file parsing      * via the FlatPack library.      *       * Category: transformation      * Available as of version: 1.4      * Maven coordinates: org.apache.camel:camel-flatpack      *       * Syntax:<code>flatpack:type:resourceUri</code>      *       * Path parameter: type      * Whether to use fixed or delimiter      * Default value: delim      * The value can be one of: fixed, delim      *       * Path parameter: resourceUri (required)      * URL for loading the flatpack mapping file from classpath or file system      */
...
block|{
class|class
name|FlatpackEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
