...
begin_comment
comment|/**  * The Kubernetes HPA component provides a producer to execute kubernetes hpa  * operations and a consumer to consume HPA events.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|KubernetesHPAEndpointBuilderFactory
specifier|public
interface|interface
name|KubernetesHPAEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the Kubernetes HPA component.      */
DECL|interface|KubernetesHPAEndpointConsumerBuilder
specifier|public
interface|interface
...
specifier|default
name|AdvancedKubernetesHPAEndpointConsumerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the Kubernetes HPA component.      */
DECL|interface|AdvancedKubernetesHPAEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedKubernetesHPAEndpointConsumerBuilder
extends|extends
...
DECL|method|advanced ()
specifier|default
name|AdvancedKubernetesHPAEndpointProducerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the Kubernetes HPA component.      */
DECL|interface|AdvancedKubernetesHPAEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedKubernetesHPAEndpointProducerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Kubernetes HPA (camel-kubernetes)      * The Kubernetes HPA component provides a producer to execute kubernetes      * hpa operations and a consumer to consume HPA events.      *       * Syntax:<code>kubernetes-hpa:masterUrl</code>      * Category: container,cloud,paas      * Available as of version: 2.23      * Maven coordinates: org.apache.camel:camel-kubernetes      */
...
block|{
class|class
name|KubernetesHPAEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
