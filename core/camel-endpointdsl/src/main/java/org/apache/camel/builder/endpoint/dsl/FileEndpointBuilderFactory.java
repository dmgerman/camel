...
return|;
block|}
comment|/**          * Used to append characters (text) after writing files. This can for          * example be used to add new lines or other separators when writing and          * appending to existing files. To specify new-line (slash-n or slash-r)          * or tab (slash-t) characters then escape with an extra slash, eg          * slash-slash-n.          *           * The option is a:<code>java.lang.String</code> type.          *           * Group: producer          */
