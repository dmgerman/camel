...
argument_list|)
DECL|interface|XsltSaxonEndpointBuilderFactory
specifier|public
interface|interface
name|XsltSaxonEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint for the XSLT Saxon component.      */
DECL|interface|XsltSaxonEndpointBuilder
specifier|public
interface|interface
name|XsltSaxonEndpointBuilder
extends|extends
name|EndpointProducerBuilder
block|{
DECL|method|advanced ()
specifier|default
name|AdvancedXsltSaxonEndpointBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint for the XSLT Saxon component.      */
DECL|interface|AdvancedXsltSaxonEndpointBuilder
specifier|public
interface|interface
name|AdvancedXsltSaxonEndpointBuilder
extends|extends
...
name|file
block|;     }
comment|/**      * XSLT Saxon (camel-xslt-saxon)      * Transforms the message using a XSLT template using Saxon.      *       * Category: core,transformation      * Available as of version: 3.0      * Maven coordinates: org.apache.camel:camel-xslt-saxon      *       * Syntax:<code>xslt-saxon:resourceUri</code>      *       * Path parameter: resourceUri (required)      * Path to the template. The following is supported by the default      * URIResolver. You can prefix with: classpath, file, http, ref, or bean.      * classpath, file and http loads the resource using these protocols      * (classpath is default). ref will lookup the resource in the registry.      * bean will call a method on a bean to be used as the resource. For bean      * you can specify the method name after dot, eg bean:myBean.myMethod      */
DECL|method|xsltSaxon (String path)
specifier|default
name|XsltSaxonEndpointBuilder
name|xsltSaxon
parameter_list|(
...
block|{
class|class
name|XsltSaxonEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
