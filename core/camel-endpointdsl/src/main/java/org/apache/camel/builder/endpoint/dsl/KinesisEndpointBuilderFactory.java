...
argument_list|)
DECL|interface|KinesisEndpointBuilderFactory
specifier|public
interface|interface
name|KinesisEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the AWS Kinesis component.      */
DECL|interface|KinesisEndpointConsumerBuilder
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the AWS Kinesis component.      */
DECL|interface|AdvancedKinesisEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedKinesisEndpointConsumerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the AWS Kinesis component.      */
DECL|interface|AdvancedKinesisEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedKinesisEndpointProducerBuilder
extends|extends
...
name|silent
block|;     }
comment|/**      * AWS Kinesis (camel-aws-kinesis)      * The aws-kinesis component is for consuming and producing records from      * Amazon Kinesis Streams.      *       * Syntax:<code>aws-kinesis:streamName</code>      * Category: cloud,messaging      * Available as of version: 2.17      * Maven coordinates: org.apache.camel:camel-aws-kinesis      */
...
block|{
class|class
name|KinesisEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
