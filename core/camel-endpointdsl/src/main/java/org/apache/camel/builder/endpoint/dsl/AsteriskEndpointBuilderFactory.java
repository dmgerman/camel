...
block|;     }
comment|/**      * Asterisk (camel-asterisk)      * The asterisk component is used to interact with Asterisk PBX Server.      *       * Category: voip      * Since: 2.18      * Maven coordinates: org.apache.camel:camel-asterisk      *       * Syntax:<code>asterisk:name</code>      *       * Path parameter: name (required)      * Logical name      */
