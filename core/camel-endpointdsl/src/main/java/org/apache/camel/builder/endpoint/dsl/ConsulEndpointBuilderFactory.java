...
return|;
block|}
comment|/**          * The API endpoint.          * The option is a<code>java.lang.String</code> type.          * @group common          */
DECL|method|apiEndpoint (String apiEndpoint)
specifier|default
name|ConsulEndpointConsumerBuilder
name|apiEndpoint
parameter_list|(
...
block|}
block|}
comment|/**      * The camel consul component allows you to work with Consul, a distributed,      * highly available, datacenter-aware, service discovery and configuration      * system. Creates a builder to build endpoints for the Consul component.      */
