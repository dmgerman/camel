...
block|}
block|}
comment|/**      * SIP (camel-sip)      * To send and receive messages using the SIP protocol (used in telco and      * mobile).      *       * Category: mobile      * Since: 2.5      * Maven coordinates: org.apache.camel:camel-sip      *       * Syntax:<code>sip:uri</code>      *       * Path parameter: uri (required)      * URI of the SIP server to connect to (the username and password can be      * included such as: john:secretmyserver:9999)      */
...
return|;
block|}
comment|/**      * SIP (Secure) (camel-sip)      * To send and receive messages using the SIP protocol (used in telco and      * mobile).      *       * Category: mobile      * Since: 2.5      * Maven coordinates: org.apache.camel:camel-sip      *       * Syntax:<code>sips:uri</code>      *       * Path parameter: uri (required)      * URI of the SIP server to connect to (the username and password can be      * included such as: john:secretmyserver:9999)      */
...
return|;
block|}
comment|/**      * SIP (camel-sip)      * To send and receive messages using the SIP protocol (used in telco and      * mobile).      *       * Category: mobile      * Since: 2.5      * Maven coordinates: org.apache.camel:camel-sip      */
