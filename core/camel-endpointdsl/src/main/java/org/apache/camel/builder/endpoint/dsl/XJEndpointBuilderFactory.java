...
begin_comment
comment|/**  * Transforms json/xml message back and forth using a XSLT.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|XJEndpointBuilderFactory
specifier|public
interface|interface
name|XJEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint for the XJ component.      */
DECL|interface|XJEndpointBuilder
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Advanced builder for endpoint for the XJ component.      */
DECL|interface|AdvancedXJEndpointBuilder
specifier|public
interface|interface
name|AdvancedXJEndpointBuilder
extends|extends
