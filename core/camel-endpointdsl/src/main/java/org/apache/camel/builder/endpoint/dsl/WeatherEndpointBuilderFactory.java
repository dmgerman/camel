...
begin_comment
comment|/**  * Polls the weather information from Open Weather Map.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|WeatherEndpointBuilderFactory
specifier|public
interface|interface
name|WeatherEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the Weather component.      */
DECL|interface|WeatherEndpointConsumerBuilder
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the Weather component.      */
DECL|interface|AdvancedWeatherEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedWeatherEndpointConsumerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the Weather component.      */
DECL|interface|AdvancedWeatherEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedWeatherEndpointProducerBuilder
extends|extends
...
name|Daily
block|;     }
comment|/**      * Weather (camel-weather)      * Polls the weather information from Open Weather Map.      *       * Category: api      * Since: 2.12      * Maven coordinates: org.apache.camel:camel-weather      *       * Syntax:<code>weather:name</code>      *       * Path parameter: name (required)      * The name value is not used.      */
...
block|{
class|class
name|WeatherEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
