...
argument_list|)
DECL|interface|Sjms2EndpointBuilderFactory
specifier|public
interface|interface
name|Sjms2EndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the Simple JMS2 component.      */
DECL|interface|Sjms2EndpointConsumerBuilder
specifier|public
interface|interface
name|Sjms2EndpointConsumerBuilder
extends|extends
name|EndpointConsumerBuilder
block|{
DECL|method|advanced ()
specifier|default
name|AdvancedSjms2EndpointConsumerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
return|;
block|}
comment|/**          * Sets topic consumer to durable.          *           * The option is a:<code>boolean</code> type.          *           * Group: consumer          */
...
return|;
block|}
comment|/**          * Sets topic consumer to durable.          *           * The option will be converted to a<code>boolean</code> type.          *           * Group: consumer          */
...
return|;
block|}
comment|/**          * Sets the consumer to shared.          *           * The option is a:<code>boolean</code> type.          *           * Group: consumer          */
DECL|method|shared (boolean shared)
specifier|default
name|Sjms2EndpointConsumerBuilder
name|shared
parameter_list|(
...
return|;
block|}
comment|/**          * Sets the consumer to shared.          *           * The option will be converted to a<code>boolean</code> type.          *           * Group: consumer          */
DECL|method|shared (String shared)
specifier|default
name|Sjms2EndpointConsumerBuilder
name|shared
parameter_list|(
...
return|;
block|}
comment|/**          * Sets the subscription Id, required for durable or shared topics.          *           * The option is a:<code>java.lang.String</code> type.          *           * Group: consumer          */
DECL|method|subscriptionId ( String subscriptionId)
specifier|default
name|Sjms2EndpointConsumerBuilder
name|subscriptionId
parameter_list|(
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the Simple JMS2 component.      */
DECL|interface|AdvancedSjms2EndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedSjms2EndpointConsumerBuilder
extends|extends
...
DECL|method|advanced ()
specifier|default
name|AdvancedSjms2EndpointProducerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the Simple JMS2 component.      */
DECL|interface|AdvancedSjms2EndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedSjms2EndpointProducerBuilder
extends|extends
...
block|;     }
comment|/**      * Simple JMS2 (camel-sjms2)      * The sjms2 component (simple jms) allows messages to be sent to (or      * consumed from) a JMS Queue or Topic (uses JMS 2.x API).      *       * Category: messaging      * Available as of version: 2.19      * Maven coordinates: org.apache.camel:camel-sjms2      *       * Syntax:<code>sjms2:destinationType:destinationName</code>      *       * Path parameter: destinationType      * The kind of destination to use      * Default value: queue      * The value can be one of: queue, topic      *       * Path parameter: destinationName (required)      * DestinationName is a JMS queue or topic name. By default, the      * destinationName is interpreted as a queue name.      */
