...
argument_list|)
DECL|interface|AMQPEndpointBuilderFactory
specifier|public
interface|interface
name|AMQPEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the AMQP component.      */
DECL|interface|AMQPEndpointConsumerBuilder
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the AMQP component.      */
DECL|interface|AdvancedAMQPEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedAMQPEndpointConsumerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the AMQP component.      */
DECL|interface|AdvancedAMQPEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedAMQPEndpointProducerBuilder
extends|extends
