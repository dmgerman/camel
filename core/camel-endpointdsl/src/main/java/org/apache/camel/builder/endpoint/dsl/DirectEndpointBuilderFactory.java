...
block|}
block|}
comment|/**      * Direct (camel-direct)      * The direct component provides direct, synchronous call to another      * endpoint from the same CamelContext.      *       * Category: core,endpoint      * Since: 1.0      * Maven coordinates: org.apache.camel:camel-direct      *       * Syntax:<code>direct:name</code>      *       * Path parameter: name (required)      * Name of direct endpoint      */
