...
block|;     }
comment|/**      * MongoDB GridFS (camel-mongodb-gridfs)      * Component for working with MongoDB GridFS.      *       * Category: database,nosql      * Since: 2.18      * Maven coordinates: org.apache.camel:camel-mongodb-gridfs      *       * Syntax:<code>mongodb-gridfs:connectionBean</code>      *       * Path parameter: connectionBean (required)      * Name of com.mongodb.MongoClient to use.      */
