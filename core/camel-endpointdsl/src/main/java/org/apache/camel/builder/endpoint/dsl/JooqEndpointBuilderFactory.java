...
argument_list|)
DECL|interface|JooqEndpointBuilderFactory
specifier|public
interface|interface
name|JooqEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the JOOQ component.      */
DECL|interface|JooqEndpointConsumerBuilder
specifier|public
interface|interface
name|JooqEndpointConsumerBuilder
extends|extends
name|EndpointConsumerBuilder
block|{
DECL|method|advanced ()
specifier|default
name|AdvancedJooqEndpointConsumerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
return|;
block|}
comment|/**          * Delete entity after it is consumed.          *           * The option is a:<code>boolean</code> type.          *           * Group: consumer          */
...
return|;
block|}
comment|/**          * Delete entity after it is consumed.          *           * The option will be converted to a<code>boolean</code> type.          *           * Group: consumer          */
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the JOOQ component.      */
DECL|interface|AdvancedJooqEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedJooqEndpointConsumerBuilder
extends|extends
...
DECL|method|advanced ()
specifier|default
name|AdvancedJooqEndpointProducerBuilder
name|advanced
parameter_list|()
block|{
return|return
...
return|;
block|}
comment|/**          * Type of operation to execute on query.          *           * The option is a:          *<code>org.apache.camel.component.jooq.JooqOperation</code> type.          *           * Group: producer          */
DECL|method|operation (JooqOperation operation)
specifier|default
name|JooqEndpointProducerBuilder
name|operation
parameter_list|(
...
return|;
block|}
comment|/**          * Type of operation to execute on query.          *           * The option will be converted to a          *<code>org.apache.camel.component.jooq.JooqOperation</code> type.          *           * Group: producer          */
...
return|;
block|}
comment|/**          * To execute plain SQL query.          *           * The option is a:<code>java.lang.String</code> type.          *           * Group: producer          */
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the JOOQ component.      */
DECL|interface|AdvancedJooqEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedJooqEndpointProducerBuilder
extends|extends
...
name|NONE
block|;     }
comment|/**      * JOOQ (camel-jooq)      * The jooq component enables you to store and retrieve entities from      * databases using JOOQ      *       * Category: database      * Available as of version: 3.0      * Maven coordinates: org.apache.camel:camel-jooq      *       * Syntax:<code>jooq:entityType</code>      *       * Path parameter: entityType      * JOOQ entity class      */
