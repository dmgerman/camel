...
begin_comment
comment|/**  * The Kubernetes Configmaps component provides a producer to execute kubernetes  * configmap operations.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|KubernetesConfigMapsEndpointBuilderFactory
specifier|public
interface|interface
...
block|{
class|class
name|KubernetesConfigMapsEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
...
name|super
argument_list|(
literal|"kubernetes-config-maps"
argument_list|,
name|path
argument_list|)
expr_stmt|;
