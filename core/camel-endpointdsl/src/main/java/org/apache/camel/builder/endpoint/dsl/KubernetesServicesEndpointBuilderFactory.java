...
begin_comment
comment|/**  * The Kubernetes Service Accounts component provides a producer to execute  * service operations and a consumer to consume service events.  *   * Generated by camel-package-maven-plugin - do not edit this file!  */
end_comment
...
argument_list|)
DECL|interface|KubernetesServicesEndpointBuilderFactory
specifier|public
interface|interface
name|KubernetesServicesEndpointBuilderFactory
block|{
comment|/**      * Builder for endpoint consumers for the Kubernetes Services component.      */
DECL|interface|KubernetesServicesEndpointConsumerBuilder
specifier|public
interface|interface
...
block|}
block|}
comment|/**      * Advanced builder for endpoint consumers for the Kubernetes Services      * component.      */
DECL|interface|AdvancedKubernetesServicesEndpointConsumerBuilder
specifier|public
interface|interface
name|AdvancedKubernetesServicesEndpointConsumerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Advanced builder for endpoint producers for the Kubernetes Services      * component.      */
DECL|interface|AdvancedKubernetesServicesEndpointProducerBuilder
specifier|public
interface|interface
name|AdvancedKubernetesServicesEndpointProducerBuilder
extends|extends
...
block|}
block|}
comment|/**      * Kubernetes Services (camel-kubernetes)      * The Kubernetes Service Accounts component provides a producer to execute      * service operations and a consumer to consume service events.      *       * Category: container,cloud,paas      * Available as of version: 2.17      * Maven coordinates: org.apache.camel:camel-kubernetes      *       * Syntax:<code>kubernetes-services:masterUrl</code>      *       * Path parameter: masterUrl (required)      * Kubernetes Master url      */
...
block|{
class|class
name|KubernetesServicesEndpointBuilderImpl
extends|extends
name|AbstractEndpointBuilder
