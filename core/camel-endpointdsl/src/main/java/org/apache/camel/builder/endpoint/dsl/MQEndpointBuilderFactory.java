...
return|;
block|}
comment|/**          * To define a proxy protocol when instantiating the MQ client.          *           * The option is a:<code>com.amazonaws.Protocol</code> type.          *           * Group: producer          */
...
return|;
block|}
comment|/**          * To define a proxy protocol when instantiating the MQ client.          *           * The option will be converted to a<code>com.amazonaws.Protocol</code>          * type.          *           * Group: producer          */
...
name|https
block|;     }
comment|/**      * AWS MQ (camel-aws-mq)      * The aws-mq is used for managing Amazon MQ instances.      *       * Category: cloud,management      * Since: 2.21      * Maven coordinates: org.apache.camel:camel-aws-mq      *       * Syntax:<code>aws-mq:label</code>      *       * Path parameter: label (required)      * Logical name      */
