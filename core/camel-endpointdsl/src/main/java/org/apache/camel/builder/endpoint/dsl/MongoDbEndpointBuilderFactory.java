...
name|MongoIterable
block|;     }
comment|/**      * MongoDB (camel-mongodb)      * Component for working with documents stored in MongoDB database.      *       * Category: database,nosql      * Since: 2.19      * Maven coordinates: org.apache.camel:camel-mongodb      *       * Syntax:<code>mongodb:connectionBean</code>      *       * Path parameter: connectionBean (required)      * Name of com.mongodb.Mongo to use.      */
