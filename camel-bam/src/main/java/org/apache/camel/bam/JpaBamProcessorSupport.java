...
expr_stmt|;
block|}
DECL|method|JpaBamProcessorSupport (Expression<Exchange> correlationKeyExpression, Activity activity, JpaTemplate template)
specifier|public
name|JpaBamProcessorSupport
parameter_list|(
name|Expression
...
return|;
block|}
DECL|method|setActivity (Activity activity)
specifier|public
name|void
name|setActivity
parameter_list|(
