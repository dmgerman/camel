...
argument_list|()
decl_stmt|;
comment|/*<bean class="org.apache.servicemix.jbi.container.ActivationSpec"><property name="id" value="receiver"/><property name="service" ref="receiverServiceName"/><property name="endpoint" value="receiver"/><!-- no need to specify service on this POJO as it is hard coded --><property name="component"><bean class="org.apache.servicemix.tck.ReceiverComponent"/></property></bean>           */
name|ActivationSpec
name|activationSpec
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|//activationSpec.setComponentName("camel");
name|jbiContainer
operator|.
...
argument_list|()
expr_stmt|;
comment|//jbiContainer.activateComponent(component, "camel");
...
name|from
argument_list|(
literal|"jbi:service:test:a"
argument_list|)
operator|.
name|to
argument_list|(
literal|"jbi:service:test:b"
argument_list|)
expr_stmt|;
name|from
argument_list|(
